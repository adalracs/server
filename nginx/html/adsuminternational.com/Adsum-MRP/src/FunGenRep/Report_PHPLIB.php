...
/*
 ...
 BEWARE: _setVar is a method to be defined on the Report.php
          setVar is PHPLIB method to set a template variable.

*/
require_once("HTML/Template/PHPLIB.php");
class ReportTemplate extends Template_PHPLIB {
   ...
   function setup()
   {
         ...
         **/
        $this->Template_PHPLIB($this->_dir);
        $this->_setFile();
    } 
    ...
    function _setFile($handle="")
    {
        ...
        $this->setFile($this->_handle, $this->_file);      
    }
    ...
    function blockParser($titlename, $title)
    {
        ...
        **/
        $titleblock = $this->_blockprefix . $titlename; 
         ...
         **/
            ...
            $this->setBlock($this->_handle, $titleblock, $this->dummies[$titleblock]);
        }
    ...
    function cleanBlock($titlename)
    {
        $titleblock = $this->_blockprefix . $titlename; 
        if ( isset($this->dummies[$titleblock]) ) {
            $this->setVar($this->dummies[$titleblock], "");    	
        }
    }
    ...
    function parseVariables($list)
    {
        ...
        **/
        ...
        if ( !isset($this->dummies[$block])) {
            ...
            $this->setBlock($this->_handle, $block, $this->dummies[$block]);
        }  
        ...
        if ($this->_showtotals && !$this->dummies[$totalsname] ) {
            ...
            $this->setBlock($this->_handle, $totalsname, $this->dummies[$totalsname]);
        }
        
        $this->setVar($this->dummies[$block], "");
	...
	$this->_totalizing = false;
        $this->_setVar($list);
	$this->parse($this->dummies[$block], $block);
	$this->_totalizing = true;
    }
