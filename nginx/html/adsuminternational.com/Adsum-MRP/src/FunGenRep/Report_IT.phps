...
class ReportTemplate extends HTML_Template_IT {
   ...
   function setup()
   {
         ...
         **/
        $this->HTML_Template_IT($this->_dir);
        $this->setFile();
    } 
    ...
    function blockParser($titlename, $title)
    {
         ...
         **/
	$block = $this->_blockprefix . $titlename;
     ...
     * @return 
     **/
    function cleanBlock($title, $level)
    {
    }
     ...
     * 
     * Wrapper to parse the last level of the report, i.e., the vars
     * 
     * @param $block
     * @param $value
     * @return 
