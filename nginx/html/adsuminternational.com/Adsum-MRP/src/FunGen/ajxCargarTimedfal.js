...
//			Tercera celda
			...
			var txtField_1 = document.createElement("INPUT");
			txtField_1.type = "TEXT";
			txtField_1.name = "horasOperac_" + iteration;
			txtField_1.size = 10;
			tblCell_3.appendChild(txtField_1);
//			Cuarta celda
			var tblCell_4 = tblRow.insertCell(3);
...
//				Elimina los codigos de strdata; datos finales sobre los cuales se realiza la consulta
			...
			tblCell_4.appendChild(btnRemove);
		}
    }
}