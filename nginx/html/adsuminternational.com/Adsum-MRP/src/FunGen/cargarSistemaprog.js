...
<!--Fecha           : 25-abr-2005-->
function cargarSistemasprog(valor)
{
    /*
    ...
    */
    ...
    jsrsExecute("procSistemas.php", cargarSistemasprogResultado, "mostrarSistemas", valor );
}

function cargarSistemasprogResultado(cadena)
{
	if(cadena != "")
	{
