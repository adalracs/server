...
ini_set("display_errors", 1);
	...
	function innerHTML (&$html, $sbRow, $tipmat, $swth_sel,$sbarray){
		...
		$html .= '<input type="checkbox" name="chkselstar" value="'.$sbarray.'" '.$swth_sel.' onclick="'."setSelectionRow(this.value, document.getElementById('arrmatrep').value, ':|:', 'arrmatrep');".'">&nbsp;'.$sbRow['idmat'].'-'.$sbRow['nmat'].'</input>';
		...
		$html .= '<td class="estilo2">&nbsp;'.$sbRow['cantkg'].'</td>'."\n";
		$html .= '</tr>'."\n";
		
		$html .= '<tr>'."\n";
		$html .= '<td class="ui-widget-header estilo2"  width="35%">&nbsp;Metros:&nbsp;</td>'."\n";
		$html .= '<td class="estilo2">&nbsp;'.$sbRow['cantmt'].'</td>'."\n";
		$html .= '</tr>'."\n";
