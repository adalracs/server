<?php 
	...
	include '../../FunPerPriNiv/pktblprogramacorteextrusion.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecdProgramacorteextrusion['ordoppcodigo'] = $arrequipo[$b];
				$ircRecdProgramacorteextrusion['prograindice'] = $b;
				uprecordprogramacorteextrusion($ircRecdProgramacorteextrusion,$idcon);
