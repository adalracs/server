<?php 
	...
	include '../../FunPerPriNiv/pktblprogramavalvulado.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramavalvulado['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramavalvulado['prograindice'] = $b;
				uprecordprogramavalvulado($ircRecProgramavalvulado,$idcon);
