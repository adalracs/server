...
<table width="100%" border="0" cellspacing="1" cellpadding="1"  align="center">	
	<?php 
		for($a = 0; $a < $nr_horasextra; $a++): 
			...
			if($a % 2)
				$complement = 'class="NoiseDataTD" bgcolor="#E8F0F6" id="fila'.$a.'" onmouseover="setClassHover(this)" onmouseout="setClassIn(this)" onclick="showWindow('."'{$rw_horasextra['horextcodigo']}','{$rw_horasextra['horextfecha']}'".');"';
			else
				$complement = 'class="NoiseFooterTD" bgcolor="#f0f6ff" id="fila'.$a.'" onmouseover="setClassHover(this)" onmouseout="setClassOut(this)" onclick="showWindow('."'{$rw_horasextra['horextcodigo']}','{$rw_horasextra['horextfecha']}'".');"';
	?>
