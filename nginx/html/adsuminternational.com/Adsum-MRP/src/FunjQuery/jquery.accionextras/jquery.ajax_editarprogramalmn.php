<?php 
	...
	include '../../FunPerPriNiv/pktblprogramalaminado.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramalaminado['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramalaminado['prograindice'] = $b;
				uprecordprogramalaminado($ircRecProgramalaminado,$idcon);
