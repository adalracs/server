<?php 
	...
	include '../../FunPerPriNiv/pktblprogramacorte.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramacorte['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramacorte['prograindice'] = $b;
				uprecordprogramacorte($ircRecProgramacorte,$idcon);
