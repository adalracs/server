<?php 
	...
	include '../../FunPerPriNiv/pktblprogramaextrusion.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramaextrusion['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramaextrusion['prograindice'] = $b;
				uprecordprogramaextrusion($ircRecProgramaextrusion,$idcon);
