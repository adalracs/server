<?php 
	...
	include '../../FunPerPriNiv/pktblprogramasellado.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramasellado['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramasellado['prograindice'] = $b;
				uprecordprogramasellado($ircRecProgramasellado,$idcon);
