<?php 
	...
	include '../../FunPerPriNiv/pktblprogramatroquelado.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramatroquelado['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramatroquelado['prograindice'] = $b;
				uprecordprogramatroquelado($ircRecProgramatroquelado,$idcon);
