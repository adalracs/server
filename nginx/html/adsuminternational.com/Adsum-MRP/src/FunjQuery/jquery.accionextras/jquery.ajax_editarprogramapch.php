<?php 
	...
	include '../../FunPerPriNiv/pktblprogramapauchado.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramapauchado['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramapauchado['prograindice'] = $b;
				uprecordprogramapauchado($ircRecProgramapauchado,$idcon);
