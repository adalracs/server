<?php 
	...
	include '../../FunPerPriNiv/pktblprogramadoblado.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramadoblado['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramadoblado['prograindice'] = $b;
				uprecordprogramadoblado($ircRecProgramadoblado,$idcon);
