<?php 
	...
	include '../../FunPerPriNiv/pktblprogramaflexo.php';
	...
	for($a = 0;$a < count($arrObject);$a++)
	{
		...
		for($b= 0;$b<count($arrequipo);$b++)
		{
			if($b>0)
			{
				$ircRecProgramaflexo['ordoppcodigo'] = $arrequipo[$b];
				$ircRecProgramaflexo['prograindice'] = $b;
				uprecordprogramaflexo($ircRecProgramaflexo,$idcon);
