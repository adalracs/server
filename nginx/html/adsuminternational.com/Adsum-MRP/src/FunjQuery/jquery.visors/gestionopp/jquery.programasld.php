...
?>			
	<tr <?php echo $complement; ?> >
		...
		<td width="5%" class="cont-line">&nbsp;<input type="radio" name="radiobutton1" id="radiobutton1" value="<?php echo $rwSellado['ordoppcodigo']; ?>" onclick="setOrdoppcodigo(this.value);" /></td>
