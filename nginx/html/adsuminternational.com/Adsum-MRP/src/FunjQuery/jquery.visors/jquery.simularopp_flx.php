	...
	<div style="width:100%; height: auto;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">	
			<tr>
				...
				<td width="200" class="ui-state-default" style="border-top:0; border-bottom:0; border-left:0;">&nbsp;Proceso</td>
				<td width="15" class="ui-state-default" style="border:0;">&nbsp;</td>
			</tr>
		</table>
	</div>
</div>
<div style="width:950px; height: 350px; overflow:auto; border-top:0;" class="ui-widget-content">
...
?>
			<tr <?php echo $complement ?>>
				...
				<td width="198" style="border-left: 1px solid #fff; border-bottom: 1px solid #fff;">&nbsp;<small>
					<select name="<?php echo $objProcedimiento ?>" id="<?php echo $objProcedimiento ?>">
						<option value="">--Seleccione--</option>
							<?php 
								include_once('../../FunGen/floadprocedimiento.php');
								floadprocedimiento3($$objProcedimiento,$arrrutaitem,$arrmatlaminar,$idcon);
							?>
					</select></small>
				</td>
			</tr>
...
?>
			<tr class="<?php echo $class ?>">
				...
				<td width="100" style="border-left: 1px solid #fff; border-bottom: 1px solid #fff;">&nbsp;</td>
				<td width="100" style="border-left: 1px solid #fff; border-bottom: 1px solid #fff;">&nbsp;</td>
				<td width="198" style="border-left: 1px solid #fff; border-bottom: 1px solid #fff;">&nbsp;</td>
			</tr>
<?php
			}
		}
