...
<div style="width:778px; height: 14px; margin:0 auto;" class="ui-state-default">
	<div style="width:100%; height: auto;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">	
			<tr>
				<td width="150" class="ui-state-default" style="border-top:0; border-bottom:0; border-left:0;">&nbsp;C&oacute;digo</td>
				<td width="613" class="ui-state-default" style="border-top:0; border-bottom:0; border-left:0;">&nbsp;Componente</td>
...
?>			
			<tr <?php echo $complement ?> onClick="window.open('detallarcomponen.php?codigo=Endadsum&radiobutton=<?php echo $rwComponen['componcodigo'].'|s' ?>&nombtabl=componen','','status=no,menubar=no,scrollbars=yes,resizable=yes,left=300,width=800,height=550');">
				<td width="149" style=" border-bottom: 1px solid #fff;">&nbsp;<?php echo $rwComponen['componcodigo'] ?></td>
				<td width="613" style="border-left: 1px solid #fff; border-bottom: 1px solid #fff;">&nbsp;<?php echo $rwComponen['componnombre'] ?></td>
			</tr>
<?php
		endfor;
	endif;
