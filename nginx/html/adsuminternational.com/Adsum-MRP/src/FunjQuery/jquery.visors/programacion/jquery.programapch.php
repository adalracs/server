<?php
	//conexion
	$idcon = fncconn();
	$rsPauchado = dinamicscanopprogramapauchado1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
...
?>			
	<tr <?php echo $complement ?>">
		...
		<td class="cont-line">&nbsp;&nbsp;<?php echo ($b + 1) ?>&nbsp;<a onclick="openUpdateOpp('<?php echo $rwPauchado['ordoppcodigo'] ?>', '<?php echo $equipo ?>')"><span class="ui-icon ui-icon-document" style="float: left; margin-right: .3em;"></span></a></td>
