<?php
	...
	$idcon = fncconn();
	$rsLaminado = dinamicscanopprogramalaminado1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon, $rtr = 1);
...
?>		
	<tr <?php echo $complement; ?> >
		...
		<td width="5%" class="cont-line">&nbsp;&nbsp;<?php echo ($b + 1) ?>&nbsp;<a onclick="openUpdateOpp('<?php echo $rwLaminado['ordoppcodigo'] ?>', '<?php echo $equipo ?>')"><span class="ui-icon ui-icon-document" style="float: left; margin-right: .3em;"></span></a></td>
