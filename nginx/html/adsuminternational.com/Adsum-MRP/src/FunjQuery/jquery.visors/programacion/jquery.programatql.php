<?php
	//conexion
	$idcon = fncconn();
	$rsTroquelado = dinamicscanopprogramatroquelado1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
...
?>			
	<tr <?php echo $complement ?>">
		...
		<td class="cont-line">&nbsp;&nbsp;<?php echo ($b + 1) ?>&nbsp;<a onclick="openUpdateOpp('<?php echo $rwTroquelado['ordoppcodigo'] ?>', '<?php echo $equipo ?>')"><span class="ui-icon ui-icon-document" style="float: left; margin-right: .3em;"></span></a></td>
		<td class="cont-line">&nbsp;<?php echo str_pad($rwOptroquelado['solprocodigo'], 4, "0", STR_PAD_LEFT) ?></td>
