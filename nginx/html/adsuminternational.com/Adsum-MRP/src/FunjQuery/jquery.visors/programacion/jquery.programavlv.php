<?php
	//conexion
	$idcon = fncconn();
	$rsValvulado = dinamicscanopprogramavalvulado1(array('equipocodigo' => $equipo, 'ordoppcomfir' => '1'),array('equipocodigo' => '=', 'ordoppcomfir' => '='),$idcon);
...
?>			
	<tr <?php echo $complement ?>">
		...
		<td class="cont-line">&nbsp;&nbsp;<?php echo ($b + 1) ?>&nbsp;<a onclick="openUpdateOpp('<?php echo $rwValvulado['ordoppcodigo'] ?>', '<?php echo $equipo ?>')"><span class="ui-icon ui-icon-document" style="float: left; margin-right: .3em;"></span></a></td>
		...
		<td class="cont-line">&nbsp;<?php echo $APROBADOVALVULADO; ?></td>
	</tr>
	<tr <?php echo $complement ?>">
		<td></td>
		<td colspan="11">
