<?php
	$idcon = fncconn();
	$rsCorte = dinamicscanopprogramacorte1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon, $rtr = 1);
...
?>			
	<tr <?php echo $complement ?>>
		...
		<td width="8%" class="cont-line">&nbsp;&nbsp;<?php echo ($b + 1); ?>&nbsp;<a onclick="openUpdateOpp('<?php echo $rwCorte['ordoppcodigo'] ?>', '<?php echo $equipo ?>')"><span class="ui-icon ui-icon-document" style="float: left; margin-right: .3em;"></span></a></td>
