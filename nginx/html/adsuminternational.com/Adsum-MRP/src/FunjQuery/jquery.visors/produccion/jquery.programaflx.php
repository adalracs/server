<?php
	...
	$rsFlexografia = dinamicscanopprogramaflexo1(array('equipocodigo' => $equipo, 'ordoppcomfir' => 1),array('equipocodigo' => '=', 'ordoppcomfir' => '='),$idcon, $rtr = 1);//opcion para diferenciar las ordenes cerradas
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
	<tr>
		...
		<td class="ui-state-default" width="10%"  align="center">Referencia</td>
...
?>			
	<tr <?php echo $complement; ?>>
		...
		<td width="10%" class="cont-line">&nbsp;<font color="blue"><small><?php echo $REFPRODUCCION; ?></small></font></td>
