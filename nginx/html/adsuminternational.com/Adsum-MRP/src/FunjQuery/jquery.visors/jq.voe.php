...
<?php 
	...
	for($a = 0;$a< count($arrObjsoe);$a++){
		$rwReporteoporeportepn = loadrecordreporteoppreportepn($arrObjsoe[$a],$idcon);
...
?>
			<tr <?php echo $complement ?>">
				<td width="30" style=" border-bottom: 1px solid #fff;"><?php if(!$flagdetallar):?><input type="checkbox" name="chkarroe" id="chkarroe" value="<?php echo $arrObjsoe[$a] ?>" onclick="setSelectionRow(this.value, document.getElementById('arroetmp').value, ',', 'arroetmp');" /><?php else:?>&nbsp;&nbsp;&nbsp;<b>X</b><?php endif;?></td>
