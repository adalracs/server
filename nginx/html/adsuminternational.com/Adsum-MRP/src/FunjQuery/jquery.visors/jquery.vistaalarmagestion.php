...
?>			
			<tr <?php echo $complement ?>">
				<td width="30" style=" border-bottom: 1px solid #fff;"><?php if(!$flagdetallar):?><input type="checkbox" id="chkmodulocodigo" name="chkmodulocodigo" <?php echo $checked ?> onclick="setSelectionRow(this.value, document.getElementById('arrmodulocodigotmp').value, ':,:', 'modulocodigotmp');" value="<?php echo $array_tmp[$a] ?>"><?php else:?>&nbsp;&nbsp;&nbsp;<b>X</b><?php endif;?></td>
...
<input type="hidden" name="arrmodulocodigo" id="arrmodulocodigo" size="60"value="<?php echo $arrmodulocodigo ?>" />
<input type="hidden" name="arrmodulocodigotmp" id="arrmodulocodigotmp" size="60"value="<?php echo $arrmodulocodigotmp ?>" />
