<?php 
	...
	if($ordcomcodcli || $ordcomrazsoc ){
		...
		*/
		...
		$rsItemDesa = fullscanitemdesakeylinea1($idcon);
	}
...
<div style="width:648px; height: 20px;" class="ui-state-default">
	<div style="width:100%; height: auto;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">	
			<tr>
				<td width="50" class="ui-state-default" style="border-top:0; border-bottom:0; border-left:0;">&nbsp;Sel<input type="checkbox" onclick="setSelectionAll('keylinea',',');" value="1" name="allkeylinea" id="allkeylinea" <?php if($allkeylinea) echo 'checked'; ?> ></td>
				<td width="150" class="ui-state-default" style="border-top:0; border-bottom:0; border-left:0;">&nbsp;Id</td>
				<td width="433" class="ui-state-default" style="border-top:0; border-bottom:0; border-left:0;">&nbsp;Linea</td>
	...
	if($nrItemDesa){
		...
		for($a = 0; $a < $nrItemDesa; $a++){
			...
			if(is_array($array_key)){
				...
				$checked = '';
				if(array_key_exists($rwItemDesa['keylinea'], $array_key) || $allkeylinea)
					$checked = 'checked';
			}	
?>			
			<tr <?php echo $complement; ?> >
				<td width="50" style="border-bottom: 1px solid #fff;"><input type="checkbox" id="chkkeylinea" name="chkkeylinea" <?php echo $checked ?> onclick="setSelectionRow(this.value, document.getElementById('arrkeylinea').value, ',', 'arrkeylinea'); " value="<?php echo $rwItemDesa['keylinea']; ?>"></td>
				<td width="150" style="border-left: 1px solid #fff; border-bottom: 1px solid #fff;">&nbsp;<?php echo str_pad($rwItemDesa['keylinea'], 4, "0", STR_PAD_LEFT); ?></td>
				<td width="430" style="border-left: 1px solid #fff; border-bottom: 1px solid #fff;">&nbsp;<?php echo $rwItemDesa['itedeslinea'];?></td>
			</tr>
<?php
		}
	}
