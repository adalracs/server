...
?>			
	<tr <?php echo $complement; ?> >
		...
		<td width="5%" class="cont-line">&nbsp;<input type="checkbox" name="checkbox1" id="checkbox1" value="<?php echo $rwDoblado['ordoppcodigo']; ?>" onclick="setArrrequisicionopp(this.value);" /></td>
