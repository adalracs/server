...
?>		
	<tr <?php echo $complement; ?> >
		...
		<td width="5%" class="cont-line">&nbsp;<input type="checkbox" name="checkbox1" id="checkbox1" value="<?php echo $rwExtrusion['ordoppcodigo']; ?>" onclick="setArrrequisicionopp(this.value);" /></td>
		...
		<td width="10%" class="cont-line">&nbsp;<font color="blue"><b><?php echo str_pad($rwExtrusion['ordoppcodigo'], 4, "0", STR_PAD_LEFT); ?></b></font></td>
