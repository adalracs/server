...
<div id="opt-tab2">
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
  		...
  		<tr>
  			<td width="20%" class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['apli_tinta_mt2']] > 0){echo 'ui-state-error ui-corner-all';}?>"><?php if ($campnomb["apli_tinta_mt2"] == 1) { $tinta_espe = null; echo "*";}?>&nbsp;Aplicacion Tinta gr/mt2</td>
