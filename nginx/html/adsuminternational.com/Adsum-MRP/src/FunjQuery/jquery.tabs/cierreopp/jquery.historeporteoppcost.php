...
<?php
	$rsreporteopp = dinamicscanopreporteopp(array('ordoppcodigo' => $ordoppcodigo),array("ordoppcodigo"=>"="),$idcon);
	echo $rsreporteopp;
...
?>
	...
	<tr>
		<td class="ui-state-default" colspan="6">&nbsp;Total Mano de Obra :&nbsp;<?php echo number_format($SZreopdecantkg, 2, ',', '.'); ?>&nbsp;</td>
	</tr>
</table>