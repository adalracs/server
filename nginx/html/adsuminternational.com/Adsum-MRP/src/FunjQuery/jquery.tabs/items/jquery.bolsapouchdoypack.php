...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['tole_fuelle_ms']] > 0){echo 'ui-state-error ui-corner-all';}?>"><?php if($campnomb["tole_fuelle_ms"] == 1 || $campnomb["tole_fuelle_mn"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tolerancia de fuelle (mm)</td>
			<td class="NoiseDataTD">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td width="20%" class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_selle']] > 0){echo 'ui-state-error ui-corner-all';}?>"><?php if($campnomb["tipo_selle"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipo de selle</td>
			<td width="30%" class="NoiseDataTD"><select name="tipo_selle" id="tipo_selle">
				<option value="">-- Seleccione --</option>
				<option value="k"<?php if($tipo_selle == 'k') echo ' selected' ?>>K</option>
				<option value="redondo"<?php if($tipo_selle == 'redondo') echo ' selected' ?>>Redondo</option>
			</select></td>
		...
		<tr>
			<td class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['sellos']] > 0){echo 'ui-state-error ui-corner-all';}?>"><?php if($campnomb["sellos"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. de sellos</td>
			<td class="NoiseDataTD">&nbsp;2&nbsp;<input type="radio" name="sellos" id="sellos" value="2" <?php if($sellos == '2'){echo 'checked';}?> />&nbsp;&nbsp;&nbsp;3&nbsp;<input type="radio" name="sellos" id="sellos" value="3" <?php if($sellos == '3'){echo 'checked';}?> />&nbsp;&nbsp;&nbsp;4&nbsp;<input type="radio" name="sellos" id="sellos" value="4" <?php if($sellos == '4'){echo 'checked';}?> /></td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
	 	  	...
	 	  	<td class="NoiseDataTD" colspan="3">&nbsp;Si&nbsp;<input type="radio" name="valve" id="valve" value="si" <?php if($valve == 'si'){echo 'checked';}?> onclick="eventOcultaValvula(this.value);" />&nbsp;No&nbsp;<input type="radio" name="valve" id="valve" value="no" <?php if($valve == 'no'){echo 'checked';}?> onclick="eventOcultaValvula(this.value);" onkeypress="return event.keyCode!=13"/></td>
	  	</tr>
		<tr> 
			<td width="20%" class="NoiseFooterTD"><span id="ctapa_valvelb" class="<?php if($arrCampertipproCAL[$arrCampertipproCOD['ctapa_valve']] > 0){echo 'ui-state-error ui-corner-all';}?>" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>"><?php if ($campnomb["ctapa_valve"] == 1) { $ctapa_valve = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Color Tapa V&aacute;lvula</span></td> 
			<td width="30%" class="NoiseDataTD"><span id="ctapa_valveobj" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>"><input type="text" name="ctapa_valve" id="ctapa_valve" value="<?php echo $ctapa_valve; ?>" size="20" onkeypress="return event.keyCode!=13"/></span></td>
	  		<td width="20%" class="NoiseFooterTD"><span id="medi_valvelb" class="<?php if($arrCampertipproCAL[$arrCampertipproCOD['medi_valve']] > 0){echo 'ui-state-error ui-corner-all';}?>" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>"><?php if ($campnomb["medi_valve"] == 1) { $medi_valve = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Medida V&aacute;lvula (mm)</span></td>
	  		<td width="30%" class="NoiseDataTD"><span id="medi_valveobj" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>"><input type="text" name="medi_valve" id="medi_valve" value="<?php echo $medi_valve; ?>" size="20" onkeypress="return event.keyCode!=13"/></span></td>
	  	</tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			<td class="NoiseFooterTD" width="20%"><span id="tipo_cierre_lb" class="<?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_cierre']] > 0){echo 'ui-state-error ui-corner-all';}?>" style="display : <?php if($valve == 'si'){echo 'none';}else{echo 'block';}?>"><?php if($campnomb["tipo_cierre"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipos de cierre</span></td>
			<td class="NoiseDataTD" width="30%"><span id="tipo_cierre_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{'block';}?>"><select name="tipo_cierre" id="tipo_cierre" onchange="eventTipocierre(this.value);">
				<option value="">-- Seleccione --</option>
				<option value="zipper_vena"<?php if($tipo_cierre == 'zipper_vena') echo ' selected ' ?>>Zipper Vena</option>
				<option value="zipper_plano"<?php if($tipo_cierre == 'zipper_plano') echo ' selected ' ?>>Zipper Plano</option>
				<option value="NA"<?php if($tipo_cierre == 'NA') echo ' selected ' ?>>N/A</option>
			</select></span></td>
			<td class="NoiseFooterTD" width="20%"><span id="dist_cierre_lb" class="<?php if($arrCampertipproCAL[$arrCampertipproCOD['dist_cierre']] > 0){echo 'ui-state-error ui-corner-all';}?>" style="display : <?php if($valve == 'si'){echo 'none';}else{echo 'block';}?>"><?php if($campnomb["dist_cierre"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Dist. de cierre al borde</span></td>
			<td class="NoiseDataTD" width="30%"><span id="dist_cierre_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{'block';}?>"><input type="text" name="dist_cierre" id="dist_cierre" value="<?php if(!$flagnuevopedidoventa){ echo $sbreg[dist_cierre];}else{ echo $dist_cierre; }?>" size="20" onkeypress="return event.keyCode!=13"/></span></td>	
		</tr>
		<tr>
			<td class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_aper']] > 0){echo 'ui-state-error ui-corner-all';}?>" width="20%"><?php if($campnomb["tipo_aper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipos de apertura</td>
			<td class="NoiseDataTD" width="30%"><select name="tipo_aper" id="tipo_aper" onchange="eventTipoaper(this.value);">
				<option value="">-- Seleccione --</option>
				<option value="muesca"<?php if($tipo_aper == 'muesca') echo ' selected ' ?>>Muesca</option>
				<option value="laser"<?php if($tipo_aper == 'laser') echo ' selected ' ?>>Laser</option>
				<option value="precorte"<?php if($tipo_aper == 'precorte') echo ' selected ' ?>>Precorte</option>
				<option value="NA"<?php if($tipo_aper == 'NA') echo ' selected ' ?>>N/A</option>
			</select></td>
			<td class="NoiseFooterTD" width="20%"><?php if($campnomb["dist_aper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Dist. de apertura al borde</td>
			<td class="NoiseDataTD" width="30%"><input type="text" name="dist_aper" id="dist_aper" value="<?php  echo $dist_aper; ?>" size="20" onkeypress="return event.keyCode!=13"/></td>	
			</tr>
		</table>
