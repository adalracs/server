	...
	<div id="item_sessiona">
		<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
			...
			<tr> 
				...
				<td class="NoiseDataTD">&nbsp;<?php echo $rwOrdencompra['ordcomcodcli'].' - '.$clientnombre ?></td> 
				<td class="NoiseFooterTD">&nbsp;Nombre/Item</td> 
				<td class="NoiseDataTD">&nbsp;<?php echo $sbreg['producnombre'] ?></td>
			</tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
			...
			<tr>
		  		...
		  		<td class="NoiseDataTD">&nbsp;<?php echo ($precio) ? $precio : '---' ; ?>&nbsp;<input type="checkbox" name="chkprecio" value="<?php echo $arrCampertipproCOD['precio'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['precio']] > 0){echo 'checked';}?> ></td>
		  		<td class="NoiseFooterTD">&nbsp;Moneda</td>
		  		<td class="NoiseDataTD">&nbsp;<?php echo ($moneda)? strtoupper($moneda) : '---' ; ?>&nbsp;<input type="checkbox" name="chkmoneda" value="<?php echo $arrCampertipproCOD['moneda'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['moneda']] > 0){echo 'checked';}?> ></td>
		  	</tr>
		  	<tr>
		  		<td class="NoiseFooterTD">&nbsp;Exportaci&oacute;n</td>
		  		<td class="NoiseDataTD">&nbsp;<?php echo ($exportacion)? strtoupper($exportacion) : '---' ;?>&nbsp;<input type="checkbox" name="chkexportacion" value="<?php echo $arrCampertipproCOD['exportacion'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['exportacion']] > 0){echo 'checked';}?> ></td>
		  		<td class="NoiseFooterTD">&nbsp;Cartera Cumple</td>
		  		<td class="NoiseDataTD">&nbsp;<?php echo ($cartera)? strtoupper($cartera) : '---' ;?>&nbsp;<input type="checkbox" name="chkcartera" value="<?php echo $arrCampertipproCOD['cartera'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['cartera']] > 0){echo 'checked';}?> ></td>
		  	</tr>
		  	<tr>
		  		<td class="NoiseFooterTD">&nbsp;Cobro de fotopolimeros</td>
		  		<td class="NoiseDataTD">&nbsp;<?php echo ($cobro_fotopo)? strtoupper($cobro_fotopo) : '---' ; ?>&nbsp;<input type="checkbox" name="chkcobro_fotopo" value="<?php echo $arrCampertipproCOD['cobro_fotopo'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['cobro_fotopo']] > 0){echo 'checked';}?> ></td>
		  	...
		  	<tr>
		  		...
		  		<td colspan="3" class="NoiseDataTD">&nbsp;<?php echo ($version_arte) ? $version_arte : '---' ; ?>&nbsp;<input type="checkbox" name="chkversion_arte" value="<?php echo $arrCampertipproCOD['version_arte'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['version_arte']] > 0){echo 'checked';}?> ></td>
		  	</tr>
		  	<tr><td class="ui-state-default" colspan="4"></td></tr>
			<tr><td class="NoiseFooterTD" colspan="4"><?php if ($campnomb['otros'] == 1) { $cobro_fotopo = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Otros&nbsp;<input type="checkbox" name="chkotros" value="<?php echo ($arrCampertipproCOD['otros'])? $arrCampertipproCOD['otros'] : '1017' ; ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['otros']] > 0){echo 'checked';}?> /></td></tr>
			<tr>
				<td class="NoiseDataTD" colspan="4"><textarea name="otros" cols="123" rows="3"><?php echo $otros; ?></textarea>
			</tr>
       	</table>
       	<?php } ?>
	</div>
	...
	<div id="item_sessionb">
		<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 	
			...
			<tr>
		  	...
		  	<tr>
		  		<td class="NoiseFooterTD">&nbsp;Cobro de fotopolimeros</td>
		  		<td class="NoiseDataTD" colspan="3">&nbsp;<?php echo ($cobro_fotopo)? strtoupper($cobro_fotopo) : '---' ; ?>&nbsp;<input type="checkbox" name="chkcobro_fotopo" value="<?php echo $arrCampertipproCOD['cobro_fotopo'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['cobro_fotopo']] > 0){echo 'checked';}?> ></td>
		  	</tr>
		  	<tr><td class="ui-state-default" colspan="4"></td></tr>
			<tr><td class="NoiseFooterTD" colspan="4">&nbsp;Otros&nbsp;<input type="checkbox" name="chkotros" value="<?php echo $arrCampertipproCOD['otros'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['otros']] > 0){echo 'checked';}?> ></td></tr>
			<tr>
				<td class="NoiseDataTD" colspan="4"><textarea name="otros" cols="123" rows="3"><?php echo $otros; ?></textarea>
			</tr>
  		</table>
  	...
  	<?php endif ?>
  		...
  		<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
			...
			<tr>
				<td>
					&nbsp;<input type="checkbox" name="chkexportacion" onclick="document.getElementById('arrRatings').value = '0' ;"  />
				</td>
			</tr>
  		</table>  	
  	</div>
