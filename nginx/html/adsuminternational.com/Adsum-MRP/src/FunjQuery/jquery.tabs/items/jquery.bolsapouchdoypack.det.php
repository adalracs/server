...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<input type="hidden" name="tipo_selle" id="tipo_selle" value="<?php echo $tipo_selle ?>" /><?php echo ($tipo_selle)? strtoupper($tipo_selle) : '---' ; ?></td>
	  		...
	  		<td class="NoiseDataTD">&nbsp;<input type="hidden" name="aselle_bolsa" id="aselle_bolsa" value="<?php echo $aselle_bolsa ?>" /><?php echo ($aselle_bolsa)? strtoupper($aselle_bolsa) : '---' ;  ?></td>
	  	</tr>
		<tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<input type="hidden" name="dist_aper" id="dist_aper" value="<?php echo $dist_aper ?> " /><?php echo ($dist_aper)? strtoupper($dist_aper) : '---' ;?></td>
		</tr>
		</table>
