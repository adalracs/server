...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<?php echo ($traslape)? $traslape : '---' ; ?>&nbsp;<input type="checkbox" name="chktraslape" value="<?php echo $arrCampertipproCOD['traslape'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['traslape']] > 0){echo 'checked';}?> ></td>
			<td class="NoiseFooterTD">&nbsp;Tolerancia traslape (mm)</td>
			<td class="NoiseDataTD">
				<b>+</b>&nbsp;<?php echo ($tole_traslape_ms)? $tole_traslape_ms : '**' ?>
				<b>-</b>&nbsp;<?php echo ($tole_traslape_mn)? $tole_traslape_mn : '**' ?>
				&nbsp;<input type="checkbox" name="chktole_traslape_ms" value="<?php echo $arrCampertipproCOD['tole_traslape_ms'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['tole_traslape_ms']] > 0){echo 'checked';}?> >
			</td>
		</tr>
		<tr>
			<td class="NoiseFooterTD"><span style="display : <?php if($traslape > 0){echo 'block';}else{echo 'none';}?>">&nbsp;Tipo Traslape </span></td>
			<td class="NoiseDataTD" colspan="3"><span style="display : <?php if($traslape > 0){echo 'block';}else{echo 'none';}?>">&nbsp;<?php echo ($tipo_traslape)? strtoupper($tipo_traslape) : '---' ; ?> &nbsp;<input type="checkbox" name="chktipo_traslape" value="<?php echo $arrCampertipproCOD['tipo_traslape'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_traslape']] > 0){echo 'checked';}?> ></span></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
	 	  	...
	 	  	<td width="30%" class="NoiseDataTD">&nbsp;<?php echo ($valve)? strtoupper($valve) : '---' ; ?>&nbsp;<input type="checkbox" name="chkvalve" value="<?php echo $arrCampertipproCOD['valve'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['valve']] > 0){echo 'checked';}?> ></td>
	  		<td width="24%" class="NoiseFooterTD">&nbsp;Ancho de selle a las bolsas (mm)</td>
	  		<td width="26%" class="NoiseDataTD">&nbsp;<?php echo ($aselle_bolsa)? $aselle_bolsa : '---' ; ?>&nbsp;<input type="checkbox" name="chkaselle_bolsa" value="<?php echo $arrCampertipproCOD['aselle_bolsa'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['aselle_bolsa']] > 0){echo 'checked';}?> ></td>
	  	</tr>
		<tr> 
		...
		<tr>
			...
			<td class="NoiseDataTD" colspan="3"><span style="display : <?php if($tipo_impresion == 'sin_impresion'){echo 'none';}else{echo 'block';}?>">&nbsp;<?php echo ($cod_barras)? strtoupper($cod_barras) : '---' ; ?>&nbsp;<input type="checkbox" name="chkcod_barras" value="<?php echo $arrCampertipproCOD['cod_barras'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['cod_barras']] > 0){echo 'checked';}?> ></span></td>
		</tr>
