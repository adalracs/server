...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['solapa']] > 0){echo 'ui-state-error ui-corner-all';}?>"><?php if($campnomb["solapa"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Solapa (mm)</td>
			<td class="NoiseDataTD"><input type="text" name="solapa" id="solapa" size="15" value="<?php echo $solapa ?>" onkeyup="eventPesomillar();" onkeypress="return event.keyCode!=13"/></td>
			<td class="NoiseFooterTD"><span id="ncaras_imp_lb" class="<?php if($arrCampertipproCAL[$arrCampertipproCOD['ncaras_imp']] > 0){echo 'ui-state-error ui-corner-all';}?>" style="display : <?php if($tipo_impresion != 'sin_impresion'){echo 'block';}else{echo 'none';}?>"><?php if($campnomb["ncaras_imp"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. de caras impresas</span></td>
		...
		<tr>
			<td class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['wicket']] > 0){echo 'ui-state-error ui-corner-all';}?>"><?php if($campnomb["wicket"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Wicket</td>
			<td class="NoiseDataTD">&nbsp;1&nbsp;<input type="radio" name="wicket" id="wicket" <?php if($wicket == '1'){echo 'checked';}?> value="1" />&nbsp;&nbsp;&nbsp;2&nbsp;<input type="radio" name="wicket" id="wicket" <?php if($wicket == '2'){echo 'checked';}?> value="2" />&nbsp;&nbsp;&nbsp;N/A&nbsp;<input type="radio" name="wicket" id="wicket" <?php if($wicket == 'no_aplica'){echo 'checked';}?> value="no_aplica" /></td>
	...
	<div id="session_tipotroquel" style="display: <?php if($troquel == 'si'){ echo 'block'; } else { echo 'none'; } ?>">
		<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
			<tr>
				<td class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['ncaras_imp']] > 0){echo 'ui-state-error ui-corner-all';}?>" width="20%"><?php if($campnomb["tipo_troquel"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipo de troquel</td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			<td width="20%" class="NoiseFooterTD <?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_llenado']] > 0){echo 'ui-state-error ui-corner-all';}?>"><?php if($campnomb["tipo_llenado"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Llenado</td>
			<td width="30%" class="NoiseDataTD">&nbsp;Superior&nbsp;<input type="radio" name="tipo_llenado" id="tipo_llenado" value="superior" <?php if($tipo_llenado == 'superior'){echo 'checked';}?>/>&nbsp;&nbsp;&nbsp;Lateral&nbsp;<input type="radio" name="tipo_llenado" id="tipo_llenado" value="lateral" <?php if($tipo_llenado == 'lateral'){echo 'checked';}?> />&nbsp;&nbsp;&nbsp;Inferior&nbsp;<input type="radio" name="tipo_llenado" id="tipo_llenado" value="inferior" <?php if($tipo_llenado == 'inferior'){echo 'checked';}?> /></td>
			<td width="20%" class="NoiseFooterTD "><span id="cod_barras_lb" class="<?php if($arrCampertipproCAL[$arrCampertipproCOD['cod_barras']] > 0){echo 'ui-state-error ui-corner-all';}?>" style="display : <?php if($tipo_impresion == 'sin_impresion'){echo 'none';}else{echo 'block';}?>"><?php if($campnomb["cod_barras"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;C&oacute;digo de barras</span></td>
			<td width="30%" class="NoiseDataTD"><span id="cod_barras_obj" style="display : <?php if($tipo_impresion == 'sin_impresion'){echo 'none';}else{echo 'block';}?>"><input type="text" name="cod_barras" id="cod_barras" size="15" value="<?php echo $cod_barras ?>" onkeypress="return event.keyCode!=13"/></span></td>
		</tr>
...
<div id="opt-tab8">
	<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td colspan="1" class="NoiseDataTD"><?php if($campnomb["esp_emb"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Especificaci&oacute;n de embalaje<input type="checkbox" name="esp_emb" id="esp_emb" value="1" onclick="eventNotaesp_emb();"/></td>
