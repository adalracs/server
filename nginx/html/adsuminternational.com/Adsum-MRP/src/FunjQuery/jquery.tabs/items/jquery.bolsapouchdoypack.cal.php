...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<?php echo ($tipo_selle)? strtoupper($tipo_selle) : '---' ; ?>&nbsp;<input type="checkbox" name="chktipo_selle" value="<?php echo $arrCampertipproCOD['tipo_selle'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_selle']] > 0){echo 'checked';}?> ></td>
	  		<td width="20%" class="NoiseFooterTD">&nbsp;Ancho de selle a las bolsas</td>
	  		<td class="NoiseDataTD">&nbsp;<?php echo ($aselle_bolsa)? strtoupper($aselle_bolsa) : '---' ;?>&nbsp;<input type="checkbox" name="chkaselle_bolsa" value="<?php echo $arrCampertipproCOD['aselle_bolsa'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['aselle_bolsa']] > 0){echo 'checked';}?> ></td>
	  	</tr>
		<tr>
			<td class="NoiseFooterTD">&nbsp;No. de sellos</td>
			<td class="NoiseDataTD">&nbsp;<?php echo ($sellos)? $sellos : '---' ; ?>&nbsp;<input type="checkbox" name="chksellos" value="<?php echo $arrCampertipproCOD['sellos'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['sellos']] > 0){echo 'checked';}?> ></td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			...
			<td class="NoiseDataTD" width="30%"><span id="tipo_cierre_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{'block';}?>">&nbsp;<?php echo ($tipo_cierre)? strtoupper($tipo_cierre) : '---' ; ?>&nbsp;<input type="checkbox" name="chktipo_cierre" value="<?php echo $arrCampertipproCOD['tipo_cierre'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_cierre']] > 0){echo 'checked';}?> ></span></td>
			...
			<td class="NoiseDataTD" width="30%"><span id="dist_cierre_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{'block';}?>">&nbsp;<?php echo ($dist_cierre)? strtoupper($dist_cierre) : '---' ; ?>&nbsp;<input type="checkbox" name="chkdist_cierre" value="<?php echo $arrCampertipproCOD['dist_cierre'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['dist_cierre']] > 0){echo 'checked';}?> ></span></td>
		</tr>
		<tr>
			<td class="NoiseFooterTD">&nbsp;Tipos de apertura</td>
			<td class="NoiseDataTD">&nbsp;<?php echo ($tipo_aper)? strtoupper($tipo_aper) : '---' ; ?>&nbsp;<input type="checkbox" name="chktipo_aper" value="<?php echo $arrCampertipproCOD['tipo_aper'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['tipo_aper']] > 0){echo 'checked';}?> ></td>
			<td class="NoiseFooterTD">&nbsp;Dist. de apertura al borde</td>
			<td class="NoiseDataTD">&nbsp;<?php echo ($dist_aper)? strtoupper($dist_aper) : '---' ; ?>&nbsp;<input type="checkbox" name="chkdist_aper" value="<?php echo $arrCampertipproCOD['dist_aper'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['dist_aper']] > 0){echo 'checked';}?> ></td>
		</tr>
	</table>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			...
			<td class="NoiseDataTD" width="30%">&nbsp;<?php echo ($cod_barras)? $cod_barras : '---' ; ?>&nbsp;<input type="checkbox" name="chkcod_barras" value="<?php echo $arrCampertipproCOD['cod_barras'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');" <?php if($arrCampertipproCAL[$arrCampertipproCOD['cod_barras']] > 0){echo 'checked';}?> ></td>
		</tr>
		<tr><td class="ui-state-default" colspan="4"></td></tr>
		<tr><td class="NoiseFooterTD" colspan="4">&nbsp;Observaciones</td></tr>
		<tr><td class="NoiseDataTD" colspan="4">&nbsp;<?php echo strtoupper($note_product) ?>&nbsp;<input type="checkbox" name="chkcobro_fotopo" value="<?php echo $arrCampertipproCOD['cobro_fotopo'] ?>" onclick="setSelectionRow(this.value, document.getElementById('arrRatings').value, ',', 'arrRatings');"></tr>
	</table>
</div>
