<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
	<tr class="ui-state-default">
		<td class="cont-title">&nbsp;<a onClick="return verocultar('filgestionoppreporteapro',3);" href="javascript:animatedcollapse.toggle('filgestionoppreporteapro');"><img id="row3" align="middle" align="top"  src="temas/Noise/DescOn.gif" border="0">Historial Bobinas Aprobadas</a></td>
	</tr>
</table>
<div id="filgestionoppreporteapro" style="padding: 2px 2px 2px 2px; display:none;" >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
<?php 
...
?>
		...
		<?php 
			...
			for( $a = 0; $a < $nrGestionopp; $a++){
				...
				$rsGestionoppreporte = dinamicscanopgestionoppreporte(array("gesoppcodigo" => $rwGestionopp["gesoppcodigo"], "geopreestado" => "1"),array("gesoppcodigo" => "=", "geopreestado" => ">="),$idcon);
...
<?php 
			...
			for( $a = 0; $a < $nrGestionopp; $a++){
				...
				$rwGestionopp = fncfetch($rsGestionopp,$a);
				$rsGestionoppreportesaldo = dinamicscanopgestionoppreportesaldo(array("gesoppcodigo" => $rwGestionopp["gesoppcodigo"], "geopreestado" => "1"),array("gesoppcodigo" => "=", "geopreestado" => ">="),$idcon);
		...
		<tr>
			...
			<td colspan="4">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td class="NoiseDataTD row-soliserv" width="5%">&nbsp;</td>
						<td class="NoiseDataTD row-soliserv" width="65%">&nbsp;<b>Entrega :</b>&nbsp;<?php echo carganombitemdesa1($rwSaldo["itedescodigo"],$idcon)?>&nbsp;<b>{Saldo}</b></td>
...
?>
		<tr>
			<td class="ui-state-default" colspan="5">&nbsp;Total Aprobados:&nbsp;<?php echo number_format($SZreoppncantkg, 2, ',', '.'); ?>&nbsp;(kgs)&nbsp;&nbsp;&nbsp;<?php echo number_format($SZreoppncantmt, 2, ',', '.'); ?>&nbsp;(mts)&nbsp;&nbsp;&nbsp;<?php echo number_format($bobinano, 2, ',', '.'); ?>&nbsp;(und)</td>
		</tr>
		...
		<tr>
			<td>
				<div class="ui-widget">
					 <div style="margin-top: 1px; padding: 0 .7em;" class="ui-state-highlight ui-corner-all"> 
				  		<p><span style="float: left; margin-right: .3em;" class="ui-icon ui-icon-info"></span>
				  		<b>No se encontraron reportes de recepcion de materiales.</b></p>
				 	</div>
				</div>
			</td>
		</tr>
