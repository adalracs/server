...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<input type="hidden" name="fuelle" id="fuelle" value="<?php echo $fuelle ?>" size="7" /><?php echo($fuelle)? $fuelle : '---' ; ?></td>
			<td class="NoiseFooterTD">&nbsp;Tolerancia de fuelle (mm)</td>
			<td class="NoiseDataTD">
				<b>+</b>&nbsp;<input type="hidden" name="tole_fuelle_ms" id="tole_fuelle_ms" value="<?php echo $tole_fuelle_ms ?>" size="7" /><?php echo ($tole_fuelle_ms)? $tole_fuelle_ms : '**' ; ?>
				<b>-</b>&nbsp;<input type="hidden" name="tole_fuelle_mn" id="tole_fuelle_mn" value="<?php echo $tole_fuelle_mn ?>" size="7" /><?php echo ($tole_fuelle_mn)? $tole_fuelle_mn : '**' ; ?>
			</td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td width="20%" class="NoiseFooterTD">&nbsp;Tipo de selle</td>
			<td width="30%" class="NoiseDataTD">&nbsp;<input type="hidden" name="tipo_selle" id="tipo_selle" value="<?php echo $tipo_selle ?>" /><?php echo ($tipo_selle)? strtoupper($tipo_selle) : '---' ;?></td>
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<input type="hidden" name=sellos id="sellos" value="<?php echo $sellos ?>" /><?php echo ($sellos)? strtoupper($sellos) : '---' ;?></td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
	 	  	...
	 	  	<td colspan="3" class="NoiseDataTD">&nbsp;<input type="hidden" name="valve" id="valve" value="<?php echo $valve ?>" /><?php echo ($valve)? strtoupper($valve) : '---' ; ?></td>
	  	</tr>
		<tr> 
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			...
			<td class="NoiseDataTD" width="30%"><span id="tipo_cierre_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{'block';}?>">&nbsp;<input type="hidden" id="tipo_cierre" name="tipo_cierre" value="<?php echo $tipo_cierre ?>" /><?php echo ($tipo_cierre)? strtoupper($tipo_cierre) : '---' ;?></span></td>
			...
			<td class="NoiseDataTD" width="30%"><span id="dist_cierre_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{'block';}?>">&nbsp;<input type="hidden" name="dist_cierre" id="dist_cierre" value="<?php echo $dist_cierre ?>" /><?php echo ($dist_cierre)? strtoupper($dist_cierre) : '---' ;?></span></td>	
		</tr>
		<tr>
			<td class="NoiseFooterTD" width="20%">&nbsp;Tipos de apertura</td>
			<td class="NoiseDataTD" width="30%">&nbsp;<input type="hidden" name="tipo_aper" id="tipo_aper" value="<?php echo $tipo_aper ?>" /><?php echo ($tipo_aper)? strtoupper($tipo_aper) : '---' ;?></td>
			<td class="NoiseFooterTD" width="20%">&nbsp;Dist. de apertura al borde</td>
			<td class="NoiseDataTD" width="30%">&nbsp;<input type="hidden" name="dist_aper" id="dist_aper" value="<?php  echo $dist_aper; ?>" /><?php echo ($dist_aper)? strtoupper($dist_aper) : '---' ;?></td>	
		</tr>
		</table>
	...
	<?php if($tipo_impresion != 'sin_impresion'){?>
		...
		<tr><td class="NoiseDataTD" colspan="2">&nbsp;<?php echo $note_product; ?></tr>
	</table>
	</div>
</div>
