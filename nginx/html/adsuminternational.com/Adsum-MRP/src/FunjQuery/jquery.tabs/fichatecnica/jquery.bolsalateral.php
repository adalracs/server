...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td width="30%" class="NoiseDataTD">
				<b>+</b>&nbsp;<input type="text" name="tole_ancho_ms" id="tole_ancho_ms" value="<?php echo $tole_ancho_ms ?>" /><?php //echo ($tole_ancho_ms)? $tole_ancho_ms : '**' ; ?>
				<b>-</b>&nbsp;<input type="text" name="tole_ancho_mn" id="tole_ancho_mn" value="<?php echo $tole_ancho_mn ?>" /><?php //echo ($tole_ancho_mn)? $tole_ancho_mn : '**' ; ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="NoiseFooterTD"><?php if ($campnomb["solapa"] == 1) { $solapa = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Solapa (mm)</td>
			<td class="NoiseDataTD">&nbsp;<input type="text" name="solapa" id="solapa" value="<?php echo $solapa ?>" size="7"/><?php //echo ($traslape)? $traslape : '---' ; ?></td>
			<td class="NoiseFooterTD"><span id="ncaras_imp_lb" style="display : <?php if($tipo_impresion != 'sin_impresion'){echo 'block';}else{echo 'none';}?>"><?php if($campnomb["ncaras_imp"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. de caras impresas</span></td>
			<td class="NoiseDataTD"><span id="ncaras_imp_obj" style="display : <?php if($tipo_impresion != 'sin_impresion'){echo 'block';}else{echo 'none';}?>">&nbsp;1&nbsp;<input type="radio" name="ncaras_imp" id="ncaras_imp" value="1" <?php if($ncaras_imp == 1) echo ' checked' ?> />&nbsp;&nbsp;&nbsp;2&nbsp;<input type="radio" name="ncaras_imp" id="ncaras_imp" value="2" <?php if($ncaras_imp == 2) echo ' checked' ?> /></span> </td>
		</tr>
		<tr>
			<td class="NoiseFooterTD"><?php if($campnomb["wicket"] == 1){ $wicket = null; echo "<b style='font-size:15px; color:red;'>*</b>";} ?>&nbsp;Wicket</td>
			<td class="NoiseDataTD" colspan="3">&nbsp;1&nbsp;<input type="radio" name="wicket" id="wicket" <?php if($wicket == '1'){echo 'checked';}?> value="1" />&nbsp;&nbsp;&nbsp;2&nbsp;<input type="radio" name="wicket" id="wicket" <?php if($wicket == '2'){echo 'checked';}?> value="2" />&nbsp;&nbsp;&nbsp;N/A&nbsp;<input type="radio" name="wicket" id="wicket" <?php if($wicket == 'no_aplica'){echo 'checked';}?> value="no_aplica" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="4" class="ui-state-default">&nbsp;Accesorios de Bolsa Lateral</td>
		</tr>
		<tr>
