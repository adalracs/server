...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
		<td colspan="4" class="ui-state-default">&nbsp;Medidas de Capuchon</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="NoiseFooterTD"><?php if($campnomb["pestania"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Pesta&ntilde;a (mm)</td>
			<td class="NoiseDataTD"><input type="hidden" name="pestania" id="pestania" value="<?php echo $pestania ?>" /><?php echo ($pestania)? $pestania : '---' ;?></td>
			<td class="NoiseFooterTD"><?php if($campnomb["tole_pestania_ms"] == 1 || $campnomb["tole_pestania_mn"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tolerancia de pesta&ntilde;a (mm)</td>
			<td class="NoiseDataTD">
		...
		<tr>
			<td class="NoiseFooterTD"><?php if($campnomb["bmayor"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Base mayor (mm)</td>
			<td class="NoiseDataTD"><input type="hidden" name="bmayor" id="bmayor" value="<?php echo $bmayor ?>" /><?php echo ($bmayor)? $bmayor : '---' ;?></td>
			<td class="NoiseFooterTD"><?php if($campnomb["tole_bmayor_ms"] == 1 || $campnomb["tole_bmayor_mn"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tol. base mayor (mm)</td>
			<td class="NoiseDataTD">
		...
		<tr>
			<td class="NoiseFooterTD"><?php if($campnomb["bmenor"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Base menor (mm)</td>
			<td class="NoiseDataTD"><input type="hidden" name="bmenor" id="bmenor" value="<?php echo $bmenor ?>" /><?php echo ($bmenor)? $bmenor : '---' ;?></td>
			<td class="NoiseFooterTD"><?php if($campnomb["tole_bmenor_ms"] == 1 || $campnomb["tole_bmenor_mn"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tol. base menor (mm)</td>
			<td class="NoiseDataTD">
		...
		<tr>
			<td width="20%" class="NoiseFooterTD"><?php if ($campnomb["largo_impresion"] == 1) { $largo_impresion = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Largo impresion (mm)</td>
			<td width="30%" class="NoiseDataTD">&nbsp;<input type="text" name="largo_impresion" id="largo_impresion" value="<?php echo $largo_impresion ?>" size="7" /></td>
			<td width="20%" class="NoiseFooterTD"><?php if($campnomb["tole_largo_impresion_ms"] == 1 || $campnomb["tole_largo_impresion_mn"]){echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Tolerancia largo imp (mm)</td>
			<td width="30%" class="NoiseDataTD">
				<b>+</b>&nbsp;<input type="text" name="tole_largo_impresion_ms" id="tole_largo_impresion_ms" value="<?php echo $tole_largo_impresion_ms ?>" size="7" />
				<b>-</b>&nbsp;<input type="text" name="tole_largo_impresion_mn" id="tole_largo_impresion_mn" value="<?php echo $tole_largo_impresion_mn ?>" size="7" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td width="20%" class="NoiseFooterTD"><?php if($campnomb["macroper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Macroperforaciones</td>
			...
			<td width="25%" class="NoiseFooterTD"><span id="n_macroperflbl" style="display: <?php if($macroper == 'no'){ echo 'none'; } else { echo 'block'; } ?>"><?php if($campnomb["nro_macroper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. de macroperforaciones</span></td>
			<td width="25%" class="NoiseDataTD"><span id="n_macroperfobj" style="display: <?php if($macroper == 'no'){ echo 'none'; } else { echo 'block'; } ?>"><input type="text" name="nro_macroper" id="nro_macroper" size="15" value="<?php echo $nro_macroper ?>" onkeypress="return event.keyCode!=13"/></span></td>
		</tr>
		<tr>
			<td class="NoiseFooterTD"><?php if($campnomb["microper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Microperforaciones</td>
			...
			<td class="NoiseFooterTD"><span id="n_caras_microperflbl" style="display: <?php if($microper == 'no'){ echo 'none'; } else { echo 'block'; } ?>"><?php if($campnomb["ncaras_microper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. caras microperforaciones</span></td>
			<td class="NoiseDataTD"><span id="n_caras_microperfobj" style="display: <?php if($microper == 'no'){ echo 'none'; } else { echo 'block'; } ?>">&nbsp;1&nbsp;<input type="radio" name="ncaras_microper" id="ncaras_microper" value="1" <?php if($ncaras_microper == 1) echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;2&nbsp;<input type="radio" name="ncaras_microper" id="ncaras_microper" value="2" <?php if($ncaras_microper == 2) echo 'checked'; ?> /></span></td>
		</tr>
		<tr>
			<td class="NoiseFooterTD"><span id="tipo_microperlbl" style="display: <?php if($microper=="si"){echo 'block';}else{echo 'none';}?>"><?php if($campnomb["tipo_microper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipo de microperforaciones</span></td>
			<td class="NoiseDataTD"><span id="tipo_microperobj" style="display: <?php if($microper=="si"){echo 'block';}else{echo 'none';}?>"><select name="tipo_microper" id="tipo_microper">
				<option value="">-- Seleccione --</option>
				<option value="5x5"<?php if($tipo_microper == '5x5') echo ' selected' ?>>5 X 5</option>
				<option value="10x10"<?php if($tipo_microper == '10x10') echo ' selected' ?>>10 X 10</option>
			</select></span></td>
			<td class="NoiseFooterTD"><span id="dist_microper_lb" style="display: <?php if($microper=="si"){echo 'block';}else{echo 'none';}?>"><?php if($campnomb["dist_microper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Distancia Microperforacion (mm)</span></td>
		...
		<tr>
			...
			<td class="NoiseFooterTD"><?php if($campnomb["selle_fondo"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Sello de fondo</td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			<td width="20%" class="NoiseFooterTD"><?php if ($campnomb["dist_perf_pestania"] == 1) { $dist_perf_pestania = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Dist. perf. pesta&ntilde;a (mm)</td>
			<td width="30%" class="NoiseDataTD">&nbsp;&nbsp;<input type="hidden" name="dist_perf_pestania" id="dist_perf_pestania" value="<?php echo $dist_perf_pestania ?>" /><?php echo ($dist_perf_pestania)? strtoupper($dist_perf_pestania) : '---' ; ?></td>
		...
		<tr>
			...
			<td width="30%" class="NoiseDataTD">
				<select name="forma_sellado" id="forma_sellado">
					<option value="">--Seleccione--</option>
					<option value="lateral" <?php if($forma_sellado == 'lateral'){echo 'selected';}?> >Lateral</option>
					<option value="plano" <?php if($forma_sellado == 'plano'){echo 'selected';}?> >Plano</option>
				</select>
			</td>
			...
			<td width="30%" class="NoiseDataTD"><input type="text" name="dist_precalentadores" id="dist_precalentadores" value="<?php echo $dist_precalentadores ?>" /></td>
		</tr>
		<tr>
