...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<input type="hidden" name="solapa" id="solapa" value="<?php echo $solapa ?>" /><?php echo ($traslape)? $traslape : '---' ; ?></td>
			<td class="NoiseFooterTD"><span id="ncaras_imp_lb" style="display : <?php if($tipo_impresion != 'sin_impresion'){echo 'block';}else{echo 'none';}?>">&nbsp;No. de caras impresas</span></td>
			<td class="NoiseDataTD"><span id="ncaras_imp_obj" style="display : <?php if($tipo_impresion != 'sin_impresion'){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="hidden" name="ncaras_imp" id="ncaras_imp" value="<?php echo $ncaras_imp ?>" /><?php echo ($ncaras_imp)? strtoupper($ncaras_imp) : '---' ;?></span></td>
		</tr>
		<tr>
			<td class="NoiseFooterTD">&nbsp;Wicket</td>
			<td class="NoiseDataTD" colspan="3">&nbsp;<input type="hidden" name="wicket" id="wicket" value="<?php echo $wicket ?>" /><?php echo ($wicket)? strtoupper($wicket) : '---' ; ?></td>
		</tr>
		<tr>
