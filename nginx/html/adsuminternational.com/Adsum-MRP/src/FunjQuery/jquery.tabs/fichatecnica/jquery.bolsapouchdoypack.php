...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseDataTD">&nbsp;<input type="text" name="fuelle" id="fuelle" value="<?php echo $fuelle ?>" size="7" /><?php //echo($fuelle)? $fuelle : '---' ; ?></td>
			<td class="NoiseFooterTD"><?php if($campnomb["tole_fuelle_ms"] == 1 || $campnomb["tole_fuelle_ms"]){echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Tolerancia de fuelle (mm)</td>
			<td class="NoiseDataTD">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td width="20%" class="NoiseFooterTD"><?php if($campnomb["tipo_selle"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipo de selle</td>
			<td width="30%" class="NoiseDataTD"><select name="tipo_selle" id="tipo_selle">
	  		...
	  		<td width="20%" class="NoiseFooterTD"><?php if ($campnomb["aselle_bolsa"] == 1) { $aselle_bolsa = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Ancho de selle a las bolsas</td>
		...
		<tr>
			<td class="NoiseFooterTD"><?php if($campnomb["sellos"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. de sellos</td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			<td class="NoiseFooterTD" width="20%"><span id="tipo_cierre_lb" style="display : <?php if($valve == 'si'){echo 'none';}else{echo 'block';}?>"><?php if($campnomb["tipo_cierre"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipos de cierre</span></td>
			...
			<td class="NoiseFooterTD" width="20%"><span id="dist_cierre_lb" style="display : <?php if($valve == 'si'){echo 'none';}else{echo 'block';}?>"><?php if($campnomb["dist_cierre"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Dist. de cierre al borde</span></td>
			<td class="NoiseDataTD" width="30%"><span id="dist_cierre_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{'block';}?>"><input type="text" name="dist_cierre" id="dist_cierre" value="<?php echo $dist_cierre ?>" size="20" onkeypress="return event.keyCode!=13"/></span></td>	
		</tr>
		<tr>
			<td class="NoiseFooterTD" width="20%"><?php if($campnomb["tipo_aper"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;Tipos de apertura</td>
