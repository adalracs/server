...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td width="20%" class="NoiseFooterTD">&nbsp;Macroperforaciones</td>
			<td width="30%" class="NoiseDataTD">&nbsp;<input type="hidden" name="macroper" id="macroper" value="<?php echo $macroper ?>" /><?php echo ($macroper)? strtoupper($macroper) : '---' ; ?></td>
			<td width="25%" class="NoiseFooterTD"><span id="n_macroperflbl" style="display: <?php if($macroper == 'no'){ echo 'none'; } else { echo 'block'; } ?>">&nbsp;No. de macroperforaciones</span></td>
			<td width="25%" class="NoiseDataTD"><span id="n_macroperfobj" style="display: <?php if($macroper == 'no'){ echo 'none'; } else { echo 'block'; } ?>"><input type="hidden" name="nro_macroper" id="nro_macroper" value="<?php echo $nro_macroper ?>" /><?php echo ($nro_macroper)? strtoupper($nro_macroper) : '---' ; ?></span></td>
		</tr>
		<tr>
			...
			<td class="NoiseFooterTD"><span id="n_caras_microperflbl" style="display: <?php if($microper == 'no'){ echo 'none'; } else { echo 'block'; } ?>">&nbsp;No. caras microperforaciones</span></td>
			<td class="NoiseDataTD"><span id="n_caras_microperfobj" style="display: <?php if($microper == 'no'){ echo 'none'; } else { echo 'block'; } ?>">&nbsp;<input type="hidden" name="ncaras_microper" id="ncaras_microper" value="<?php echo $ncaras_microper ?>" /><?php echo ($ncaras_microper)? strtoupper($ncaras_microper) : '---' ;?></span></td>
		</tr>
		<tr>
			<td class="NoiseFooterTD"><span id="tipo_microperlbl" style="display: <?php if($microper=="si"){echo 'block';}else{echo 'none';}?>">&nbsp;Tipo de microperforaciones</span></td>
			<td class="NoiseDataTD"><span id="tipo_microperobj" style="display: <?php if($microper=="si"){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="hidden" name="tipo_microper" id="tipo_microper" value="<?php echo $tipo_microper ?>" /><?php echo ($tipo_microper)? strtoupper($tipo_microper) : '---' ;?></span></td>
			<td class="NoiseFooterTD"><span id="dist_microper_lb" style="display: <?php if($microper=="si"){echo 'block';}else{echo 'none';}?>">&nbsp;Distancia Microperforacion (mm)</span></td>
			<td class="NoiseDataTD"><span id="dist_microper_obj" style="display: <?php if($microper=="si"){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="hidden" name="dist_microper" id="dist_microper" value="<?php echo $dist_microper ?>" /><?php echo ($dist_microper)? strtoupper($dist_microper) : '---' ;?></span></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		<tr>
			<td width="20%" class="NoiseFooterTD">&nbsp;Dist. perf. pesta&ntilde;a (mm)</td>
