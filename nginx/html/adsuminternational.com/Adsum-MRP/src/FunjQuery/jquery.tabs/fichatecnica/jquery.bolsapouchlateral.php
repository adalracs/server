...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td class="NoiseFooterTD"><span id="ncaras_imp_lb" style="display : <?php if($tipo_impresion != 'sin_impresion'){echo 'block';}else{'none';}?>"><?php if($campnomb["ncaras_imp"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. de caras impresas</span></td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td width="20%" class="NoiseFooterTD"><?php if($campnomb["nro_sellos"] == 1)echo "<b style='font-size:15px; color:red;'>*</b>"; ?>&nbsp;No. de sellos</td>
			<td width="30%" class="NoiseDataTD">&nbsp;2&nbsp;<input type="radio" name="nro_sellos" id="nro_sellos" value="2" <?php if($nro_sellos == 2) echo ' checked' ?> />&nbsp;&nbsp;&nbsp;3&nbsp;<input type="radio" name="nro_sellos" id="nro_sellos" value="3" <?php if($nro_sellos == 3) echo ' checked' ?> />&nbsp;&nbsp;&nbsp;4&nbsp;<input type="radio" name="nro_sellos" id="nro_sellos" value="4" <?php if($nro_sellos == 4) echo ' checked' ?> /></td>
		...
		<tr> 
			...
			<td class="NoiseDataTD"><span id="ctapa_valveobj" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="text" name="ctapa_valve" id="ctapa_valve" value="<?php echo $ctapa_valve ?>" /></span></td>
	  		...
	  		<td class="NoiseDataTD"><span id="medi_valveobj" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="text" name="medi_valve" id="medi_valve" value="<?php echo $medi_valve ?>" /></span></td>
	  	</tr>
		...
		<tr> 
	  		...
	  		<td class="NoiseDataTD"><span id="ubic_valveobj" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="text" name="ubic_valve" id="ubic_valve" value="<?php echo $ubic_valve ?>" /></span></td>
	  		<td class="NoiseFooterTD"><span id="tipo_valvelb" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>"><?php if ($campnomb["tipo_valve"] == 1) { $tipo_valve = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Tipo de V&aacute;lvula</span></td>
	 	  	<td class="NoiseDataTD"><span id="tipo_valveobj" style="display : <?php if($valve == 'si'){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="text" name="tipo_valve" id="tipo_valve" value="<?php echo $tipo_valve ?>" /></span></td>
	  	</tr>
	  	<tr>
	  		<td class="NoiseFooterTD"><span id="ziper_lb" style="display : <?php if($valve == 'si'){echo 'none';}else{echo 'block';}?>"><?php if ($campnomb["ziper"] == 1) { $ziper = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Ziper</span></td>
	  		<td class="NoiseDataTD"><span id="ziper_obj" style="display : <?php if($valve == 'si'){echo 'none';}else{echo 'block';}?>">&nbsp;Si&nbsp;<input type="radio" name="ziper" id="ziper" value="si" <?php if($ziper == 'si'){ echo ' checked';} ?> onclick="eventOcultaDistancia(this.value,'ziper');" />&nbsp;No&nbsp;<input type="radio" name="ziper" id="ziper" value="no" <?php if($ziper == 'no'){ echo ' checked';} ?> onclick="eventOcultaDistancia(this.value,'ziper');" /></span></td>
	  		<td class="NoiseFooterTD"><span id="dist_ziper_lb" style="display : <?php if($ziper == 'si' && $valve == 'no'){echo 'block';}else{echo 'none';}?>"><?php if ($campnomb["dist_ziper"] == 1) { $dist_ziper = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Dist. ziper al borde</span></td>
	  		<td class="NoiseDataTD"><span id="dist_ziper_obj" style="display : <?php if($ziper == 'si' && $valve == 'no'){echo 'block';}else{echo 'none';}?>"><input type="text" name="dist_ziper" id="dist_ziper" value="<?php echo $dist_ziper; ?>"></span></td>
	  	</tr>
	  	<tr>
	  		<td class="NoiseFooterTD"><?php if ($campnomb["muesca"] == 1) { $muesca = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Muesca</td>
	  		...
	  		<td class="NoiseFooterTD"><span id="dist_muesca_lb" style="display : <?php if($muesca == 'si'){echo 'block';}else{echo 'none';}?>"><?php if ($campnomb["dist_muesca"] == 1) { $dist_muesca = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Dist. muesca al borde</span></td>
	  	...
	  	<tr>
	  		<td class="NoiseFooterTD"><?php if ($campnomb["precorte"] == 1) { $precorte = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Precorte</td>
	  		...
	  		<td class="NoiseFooterTD"><span id="dist_precorte_lb" style="display : <?php if($precorte == 'si'){echo 'block';}else{echo 'none';}?>"><?php if ($campnomb["dist_precorte"] == 1) { $dist_precorte = null; echo "<b style='font-size:15px; color:red;'>*</b>";}?>&nbsp;Dist. precorte al borde</span></td>
	...
	<div id="esp_ext_seccion">
		<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
			...
			<tr>
				<td colspan="4" >
					<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
						<?php if($tipo_impresion == 'interna' || $tipo_impresion == 'externa' || $tipo_impresion == 'sin_impresion'){
							$idcon = fncconn();?>
						<tr>
