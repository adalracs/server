...
<div id="opt-tab2">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			...
			<td class="NoiseFooterTD"><span id="tole_traslape_lb" style="display : <?php if($traslape > 0){echo 'block';}else{echo 'none';}?>">&nbsp;Tolerancia traslape (mm)</span></td>
			<td class="NoiseDataTD"><span id="tole_traslape_obj" style="display : <?php if($traslape > 0){echo 'block';}else{echo 'none';}?>">
				<b>+</b>&nbsp;<input type="hidden" name="tole_traslape_ms" id="tole_traslape_ms" value="<?php echo $tole_traslape_ms ?>" size="7" /><?php echo ($tole_traslape_ms)? $tole_traslape_ms : '**' ; ?>
				<b>-</b>&nbsp;<input type="hidden" name="tole_traslape_mn" id="tole_traslape_mn" value="<?php echo $tole_traslape_mn ?>" size="7" /><?php echo ($tole_traslape_mn)? $tole_traslape_mn : '**' ?>
			</span></td>
		</tr>
		<tr>
			<td class="NoiseFooterTD"><span id="tipo_traslape_lb" style="display : <?php if($traslape > 0){echo 'block';}else{echo 'none';}?>">&nbsp;Tipo Traslape </span></td>
			<td class="NoiseDataTD" colspan="3"><span id="tipo_traslape_obj" style="display : <?php if($traslape > 0){echo 'block';}else{echo 'none';}?>">&nbsp;<input type="hidden" name="tipo_traslape" id="tipo_traslape" value="<?php echo $tipo_traslape ?>" size="7" /><?php echo ($tipo_traslape)? strtoupper($tipo_traslape) : '---' ; ?></span></td>
		</tr>
		<tr>
...
<div id="opt-tab4a">
	<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		...
		<tr>
			<td width="20%" class="NoiseFooterTD">&nbsp;Tipo sellado</td>
			<td width="30%" class="NoiseDataTD">&nbsp;<input type="hidden" name="tipo_sellado" id="tipo_sellado" value="<?php echo $tipo_sellado ?>" /><?php echo ($tipo_sellado)? strtoupper($tipo_sellado) : '---' ;?></td>
		...
		<tr>
			...
			<td colspan="3" class="NoiseDataTD">&nbsp;<input type="hidden" name="dist_precalentadores" id="dist_precalentadores" value="<?php echo $dist_precalentadores ?>" /><?php echo ($dist_precalentadores)? strtoupper($dist_precalentadores) : '---' ;?></td>
		</tr>
		<tr>
