<div id="opt-tab1">
		<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
			<tr>
  				...
  				<td width="40%" class="NoiseDataTD">&nbsp;<input type="hidden" name="tipopedido" value="<?php echo $tipopedido ?>" /><?php echo $tipopedido ?></td>
          <td width="20%" class="NoiseFooterTD">&nbsp;Gen. Solicitud</td>
          <td width="20%" class="NoiseDataTD">&nbsp;<?php if ($campnomb["gensolicitud"] == 1) { $gensolicitud = null; echo "*";} ?>
            <select name="gensolicitud" id="gensolicitud">
  			...
  			<tr>
  				...
  				<td width="20%" class="NoiseFooterTD">&nbsp;<input type="hidden" name="unimedi" id="unimedi" value="<?php echo $unimedi?>" />Cantidad</td>
  			...
  			<tr>
  				...
  				<td colspan="3" class="NoiseDataTD">&nbsp;<input type="hidden" name="nombre" value="<?php echo $nombre ?>" /><?php echo $nombre ?></td>
  			</tr>
  			<?php else:?>
  			<tr>
