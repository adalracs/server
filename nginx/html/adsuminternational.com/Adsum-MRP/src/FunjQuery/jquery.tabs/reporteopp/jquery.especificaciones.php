...
for($a = 0;$a < $nrOpproduccion;$a++)
{
	...
	if($rwOpsellado['unidadcodigo']) $UNIDADPED = ($UNIDADPED)? $UNIDADPED.'<br>&nbsp;'.$rwOpsellado['unidadcodigo'] : $rwOpsellado['unidadcodigo'] ;
}
?>
<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
	<tr>
	...
	<tr>
		...
		<td colspan="3" class="NoiseDataTD">&nbsp;<?php echo $CANTIDADPED;  ?>&nbsp;<?php echo $UNIDADPED; ?></td>
	</tr>
</table>
