...
<table width="100%" border="0" cellspacing="1" cellpadding="1"
	...
	<tr>
		...
		<td colspan="3" class="NoiseDataTD"><select name="opestacodigo"
			id="opestacodigo">
			<option value="">--Seleccione--</option>
			<?php
			include '../src/FunGen/floadopestado.php';
			floadopestadoreporte($opestacodigo,$idcon);
			?>
		</select></td>
	</tr>
	<tr>
		<td colspan="4" class="NoiseFooterTD"><?php if($campnomb["repoppdescri"] == 1){ $repoppdescri = null;echo "*";}?>&nbsp;Aclaraci&oacute;n</td>
	</tr>
	<tr>
		<td colspan="4" rowspan="3"><textarea name="repoppdescri" id="repoppdescri" cols="90" rows="3"><?php echo $repoppdescri;?></textarea></td>
	</tr>
</table>