...
ob_start(); 
	...
	if($accionborrarreportelampn) 
		include ( 'borrareportelampn.php'); 
	else 
	{ 
		if($accionconsultarreportelampn) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarreportelampn = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('reportelampn',$inicio,$fin,$mov,$accionconsultarreportelampn,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de reporte parametros de laminado</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de reporte parametros de laminado</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablreportelampn.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="45%" class="ui-state-default">Patron Estructura</td>
								<td width="20%" class="ui-state-default">Equipo</td>
								<td width="20%" class="ui-state-default">Responsable</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregreportelampn.php'); 
								$reg[0] = 'relapncodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregreportelampn('reportelampn', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="reportelampn"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="reportelampn"> 
			<input type="hidden" name="columnas" value="relapncodigo,patestcodigo,relapnfecha, relapnhora"> 
			...
			<input type="hidden" name="relapnfecha" value="<?php if($accionconsultarreportelampn) echo $relapnfecha; ?>"> 
			<input type="hidden" name="relapnhora" value="<?php if($accionconsultarreportelampn) echo $relapnhora; ?>"> 
			...
			<input type="hidden" name="selcampos" value="relapncodigo">
			<!--											-->
