...
<tr>
	<td width="749" class="NoiseColumnTD">Creacion de edificio </td>
</tr>
<tr>
...
<tr>
	<td><table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
          ...
          <tr>
            <td><?php if($campnomb["equipocodigo"] == 1)echo "*"; ?>Nombre</td>
            <td colspan="2"><input name="textarea" type="text" value="<?php if(!$flagnuevoot){echo $sbreg["ordtradescri"];}else{ echo $ordtradescri;}?>
		   " size="14"></td>
            <td colspan="2">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
		...
		<tr>
			<td width="17%"><?php if($campnomb["ordtradescri"] == 1){$ordtradescri = null; echo "*";} ?>Descripci&oacute;n</td>
