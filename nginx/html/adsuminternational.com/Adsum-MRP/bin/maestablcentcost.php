...
ini_set("display_errors", 1);
	...
	if ($accionborrarcentcost) { 
		include ("borracentcost.php"); 
	} else { 
		if ($accionconsultarcentcost) { 
			$nusw = 0; 
	...
	$intervalo = fncaumdec ( "centcost", $inicio, $fin, $mov, $accionconsultarcentcost, $recarreglo ); 
...
<p><font class="NoiseFormHeaderFont">Listado de centros de costo</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750"> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablcentcost.php', $flagcheck ); ?></td> </tr> 
	<tr> <td>&nbsp;</td> </tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<td width="40%" class="ui-state-default tbl-head-font">Clasificaci&oacute;n</td>								
			</tr>
				<?php 
				include ('../src/FunGen/sesion/fncvisregcentcost.php'); 
				$reg [0] = 'cencoscodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregcentcost ( 'centcost', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> <td>&nbsp;</td> </tr> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablcentcost.php', $flagcheck ); ?></td> 
	</tr> 
</table> 
<input type="hidden" name="codigo" value="<?php echo $codigo; ?>"> 
<input type="hidden" name="inicio" value="<?php echo $intervalo ["inicio"];	?>"> 
<input type="hidden" name="fin"	value="<?php echo $intervalo ["fin"];	?>"> 
<input type="hidden" name="sourcetable" value="centcost"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="centcost"> 
<input type="hidden" name="columnas" value="cencoscodigo, cencosnombre, cencosdescri, cencosclasif"> 
...
<input type="hidden" name="cencosclasif" value="<?php if ($accionconsultarcentcost) { echo $cencosclasif; } ?>">  
<input type="hidden" name="accionconsultarcentcost"	value="<?php echo $accionconsultarcentcost; ?>"> 
