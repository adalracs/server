...
if($accionborrartipotrab)
{
	include ( 'borratipotrab.php');
}
else
{
	if($accionconsultartipotrab)
	{
...
$intervalo = fncaumdec('tipotrab',$inicio,$fin,$mov,$accionconsultartipotrab,$recarreglo);
...
<html> 
<head> 
<title>Registros de tipo de trabajo</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de tipos de trabajos</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipotrab.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevtipotrab.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultartipotrab.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipotrab.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestabltipotrab.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallartipotrab.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrartipotrab.php';
...
onclick="form1.action='."'".'editartipotrab.php'."'".';"  width="87" 
...
$reg[0] = 'tiptracodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('tipotrab', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
?>
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestabltipotrab.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipotrab.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
	        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestabltipotrab.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipotrab.php',$flagcheck); ?></td> 
  </tr> 
 ...
 <input type="hidden" name="nombtabl" value="tipotrab"> 
<input type="hidden" name="columnas" value="tiptracodigo, 
tiptranombre, 
tiptradescri 
"> 
 <input type="hidden" name="tiptracodigo" value="<?php echo $tiptracodigo; ?>"> 
 <input type="hidden" name="tiptranombre" value="<?php echo $tiptranombre; ?>"> 
 <input type="hidden" name="tiptradescri" value="<?php echo $tiptradescri; ?>"> 
 <input type="hidden" name="accionconsultartipotrab" value="<?php echo 
$accionconsultartipotrab; ?>"> 
...
<input type="hidden" name="selcampos" value="tiptracodigo, tiptranombre">
<!--											-->
