...
function editaestadosaldo($iRegestadosaldo,&$flageditarestadosaldo,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordestadosaldo($iRegestadosaldo,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editaestadosaldo($iRegestadosaldo,$flageditarestadosaldo,$campnomb,$codigo);
?> 
