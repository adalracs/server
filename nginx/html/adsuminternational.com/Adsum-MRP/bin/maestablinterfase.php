...
if($accionborrarinterfase)
{
	include ( 'borrainterfase.php');
}
else
{
	if($accionconsultarinterfase)
	{
		...
		while ($nombcamp)
		{
			...
			if($nombcamp == "interftipo")
				if($recarreglo[$nombcamp] == "0")
					$nusw =1;
				elseif($recarreglo[$nombcamp] == "1") 
					$nusw =1;
			elseif($recarreglo[$nombcamp])
				$nusw =1;
...
<html> 
<head> 
<title>Registros de interfase</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de Interfases</font><br>
  <br></p> 
...
onclick="form1.action='."'".'ingrnuevinterfase.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarinterfase.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablinterfase.php';" alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
  $intervalo = fncaumdec('interfase',$inicio,$fin,$mov,$accionconsultarinterfase,$recarreglo);
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablinterfase.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarinterfase.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarinterfase.php';
...
onclick="form1.action='."'".'editarinterfase.php'."'".';"  width="87" 
...
<td width="46%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">regist</font></span></td> 
</tr> 
<?php 
include ( '../src/FunGen/sesion/fncvisreg.php');
$reg[0] = 'interfcodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('interfase', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?>
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablinterfase.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onClick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablinterfase.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablinterfase.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
 ...
 <input type="hidden" name="nombtabl" value="interfase"> 
<input type="hidden" name="columnas" value="interfcodigo, 
interfregist, 
interfutiliz,
interftipo
"> 
 <input type="hidden" name="interfcodigo" value="<?php echo $interfcodigo; ?>"> 
 <input type="hidden" name="interfregist" value="<?php echo $interfregist; ?>"> 
 <input type="hidden" name="interfutiliz" value="<?php echo $interfutiliz; ?>"> 
 <input type="hidden" name="interftipo" value="<?php echo $interftipo; ?>"> 
 <input type="hidden" name="accionconsultarinterfase" value="<?php echo 
$accionconsultarinterfase; ?>"> 
...
<input type="hidden" name="selcampos" value="interfcodigo, interfregist">
<!--											-->
