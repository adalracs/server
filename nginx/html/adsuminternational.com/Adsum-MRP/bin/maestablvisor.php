...
include ( '../src/FunPerPriNiv/pktblvisor.php');
...
if($accionborravisor)
{
	include ( 'borravisor.php');
}
else
{
		if($accionconsultarvisor)
			{
...
<p><font class="NoiseFormHeaderFont">visores de imagenes</font><br><br></p>
...
onclick="form1.mov.value = 'menos';form1.action='maestablvisor.php';"
alt="Anterior"></td>
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td>
 <td width="50">
  <?php
	$intervalo = fncaumdec('visor',$inicio,$fin,$mov,$accionconsultarvisor,$recarreglo);
...
onclick="form1.mov.value = 'mas';form1.action='maestablvisor.php';"
alt="Siguiente"></td>
 </tr>
 <tr>
...
onclick="form1.action='."'".'detallarvisor.php'."'".';"  width="87"
height="19"  alt="Ver detalle" border=0></b>';
}
if($reccomact[borrar]){
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif"
onclick="form1.action='."'".'borrarvisor.php'."'".';"  width="87"
...
onclick="form1.action='."'".'editarvisor.php'."'".';"  width="87"
...
color="#FFFFFF">Articulo</font></span></td>
<td width="20%" class="NoiseFieldCaptionTD"><span class="style5"><font
color="#FFFFFF">ruta de imagen</font></span></td>
</tr>
<?php
include ( '../src/FunGen/sesion/fncvisregvisor.php');
	$reg[0] = 'cod_visor';
	$reg1[0] = 'n';
	$nureturn = fncvisregvisor('visor',$reg,$reg1,$idtrans);
...
onclick="form1.mov.value = 'primero';form1.action='maestablvisor.php';"
alt="Primero"></td>
   <td width="46"><input type="image" name="adelanta"
src="../img/adelanta.gif" onclick="form1.mov.value =
'menos';form1.action='maestablvisor.php';" alt="Anterior"></td>
   <td width="50">
<?php
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablvisor.php';"
alt="Ultimo"></td>
  </tr>
  <tr>
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td>
 ...
 <input type="hidden" name="nombtabl" value="visor">
<input type="hidden" name="columnas" value="cod_visor,
nombvisor,
rut_imagen,
estadocodigo,
articucodigo
">
 <input type="hidden" name="cod_visor" value="<?php echo $cod_visor; ?>">
 <input type="hidden" name="nombvisor" value="<?php echo $nombvisor; ?>">
 <input type="hidden" name="rut_imagen" value="<?php echo $rut_imagen; ?>">
 <input type="hidden" name="estadocodigo" value="<?php echo $estadocodigo; ?>">
 <input type="hidden" name="articucodigo" value="<?php echo $rut_imagen; ?>">
 <input type="hidden" name="accionconsultarvisor" value="<?php echo
$accionconsultarvisor; ?>">
