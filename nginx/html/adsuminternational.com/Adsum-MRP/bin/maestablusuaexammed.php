...
onclick="form1.action='consultarusuaexammed.php';"  width="86" 
height="18" alt="Consultar" border=0>
 </td> 
 <td width="42"> 
  <input type="image" name="adelanta"  src="../img/adelanta.gif" 
onclick="form1.mov.value='menos';form1.action='maestablusuaexammed.php';" alt="Anterior"></td> 
...
onclick="form1.mov.value='mas';form1.action='maestablusuaexammed.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregusuaexammed.php'); 
	$reg[0] = 'usuacodi'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregusuaexammed('usuario',$reg,$reg1,$idtrans,$arreglo_aux); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value='primero';form1.action='maestablusuaexammed.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"
src="../img/adelanta.gif" onclick="form1.mov.value='menos';form1.action='maestablusuaexammed.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value='ultimo';form1.action='maestablusuaexammed.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
