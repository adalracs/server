...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="accionconsultarcuadrillagen">
			...
			<input type="hidden" name="columnas" value="cuadricodigo,cuadrinombre,cuadriacti,servicicodigo,departcodigo"> 
