...
ob_start(); 
	...
	if($accionnuevocuadrilla)
		include('grabacuadrilla.php');
...
<html> 
	<head> 
		<title>Nuevo registro de cuadrilla</title> 
...
<?php endif; ?>
			  					...
			  					<td> 
			            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
										<tr> 
			 								...
			 								<td width="78%" class="NoiseDataTD"><input type="text" name="cuadrinombre" id="cuadrinombre"  size="50" value="<?php if(!$flagnuevocuadrilla){echo $sbreg[cuadrinombre];}else{ echo $cuadrinombre; }?>" onchange="document.getElementById('cuadriname').innerHTML = this.value; document.getElementById('titlecuadrilla').value = this.value;"></td>
			 							</tr> 
										<tr>
										...
										<tr>
			     							...
			     							<td class="NoiseDataTD"><select name="cuadriacti" id="cuadriacti">
			     								<option value = "">-- Seleccione --</option>
			     								<option value = "1" <?php if($flagnuevocuadrilla && $cuadriacti == 1) echo 'selected'; ?>>Activo</option>
			     								<option value = "2" <?php if($flagnuevocuadrilla && $cuadriacti == 2) echo 'selected'; ?>>Inactivo</option>
			    							</select></td>
										</tr>   
									</table> 
			  					</td> 
			...
			<input type="hidden" name="cuadricodigo" id="cuadricodigo" value="<?php if(!$flagnuevocuadrilla){ echo $sbreg[cuadricodigo];}else{ echo $cuadricodigo; } ?>"> 
			...
			<input type="hidden" name="accionnuevocuadrilla">
