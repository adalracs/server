...
ob_start(); 
	...
	if($accionconsultarnoconformepr) 
	{ 
		$nusw = 0; 
		...
		if(!$nusw)
			$accionconsultarnoconformepr = 0; 
	} 
	
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('noconformepr',$inicio,$fin,$mov,$accionconsultarnoconformepr,$recarreglo); 
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="950">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablnoconformepr.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'nocomcodigo';
								$reg1[0] = 'n';
								$nureturn = fncvisregnoconformepr('noconformepr', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="noconformepr"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="noconformepr"> 
			...
			<input type="hidden" name="nocomcodigo" value="<?php if($accionconsultarnoconformepr) echo $analiscodigo; ?>">
			<input type="hidden" name="analiscodigo" value="<?php if($accionconsultarnoconformepr) echo $proveecodigo; ?>">
			<input type="hidden" name="nocomfecha1" value="<?php if($accionconsultarnoconformepr) echo $analisnolote; ?>">                   
			<input type="hidden" name="usuacodi2" value="<?php if($accionconsultarnoconformepr) echo $itedescodigo; ?>">
			<input type="hidden" name="usuacodi" value="<?php if($accionconsultarnoconformepr) echo $usuacodi; ?>">
			<input type="hidden" name="nocomhora" value="<?php if($accionconsultarnoconformepr) echo $nocomhora; ?>">
			<input type="hidden" name="causacodigo" value="<?php if($accionconsultarnoconformepr) echo $causacodigo; ?>">
			<input type="hidden" name="causadescri" value="<?php if($accionconsultarnoconformepr) echo $causadescri; ?>">
			<input type="hidden" name="defectcodigo" value="<?php if($accionconsultarnoconformepr) echo $defectcodigo; ?>">
			<input type="hidden" name="defectcodigo" value="<?php if($accionconsultarnoconformepr) echo $defectcodigo; ?>">
			<input type="hidden" name="defectodescri" value="<?php if($accionconsultarnoconformepr) echo $defectodescri; ?>">
			<input type="hidden" name="accionconsultarnoconformepr" value="<?php echo $accionconsultarnoconformepr; ?>">
