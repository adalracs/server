...
//			$result = uprecordopp($iRegopp,$nuconn);
			...
			if($result > 0)
			{
				...
				fncmsgerror(grabaEx);	
				insrecordprogramamicroperforado(array('ordoppcodigo' => $iRegopp['ordoppcodigo'], 'prograindice' => 999),$nuconn);			
			}
			fncclose($nuconn);
		}
	}
...
if(!$flagnuevoopp)
{
	...
	echo '<!--//'."\n";
	echo 'location ="maestablbandejamicroperforado.php?codigo='.$codigo.';"';
	echo '//-->'."\n";
	echo '</script>';
}
