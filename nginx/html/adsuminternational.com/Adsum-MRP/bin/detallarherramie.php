...
<html> 
	<head> 
		<title>Detalle registro de herramienta</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="acciondetallarherramie">
			<input type="hidden" name="flagdetallarherramie" value="1">
