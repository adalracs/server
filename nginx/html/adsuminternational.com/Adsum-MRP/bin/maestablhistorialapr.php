<?php 
ob_start(); 
	include ( '../src/FunPerPriNiv/pktblvistahistorialpr.php');
	...
	if($accionconsultarhistorialapr)
	{
		$nusw = 0;
		...
		if(!$nusw)
			$accionconsultarhistorialapr = 0;
	}
	
	include ( '../src/FunGen/sesion/fncaumdec.php');
	include('../src/FunGen/fncpageposition.php');
	
  	$intervalo = fncaumdec('vistahistorialpr',$inicio,$fin,$mov,$accionconsultarhistorialapr,$recarreglo);
...
<html> 
	<head> 
		<title>Historial de analisis producto en proceso</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Historial de analisis de producto en proceso</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="950">
				<tr><td class="NoiseErrorDataTD" align="right"><?php page_position($intervalo,'maestablhistorialapr.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
 			...
 			<input type="hidden" name="sourcetable" value="historialapr"> 
			...
			<input type="hidden" name="analiscodigo" value="<?php if($accionconsultarhistorialapr) echo $analiscodigo; ?>">
			<input type="hidden" name="lotecodigo" value="<?php if($accionconsultarhistorialapr) echo $analisnolote; ?>">
			<input type="hidden" name="itedescodigo" value="<?php if($accionconsultarhistorialapr) echo $itedescodigo; ?>">
			<input type="hidden" name="usuacodi" value="<?php if($accionconsultarhistorialapr) echo $usuacodi; ?>">
			<input type="hidden" name="analisfecha" value="<?php if($accionconsultarhistorialapr) echo $analisfecha; ?>">
			<input type="hidden" name="estanacodigo" value="<?php if($accionconsultarhistorialapr) echo $estanacodigo; ?>">
			<input type="hidden" name="analisdescri" value="<?php if($accionconsultarhistorialapr) echo $analisdescri; ?>">
			<input type="hidden" name="analisestado" value="<?php if($accionconsultarhistorialapr) echo $analisestado; ?>">
			<input type="hidden" name="accionconsultarhistorialapr" value="<?php echo $accionconsultarhistorialapr; ?>">
