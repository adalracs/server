	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
      		...
      		<input type="hidden" name="grugercodigo1" value="<?php echo $grugercodigo; ?>">
	  		<input type="hidden" name="accionborrargrupogerencial">
	  		<input type="hidden" name="flagborrargrupogerencial" value="1">
