...
<?php endif; ?> 
       					...
       					<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
       						<tr> 
 								<td class="NoiseFooterTD"><?php if($campnomb["itemcodigo"] == 1){ $itemcodigo = null; echo "*";} ?>&nbsp;C&oacute;digo</td> 
  								<td colspan="3" class="NoiseDataTD"><input type="text" name="itemcodigo"	value="<?php if(!$flagnuevoitem){ echo $sbreg[itemcodigo];}else {echo $itemcodigo;}?>" size="30"></td> 
 							</tr>
       						<tr> 
 								<td class="NoiseFooterTD"><?php if($campnomb["itemnombre"] == 1){ $itemnombre = null; echo "*";} ?>&nbsp;Nombre</td> 
  								<td colspan="3" class="NoiseDataTD"><input type="text" name="itemnombre"	value="<?php if(!$flagnuevoitem){ echo $sbreg[itemnombre];}else {echo $itemnombre;}?>" size="50"></td> 
 							</tr>
 							<tr>
					    	...
					    	<tr>
								...
								<td width="30%" class="NoiseDataTD"><select name="unidadcodigo">
							 	...
							 	<td width="30%" class="NoiseDataTD"><input name="itemvalor" type="text"	value="<?php if(!$flagnuevoitem){ echo $sbreg[itemvalor];}else{ echo $itemvalor;}?>" size="20"></td>
							</tr>
					    	<tr>
							 	<td class="NoiseFooterTD"><?php if($campnomb["itemcanmin"] == 1){ $itemcanmin=null; echo "*";}?>&nbsp;Cantidad M&iacute;nima</td>
							 	<td class="NoiseDataTD"><input name="itemcanmin" type="text"	value="<?php if(!$flagnuevoitem){ echo $sbreg[itemcanmin];}else{ echo $itemcanmin;}?>" size="20"></td>
							 	<td class="NoiseFooterTD"><?php if($campnomb["itemcanmax"] == 1){ $itemcanmax=null; echo "*";}?>&nbsp;Cantidad M&aacute;xima</td>
							 	<td class="NoiseDataTD"><input name="itemcanmax" type="text"	value="<?php if(!$flagnuevoitem){ echo $sbreg[itemcanmax];}else{ echo $itemcanmax;}?>" size="20"></td>
							</tr>
							<tr> 
 								<td class="NoiseFooterTD"><?php if($campnomb["itemdensid"] == 1){ $itemdensid = null; echo "*";} ?>&nbsp;Densidad</td> 
  								<td class="NoiseDataTD"><input type="text" name="itemdensid"	value="<?php if(!$flagnuevoitem){ echo $sbreg[itemdensid];}else {echo $itemdensid;}?>" size="20"></td> 
							...
							<tr><td colspan="4" rowspan="2" class="NoiseDataTD"><textarea name="itemnota" rows="3" cols="65"><?php if(!$flagnuevoitem){ echo $sbreg[itemnota];}else{ echo $itemnota;} ?></textarea>  </td></tr>
						</table>
					</td>
				</tr>
				<tr> 
			...
			<input type="hidden" name="itemdisponib" value="0">
