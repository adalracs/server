<?php 
	...
	if($accionnuevogestionplaneacionopp){ 
		include ( "grabagestionplaneacionopp.php");
	}
	...
	if(!$flagnuevogestionplaneacionopp){
		...
		if (!$sbreg) {
			...
			$flagvalidaciongestionplaneacionopp = 1;
		}else{
		...
		$gesoppdescri = "Gestion Planeacion [OK]";
		
		//$MODULOCODIGO	= 5;//constante de la tabla "modulo" 
		//$rutamodulo = "maestablgestionopp.php";
		//include "scanalarma.php";//se escanea para activar alarmas configuradas

		$rsRutaitempv = dinamicscanopplanearutaitempv(array( "produccodigo" => $produccodigo), array("produccodigo" => "="), $idcon);
		...
		for($a = 0; $a < $nrOppitemdesa; $a++){
			...
			$arrplaneacionopp = ($arrplaneacionopp)? $arrplaneacionopp.",".$rwOppitemdesa["itedescodigo"] : $rwOppitemdesa["itedescodigo"] ;
...
<?php elseif($flagvalidaciongestionplaneacionopp): ?> 	
				<tr><td><div class="ui-widget">
					<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;"> 
						<p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span> 
...
<?php endif; ?>
								...
								<td>
									<div id="tabs_opp">
										...
										<div id="tabs_material">
											<?php include "../src/FunjQuery/jquery.tabs/gestionopp/jquery.gestionplaneacionopp.php"; ?>
										</div>
				...
				<tr>
					<td class="NoiseErrorDataTD" align="center">
						<div class="ui-buttonset">
							<?php if(!$flagvalidaciongestionplaneacionopp): ?>
			...
			<input type="hidden" name="flagnuevogestionplaneacionopp">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="nuevo">  
			<input type="hidden" name="accionnuevogestionplaneacionopp"> 
