...
<html> 
<head> 
<title>Borrar registro de Sesion</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionborrarsesion.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagborrarsesion){ echo $sbreg[sesicose];}else{ echo $sesicose; } ?>" 
...
onFocus="if (!agree)this.blur();" ><?php if(!$flagborrarsesion){ echo 
...
if(!$flagborrarsesion){ echo $sbreg[usuacodi];}else{ echo $usuacodi;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarsesion){ echo $sbreg[sesifein];}else{ echo $sesifein;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarsesion){ echo $sbreg[sesifefi];}else{ echo $sesifefi;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarsesion){ echo $sbreg[sesifeua];}else{ echo $sesifeua;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarsesion){ echo $sbreg[sesiacti];}else{ echo $sesiacti; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarsesion){ echo $sbreg[sesiip];}else{ echo $sesiip;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagborrarsesion" value="1"> 
<input type="hidden" name="accionborrarsesion"> 
