...
<html> 
<head> 
<title>Editar registro de Sesion</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accioneditarsesion.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flageditarsesion){ echo $sbreg[sesicose];}else{ echo $sesicose; } ?>" 
...
onFocus="if (!agree)this.blur();" ><?php if(!$flageditarsesion){ echo 
...
if(!$flageditarsesion){ echo $sbreg[sesiacti];}else{ echo $sesiacti;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flageditarsesion){ echo $sbreg[sesiip];}else{ echo $sesiip;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flageditarsesion" value="1"> 
<input type="hidden" name="accioneditarsesion"> 
