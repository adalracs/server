...
<html> 
<head> 
<title>Borrar registro de Usuario-Grupo</title> 
...
<script language="JavaScript"> 
<!-- Begin
function foo(){ form1.accionborrarusuagrup.value =  1; }
//  End -->
</script> 
</head> 
<?php 
...
sans-serif">Código de  grupo</font></td> 
                <td width="59%"> 
                  <input type="text" name="grupcodi" value="<?php 
if(!$flagborrarusuagrup){ echo $sbreg[grupcodi];}else{ echo $grupcodi; } ?>" 
...
if(!$flagborrarusuagrup){ echo $sbreg[usuacodi];}else{ echo $usuacodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
src="../img/aceptar.gif" 
onclick="foo();form1.action='maestablusuagrup.php';submit();"  width="86" 
height="18" align="right" alt="Aceptar" border=0></td> 
          <td width="47%"><input type="image" name="cancelar"  
src="../img/cancelar.gif" 
onclick="form1.action='maestablusuagrup.php';submit();"  width="86" height="18" 
...
<input type="hidden" name="flagborrarusuagrup" value="1"> 
<input type="hidden" name="accionborrarusuagrup"> 
