...
<html> 
	<head> 
		<title>Consultar tipo de material</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Tipo de marterial</font></p> 
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr>
								...
								<td width="80%" class="NoiseDataTD"><input type="text" name="tipmatcodigo" size="30" value="<?php echo $tipmatcodigo; ?>"></td> 
 							</tr>
							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Nombre</td>
								<td width="80%" class="NoiseDataTD"><input type="text" name="tipmatnombre" size="30" value="<?php echo $tipmatnombre; ?>"></td> 
 							</tr>
						</table> 
  					</td> 
 				</tr> 
 			...
 			<input type="hidden" name="flagconsultartipomaterial" value="1"> 
			<input type="hidden" name="accionconsultartipomaterial"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="tipmatcodigo, tipmatnombre">
