...
ini_set('display_errors',1);
	...
	if(!$flageditaropp)
	{
		...
		$rsOrdproduccion = dinamicscanopopcorte(array('ordoppcodigo' => $arropp),array('ordoppcodigo' => '='),$idcon);
...
<html> 
	<head> 
		<title>editar registro de orden de produccion corte programadas</title> 
				...
				<?php 
					...
					if($arrop) $arrObject = explode(',',$arrop);
      				for ($a = 0; $a < count($arrObject); $a++)
      				{
      					...
      					$rwVistaop = loadrecordopcorte($arrObject[$a],$idcon);
					...
					<td>
						<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">		
							...
							<tr>
								...
								<td width="16%" class="ui-state-default"><small>Anc.<b>(mm)</b></small></td>
