...
<html> 
<head> 
<title>Editar registro de Numerador</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accioneditarnumerado.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flageditarnumerado){ echo $sbreg[numecodi];}else{ echo $numecodi; } ?>" 
...
if(!$flageditarnumerado){ echo $sbreg[numedesc];}else{ echo $numedesc;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flageditarnumerado){ echo $sbreg[numeprox];}else{ echo $numeprox;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flageditarnumerado" value="1"> 
<input type="hidden" name="accioneditarnumerado"> 
