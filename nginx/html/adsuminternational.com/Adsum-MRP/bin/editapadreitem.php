...
$paditekeylin = trim($arrkeylinea);
function editapadreitem($iRegpadreitem,&$flageditarpadreitem,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordpadreitem($iRegpadreitem,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editapadreitem($iRegpadreitem,$flageditarpadreitem,$campnomb,$codigo);
?> 
