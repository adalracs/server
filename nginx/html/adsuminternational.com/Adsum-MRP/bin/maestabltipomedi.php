...
ob_start(); 
	...
	if($accionborrartipomedi) 
		include ( 'borratipomedi.php'); 
	else 
	{ 
		if($accionconsultartipomedi) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultartipomedi = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('tipomedi',$inicio,$fin,$mov,$accionconsultartipomedi,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de tipos de mediciones</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de tipos de mediciones</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipomedi.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="65%" class="ui-state-default">Nombre</td> 
								<td width="20%" class="ui-state-default">Acronimo</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregtipomedi.php'); 
								$reg[0] = 'tipmedcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregtipomedi('tipomedi', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="tipomedi"> 
