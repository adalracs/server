...
function editapatronestruc($iRegpatronestruc,&$flageditarpatronestruc,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordpatronestruc($iRegpatronestruc,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
$iRegpatronestruc[patestcodigo] = $patestcodigo;
...
editapatronestruc($iRegpatronestruc,$flageditarpatronestruc,$campnomb,$codigo);
if(!$flageditarpatronestruc)
{
	$idcon = fncconn();
	delrecordpatronestrucpadreitem($iRegpatronestruc[patestcodigo],$idcon);
