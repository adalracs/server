...
if ($accionborrarvistasoliextru) { 
	include ('borravistasoliextru.php'); 
} else { 
	if ($accionconsultarvistasoliextru) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistasoliextru = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistasoliextru', $inicio, $fin, $mov, $accionconsultarvistasoliextru, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de solicitud de programacion de extrusion</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de solicitudes de programacion [Extrusi&oacute;n]</font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablvistasoliextru.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistasoliextru.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistasoliextru ( 'vistasoliextru', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistasoliextru"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistasoliextru"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistasoliextru) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistasoliextru"	value="<?php echo $accionconsultarvistasoliextru; ?>"> 
