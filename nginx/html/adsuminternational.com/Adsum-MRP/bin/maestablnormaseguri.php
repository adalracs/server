...
class="NoiseFormTABLE">
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablnormaseguri.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php  
...
onclick="form1.action='."'".'ingrnuevnormaseguri.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarnormaseguri.php'."'".';"  width="86" 
...
onclick="form1.mov.value = 'menos';form1.action='maestablnormaseguri.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablnormaseguri.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarnormaseguri.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarnormaseguri.php';
...
onclick="form1.action='."'".'editarnormaseguri.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'norsegcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('normaseguri', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablnormaseguri.php';" 
alt="Primero"></td> 
...
'menos';form1.action='maestablnormaseguri.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php  
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablnormaseguri.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablnormaseguri.php',$flagcheck); ?></td> 
...
"> 
 ...
 <input type="hidden" name="accionconsultarnormaseguri" value="<?php  echo 
$accionconsultarnormaseguri; ?>"> 
...
<input type="hidden" name="selcampos" value="norsegcodigo, norsegnombre">
<!--											-->
