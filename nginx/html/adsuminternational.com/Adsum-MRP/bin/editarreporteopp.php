...
ini_set("display_errors",1);
	...
	if($accioneditarreporteopp){ 
		include ( "editareporteopp.php");
	}
	...
	if(!$flageditarreporteopp)
	{
		...
		//$rutamodulo = "maestablreporteopp.php";
...
<?php endif; ?>
			...
			<input type="hidden" name="flageditarreporteopp">
			<input type="hidden" name="accioneditarreporteopp"> 
