...
<html> 
<head> 
<title>Nuevo registro de Tipo Menu Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionnuevotipomeco.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
color="669999"><b><font size="3" face="Arial, Helvetica, sans-serif"> 
            <font color="#006699">Ingresar nuevo</font></font></b></font></td> 
...
if(!$flagnuevotipomeco){ echo $sbreg[timecodi];}else{ echo $timecodi; } ?>" 
...
if(!$flagnuevotipomeco){ echo $sbreg[ticonomb];}else{ echo $ticonomb;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagnuevotipomeco){ echo $sbreg[ticodesc];}else{ echo $ticodesc;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flagnuevotipomeco" value="1"> 
<input type="hidden" name="accionnuevotipomeco"> 
