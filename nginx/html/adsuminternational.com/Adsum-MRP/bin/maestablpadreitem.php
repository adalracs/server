...
ob_start(); 
	...
	include ( '../src/FunPerPriNiv/pktblvistapadreitem.php'); 
	include ( '../src/FunGen/sesion/fncalmdat.php'); 
	include ( '../src/FunGen/sesion/fnccaf.php');
	 
	$reccomact =  fnccaf($GLOBALS[usuacodi],$_SERVER["SCRIPT_FILENAME"]);
	
	if($accionborrarpadreitem) 
		include ( 'borrapadreitem.php'); 
	else 
	{ 
		if($accionconsultarpadreitem) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarpadreitem = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('vistapadreitem',$inicio,$fin,$mov,$accionconsultarpadreitem,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de padre item</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de padre item's</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablpadreitem.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'paditecodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('vistapadreitem', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="padreitem"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="padreitem"> 
			...
			<input type="hidden" name="paditeextrui" value="<?php if($accionconsultarpadreitem) echo $paditeextrui; ?>"> 
			<input type="hidden" name="paditepigmen" value="<?php if($accionconsultarpadreitem) echo $paditepigmen; ?>">
			<input type="hidden" name="paditedensid" value="<?php if($accionconsultarpadreitem) echo $paditedensid; ?>">  
			...
			<input type="hidden" name="selcampos" value="paditecodigo">
			<!--											-->
