...
if($accionborrarplano)
{
	include ( 'borraplano.php');
}
else
{
	
	if($accionconsultarplano)
	{
...
$intervalo = fncaumdec('plano',$inicio,$fin,$mov,$accionconsultarplano,$recarreglo);
...
<html> 
<head> 
<title>Registros de plano</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de planos</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablplano.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevplano.php'."'".';"  width="86" height="18" 
...
onclick="form1.action='."'".'consultarplano.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablplano.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablplano.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarplano.php'."'".';"  width="87" height="19" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarplano.php';
...
onclick="form1.action='."'".'editarplano.php'."'".';"  width="87" height="19"  
...
$reg[0] = 'planocodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('plano', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablplano.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablplano.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablplano.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablplano.php',$flagcheck); ?></td> 
  </tr> 
...
"> 
 ...
 <input type="hidden" name="planonombre" value="<?php echo $planonombre; ?>"> 
 <input type="hidden" name="planoruta" value="<?php echo $planoruta; ?>"> 
 <input type="hidden" name="planodescri" value="<?php echo $planodescri; ?>"> 
 <input type="hidden" name="accionconsultarplano" value="<?php echo 
$accionconsultarplano; ?>"> 
...
<input type="hidden" name="selcampos" value="planocodigo, planonombre, planoruta">
<!--											-->
