...
ob_start();
	...
	if($accioneditaritemdesa) 
	{ 
		include ( 'editaitemdesa.php'); 
		$flageditaritemdesa = 1;
	}
ob_end_flush();

	if(!$flageditaritemdesa)
	{
...
<?php endif; ?>
							...
							<tr> 
 							...
 							<tr> 
 								<td class="NoiseFooterTD">&nbsp;Slip </td> 
  								<td class="NoiseDataTD"><input type="text" name="itedesslip" id="itedesslip" value="<?php echo $itedesslip; ?>" />&nbsp;(und * mill)</td> 
 							</tr> 
 							<tr> 
 								<td class="NoiseFooterTD">&nbsp;Antiblock </td> 
  								<td class="NoiseDataTD"><input type="text" name="itedesantibl" id="itedesantibl" value="<?php echo $itedesantibl; ?>" />&nbsp;(und * mill)</td> 
 							</tr>
 							    <td class="NoiseFooterTD"><?php if($campnomb["tipitemcodigo"] == 1): $tipitemcodigo = null; ?><span style="color:black;">*</span><?php endif; ?>&nbsp;Tipo de item</td>
			...
			<input type="hidden" name="accioneditaritemdesa">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="editar">
			<input type="hidden" name="codigo1" value="<?php if(!$flageditaritemdesa){echo $sbreg[itedescodigo];}else{echo $codigo1;}?>">
