...
ini_set('display_errors',1);
	...
	//conexion
	$idcon = fncconn();
	$rs_equipo = fullscanprogramavalvuladodisctequipo($idcon);
	...
	for($a = 0;$a < $nr_equipo;$a++)
	{
		...
		if($equipo)
			$rs_opp = dinamicscanopprogramavalvulado1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
...
<html>
	<head>
		<title>Bandeja de solicitudes valvulado</title>
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<p><font class="NoiseFormHeaderFont">{Valvulado}</font></p>			
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
									<tr>
										<td>
											<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
												<tr>
		  											<td class="ui-state-default">&nbsp;&nbsp;op de valvulado
						       							<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
						       								<tr>
																<td class="NoiseFooterTD">
																	<div id="detallebandejavalvulado" style="height: 350px; margin:0 auto; overflow:auto;">
																		<?php $noAjax = true;include 'detallabandejavalvulado.php'; ?>
																	</div>
																</td>
															</tr>
						                   				</table>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[nuevo] && !$flagcheck)
										echo '<button id="generaropp_vlv">Generar [opp]</button>&nbsp';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
													...
													<tr>
			  											<td class="ui-state-default">&nbsp;&nbsp;
							        						<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
							        							<tr>
																	<td class="NoiseFooterTD">
																		<div id="detalleordenvalvulado" style="height: 350px; margin:0 auto; overflow:auto;">
																			<?php $noAjax = true;include 'detallaordenvalvulado.php'; ?>
																		</div>
																	</td>
																</tr>
							                   				</table>						                   				
								...
								<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
									<?php  		
										if($reccomact[modificar] && !$flagcheck)
											echo '<button id="editaropp_vlv">Editar [opp]</button>';
									?>
								</div></td>
							</tr>
							<tr><td>&nbsp;</td></tr> 
