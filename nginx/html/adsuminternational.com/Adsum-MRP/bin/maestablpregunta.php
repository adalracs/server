...
include ( '../src/FunPerPriNiv/pktblpregunta.php');
include ( '../src/FunPerPriNiv/pktblestado.php'); 
include ( '../src/FunGen/sesion/fncalmdat.php'); 
include ( '../src/FunGen/sesion/fnccaf.php'); 
$reccomact.= fnccaf($GLOBALS[usuacodi],$PATH_TRANSLATED); 
if($accionborrarpregunta) 
{ 
	include ( 'borrapregunta.php'); 
} 
else 
{ 
		if($accionconsultarpregunta) 
			{ 
...
<html> 
<head> 
<title>Registros de pregunta</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de preguntas</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablpregunta.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php   
	$intervalo = fncaumdec 
('pregunta',$inicio,$fin,$mov,$accionconsultarpregunta,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablpregunta.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarpregunta.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarpregunta.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarpregunta.php'."'".';"  width="87" 
...
<td width="62%" class="NoiseFieldCaptionTD"><span class="style5"><font 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregpregunta.php'); 
	$reg[0] = 'preguncodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregpregunta('pregunta',$reg,$reg1,$idtrans);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablpregunta.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablpregunta.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablpregunta.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="pregunta"> 
<input type="hidden" name="columnas" value="preguncodigo, 
clientcodigo, 
articucodigo, 
estadocodigo, 
pregundescri, 
pregunresp"> 
 <input type="hidden" name="preguncodigo" value="<?php echo $preguncodigo; ?>"> 
 <input type="hidden" name="clientcodigo" value="<?php echo $clientcodigo; ?>"> 
 <input type="hidden" name="articucodigo" value="<?php echo $articucodigo; ?>"> 
 <input type="hidden" name="estadocodigo" value="<?php echo $estadocodigo; ?>"> 
 <input type="hidden" name="pregundescri" value="<?php echo $pregundescri; ?>"> 
 <input type="hidden" name="pregunresp" value="<?php echo $pregunresp; ?>"> 
 <input type="hidden" name="accionconsultarpregunta" value="<?php echo 
$accionconsultarpregunta; ?>"> 
