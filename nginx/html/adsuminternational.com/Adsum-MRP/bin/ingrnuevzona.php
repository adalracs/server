...
ob_start(); 
	...
	if($accionnuevozona)
		include ( 'grabazona.php'); 
ob_end_flush(); 
?>
<html> 
	<head> 
		<title>Nuevo registro de zona</title> 
...
<?php endif; ?>
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr> 
 								...
 								<td width="78%" class="NoiseDataTD"><input type="text" name="zonanombre" id="zonanombre"  size="50" value="<?php if(!$flagnuevozona){echo $sbreg[zonanombre];}else{ echo $zonanombre; }?>"></td> 
 							</tr> 
							<tr>
 							...
 							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["zonadescri"] == 1){ $zonadescri=null; echo "*";} ?>&nbsp;Descripci&oacute;n</td></tr>
  							<tr><td colspan="2" class="NoiseFooterTD"><textarea name="zonadescri" id="zonadescri" rows="3" cols="50" wrap="VIRTUAL"><?php if(!$flagnuevozona){echo $sbreg[zonadescri];}else {echo $zonadescri;}?></textarea></td></tr>
						</table> 
  					</td> 
 				</tr> 
 				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="zonacodigo" value="<?php if(!$flagnuevozona){ echo $sbreg[zonacodigo];}else{ echo $zonacodigo; } ?>"> 
			<input type="hidden" name="accionnuevozona">
