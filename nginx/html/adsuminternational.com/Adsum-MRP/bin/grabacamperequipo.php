...
function grabacamperequipo($iRegcamperequipo,&$flagnuevocamperequipo,&$campnomb) 
{ 
	$nuconn = fncconn(); 
...
grabacamperequipo($iRegcamperequipo,$flagnuevocamperequipo,$campnomb); 
?> 
