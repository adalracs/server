...
include ('../src/FunPerPriNiv/pktblproducestado.php'); 
include ('../src/FunGen/sesion/fncalmdat.php'); 
include ('../src/FunGen/sesion/fnccaf.php'); 
$reccomact = fnccaf ( $GLOBALS [usuacodi], $_SERVER ["SCRIPT_FILENAME"] ); 
 
if ($accionborrarproducestado) { 
	include ('borraproducestado.php'); 
} else { 
	if ($accionconsultarproducestado) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'producestado', $inicio, $fin, $mov, $accionconsultarproducestado, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de producestado</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de producestado</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" 
	class="ui-widget-content"> 
	<tr> 
		<td class="NoiseErrorDataTD" align="right"> 
	<?php 
	page_position ( $intervalo, 'maestablproducestado.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				$reg [0] = 'proestcodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreg ( 'producestado', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="producestado"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="producestado"> 
<input type="hidden" name="columnas" value="proestcodigo, proestnombre, proestdescri"> 
<input type="hidden" name="proestcodigo" value="<?php if ($accionconsultarproducestado) { echo $proestcodigo; } ?>"> 
<input type="hidden" name="proestnombre" value="<?php if ($accionconsultarproducestado) { echo $proestnombre; } ?>"> 
<input type="hidden" name="proestdescri" value="<?php if ($accionconsultarproducestado) { echo $proestdescri; } ?>"> 
<input type="hidden" name="accionconsultarproducestado"	value="<?php echo $accionconsultarproducestado; ?>"> 
...
<input type="hidden" name="selcampos" value="proestcodigo, proestnombre, proestdescri"><!--					--> 
