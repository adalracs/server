...
include ('scanuprecordopp.php'); 
$reccomact = fnccaf ( $GLOBALS [usuacodi], $_SERVER ["SCRIPT_FILENAME"] ); 
 
if ($accionborrarreporteopp) { 
	include ('borrareporteopp.php'); 
} else { 
	if ($accionconsultarreporteopp) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'vistareporteopp', $inicio, $fin, $mov, $accionconsultarreporteopp, $recarreglo ); 
...
<p><font class="NoiseFormHeaderFont">Reporte de ordenes de produccion programada {opp}</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="99%"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablreporteopp.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregreporteopp.php'); 
				$reg [0] = 'ordoppcodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregreporteopp ( 'reporteopp', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="reporteopp"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistareporteopp"> 
<input type="hidden" name="columnas" value="ordoppcodigo"> 
<input type="hidden" name="ordoppcodigo" value="<?php if ($accionconsultarreporteopp) { echo $ordoppcodigo; } ?>">  
<input type="hidden" name="accionconsultarreporteopp"	value="<?php echo $accionconsultarreporteopp; ?>"> 
