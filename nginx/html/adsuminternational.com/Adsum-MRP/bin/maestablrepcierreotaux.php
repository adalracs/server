...
$intervalo = fncaumdec('reportot',$inicio,$fin,$mov,$accionconsultarvistaot,$recarreglo);
...
onclick="form1.action='."'".'consultarrepcierreotaux.php'."'".';"  width="86" 
...
onclick="form1.mov.value = 'menos';form1.action='maestablrepcierreotaux.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec('reportot',$inicio,$fin,$mov,$accionconsultarreportot,$recarreglo); 
	$cantrow = $intervalo[total]; 
	if($intervalo[idtrans]){ $idtrans = $intervalo[idtrans]; } 
?> 
 </td> 
...
onclick="form1.mov.value = 'mas';form1.action='maestablrepcierreotaux.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregrepcierreotaux.php'); 
	$reg[0] = 'reportcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregrepcierreotaux('reportot',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablrepcierreotaux.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablrepcierreotaux.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablrepcierreotaux.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
