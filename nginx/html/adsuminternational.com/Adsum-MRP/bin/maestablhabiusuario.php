...
if($accionborrarhabiusuario) 
{ 
	include ( 'borrahabiusuario.php'); 
} 
else 
{ 
		if($accionconsultarhabiusuario) 
			{ 
...
<html> 
<head> 
<title>Registros de habiusuario</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de habiusuario</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablhabiusuario.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('habiusuario',$inicio,$fin,$mov,$accionconsultarhabiusuario,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablhabiusuario.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarhabiusuario.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarhabiusuario.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarhabiusuario.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'habusucodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('habiusuario',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablhabiusuario.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablhabiusuario.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablhabiusuario.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="habiusuario"> 
<input type="hidden" name="columnas" value="habusucodigo, 
habilicodigo, 
usuacodi, 
habempnota 
"> 
 <input type="hidden" name="habusucodigo" value="<?php echo $habusucodigo; ?>"> 
 <input type="hidden" name="habilicodigo" value="<?php echo $habilicodigo; ?>"> 
 <input type="hidden" name="usuacodi" value="<?php echo $usuacodi; ?>"> 
 <input type="hidden" name="habempnota" value="<?php echo $habempnota; ?>"> 
 <input type="hidden" name="accionconsultarhabiusuario" value="<?php echo 
$accionconsultarhabiusuario; ?>"> 
