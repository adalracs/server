...
if($accionborrarmanual)
{
	include ( 'borramanual.php');
}
else
{
	
	if($accionconsultarmanual)
	{
		...
		if(!$nusw){
			$accionconsultarmanual = 0;
		}
	}
}
include ( '../src/FunGen/sesion/fncaumdec.php');
include('../src/FunGen/fncpageposition.php');
  $intervalo = fncaumdec('manual',$inicio,$fin,$mov,$accionconsultarmanual,$recarreglo);
...
<html> 
<head> 
<title>Registros de manual</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de manuales</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablmanual.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php  
...
onclick="form1.action='."'".'ingrnuevmanual.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarmanual.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablmanual.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablmanual.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarmanual.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarmanual.php';
...
onclick="form1.action='."'".'editarmanual.php'."'".';"  width="87" height="19"  
...
$reg[0] = 'manualcodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('manual', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablmanual.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablmanual.php';" 
alt="Anterior"></td>
   <td width="50">
<?php  
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablmanual.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablmanual.php',$flagcheck); ?></td> 
  </tr> 
...
">
 ...
 <input type="hidden" name="manualnombre" value="<?php  echo $manualnombre; ?>"> 
 <input type="hidden" name="manualruta" value="<?php  echo $manualruta; ?>"> 
 <input type="hidden" name="manualdescri" value="<?php  echo $manualdescri; ?>"> 
 <input type="hidden" name="accionconsultarmanual" value="<?php  echo 
$accionconsultarmanual; ?>"> 
...
<input type="hidden" name="selcampos" value="manualcodigo, manualnombre, manualruta">
<!--											-->
