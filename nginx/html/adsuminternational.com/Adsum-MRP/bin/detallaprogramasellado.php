...
<!--  division contenedora del programa de sellado-->
<?php 
	...
	if(!$noAjax)
	{
		...
		require_once ( '../src/FunPerPriNiv/pktblprogramasellado.php');
		...
		require_once ( '../src/FunPerPriNiv/pktblopsellado.php');
...
<div id="programasellado">
	...
	<div id="<?php echo $obj_tab ?>" >
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include '../src/FunjQuery/jquery.visors/gestionopp/jquery.programasld.php';
        			break;
    			case "reporteopp":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programasld.php';
        			break;
    			case "gestionopparte":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programasld.php';
        			break;
        		...
        		case "gestionopprequisicion":
        			include '../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programasld.php';
        			break;
        		...
        		case "gestionoppanalisispr":
        			...
        			break;
        		default:
       				include '../src/FunjQuery/jquery.visors/programacion/jquery.programasld.php';
       				break;
			}
