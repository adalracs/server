...
ob_end_flush();
	...
	if($accioneditarvaranalisis) 
	{ 
		include ( 'editavaranalisis.php'); 
		$flageditarvaranalisis = 1;
	}

	if(!$flageditarvaranalisis)
	{
...
<html> 
	<head> 
		<title>Editar registro de variables de analisis</title> 
...
<?php endif; ?>
			...
			<input type="hidden" name="accioneditarvaranalisis">
