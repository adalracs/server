<?php	
	...
	//conexion
	$idcon = fncconn();
	//equipos del sistema de corte extrusion {67}
	$rs_equipo = dinamicscanopequipo(array('sistemcodigo' => 67, 'tipequcodigo' => 3),array('sistemcodigo' => '=', 'tipequcodigo' => '='),$idcon);
...
<html>
	<head>
		<title>Programa de corte extrusion</title>
	...
	<form name="form1" method="post"  enctype="multipart/form-data">
		<div id="programacorteextrusion" style="width:900px;align:center;margin-left:20px;">
			<ul>
			<?php 
			...
			<?php 
				...
				for($a = 0;$a < $nr_equipo;$a++)
				{
					...
					$rsCorteExtrusion = dinamicscanopprogramacorteextrusion1(array('equipocodigo' => $obj_equipo),array('equipocodigo' => '='),$idcon);
					//se consulta el numero de resgirstro de la consulta
					$nrCorteExtrusion = fncnumreg($rsCorteExtrusion);
			?>
			<script type="text/javascript">
				Event_animatedcollapse('<?php echo $nrCorteExtrusion ?>', 'filtrProext_<?php echo $obj_equipo ;?>');
			</script>
				...
				<ul id="<?php echo $obj_sortable ?>" class="connectedSortable ui-helper-reset">
					<?php 
						...
						for($b = 0;$b < $nrCorteExtrusion;$b++)
						{
							...
							$checked = '';
							if($rwCorteExtrusion['ordoppcomfir'] > 0)
							{
								$checked = 'checked';
								$arroppview = ($arroppview)? $arroppview.','.$rwCorteExtrusion['ordoppcodigo'] : $rwCorteExtrusion['ordoppcodigo'];
							}
							...
							for($c = 0;$c < $nrOpproduccion;$c++)
							{
								...
								//VARIABLE A USAR EN OP {ORDENES DE PRODUCCION}
								$FORMULAEXTRUSION = ($rwOpCorteExtrusion['formulnumero'])? $rwOpCorteExtrusion['formulnumero'] : '---' ;
					...
					?>
					<li class="ui-state-default"  id="<?php echo $rwCorteExtrusion['ordoppcodigo'] ?>" style="width:100%;">
						<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
							<tr <?php echo $complement ?> >
								<td width="5%" class="cont-line">&nbsp;<font color="blue"><b><?php echo str_pad($rwOpCorteExtrusion['solprocodigo'], 4, "0", STR_PAD_LEFT); ?></b></font></td>
								...
								<td width="5%" class="cont-line">&nbsp;<input type="checkbox" id="chkoppview" name="chkoppview" <?php echo $checked ?> onclick="setSelectionRow(this.value, document.getElementById('arroppview').value, ',', 'arroppview');" value="<?php echo $rwCorteExtrusion['ordoppcodigo'] ?>"></td>
							</tr>
						</table>
					</li>
					<?php 
		...
		<table width="100%" align="center" cellpadding="1" cellspacing="1">
			...
			<tr>
				<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
					<button id="editaprograma_cxt">Editar [programa]</button>
					<button id="cancelarprograma_cxt">Atras</button></div>
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr> 
		</table>
