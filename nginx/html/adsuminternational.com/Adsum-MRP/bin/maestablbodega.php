...
ob_start(); 
	...
	$intervalo = fncaumdec('vistabodega',$inicio,$fin,$mov,$accionconsultarbodega,$recarreglo); 
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="600">
 			...
 			<input type="hidden" name="sourcetable" value="bodega"> 
			...
			<input type="hidden" name="bodegacodigo" value="<?php if($accionconsultarbodega) echo $bodegacodigo; ?>"> 
			<input type="hidden" name="bodeganombre" value="<?php if($accionconsultarbodega) echo $bodeganombre; ?>"> 
			<input type="hidden" name="usuacodigo" value="<?php if($accionconsultarbodega) echo $usuacodigo; ?>"> 
			<input type="hidden" name="usuanombre" value="<?php if($accionconsultarbodega) echo $usuanombre; ?>"> 
			<input type="hidden" name="bodegaubicac" value="<?php if($accionconsultarbodega) echo $bodegaubicac; ?>"> 
			<input type="hidden" name="bodegacapaci" value="<?php if($accionconsultarbodega) echo $bodegacapaci; ?>"> 
			<input type="hidden" name="bodeganota" value="<?php if($accionconsultarbodega) echo $bodeganota; ?>"> 
			<input type="hidden" name="cencoscodigo" value="<?php if($accionconsultarbodega) echo $cencoscodigo; ?>"> 
			<input type="hidden" name="ciudadcodigo" value="<?php if($accionconsultarbodega) echo $ciudadcodigo; ?>"> 
			<input type="hidden" name="deptocodigo" value="<?php if($accionconsultarbodega) echo $deptocodigo; ?>"> 
			<input type="hidden" name="accionconsultarbodega" value="<?php echo $accionconsultarbodega; ?>"> 
