...
if($accionborrarexammediusuario) 
{ 
	include ( 'borraexammediusuario.php'); 
} 
else 
{ 
		if($accionconsultarexammediusuario) 
			{ 
//				include ( '../src/FunGen/sesion/fncalmdatc.php'); 
				...
				if(!$nusw){ 
					$accionconsultarexammediusuario = 0; 
				} 
			} 
} 
include ( '../src/FunGen/sesion/fncaumdec.php'); 
include('../src/FunGen/fncpageposition.php');
$intervalo = fncaumdec('exammediusuario',$inicio,$fin,$mov,$accionconsultarexammediusuario,$recarreglo); 
...
<html> 
<head> 
<title>Registros de exammediusuario</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de ex&aacute;menes m&eacute;dicos por empleados</font><br><br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablexammediusuario.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevexammediusuario.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarexammediusuario.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablexammediusuario.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablexammediusuario.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarexammediusuario.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarexammediusuario.php';
...
onclick="form1.action='."'".'editarexammediusuario.php'."'".';"  width="87" 
...
color="#FFFFFF">Empleado</font></span></td> 
<td width="32%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Fecha</font></span></td> 
</tr> 
<?php 
include ( '../src/FunGen/sesion/fncvisregexammediusuario.php'); 
	$reg[0] = 'exmusucodigo'; 
	$reg1[0] = 'n';
	$nureturn = fncvisregexammediusuario('exammediusuario', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 
'primero';form1.action='maestablexammediusuario.php';" alt="Primero"></td> 
...
'menos';form1.action='maestablexammediusuario.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 
'ultimo';form1.action='maestablexammediusuario.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablexammediusuario.php',$flagcheck); ?></td> 
  </tr> 
...
exmusupinifec 
"> 
 <input type="hidden" name="exmusucodigo" value="<?php echo $exmusucodigo; ?>"> 
 <input type="hidden" name="examedcodigo" value="<?php echo $examedcodigo; ?>"> 
 <input type="hidden" name="usuacodi" value="<?php echo $usuacodi; ?>"> 
 <input type="hidden" name="exmusupinifec" value="<?php echo $exmusupinifec; ?>"> 
 <input type="hidden" name="accionconsultarexammediusuario" value="<?php echo 
$accionconsultarexammediusuario; ?>"> 
...
<input type="hidden" name="selcampos" value="exmusucodigo, usuacodi, exmusupinifec">
<!--											-->
