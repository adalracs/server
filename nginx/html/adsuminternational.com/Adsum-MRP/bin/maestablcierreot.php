...
ob_start();
	...
	include('../src/FunGen/fncpageposition.php');
  	...
  	$intervalo = fncaumdec('vistacierreot',$inicio,$fin,$mov,$accionconsultarcierreot,$recarreglo);
...
<html> 
	<head> 
		<title>Registros de cierre de Ordenes de trabajo</title> 
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="850"> 
 				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablcierreot.php',$flagcheck); ?></td></tr>
				<tr><td>&nbsp;</td></tr> 
 			...
 			<input type="hidden" name="nombtabl" value="cierreot">
  			<input type="hidden" name="sourcetable" value="cierreot"> 
...
tareacodigo,
cierotdescri">
 			<input type="hidden" name="cierotcodigo" value="<?php if($accionconsultarcierreot) echo $cierotcodigo; ?>">
 			<input type="hidden" name="ordtracodigo" value="<?php if($accionconsultarcierreot) echo $ordtracodigo; ?>">
 			<input type="hidden" name="plantacodigo" value="<?php if($accionconsultarcierreot) echo $plantacodigo; ?>">
 			<input type="hidden" name="sistemcodigo" value="<?php if($accionconsultarcierreot) echo $sistemcodigo; ?>">
 			<input type="hidden" name="equipocodigo" value="<?php if($accionconsultarcierreot) echo $equipocodigo; ?>">
 			<input type="hidden" name="tipmancodigo" value="<?php if($accionconsultarcierreot) echo $tipmancodigo; ?>">
 			<input type="hidden" name="componcodigo" value="<?php if($accionconsultarcierreot) echo $componcodigo; ?>">
 			<input type="hidden" name="prioricodigo" value="<?php if($accionconsultarcierreot) echo $prioricodigo; ?>">
 			<input type="hidden" name="tipfalcodigo" value="<?php if($accionconsultarcierreot) echo $tipfalcodigo; ?>">
 			<input type="hidden" name="ordtrafecini" value="<?php if($accionconsultarcierreot) echo $ordtrafecini; ?>">
 			<input type="hidden" name="ordtrafecfin" value="<?php if($accionconsultarcierreot) echo $ordtrafecfin; ?>">
 			<input type="hidden" name="tiptracodigo" value="<?php if($accionconsultarcierreot) echo $tiptracodigo; ?>">
 			<input type="hidden" name="tareacodigo" value="<?php if($accionconsultarcierreot) echo $tareacodigo; ?>">
 			<input type="hidden" name="cierotdescri" value="<?php if($accionconsultarcierreot) echo $cierotdescri; ?>">
