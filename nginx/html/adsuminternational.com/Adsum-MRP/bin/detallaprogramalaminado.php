<!-- by ralvear 20130812-->
<!--  division contenedora del programa de laminado-->
<?php 
	...
	if(!$noAjax)
	{
		...
		require_once ( "../src/FunPerPriNiv/pktblprogramalaminado.php");
		...
		require_once ( "../src/FunPerPriNiv/pktbloplaminado.php");
...
<div id="programalaminado">
	...
	<div id="<?php echo $obj_tab ?>" style="height: 350px; margin:0 auto; overflow:auto;">
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include '../src/FunjQuery/jquery.visors/gestionopp/jquery.programalmn.php';
        			break;
    			case "reporteopp":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programalmn.php';
        			break;
    			case "gestionopparte":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programalmn.php';
        			break;
        		...
        		case "gestionopprequisicion":
        			include '../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programalmn.php';
        			break;
        		...
        		case "gestionoppanalisispr":
        			...
        			break;
        		default:
       				include '../src/FunjQuery/jquery.visors/programacion/jquery.programalmn.php';
       				break;
			}
