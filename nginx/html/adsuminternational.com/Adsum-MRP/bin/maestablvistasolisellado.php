...
include ('../src/FunPerPriNiv/pktblvistasolisellado.php');
...
if ($accionborrarvistasolisellado) { 
	include ('borravistasolisellado.php'); 
} else { 
	if ($accionconsultarvistasolisellado) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistasolisellado = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistasolisellado', $inicio, $fin, $mov, $accionconsultarvistasolisellado, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de solicitud de programacion de sellado</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de solicitudes de programacion [Sellado]</font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablvistasolisellado.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistasolisellado.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistasolisellado ( 'vistasolisellado', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistasolisellado"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistasolisellado"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistasolisellado) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistasolisellado"	value="<?php echo $accionconsultarvistasolisellado; ?>"> 
