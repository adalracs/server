...
if($accionborrardepartam) 
{ 
	include ( 'borradepartam.php'); 
} 
else 
{
	if($accionconsultardepartam)
	{
//		include ( '../src/FunGen/sesion/fncalmdatc.php');
		...
		if(!$nusw){
			$accionconsultardepartam = 0;
		}
	}
}
include ( '../src/FunGen/sesion/fncaumdec.php');
include('../src/FunGen/fncpageposition.php');
$intervalo = fncaumdec('departam',$inicio,$fin,$mov,$accionconsultardepartam,$recarreglo); 
...
<html> 
<head> 
<title>Registros de departam</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de departamentos</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE" width="600"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabldepartam.php',$flagcheck); ?></td> 
 </tr>
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevdepartam.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultardepartam.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'menos'; form1.action='maestabldepartam.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'mas'; form1.action='maestabldepartam.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallardepartam.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrardepartam.php';
...
onclick="form1.action='."'".'editardepartam.php'."'".';"  width="87" 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregdepartam.php'); 
	$reg[0] = 'departcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('departam', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'primero'; form1.action='maestabldepartam.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> 
form1.mov.value = 'menos'; form1.action='maestabldepartam.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'ultimo'; form1.action='maestabldepartam.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
    <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabldepartam.php',$flagcheck); ?></td> 
  </tr> 
...
"> 
 ...
 <input type="hidden" name="departnombre" value="<?php echo $departnombre; ?>"> 
 <input type="hidden" name="departdescri" value="<?php echo $departdescri; ?>"> 
 <input type="hidden" name="negocicodigo" value="<?php echo $negocicodigo; ?>"> 
 <input type="hidden" name="accionconsultardepartam" value="<?php echo 
$accionconsultardepartam; ?>"> 
...
<input type="hidden" name="selcampos" value="departcodigo, departnombre">
<!--											-->
