...
ob_start(); 
	...
	if($accioneditarareafuncio)
	{ 
		include ( 'editaareafuncio.php'); 
		$flageditarareafuncio = 1; 
	} 
ob_end_flush(); 

	if(!$flageditarareafuncio)
	{ 
...
<html> 
	<head> 
		<title>Editar registro de Area Funcional</title> 
...
<?php endif; ?>
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">
            				<tr> 
 								...
 								<td width="78%" class="NoiseDataTD"><input type="text" name="arefunnombre"  size="50" value="<?php if(!$flageditarareafuncio){echo $sbreg[arefunnombre];}else{ echo $arefunnombre; }?>"></td> 
 							</tr>
							<tr>
							...
							<tr><td class="ui-state-default" colspan="2"></td></tr>	  
 							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["arefundescri"] == 1){ $arefundescri=null; echo "*";} ?>&nbsp;Descripci&oacute;n</td></tr>
  							<tr><td colspan="2" class="NoiseFooterTD"><textarea name="arefundescri" id="arefundescri" rows="3" cols="50" wrap="VIRTUAL"><?php if(!$flageditarareafuncio){echo $sbreg[arefundescri];}else {echo $arefundescri;}?></textarea></td></tr>
						</table> 
  					</td> 
 				</tr> 
 				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="arefuncodigo" value="<?php if(!$flageditarareafuncio){ echo $sbreg[arefuncodigo];}else{ echo $arefuncodigo; } ?>"> 
			<input type="hidden" name="accioneditarareafuncio"> 
