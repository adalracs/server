...
ob_start();
	...
	if($accioneditarvistasolilaminado) 
		include ( 'editavistasolilaminado.php');

ob_end_flush();

	if(!$flageditarvistasolilaminado)
	{
		include ( '../src/FunGen/sesion/fnccarga.php');
		$sbreg = fnccarga($nombtabl,$radiobutton);
		if (!$sbreg)
			include( '../src/FunGen/fnccontfron.php');
		//regriso de vistasolilaminado
		$idcon = fncconn();
...
<html> 
	<head> 
    	<title>Editar registro de solicitud de programacion de laminado</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Solicitud de programacion laminado</font></p> 
...
<?php endif; ?>
					...
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
							<tr class="ui-widget-header">
								<td width="50%" class="cont-title">&nbsp;Solicitud de programacion laminacion No.&nbsp;{<?php echo $solprocodigo; ?>}</td>
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center"  class="ui-widget-content">
							<tr class="ui-state-default"><td class="cont-title">&nbsp;Informacion de laminado </td></tr>
						</table>	
						<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							<tr>
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center"  class="ui-widget-content">
							<tr class="ui-state-default"><td class="cont-title">&nbsp;Ordenes de laminado</td></tr>
						</table>	
						<?php 
							for($a = 0;$a < $nr_op;$a++){
								//variables a usar 
						...
						<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							<tr>
								<td class="NoiseFooterTD" width="15%">&nbsp;Laminado&nbsp;</td>
								<td class="NoiseDataTD"><?php echo strtoupper($$obj_laminado); ?></td>
							</tr>
							<tr>
								<td class="NoiseFooterTD" width="15%">&nbsp;Desempe&ntilde;o&nbsp;</td>
								<td class="NoiseDataTD"><?php echo strtoupper($$obj_desempeno) ?></td>
							</tr>
							<tr>
								<td class="NoiseFooterTD" width="15%">&nbsp;Tipo&nbsp;</td>
								<td class="NoiseDataTD"><?php echo strtoupper($$obj_tipo) ?></td>
							</tr>
							<tr>
     		...
     		<input type="hidden" name="accioneditarvistasolilaminado">
