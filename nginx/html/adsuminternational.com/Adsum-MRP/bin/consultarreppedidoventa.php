...
<html>
	<head>
		<title>Informe de pedidos de venta </title>
		...
		<script type="text/javascript">
			$(function(){
				...
				$('#aceptarinforme').button({ icons: { primary: "ui-icon-circle-check" } }).click(function() {
					...
					if(err == '')
					{
						document.form1.action = 'detallareppedidoventa.php';
			    ...
			    /*$("#txtcliente").autocomplete({
					...
					select: function(event, ui) {
						if(ui.item)
						{
							document.getElementById('txtcliente').value = ui.item.label;
						}
						else
						{
...
<?php if(!$codigo){ echo "<!--";}?> 
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<p><font class="NoiseFormHeaderFont">Informe de pedidos de venta</font></p>
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="670">
				<tr><td class="NoiseErrorDataTD">&nbsp;</td></tr>	
  				<tr><td class="ui-widget-header"><font color="FFFFFF"> Informe de pedidos de venta</font></td></tr>
				<tr>
	    					...
	    					<tr>
	    						<td>
									...
									<div style="width:648px; height: 25px;padding: 1px;">
										&nbsp;Cliente&nbsp;<input type="text" id="txtcliente" name="txtcliente" onkeyup="accionReloadCliente(this.value);" />
									</div>
		  							<div id="listcliente" style="width:648px;" class="ui-state-default">
										<?php 
											include_once '../src/FunPerPriNiv/pktblordencompra.php';
											$noAjax = true;
											include '../src/FunjQuery/jquery.visors/jquery.ordencompra.cliente.php'; 
										?>
									</div>
									<input type="hidden" name="arrclienteoc" id="arrclienteoc" value="<?php echo $arrclienteoc; ?>">
