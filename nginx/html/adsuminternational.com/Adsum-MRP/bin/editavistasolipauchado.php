...
for($a = 0;$a < $nr_op;$a++){
	...
	$iRegoppauchado[ordprocalib] = $$obj_calibre;
	$iRegoppauchado[ordprocantid] = $$obj_cant_kg;
	$iRegoppauchado[ordproanchop] = $$obj_ancho;
	$iRegoppauchado[ordproanchom] = $ancho;
	$iRegoppauchado[ordpropista] = $nropistas;
	$iRegoppauchado[ordprometros] = $$obj_cant_mt;	
...
//desconectar
$flageditarvistasolipauchado = 1;
fncclose($idcon);
fncmsgerror(editaEx);
echo '<script language="javascript">';
echo '<!--//'."\n";
echo 'location ="maestablvistasolipauchado.php?codigo='.$codigo.';"';
echo '//-->'."\n";
echo '</script>';
?>