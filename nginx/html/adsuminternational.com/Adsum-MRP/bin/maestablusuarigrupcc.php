...
<html> 
<head> 
<title>Registros de colaboradores</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de colaboradores</font><br>
  <br></p> 
...
class="NoiseFormTABLE"> 
 ...
 <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  ...
  <?php 
if($reccomact[nuevo]){ 
echo '       <input type="image" name="aceptar"  src="../img/aceptar.gif" 
onclick="form1.accionusuario2.value =  2;form1.action='."'".'consultarusuagrupcapa.php'."'".';"  width="86" 
height="18" alt="Nuevo Registro" border=0>'; 
} 
if($reccomact[consultar]){ 
echo '            <input type="image" name="consultar"  
src="../img/consulta.gif" 
onclick="form1.action='."'".'consultarusuarigrupcc.php'."'".';"  width="86" 
...
onclick="form1.mov.value='menos';form1.action='maestablusuarigrupcc.php';" alt="Anterior"></td> 
...
onclick="form1.mov.value='mas';form1.action='maestablusuarigrupcc.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregusuarigrupcc.php'); 
	$reg[0] = 'usuacodi'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregusuarigrupcc('usuario',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value='primero';form1.action='maestablusuarigrupcc.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value='menos';form1.action='maestablusuarigrupcc.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value='ultimo';form1.action='maestablusuarigrupcc.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
 </table> 
 <input type="hidden" name="accionusuario2"> 
