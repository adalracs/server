...
if($accionborrarhabilida)
{
	include ( 'borrahabilida.php');
}
else 
{
	if($accionconsultarhabilida)
	{
...
include('../src/FunGen/fncpageposition.php');
  ...
  $intervalo = fncaumdec('habilida',$inicio,$fin,$mov,$accionconsultarhabilida,$recarreglo);
...
<html> 
<head> 
<title>Registros de habilida</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de habilidades</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center"
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablhabilida.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td>
  <?php
...
onclick="form1.action='."'".'ingrnuevhabilida.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarhabilida.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'menos';form1.action='maestablhabilida.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'mas'; form1.action='maestablhabilida.php';" alt="Siguiente"></td> 
 </tr>
 <tr> 
...
onclick="form1.action='."'".'detallarhabilida.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarhabilida.php';
...
onclick="form1.action='."'".'editarhabilida.php'."'".';"  width="87" 
...
$reg[0] = 'habilicodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('habilida', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'primero';form1.action='maestablhabilida.php';" alt="Primero"></td> 
...
'menos';form1.action='maestablhabilida.php';"
alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?> form1.mov.value = 'ultimo';form1.action='maestablhabilida.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablhabilida.php',$flagcheck); ?></td> 
  </tr> 
...
equiponohs 
"> 
 <input type="hidden" name="habilicodigo" value="<?php echo $habilicodigo; ?>"> 
 <input type="hidden" name="habilinombre" value="<?php echo $habilinombre; ?>"> 
 <input type="hidden" name="habilidescri" value="<?php echo $habilidescri; ?>">
 <input type="hidden" name="accionconsultarhabilida" value="<?php echo 
$accionconsultarhabilida; ?>">
...
<input type="hidden" name="selcampos" value="habilicodigo, habilinombre">
<!--											-->
