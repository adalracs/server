...
if($accionborrartransacherramietemp)
{
	include ( 'borratransacherramietemp.php');
}
else
{
	if($accionconsultartransacherramietemp)
	{
		...
		if(!$nusw){
			$accionconsultartransacherramietemp = 0;
		}
	}
}
...
<html> 
<head> 
<title>Registros de transacherramietemp</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de 
Entrada/Salida Herramientas Temporales</font><br><br></p> 
...
onclick="form1.action='."'".'ingrnuevtransacherramietemp.php'."'".';"  
width="86" height="18" alt="Nuevo Registro" border=0>'; 
  }
  if($reccomact[consultar]){
  	echo '       <input type="image" name="consultar"  src="../img/consulta.gif"
onclick="form1.action='."'".'consultartransacherramietemp.php'."'".';"  
...
'menos';form1.action='maestabltransacherramietemp.php';" alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
  $intervalo = fncaumdec('herramietemp',$inicio,$fin,$mov,$accionconsultartransacherramietemp,$recarreglo);
...
onclick="form1.mov.value = 
'mas';form1.action='maestabltransacherramietemp.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallartransacherramietemp.php'."'".';"  
width="87" height="19"  alt="Ver detalle" border=0></b>'; 
   }
   if($reccomact[borrar]){
   	echo '<b><input type="image" name="borrar"  src="../img/borrar.gif"
onclick="form1.action='."'".'borrartransacherramietemp.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editartransacherramietemp.php'."'".';"  width="87" 
...
*/
$nureturn = fncvisreg('transacherramietemp',$reg,$reg1,$idtrans,$arr_borrar,$flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 
'primero';form1.action='maestabltransacherramietemp.php';" alt="Primero"></td> 
...
onclick="form1.mov.value = 
'ultimo';form1.action='maestabltransacherramietemp.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
...
usuacodi 
"> 
 <input type="hidden" name="trahetemcodigo" value="<?php echo $trahetemcodigo; 
?>"> 
 ...
 <input type="hidden" name="trahetemfecha" value="<?php echo $trahetemfecha; 
?>"> 
 <input type="hidden" name="trahetemcanti" value="<?php echo $trahetemcanti; 
?>"> 
 <input type="hidden" name="trahetemtotal" value="<?php echo $trahetemtotal; 
?>"> 
 <input type="hidden" name="usuacodi" value="<?php echo $usuacodi; ?>"> 
 <input type="hidden" name="accionconsultartransacherramietemp" value="<?php 
echo $accionconsultartransacherramietemp; ?>"> 
