...
if(!$flagdetallartransacherramietemp) 
{ 
...
<html> 
<head> 
<title>Detalle de registro de transacherramietemp</title> 
...
if(!$flagdetallartransacherramietemp){ echo $sbreg[trahetemcodigo];}else{ echo 
$trahetemcodigo; } ?>"> 
</td> 
</tr> 
<tr> 
...
if(!$flagdetallartransacherramietemp){ echo $sbreg[tipmovcodigo];}else{ echo 
...
if(!$flagdetallartransacherramietemp){ echo $sbreg[herramcodigo];}else{ echo 
...
if(!$flagdetallartransacherramietemp){ echo $sbreg[trahetemfecha];}else{ echo 
...
if(!$flagdetallartransacherramietemp){ echo $sbreg[trahetemcanti];}else{ echo 
...
if(!$flagdetallartransacherramietemp){ echo $sbreg[trahetemtotal];}else{ echo 
...
if(!$flagdetallartransacherramietemp){ echo $sbreg[usuacodi];}else{ echo 
...
height="18" alt="Aceptar" border=0> 
 ...
 <input type="hidden" name="flagdetallartransacherramietemp" value="1"> 
<input type="hidden" name="acciondetallartransacherramietemp"> 
