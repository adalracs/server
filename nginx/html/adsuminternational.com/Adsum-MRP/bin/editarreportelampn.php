...
ob_start();
	...
	if($accioneditarreportelampn) 
	{ 
		include ( 'editareportelampn.php'); 
		$flageditarreportelampn = 1;
	}
ob_end_flush();
	if(!$flageditarreportelampn)
	{
		...
		$patestnombre = $rwPatronestruc['patestnombre'];
...
<html> 
	<head> 
		<title>Editar registro de reporte parametros laminadora</title> 
...
<?php endif; ?>
				...
				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
							...
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="relapndescri" rows="3" cols="63"><?php if(!$flageditarreportelampn){ echo $sbreg[relapndescri];}else{ echo $relapndescri;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accioneditarreportelampn">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="relapncodigo" value="<?php echo $relapncodigo; ?>">
