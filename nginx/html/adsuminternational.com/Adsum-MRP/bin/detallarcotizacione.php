...
<html> 
<head> 
<title>Detalle de registro de cotizacione</title> 
...
<table width="100%" border="0">
	<tr>
		<td>Encargado:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		C&oacute;digo&nbsp;
		<input type="text" name="usuacodi" onfocus="if(!agree)this.blur();" size="5" value="<?php if(!$flagdetallarcotizacione){ 
echo $sbreg[usuacodi];}else{ echo $arrusr[usuacodi]; }?>">
		</td>
		<td>Nombre&nbsp;
		<input type="text" size="28" name="usrname" value="<?php if(!$flagdetallarcotizacione) echo $usrname; else echo $usrname;?>"
...
if(!$flagdetallarcotizacione){ echo $sbreg[proveecodigo];}else{ echo 
$proveecodigo; }?>">
		</td>
		<td>Nombre&nbsp;
		<input type="text" size="28" name="proveenombre" value="<?php if(!$flagdetallarcotizacione) echo $arrpro[proveenombre];
...
if(!$flagdetallarcotizacione){ echo $sbreg[cotiznombre];}else{ echo $cotiznombre; 
}?>"> 
 </td>
 </tr>  
<tr> 
...
if(!$flagdetallarcotizacione){ echo $sbreg[cotizdescri];}else{ echo $cotizdescri; 
}?></textarea>
</td> 
 </tr> 
 <tr> 
...
alt="Aceptar" border=0>
 ...
 <input type="hidden" name="flagdetallarcotizacione" value="1"> 
<input type="hidden" name="acciondetallarcotizacione"> 
