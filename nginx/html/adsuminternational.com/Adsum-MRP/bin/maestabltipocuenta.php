<?php 
	...
	if ($accionborrartipocuenta) { 
		include ("borratipocuenta.php"); 
	} else { 
		if ($accionconsultartipocuenta) { 
			$nusw = 0; 
	...
	$intervalo = fncaumdec ( "tipocuenta", $inicio, $fin, $mov, $accionconsultartipocuenta, $recarreglo ); 
...
<html> 
<head> 
<title>Listado de tipos de cuentas</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de tipos de cuentas</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="600"> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestabltipocuenta.php', $flagcheck ); ?></td> </tr> 
	<tr> <td>&nbsp;</td> </tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregtipocuenta.php'); 
				$reg [0] = 'tipcuecodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregtipocuenta ( 'tipocuenta', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> <td>&nbsp;</td> </tr> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestabltipocuenta.php', $flagcheck ); ?></td> 
	</tr> 
</table> 
<input type="hidden" name="codigo" value="<?php echo $codigo; ?>"> 
<input type="hidden" name="inicio" value="<?php echo $intervalo ["inicio"];	?>"> 
<input type="hidden" name="fin"	value="<?php echo $intervalo ["fin"];	?>"> 
<input type="hidden" name="sourcetable" value="tipocuenta"> 
...
<input type="hidden" name="accionconsultartipocuenta"	value="<?php echo $accionconsultartipocuenta; ?>"> 
