...
if ($accioneditarsaloncapaci) { 
	include ('editasaloncapaci.php'); 
	$flageditarsaloncapaci = 1; 
} 
if (! $flageditarsaloncapaci) { 
...
<html> 
	<head> 
		<title>Editar registro de salon de capacitacion</title> 
...
<?php endif; ?> 
					...
					<td> 
						<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center"> 
							<tr> 
								...
								<td width="80%" class="NoiseDataTD"><input type="text" name="salcapnombre"	value="<?php if(!$flageditarsaloncapaci){ echo $sbreg[salcapnombre];}else{ echo $salcapnombre; }?>" size="50"></td> 
							</tr> 
							<tr> 
							...
							<tr><td class="NoiseDataTD" colspan="2"><textarea name="salcapdescri" rows="3" cols="63"><?php if(!$flageditarsaloncapaci){ echo $sbreg[salcapdescri];}else{ echo $salcapdescri;} ?></textarea></td></tr> 
						</table>
					</td> 
				</tr>
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="salcapcodigo" value="<?php if(!$flageditarsaloncapaci){ echo $sbreg[salcapcodigo];}else{ echo $salcapcodigo; } ?>"> 
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" value="editar"> 
			<input type="hidden" name="accioneditarsaloncapaci"> 
