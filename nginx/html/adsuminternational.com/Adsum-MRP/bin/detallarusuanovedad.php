...
<html> 
	<head> 
		<title>Detalle de registro de Novedades por Empleado</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
 			...
 			<input type="hidden" name="flagdetallarusuanovedad" value="1"> 
			<input type="hidden" name="acciondetallarusuanovedad">
