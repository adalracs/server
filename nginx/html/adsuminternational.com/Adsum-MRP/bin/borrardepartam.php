		...
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table width="40%" border="0" align="center" cellpadding="2" cellspacing="1" class="NoiseFormTABLE"> 
					...
					<td> 
						<table width="85%" border="0" cellspacing="1" cellpadding="3" align="center"> 
							<tr> 
								...
								<td width="67%" class="NoiseDataTD"><?php if(!$flagborrardepartam){ echo $sbreg[departcodigo];}else{ echo $departcodigo;} ?></td> 
							</tr> 
							<tr> 
								<td width="33%" valign="top" class="NoiseFooterTD">&nbsp;Nombre</td> 
								<td width="67%" class="NoiseDataTD"><?php if(!$flagborrardepartam){ echo $sbreg[departnombre];}else{ echo $departnombre;} ?></td> 
							</tr>
							<tr> 
							...
							<tr> 
								...
								<td width="67%" rowspan="2" class="NoiseDataTD"><?php if(!$flagborrardepartam){ echo $sbreg[departdescri];}else{ echo $departdescri;} ?></td> 
							</tr>
				...
				<tr> 
					<td> 
						<div align="center"> 
							<input type="image" name="aceptar"  src="../img/aceptar.gif" onClick="form1.accionborrardepartam.value =  1; form1.action='maestabldepartam.php';"  width="86" height="18" alt="Aceptar" border=0> 
			...
			<input type="hidden" name="flagborrardepartam" value="1"> 
			<input type="hidden" name="accionborrardepartam"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>"> 
			<input type="hidden" name="departcodigo" value="<?php if(!$flagborrardepartam){ echo $sbreg[departcodigo];}else{ echo $departcodigo;}?>">
		</form> 
	</body> 
<?php if(!$codigo){ echo " -->"; } ?> 
</html> 