...
function editaitemdesa($iRegitemdesa,&$flageditaritemdesa,&$campnomb,&$codigo)
{
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecorditemdesa2($iRegitemdesa,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
$iRegitemdesa["itedesslip"] = $itedesslip;
$iRegitemdesa["itedesantibl"] = $itedesantibl;
$iRegitemdesa["tipitemcodigo"]=$tipitemcodigo;
