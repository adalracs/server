...
if($accionborrarreportotitem) 
{ 
	include ( 'borrareportotitem.php'); 
} 
else 
{ 
		if($accionconsultarreportotitem) 
			{ 
...
<html> 
<head> 
<title>Registros de reportotitem</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de reportotitem</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablreportotitem.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('reportotitem',$inicio,$fin,$mov,$accionconsultarreportotitem,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablreportotitem.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarreportotitem.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarreportotitem.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarreportotitem.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'repitemcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('reportotitem',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablreportotitem.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablreportotitem.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablreportotitem.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
...
transitecodigo 
"> 
 <input type="hidden" name="repitemcodigo" value="<?php echo $repitemcodigo; 
?>"> 
...
?>"> 
 <input type="hidden" name="accionconsultarreportotitem" value="<?php echo 
$accionconsultarreportotitem; ?>"> 
