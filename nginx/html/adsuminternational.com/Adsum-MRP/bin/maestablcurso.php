...
ob_start(); 
	...
	include ( '../src/FunPerPriNiv/limitscancurso.php'); 
	...
	if($accionborrarcurso) 
		include ( 'borracurso.php'); 
	else 
	{ 
		if($accionconsultarcurso) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarcurso = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('curso',$inicio,$fin,$mov,$accionconsultarcurso,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de curso</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de curso</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablcurso.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'cursocodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('curso', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="curso"> 
			...
			<input type="hidden" name="selcampos" value="cursocodigo">
			<!--											-->
