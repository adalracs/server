...
include ( '../src/FunPerPriNiv/pktblvistaprogramm.php');
...
else
{
	...
	if($accionconsultarvistaprogramm)
	{
	//	include ( '../src/FunGen/sesion/fncalmdatc.php');
		...
		if(!$nusw)
		{
			$accionconsultarvistaprogramm = 0;
		}
	}
}
...
onclick="form1.action='."'".'ingrnuevprogramacionequipos.php'."'".';"  width="86" 
...
onclick="form1.mov.value = 'menos';form1.action='maestblprogramacionequipos.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php
  $tabla = "vistagrupprogram";
  
  $intervalo = fncaumdec($tabla,$inicio,$fin,$mov, $accionconsultarvistaprogramm, $recarreglo);
...
onclick="form1.mov.value = 'mas';form1.action='maestblprogramacionequipos.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
  <td colspan="6"><div align="right"> 
   ...
   if($reccomact[detallar]){
   	echo '<b><input type="image" name="detallar" src="../img/verdetal.gif"
		  onclick="form1.action='."'".'detallarprogramacionot.php'."'".';"  width="87" 
		  height="19"  alt="Ver detalle" border=0></b>'; 
   }
   if($reccomact[borrar]){
   	/*echo '<b><input type="image" name="borrar"  src="../img/borrar.gif"
onclick="form1.action='."'".'borrarprogramacionequipos.php'."'".';"  width="87" 
...
cellpadding="1"> 
<tr> 
<td width="4%" class="NoiseFieldCaptionTD"><span class="style5"><font 
...
color="#FFFFFF">Fecha Prog.</font></span></td> 
...
<?php 
	...
	$reg[0] = 'progranumgru';
	$reg1[0] = 'n';
	$nureturn = fncvisregprogramacion('vistagrupprogram',$reg,$reg1,$idtrans);
?>  
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestblprogramacionequipos.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestblprogramacionequipos.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestblprogramacionequipos.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="programacion"> 
...
<!-- <input type="hidden" name="tipmancodigo" value="<?/*php echo $tipmancodigo; */?>">-->
 ...
 <input type="hidden" name="prograacti" value="<?php echo $prograacti; ?>"> 
 <input type="hidden" name="accionconsultarvistaprogramm" value="<?php echo $accionconsultarvistaprogramm; ?>"> 
