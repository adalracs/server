...
<html> 
	<head> 
		<title>Borrar de registro de tema</title> 
...
<?php if(!$codigo){ echo "<!--";} ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="temacodigo" value="<?php echo $sbreg[temacodigo]; ?>">
 			<input type="hidden" name="flagborrartema" value="1"> 
			<input type="hidden" name="accionborrartema">
