...
ob_start(); 
	...
	if($accionborrarpatronestruc) 
		include ( 'borrapatronestruc.php'); 
	else 
	{ 
		if($accionconsultarpatronestruc) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarpatronestruc = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('patronestruc',$inicio,$fin,$mov,$accionconsultarpatronestruc,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de patron estructura </title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de patron estructura</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablpatronestruc.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="25%" class="ui-state-default">Rangos Anchos</td>
								<td width="25%" class="ui-state-default">Rangos Calibres</td>    
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregpatronestruc.php'); 
								$reg[0] = 'patestcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregpatronestruc('patronestruc', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="patronestruc"> 
			...
			<input type="hidden" name="selcampos" value="patestcodigo">
			<!--											-->
