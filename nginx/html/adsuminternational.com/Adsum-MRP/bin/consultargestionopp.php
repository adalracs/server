...
<html> 
	<head> 
		<title>Consultar registro OPP</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">consultar gestion OPP</font></p> 
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							...
							<tr>
								...
								<td width="83%" class="NoiseDataTD"><input type="text" name="ordprofecgen" size="30"	value="<?php echo $ordprofecgen; ?>"></td> 
 							</tr>
 							<tr>
 							...
 							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Ruta</td>
								<td width="83%" class="NoiseDataTD"><select name="procedcodigo">
 			...
 			<input type="hidden" name="flagconsultargestionopp" value="1"> 
			<input type="hidden" name="accionconsultargestionopp"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="solprocodigo, ordprofecgen, prograindice, procedcodigo, pedvennumero, produccoduno">
			<input type="hidden" name="nombtabl" value="gestionopp"> 
		</form>
	</body>
<?php if(!$codigo){ echo " -->"; } ?> 
</html>