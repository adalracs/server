...
ob_start(); 
	...
	if($accionnuevoestadosaldo)
		include ( 'grabaestadosaldo.php');
	
ob_end_flush(); 
?>
<html> 
	<head> 
		<title>Nuevo registro de estados de saldos</title> 
...
<?php endif; ?> 
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">
 							<tr>
								...
								<td width="40%" class="NoiseDataTD"><input type="text" name="estsalnombre" size="30"	value="<?php if(!$flagnuevoestadosaldo){ echo $sbreg[estsalnombre];}else {echo $estsalnombre; }?>"></td>
 							</tr>
 							<tr>
			...
			<input type="hidden" name="accionnuevoestadosaldo">  
