...
if($accionborrartipoequipo) 
{ 
	include ( 'borratipoequipo.php'); 
} 
else 
{ 
		if($accionconsultartipoequipo) 
			{ 
...
$intervalo = fncaumdec 
('tipoequipo',$inicio,$fin,$mov,$accionconsultartipoequipo,$recarreglo); 
...
<html> 
<head> 
<title>Registros de tipos de equipo</title> 
...
<p><font class="NoiseFormHeaderFont">Listado tipos de equipo</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE" width="60%"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipoequipoaux.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevtipoequipo.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultartipoequipoaux.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipoequipoaux.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestabltipoequipoaux.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallartipoequipo.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrartipoequipo.php';
...
onclick="form1.action='."'".'editartipoequipo.php'."'".';"  width="87" 
...
<?php 
//include ( '../src/FunGen/sesion/fncvisregtipoaux.php'); 
include ( '../src/FunGen/sesion/fncvisregtipoequipoaux.php');

	$reg[0] = 'tipequcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregtipos('tipoequipo', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestabltipoequipoaux.php';" 
alt="Primero"></td> 
...
'menos';form1.action='maestabltipoequipoaux.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?>
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestabltipoequipoaux.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipoequipoaux.php',$flagcheck); ?></td> 
...
tipequcampo 
"> 
 <input type="hidden" name="tipequcodigo" value="<?php echo $tipequcodigo; ?>"> 
 <input type="hidden" name="tipequnombre" value="<?php echo $tipequnombre; ?>"> 
 <input type="hidden" name="tipequdescri" value="<?php echo $tipequdescri; ?>"> 
 <input type="hidden" name="tipequcampo" value="<?php echo $tipequcampo; ?>"> 
 <input type="hidden" name="tipequacroni" value="<?php echo $tipequacroni; ?>"> 
 <input type="hidden" name="accionconsultartipoequipo" value="<?php echo 
$accionconsultartipoequipo; ?>"> 
...
<input type="hidden" name="selcampos" value="tipequcodigo, tipequnombre, tipequacroni">
<!--											-->
