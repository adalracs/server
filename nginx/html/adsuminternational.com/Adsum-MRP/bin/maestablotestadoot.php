...
if($accionborrarotestadoot) 
{ 
	include ( 'borraotestadoot.php'); 
} 
else 
{ 
		if($accionconsultarotestadoot) 
			{ 
...
<html> 
<head> 
<title>Registros de otestadoot</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de otestadoot</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablotestadoot.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('otestadoot',$inicio,$fin,$mov,$accionconsultarotestadoot,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablotestadoot.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarotestadoot.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarotestadoot.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarotestadoot.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'otestcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('otestadoot',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablotestadoot.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablotestadoot.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablotestadoot.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="otestadoot"> 
<input type="hidden" name="columnas" value="otestcodigo, 
ordtracodigo, 
otestacodigo, 
otestorigen, 
otestfecini, 
...
otesthorfin 
"> 
 <input type="hidden" name="otestcodigo" value="<?php echo $otestcodigo; ?>"> 
 ...
 <input type="hidden" name="otestorigen" value="<?php echo $otestorigen; ?>"> 
 <input type="hidden" name="otestfecini" value="<?php echo $otestfecini; ?>"> 
 <input type="hidden" name="otesthorini" value="<?php echo $otesthorini; ?>"> 
 <input type="hidden" name="otestfecfin" value="<?php echo $otestfecfin; ?>"> 
 <input type="hidden" name="otesthorfin" value="<?php echo $otesthorfin; ?>"> 
 <input type="hidden" name="accionconsultarotestadoot" value="<?php echo 
$accionconsultarotestadoot; ?>"> 
