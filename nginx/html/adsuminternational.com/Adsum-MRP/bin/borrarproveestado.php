...
<html> 
	<head> 
		<title>Borrar registro de estado de proveedor</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="accionborrarproveestado">
			<input type="hidden" name="flagborrarproveestado" value="1">
