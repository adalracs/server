...
$intervalo = fncaumdec('vistacomponenplanta',$inicio,$fin,$mov,$accionconsultarcomponen,$recarreglo); 
...
<html> 
<head> 
<title>Registros de componen</title> 
...
class="NoiseFormTABLE" width="95%"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablcomponen.php',$flagcheck); ?></td>  
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevcomponen.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarcomponen.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos'; form1.action='maestablcomponen.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas'; form1.action='maestablcomponen.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarcomponen.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarcomponen.php';
...
onclick="form1.action='."'".'editarcomponen.php'."'".';"  width="87" 
...
<td width="34%" class="NoiseFieldCaptionTD"><span class="style5"><font 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregcomponen.php'); 
	$reg[0] = 'componcodigo'; 
	$reg1[0] = 's'; 
	$nureturn = fncvisregcomponen('vistacomponenplanta', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero'; form1.action='maestablcomponen.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos'; form1.action='maestablcomponen.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo'; form1.action='maestablcomponen.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablcomponen.php',$flagcheck); ?></td>  
  </tr> 
...
<input type="hidden" name="selcampos" value="componcodigo, componnombre">
<!--											-->
