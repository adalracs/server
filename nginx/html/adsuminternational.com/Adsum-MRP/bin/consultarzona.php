	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table width="450" border="0" align="center" cellpadding="1" cellspacing="1" class="ui-widget-content"> 
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr> 
 								...
 								<td width="78%" class="NoiseDataTD"><input type="text" name="zonacodigo" id="zonacodigo"  size="8" value="<?php echo $zonacodigo; ?>"></td> 
 							</tr> 
							<tr> 
 								<td class="NoiseFooterTD">&nbsp;Zona</td> 
 								<td class="NoiseDataTD"><input type="text" name="zonanombre" id="zonanombre" size="50" value="<?php echo $zonanombre; ?>"></td> 
 							</tr> 
							<tr>
 							...
 							<tr><td colspan="2" class="NoiseFooterTD">&nbsp;Descripci&oacute;n</td></tr>
  							<tr><td colspan="2" rowspan="2" class="NoiseFooterTD"><textarea name="zonadescri" id="zonadescri" rows="3" cols="50" wrap="VIRTUAL"><?php echo $zonadescri; ?></textarea></td></tr>
						</table> 
  					</td> 
 				</tr> 
 				<tr><td>&nbsp;</td></tr>
 			...
 			<input type="hidden" name="flagconsultarzona" value="1"> 
			<input type="hidden" name="accionconsultarzona">
