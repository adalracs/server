<?php 
	...
	if(!$flagdetallargestionplaneacionopp)
	{
...
<?php endif; ?>
								...
								<td>
									<div id="tabs_opp">
										...
										<div id="tabs_material">
											<?php include "../src/FunjQuery/jquery.tabs/gestionopp/jquery.gestionplaneacionopp.det.php"; ?>
										</div>

										<div id="tabs_gestion">
											<?php include '../src/FunjQuery/jquery.tabs/gestionopp/jquery.gestionopp.det.php'; ?>
			...
			<input type="hidden" name="flagdetallargestionplaneacionopp" value="1">
			<input type="hidden" name="acciondetallargestionplaneacionopp">
