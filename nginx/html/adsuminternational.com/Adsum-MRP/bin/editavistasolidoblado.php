...
for($a = 0;$a < $nr_op;$a++){
	...
	$iRegopdoblado[ordprocalib] = $$obj_calibre;
	$iRegopdoblado[ordprocantid] = $$obj_cant_kg;
	$iRegopdoblado[ordproanchop] = $$obj_ancho;
	$iRegopdoblado[ordproanchom] = $ancho;
	$iRegopdoblado[ordpropista] = $nropistas;
	$iRegopdoblado[ordprometros] = $$obj_cant_mt;	
...
//desconectar
$flageditarvistasolidoblado = 1;
fncclose($idcon);
fncmsgerror(editaEx);
echo '<script language="javascript">';
echo '<!--//'."\n";
echo 'location ="maestablvistasolidoblado.php?codigo='.$codigo.';"';
echo '//-->'."\n";
echo '</script>';
?>