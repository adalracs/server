<?php 
	...
	if(!$flageditarsoliserv)
	{
		...
		$rsHistsoliserv = loadrecordvistahistsoliserv($sbreg['solsercodigo'], $idcon);
	}
?>
<html> 
	<head> 
		<title>Detalle de registro historial solicitudes de servicio</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
  	<body bgcolor="FFFFFF" text="#000000"> 
    	<form name="form1" method="post"  enctype="multipart/form-data"> 
      			...
      			<tr>
					<td>
						...
						<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							...
							<tr>
								<td class="NoiseFooterTD" width="20%">&nbsp;Numero de orden</td>
								<td class="NoiseDataTD"><?php echo $rsHistsoliserv['ordtracodigo']; ?></td>
							</tr>
						</table>
					</td>
				</tr>
     		...
     		<input type="hidden" name="flagdetallarhistsoliserv" value="1"> 
			<input type="hidden" name="acciondetallarhistsoliserv">
