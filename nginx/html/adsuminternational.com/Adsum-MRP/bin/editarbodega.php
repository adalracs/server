...
<?php endif; ?>
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
            				<tr>
								...
								<td width="83%" class="NoiseDataTD"><input type="text" name="bodegacodigo1" size="30"	value="<?php if(!$flageditarbodega){ echo $sbreg[bodegacodigo];}else {echo $bodegacodigo1; }?>"></td> 
 							</tr>
							<tr>
								<td width="17%" class="NoiseFooterTD"><?php if($campnomb["bodeganombre"] == 1){ $bodeganombre = null; echo "*";}?>&nbsp;Nombre</td>
								<td width="83%" class="NoiseDataTD"><input type="text" name="bodeganombre" size="50"	value="<?php if(!$flageditarbodega){ echo $sbreg[bodeganombre];}else {echo $bodeganombre; }?>"></td> 
 							</tr>
 							<tr>
      						...
      						<tr>
								...
								<td class="NoiseDataTD"><input type="text" name="bodegaubicac" size="50"	value="<?php if(!$flageditarbodega){ echo $sbreg[bodegaubicac];}else {echo $bodegaubicac; }?>"></td> 
 							</tr>
      						<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["bodegacapaci"] == 1){ $bodegacapaci = null; echo "*";}?>&nbsp;&Aacute;rea</td>
								<td class="NoiseDataTD"><input type="text" name="bodegacapaci" size="8"	value="<?php if(!$flageditarbodega){ echo $sbreg[bodegacapaci];}else {echo $bodegacapaci; }?>">&nbsp;&nbsp;mts&sup2;</td> 
 							</tr>
 							<tr><td colspan="2" class="NoiseErrorDataTD"></td></tr>
							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["bodeganota"]	 == 1){$bodeganota = null; echo "*";}?>&nbsp;Nota</td></tr>
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="bodeganota" rows="3" cols="63"><?php if(!$flageditarbodega){ echo $sbreg[bodeganota];}else{ echo $bodeganota;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accioneditarbodega">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="bodegacodigo" value="<?php if(!$flageditarbodega){ echo $sbreg[bodegacodigo];}else {echo $bodegacodigo; }?>">
