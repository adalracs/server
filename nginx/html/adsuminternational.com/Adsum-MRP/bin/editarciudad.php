...
ob_start(); 
	...
	if($accioneditarciudad) 
	{ 
		include ( 'editaciudad.php'); 
		$flageditarciudad = 1; 
	} 
ob_end_flush();
	...
	{ 
		...
		$deptocodigo = $sbreg['deptocodigo'];
} 
?>
<html> 
	<head> 
		<title>Editar registro de ciudad</title> 
...
<?php endif; ?>
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
            				<tr> 
 								...
 								<td width="78%" class="NoiseDataTD"><input type="text" name="ciudadnombre" id="ciudadnombre"  size="50" value="<?php if(!$flageditarciudad){echo $sbreg[ciudadnombre];}else{ echo $ciudadnombre; }?>"></td> 
 							</tr> 
							<tr>
 							...
 							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["ciudaddescri"] == 1){ $ciudaddescri=null; echo "*";} ?>&nbsp;Descripci&oacute;n</td></tr>
  							<tr><td colspan="2" class="NoiseFooterTD"><textarea name="ciudaddescri" rows="3" cols="50" wrap="VIRTUAL"><?php if(!$flageditarciudad){echo $sbreg[ciudaddescri];}else {echo $ciudaddescri;}?></textarea></td></tr>
						</table> 
  					</td> 
 				</tr> 
 				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="ciudadcodigo" value="<?php if(!$flageditarciudad){ echo $sbreg[ciudadcodigo];}else{ echo $ciudadcodigo; } ?>"> 
			<input type="hidden" name="accioneditarciudad"> 
