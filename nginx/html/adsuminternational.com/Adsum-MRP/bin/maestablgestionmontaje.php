		...
		<form name="form1" method="post" enctype="multipart/form-data">
			<div class="ui-state-default">
				...
				<select name="tipsolcodigo" id="tipsolcodigo">
					...
					<option value="3">Flexografia</option>
				</select>
			</div>
			...
			<input type="hidden" name="sourcetable" id="sourcetable" value="gestionmontaje"> 
			<input type="hidden" name="selstar" id="selstar" value="0"> 
			<input type="hidden" name="nombtabl" value="vistagestionmontaje"> 
