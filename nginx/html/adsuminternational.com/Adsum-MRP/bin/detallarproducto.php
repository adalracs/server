...
<?php endif; ?>
			...
			<input type="hidden" name="flagdetallarproducto" value="1"> 
			<input type="hidden" name="acciondetallarproducto">
			<input type="hidden" name="pedvencodigo" value="<?php if(!$flagdetallarproducto){ echo $sbreg['pedvencodigo'];}else{ echo $pedvencodigo; }?>"> 
			<input type="hidden" name="produccodigo" id="produccodigo" value="<?php if(!$flagdetallarproducto){ echo $sbreg['produccodigo'];}else{ echo $produccodigo; } ?>"> 
