...
<html> 
<head> 
<title>Detalle de registro de Validaciones</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.acciondetallarvalidaci.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagdetallarvalidaci){ echo $sbreg[valicodi];}else{ echo $valicodi; } ?>" 
...
if(!$flagdetallarvalidaci){ echo $sbreg[valinomb];}else{ echo $valinomb;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagdetallarvalidaci){ echo $sbreg[validesc];}else{ echo $validesc;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagdetallarvalidaci" value="1"> 
<input type="hidden" name="acciondetallarvalidaci"> 
