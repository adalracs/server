...
*/
    ...
    */
	...
	class procesos_admin extends rs_server
	{
		...
		Fecha           : 25-abr-2005
		*/	
		function mostrarEmpleaselec($paramaters)
		{
			$idcon = fncconn();
			...
			{
				$result = loadrecordempleaselecproc($valposic[$i],$idcon);
				$str = $str.$result;
			}
    ...
    */
    ...
    $oRS = new procesos_admin( array( 'mostrarEmpleaselec'));
