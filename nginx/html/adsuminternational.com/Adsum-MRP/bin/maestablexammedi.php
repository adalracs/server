...
class="NoiseFormTABLE"> 
 <tr> 
  <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablexammedi.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevexammedi.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarexammedi.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='menos';form1.action='maestablexammedi.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='mas';form1.action='maestablexammedi.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarexammedi.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarexammedi.php';
...
onclick="form1.action='."'".'editarexammedi.php'."'".';"  width="87" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='primero';form1.action='maestablexammedi.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='menos';form1.action='maestablexammedi.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
          	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='ultimo';form1.action='maestablexammedi.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
  <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablexammedi.php',$flagcheck); ?></td> 
  </tr> 
...
<input type="hidden" name="selcampos" value="examedcodigo, examednombre">
<!--											-->
