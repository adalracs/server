...
<html> 
	<head> 
		<title>Detalle de registro de sistema</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="NoiseFormTABLE" width="70%"> 
				...
				<tr> 
					<td><div align="center"> 
						<input type="image" name="aceptar"  src="../img/aceptar.gif" onclick="form1.action='maestablsistema.php';"  width="86" height="18" alt="Aceptar" border=0> 
					</div></td> 
				</tr> 
				<tr><td class="NoiseErrorDataTD">&nbsp;</td></tr> 
			</table> 
			<input type="hidden" name="flagdetallarsistema" value="1"> 
			<input type="hidden" name="acciondetallarsistema"> 
			<input type="hidden" name="accionconsultarsistema" value="1"> 
