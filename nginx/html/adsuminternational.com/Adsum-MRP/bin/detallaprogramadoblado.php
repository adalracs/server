<!--  division contenedora del programa de doblado-->
<?php 
	...
	if(!$noAjax)
	{
		...
		require_once ( '../src/FunPerPriNiv/pktblprogramadoblado.php');
		...
		require_once ( '../src/FunPerPriNiv/pktblopdoblado.php');
...
<div id="programadoblado">
	...
	<div id="<?php echo $obj_tab ?>" >
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include '../src/FunjQuery/jquery.visors/gestionopp/jquery.programadbl.php';
        			break;
    			case "reporteopp":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programadbl.php';
        			break;
    			case "gestionopparte":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programadbl.php';
        			break;
        		...
        		case "gestionopprequisicion":
        			include '../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programadbl.php';
        			break;
        		...
        		case "gestionoppanalisispr":
        			...
        			break;
        		default:
       				include '../src/FunjQuery/jquery.visors/programacion/jquery.programadbl.php';
       				break;
			}
