<?php	
	...
	//conexion
	$idcon = fncconn();
	//validacion de filtros para la bandeja de microperforado
	if($plantacodigo)
	{
		$record['plantacodigo'] = $plantacodigo;
		$recordop['plantacodigo'] = '=';
		$rsOp = dinamicscanopvistabandejamicroperforado($record, $recordop, $idcon);
	}
	else
	{
		$rsOp = fullscanvistabandejamicroperforado($idcon);
	}
