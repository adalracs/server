...
function editamedidoequipo($iRegmedidoequipo,&$flageditarmedidoequipo,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordmedidoequipo($iRegmedidoequipo,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editamedidoequipo($iRegmedidoequipo,$flageditarmedidoequipo,$campnomb,$codigo);
?> 
