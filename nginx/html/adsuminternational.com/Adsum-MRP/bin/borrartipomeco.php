...
<html> 
<head> 
<title>Borrar registro de Tipo Menu Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionborrartipomeco.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagborrartipomeco){ echo $sbreg[timecodi];}else{ echo $timecodi; } ?>" 
...
if(!$flagborrartipomeco){ echo $sbreg[ticonomb];}else{ echo $ticonomb;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrartipomeco){ echo $sbreg[ticodesc];}else{ echo $ticodesc;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagborrartipomeco" value="1"> 
<input type="hidden" name="accionborrartipomeco"> 
