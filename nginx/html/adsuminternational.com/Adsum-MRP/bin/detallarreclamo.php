...
<html> 
	<head> 
		<title>Detallar registro de reclamo</title> 
...
<?php endif; ?> 
  				<tr><td class="ui-widget-header"><span class="style5"><font color="FFFFFF"> Ingresar detallar registro</font></span></td></tr> 
				<tr>
  					<td> 
			...
			<input type="hidden" name="acciondetallarreclamo">  
