...
<html> 
<head> 
<title>Nuevo registro de tabla</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionnuevotabla.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagnuevotabla){ echo $sbreg[tablcodi];}else{ echo $tablcodi; } ?>" 
...
if(!$flagnuevotabla){ echo $sbreg[tablnomb];}else{ echo $tablnomb;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagnuevotabla){ echo $sbreg[tabldesc];}else{ echo $tabldesc;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flagnuevotabla" value="1"> 
<input type="hidden" name="accionnuevotabla"> 
