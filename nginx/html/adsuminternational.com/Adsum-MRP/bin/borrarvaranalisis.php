...
<html> 
	<head> 
		<title>Borrar registro de variables de analisis</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="accionborrarvaranalisis">
			<input type="hidden" name="flagborrarvaranalisis" value="1">
