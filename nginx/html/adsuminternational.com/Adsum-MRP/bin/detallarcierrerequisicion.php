...
ini_set('display_errors',1);
	...
	if(!$flagdetallarhistorequisicion) 
	{ 
		...
		for( $a = 0; $a < $nrRequisicionItemDesa; $a++)
		{
			...
			$obj_reqitecantre = "reqitecantre_".$rwRequisicionItemDesa["itedescodigo"];
			$$obj_reqitecantre = $rwRequisicionItemDesa["reqitecantre"];
		}
...
<html> 
	<head> 
		<title>Detalle de registro de requisicion</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="450">
  					...
  					<td> 
            			<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center"> 
 							<tr>
								...
								<td width="75%" class="NoiseDataTD">&nbsp;<?php echo ($sbreg["estreqcodigo"])? carganombreestadorequisicion($sbreg["estreqcodigo"],$idcon) : "---"; ?></td>
								</td>
 							</tr>
 							<tr>
 								<td colspan="2">
 									<div id="seccionRecRequisicion" style="display: <?php echo ($estreqcodigo > 2)?  "none" : "block" ; ?>">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
											...
											<tr>
												...
												<td width="15%" class="NoiseFooterTD cont-field-b">&nbsp;<?php echo ($$obj_reqitecantre)? number_format( $$obj_reqitecantre, 2, ',', '.') : "---" ; ?>
											</tr>	
											<?php
 			...
 			<input type="hidden" name="flagdetallarhistorequisicion" value="1"> 
			<input type="hidden" name="acciondetallarhistorequisicion">
