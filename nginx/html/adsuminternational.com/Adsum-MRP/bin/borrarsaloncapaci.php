...
<html> 
	<head> 
		<title>Borrar registro de salon de capacitacion</title> 
...
<?php if (! $codigo) { echo "<!--"; } ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post" enctype="multipart/form-data"> 
			...
			<input type="hidden" name="salcapcodigo" value="<?php echo $sbreg[salcapcodigo]; ?>"> 
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" value="borrar"> 
			<input type="hidden" name="flagborrarsaloncapaci" value="1"> 
			<input type="hidden" name="accionborrarsaloncapaci"> 
