<?php 
	...
	include ( '../src/FunPerPriNiv/pktblvistaclientepv.php');

?>
<html> 
	<head> 
		<title>Consultar registro de ficha tecnica</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">consultar &Iacute;tem</font></p> 
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							...
							<tr>
 							...
 							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Tipo Producto</td>
 							...
 							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Cliente</td>
								<td width="83%" class="NoiseDataTD"><select name="ordcomcodcli">
								<option value="">--Seleccione--</option>
								<?php 
								$idcon = fncconn();
								include ('../src/FunGen/floadclientepv.php');
								floadclientepv($ordcomcodcli,$idcon)
								?>
								</select></td> 
 							</tr>
						</table> 
 			...
 			<input type="hidden" name="flagconsultarvistafichaitem" value="1"> 
			<input type="hidden" name="accionconsultarvistafichaitem"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="produccoduno, producnombre, tipprocodigo, ordcomcodcli, tipevecodigo">
