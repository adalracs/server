...
if($accionborrartipocump)
{
	include ( 'borratipocump.php');
}
else
{
	if($accionconsultartipocump)
	{
...
$intervalo = fncaumdec('tipocump',$inicio,$fin,$mov,$accionconsultartipocump,$recarreglo);
...
<html> 
<head> 
<title>Registros de tipo de cumplimiento</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de tipos de cumplimientos</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipocump.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevtipocump.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultartipocump.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipocump.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestabltipocump.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallartipocump.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrartipocump.php';
...
onclick="form1.action='."'".'editartipocump.php'."'".';"  width="87" 
...
$reg[0] = 'tipcumcodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('tipocump', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?>
</table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestabltipocump.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipocump.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
	        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestabltipocump.php';" alt="Ultimo"></td> 
  </tr>
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipocump.php',$flagcheck); ?></td> 
  </tr> 
...
"> 
 ...
 <input type="hidden" name="tipcumnombre" value="<?php echo $tipcumnombre; ?>"> 
 <input type="hidden" name="tipcumdescri" value="<?php echo $tipcumdescri; ?>"> 
 <input type="hidden" name="accionconsultartipocump" value="<?php echo 
$accionconsultartipocump; ?>"> 
...
<input type="hidden" name="selcampos" value="tipcumcodigo, tipcumnombre">
<!--											-->
