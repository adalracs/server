<?php
	...
	if($accionnuevogestionmontaje) 
		include ( 'grabagestionmontaje.php');
...
<html> 
	<head> 
		...
		<script type="text/javascript" src="../src/FunjQuery/jquery.jsscripts/jquery.function_gestionmontaje.js"></script>
		<style type="text/css">
...
<?php endif; ?>
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							...
							<tr>
  								<td colspan="4" rowspan="3"><textarea name="gesmondescri" cols="90" rows="3"><?php echo $gesmondescri; ?></textarea></td>
 							</tr>
		  				</table>  		
	  				</td>  
	  			</tr>	
			...
			<input type="hidden" name="flagnuevogestionmontaje">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="nuevo">  
			<input type="hidden" name="accionnuevogestionmontaje"> 
