<?php
	...
	if(!$flageditaropp)
	{
		...
		$rsOrdproduccion = dinamicscanopopflexo(array('ordoppcodigo' => $arropp),array('ordoppcodigo' => '='),$idcon);
...
<html> 
	<head> 
		<title>editar registro de orden de produccion flexografia programadas</title> 
...
<?php endif; ?>
				<tr><td class="ui-widget-header"><span class="style5"><font color="FFFFFF"> Editar nuevo registro</font></span></td></tr>
				<tr>
					<td>
				...
				<?php 
					...
					if($arrop) $arrObject = explode(',',$arrop);
      				for ($a = 0; $a < count($arrObject); $a++)
      				{
      					...
      					$rwVistaop = loadrecordopflexo($arrObject[$a],$idcon);
      			?>
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">		
							...
							<tr>
								<td colspan="6" class="NoiseDataTD">&nbsp;Orden de producci&oacute;n generada apartir de la solicitud de flexografia (#<?php echo str_pad($rwSoliprog['solprocodigo'], 4, "0", STR_PAD_LEFT) ?>) de <b><?php echo  cargausuanombre($rwSoliprog['usuacodi'],$idcon) ?></b></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="NoiseDataTD">&nbsp;<?php echo $rwVistaop['ordproancflx'] ?></td>
