...
if ($accionborrarvistasoliprog) { 
	include ('borravistasoliprog.php'); 
} else { 
	if ($accionconsultarvistasoliprog) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistasoliprog = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistasoliprog', $inicio, $fin, $mov, $accionconsultarvistasoliprog, $recarreglo ); 
...
<p><font class="NoiseFormHeaderFont">Listado de Solicitudes de programacion </font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablvistasoliprog.php', $flagcheck ); ?></td> </tr> 
	<tr> <td>&nbsp;</td> </tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistasoliprog.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistasoliprog ( 'vistasoliprog', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistasoliprog"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistasoliprog"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistasoliprog) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistasoliprog"	value="<?php echo $accionconsultarvistasoliprog; ?>"> 
