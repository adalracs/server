								...
								<td>
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
										<tr>
											...
											<td width="30%" class="NoiseDataTD">&nbsp;
												<select name="oeestacodigo" id="oeestacodigo">
													...
													floadoeestadogestion($oeestacodigo,$idcon);
													?>
												</select>
											</td>
										...
										<tr>
											...
											<td width="20%" class="NoiseFooterTD"><?php if($campnomb['ordentnumept'] == 1) echo '*';?>&nbsp;Numero EPT:</td>
											<td width="30%" class="NoiseDataTD">&nbsp;<input type="text" name="ordentnumept" id="ordentnumept" value="<?php echo $ordentnumept ?>"/></td> 	
										</tr>
										<tr><td colspan="4" class="NoiseErrorDataTD"></td></tr>
										<tr><td colspan="4" class="NoiseFooterTD"><?php if($campnomb['ordentdescri'] == 1){$ordentdescri = null; echo "*";}?>&nbsp;Nota</td></tr>
										<tr><td colspan="4" rowspan="2" class="NoiseDataTD"><textarea name="ordentdescri" rows="3" cols="63"><?php if(!$flagnuevooe){ echo $sbreg[ordentdescri];}else{ echo $ordentdescri;} ?></textarea>  </td></tr>
									</table>
								</td>
							</tr>
							<tr>
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
										<tr class="ui-state-default">
											<td class="cont-title">&nbsp;<?php if($campnomb["arroe"] == 1){ $arroe = null;echo "*";}?>Reporte Material a Entregar</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
										<tr>
