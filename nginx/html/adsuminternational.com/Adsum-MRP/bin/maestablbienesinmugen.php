	...
	<body bgcolor="FFFFFF" class="NoisePageBODY">
		<form name="form1" method="post"  enctype="multipart/form-data">
			...
			<table border="0" cellspacing="1" cellpadding="2" align="center" class="NoiseFormTABLE" width="98%">
 				<tr><td colspan="6" class="NoiseErrorDataTD" align="right"><?php page_position($intervalo,'maestablbienesinmugen.php',$flagcheck); ?></td></tr>
  				<tr>
  					<td>
  						<b><input type="image" name="consultar" src="../img/consulta.gif" onclick="form1.action='consultarbienesinmugen.php'"  width="86" height="18" alt="Consultar" border=0 ></b>
  						<?php if($reccomact[detallar]): ?>
							<b><input type="image" name="detallar"  src="../img/verdetal.gif" onclick="form1.action='detallarbienesinmugen.php';"  width="87" height="19" alt="Ver detalle" border=0></b>
						<?php endif; ?>
					</td>
 					<td width="42"> <input type="image" name="adelanta"  src="../img/adelanta.gif" onclick="form1.mov.value = 'menos';form1.action='maestablbienesinmugen.php';" alt="Anterior"></td>
 					...
 					<td width="53"><input type="image" name="atras"  src="../img/atrasa.gif" onclick="form1.mov.value = 'mas';form1.action='maestablbienesinmugen.php';" alt="Siguiente"></td>
 				</tr>
 				<tr>
 				...
 				<tr>
 					<td colspan="6">
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1">
  							<tr>
								...
								<td width="86%" class="NoiseFieldCaptionTD"><span class="style5"><font color="#FFFFFF">Nombre</font></span></td>
							</tr>
							<?php
								include ( '../src/FunGen/sesion/fncvisregbieninmutemgen.php');
  				...
  				<tr>
   					...
   					<td width="42"><input type="image" name="primero"  src="../img/primero.gif" onclick="form1.mov.value = 'primero';form1.action='maestablbienesinmugen.php';" alt="Primero"></td>
   					<td width="46"><input type="image" name="adelanta" src="../img/adelanta.gif" onclick="form1.mov.value = 'menos';form1.action='maestablbienesinmugen.php';" alt="Anterior"></td>
   					...
   					<td width="53"><input type="image" name="atras2"  src="../img/atrasa.gif" onclick="form1.mov.value = 'mas';form1.action='maestablbienesinmugen.php';" alt="Siguiente"></td>
   					<td width="53"><input type="image" name="ultimo"  src="../img/ultimo.gif" onclick="form1.mov.value = 'ultimo';form1.action='maestablbienesinmugen.php';" alt="Ultimo"></td>
  				</tr>
  				<tr><td colspan="6" class="NoiseErrorDataTD" align="right"><?php page_position($intervalo,'maestablbienesinmugen.php',$flagcheck); ?></td></tr>
 			</table>
