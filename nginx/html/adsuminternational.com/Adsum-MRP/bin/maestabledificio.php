...
<p><font class="NoiseFormHeaderFont">Listado de edificios </font><br>
  <br></p> 
...
class="NoiseFormTABLE"> 
 ...
 <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  ...
  <tr> 
  <td><a href="ingrnuevedificio.php">
 <input type="image" name="nuevo"  src="../img/nuevo.gif" 
 width="86" 
height="18" alt="Nuevo Registro" border=0 ></a>
 </td> 
 <td width="42"> 
