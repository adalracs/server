...
if($accionborrarherramietemp)
{
	include ( 'borraherramietemp.php');
}
else
{
	if($accionconsultarherramietemp)
	{
...
<html> 
<head> 
<title>Registros de herramietemp</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de Herramientas Temporales</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablherramietemp.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
  $intervalo = fncaumdec
  ('herramietemp',$inicio,$fin,$mov,$accionconsultarherramietemp,$recarreglo);
...
onclick="form1.mov.value = 'mas';form1.action='maestablherramietemp.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarherramietemp.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
   }
   if($reccomact[borrar]){
   	echo '<b><input type="image" name="borrar"  src="../img/borrar.gif"
onclick="form1.action='."'".'borrarherramietemp.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarherramietemp.php'."'".';"  width="87" 
...
$nureturn = fncvisreg('herramietemp',$reg,$reg1,$idtrans,$arr_borrar,$flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablherramietemp.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablherramietemp.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablherramietemp.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
...
hertemdispon 
"> 
 <input type="hidden" name="hertemcodigo" value="<?php echo $hertemcodigo; ?>"> 
 <input type="hidden" name="cencoscodigo" value="<?php echo $cencoscodigo; ?>"> 
 <input type="hidden" name="hertemnombre" value="<?php echo $hertemnombre; ?>"> 
 <input type="hidden" name="hertemvalor" value="<?php echo $hertemvalor; ?>"> 
 <input type="hidden" name="hertemdescri" value="<?php echo $hertemdescri; ?>"> 
 <input type="hidden" name="hertemdispon" value="<?php echo $hertemdispon; ?>"> 
 <input type="hidden" name="accionconsultarherramietemp" value="<?php echo 
$accionconsultarherramietemp; ?>"> 
