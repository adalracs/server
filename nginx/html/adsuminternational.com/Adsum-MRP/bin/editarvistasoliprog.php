...
ob_start();
	...
	if($accioneditarvistasoliprog) 
		include ( 'editavistasoliprog.php');
...
ob_end_flush();
	...
	if(!$flageditarvistasoliprog)
	{
		...
		unset($arrmatsoliextru);
		if($rsPlaneaitemdesa > 0){
			//escaniamos de acuerdo a la cantidad de registro y asignamos los valores a array de planeacion $arrmatsoliextru
			for($a = 0;$a<$nrPlaneaitemdesa;$a++){
				...
				$arrmatsoliextru = ($arrmatsoliextru)? $arrmatsoliextru.':|:'.$rwPlaneaitemdesa['itedescodigo'].':-:'.$rwPlaneaitemdesa['procedcodigo'] : $rwPlaneaitemdesa['itedescodigo'].':-:'.$rwPlaneaitemdesa['procedcodigo'] ;
				//objetos adicionales
				$obj_consumo = 'gessolcantid_'.$rwPlaneaitemdesa['itedescodigo'].':-:'.$rwPlaneaitemdesa['procedcodigo'];
...
<html> 
	<head> 
    	<title>Editar registro de solicitud de programacion</title> 
...
<?php if($campnomb || $flageditarvistasoliprog): ?>
...
<!-- 	INICIO SOLICITUD -->
										<div id="tabs_solicitud">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.solicitud.php'; ?>
										</div>
<!-- 	FIN SOLICITUD -->
<!-- 	INICIO EXTRUSION -->
									<?php if($arrProceso['tabs_solicitud']['ext'][0] > 0){?>
										<div id="tabs_extrusion">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.extrusion.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN EXTRUSION -->
<!-- 	FLEXOGRAFIA -->
									<?php if($arrProceso['tabs_solicitud']['flx'][0] > 0){?>
										<div id="tabs_flexografia">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.flexografia.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN FLEXOGRAFIA -->
<!-- 	LAMINADO -->
									<?php if($arrProceso['tabs_solicitud']['lmn'][0] > 0){?>
										<div id="tabs_laminado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.laminado.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN LAMINADO -->
<!-- 	CORTE -->
									<?php if($arrProceso['tabs_solicitud']['cor'][0] > 0){?>
										<div id="tabs_corte">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.corte.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN CORTE -->
<!-- 	SELLADO -->
									<?php if($arrProceso['tabs_solicitud']['sld'][0] > 0){?>
										<div id="tabs_sellado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.sellado.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN SELLADO -->
<!-- 	PAUCHADO -->
									<?php if($arrProceso['tabs_solicitud']['pch'][0] > 0){?>
										<div id="tabs_pauchado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.pauchado.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN PAUCHADO -->
<!-- 	DOBLADO -->
									<?php if($arrProceso['tabs_solicitud']['dbl'][0] > 0){?>
										<div id="tabs_doblado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.doblado.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN DOBLADO -->
<!-- 	MICROPERFORADO -->
									<?php if($arrProceso['tabs_solicitud']['mcr'][0] > 0){?>
										<div id="tabs_microperforado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.microperforado.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN MICROPERFORADO -->
<!-- 	TROQUELADO -->
									<?php if($arrProceso['tabs_solicitud']['tql'][0] > 0){?>
										<div id="tabs_troquelado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.troquelado.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN TROQUELADO -->
<!-- 	VALVULADO -->
									<?php if($arrProceso['tabs_solicitud']['vlv'][0] > 0){?>
										<div id="tabs_valvulado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.valvulado.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN VALVULADO -->
<!-- 	CORTE-REPROCESO -->
									<?php if($arrProceso['tabs_solicitud']['crt'][0] > 0){?>
										<div id="tabs_corter">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.corter.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN CORTE-REPROCESO -->
									</div>
     		...
     		<input type="hidden" name="accioneditarvistasoliprog">
			...
			<input type="hidden" name="sourceaction" value="editar">
     		...
     		<input type="hidden" name="ordcomcodcli" id="ordcomcodcli" value="<?php echo $ordcomcodcli; ?>"> 
     		...
     		<input type="hidden" name="tipitecodigo" value="<?php echo $tipitecodigo; ?>">
			...
			<input type="hidden" name="modulocodigo" id="modulocodigo" value="6"><!-- modulo de programacion -->
...
<!-- VARIABLES UTILIZADAS PARA LA SOLICITUD DE PROGRAMACION Y SUS ORDENES DE PRODUCCION -->
			...
			<input type="hidden" name="total_gramaje" value="<?php echo $total_gramaje; ?>">
			<input type="hidden" name="total_calibre" value="<?php echo $total_calibre; ?>"> 
