...
ob_start();
	...
	if($accioneditaritemfinanciero) 
	{ 
		include ( 'editaitemfinanciero.php'); 
		$flageditaritemdesa = 1;
	}
ob_end_flush();
	if(!$flageditaritemfinanciero)
	{
...
<?php endif; ?>
				...
				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" >
    						...
    						<tr> 
 								<td class="NoiseFooterTD"><?php if($campnomb["grugercodigo"] == 1) echo "*";?>&nbsp;Grupo gerencial</td> 
			...
			<input type="hidden" name="accioneditaritemfinanciero">
