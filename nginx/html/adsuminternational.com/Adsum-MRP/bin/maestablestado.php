...
if($accionborrarestado) 
{ 
	include ( 'borraestado.php'); 
} 
else 
{
	
	if($accionconsultarestado)
	{
...
$intervalo = fncaumdec('estado',$inicio,$fin,$mov,$accionconsultarestado,$recarreglo); 
...
<html> 
<head> 
<title>Registros de estado</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de estados</font><br><br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablestado.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevestado.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarestado.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablestado.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablestado.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarestado.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarestado.php';
...
onclick="form1.action='."'".'editarestado.php'."'".';"  width="87" height="19"  
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablestado.php';" 
alt="Primero"></td> 
...
'menos';form1.action='maestablestado.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablestado.php';" 
alt="Ultimo"></td> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablestado.php',$flagcheck); ?></td> 
  </tr> 
...
"> 
 ...
 <input type="hidden" name="estadonombre" value="<?php echo $estadonombre; ?>"> 
 <input type="hidden" name="estadodescri" value="<?php echo $estadodescri; ?>"> 
 <input type="hidden" name="estadotipo" value="<?php echo $estadotipo; ?>"> 
 <input type="hidden" name="accionconsultarestado" value="<?php echo 
$accionconsultarestado; ?>"> 
...
<input type="hidden" name="selcampos" value="estadocodigo, estadonombre, estadodescri">
<!--											-->
