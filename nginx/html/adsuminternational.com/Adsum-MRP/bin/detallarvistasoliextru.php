...
<?php endif; ?>
					...
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
							<tr class="ui-widget-header">
								<td width="50%" class="cont-title">&nbsp;Solicitud de programacion extrusion No.&nbsp;{<?php echo $solprocodigo; ?>}</td>
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center"  class="ui-widget-content">
							<tr class="ui-state-default"><td class="cont-title">&nbsp;Informacion de extrusion </td></tr>
						</table>	
						<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							<tr>
     		...
     		<input type="hidden" name="flagdetallarvistasoliextru" value="1"> 
     		<input type="hidden" name="acciondetallarvistasoliextru">
