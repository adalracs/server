...
ob_end_flush();
	...
	$idcon = fncconn();
	$rs_equipo = fullscanprogramacorteextrusiondisctequipo($idcon);
	...
	for($a = 0;$a < $nr_equipo;$a++)
	{
		...
		//consulta dinamica al programa de extrusion
		if($equipo)
			$rs_opp = dinamicscanopprogramacorteextrusion1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
...
<html>
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<!--<p><font class="NoiseFormHeaderFont">{Extrusion}</font></p>-->			
			<div id="bandejaotgeneral" style="width:900px;align:center;margin-left:20px;">
				<ul>
					<li><a href="#tabs-1"><span class="ui-icon ui-icon-clipboard" style="float: left; margin-right: .3em;"></span>Bandeja corte extrusi&oacute;n.</a></li>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
											...
											<div id="filopsbandejaop" style="padding: 2px 2px 2px 2px; display:block;" >
						        				<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
						        					<tr>
														...
														<td width="10%"  class="NoiseFooterTD">&nbsp;Mezcla</td>
														<td width="40%"  class="NoiseFooterTD"><select name="formulnumero" id="formulnumero" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option> 
															<?php
																include ('../src/FunGen/floadvistabandejacorteextrusion.php');
																floadvistabandejacorteextrusion_mezcla($formulnumero,$idcon);
															?>
															</select></td>
													</tr>
													<tr>
														...
														<td class="NoiseFooterTD"><select name="ordprocalibr" id="ordprocalibr" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejacorteextrusion_calibre($ordprocalib,$idcon);
															?>
														</select></td>
														<td width="10%"  class="NoiseFooterTD">&nbsp;Ancho Ext.</td>
														<td width="40%"  class="NoiseFooterTD"><select name="ordproanccxt" id="ordproanccxt" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejacorteextrusion_ancho($ordproanccxt,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														<td width="10%" class="NoiseFooterTD">&nbsp;Material</td>
														<td class="NoiseFooterTD" colspan="3"><select name="paditecodigo" id="paditecodigo" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejacorteextrusion_material($paditecodigo,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
										<td class="ui-state-default">
											<div id="detallebandejacorteextrusion" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallabandejacorteextrusion.php'; ?>
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="ui-state-default">&nbsp;<a onClick="return verocultar('filresbandejaop',2);" href="javascript:animatedcollapse.toggle('filresbandejaop');"><img id="row2" align="middle" align="top"  src="temas/Noise/DescOn.gif" border="0">&nbsp;Filtro Resumen de la bandeja por equipo.</a>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[simular] && !$flagcheck)
										echo '<button id="simularopp_cxt">Simular [opp]</button>';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
			  		...
			  		<table width="860px" align="center" cellpadding="1" cellspacing="1">
			    		<tr>
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
									<tr>
		  								<td class="ui-state-default">&nbsp;<a onClick="return verocultar('filopsbandejaopp',3);" href="javascript:animatedcollapse.toggle('filopsbandejaopp');"><img id="row3" align="middle" align="top"  src="temas/Noise/AscOn.gif" border="0">&nbsp;Filtros de la ordenes.</a>
											<div id="filopsbandejaopp" style="padding: 2px 2px 2px 2px; display:block;" >
						        				<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
						        					<tr>
														...
														<td width="10%"  class="NoiseFooterTD">&nbsp;Mezcla</td>
														<td width="40%"  class="NoiseFooterTD"><select name="formulnumero_opp" id="formulnumero_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejacorteextrusion_mezclaopp($formulnumero_opp,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														...
														<td class="NoiseFooterTD"><select name="ordprocalibr_opp" id="ordprocalibr_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejacorteextrusion_calibreopp($ordprocalibr_opp,$idcon);
															?>
														</select></td>
														<td width="10%"  class="NoiseFooterTD">&nbsp;Ancho Ext.</td>
														<td width="40%"  class="NoiseFooterTD"><select name="ordproanccxt_opp" id="ordproanccxt_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejacorteextrusion_anchoopp($ordproanccxt_opp,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														<td width="10%"  class="NoiseFooterTD">&nbsp;Material</td>
														<td class="NoiseFooterTD" colspan="3"><select name="paditecodigo_opp" id="paditecodigo_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejacorteextrusion_materialopp($paditecodigo_opp,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
										<td class="ui-state-default">
											<div id="detalleordencorteextrusion" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallaordencorteextrusion.php'; ?>
											</div>
										</td>
									</tr>	
									<tr>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[modificar] && !$flagcheck)
										echo '<button id="editaropp_cxt">Editar [opp]</button>';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
