...
include ( '../src/FunPerPriNiv/pktblvistatimedfall.php');
...
<!-- class="NoiseFormTABLE" -->
 ...
 <tr><td align="center"><b>Tiempo medio entre fallas</b></td><tr>
...
alt="Imprimir" name="imprimir">
  <input type="image" nam1="consultar"  src="../img/consulta.gif" onclick="form1.action='consultartimedfall.php';" 
