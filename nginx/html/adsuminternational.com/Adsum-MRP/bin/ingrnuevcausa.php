...
ob_start(); 
	...
	if($accionnuevocausa)
		include ( 'grabacausa.php');
	
ob_end_flush(); 
?>
<html> 
	<head> 
		<title>Nuevo registro de causa de calidad</title> 
...
<?php endif; ?> 
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">
 							<tr>
								...
								<td width="40%" class="NoiseDataTD"><input type="text" name="causanombre" size="30"	value="<?php if(!$flagnuevocausa){ echo $sbreg[causanombre];}else {echo $causanombre; }?>"></td>
 							</tr>
 							<tr>
							...
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="causadescri" rows="3" cols="63"><?php if(!$flagnuevocausa){ echo $sbreg[causadescri];}else{ echo $causadescri;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accionnuevocausa">  
