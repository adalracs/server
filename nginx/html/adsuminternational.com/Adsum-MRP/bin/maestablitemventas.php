...
ob_start(); 
	...
	if($accionborraritemventas) 
		include ( 'borraitemventas.php'); 
	else 
	{ 
		if($accionconsultaritemventas) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultaritemventas = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('itemventas',$inicio,$fin,$mov,$accionconsultaritemventas,$recarreglo); 
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablitemventas.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="20%" class="ui-state-default">C&oacute;digo</td> 
							...
							<?php 
								...
								$reg[0] = 'itevencodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('itemventas', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="itemventas"> 
			...
			<input type="hidden" name="selcampos" value="itevencodigo">
			<!--											-->
