...
include ('../src/FunPerPriNiv/pktblvistasolicorte.php');
...
if ($accionborrarvistasolicorte) { 
	include ('borravistasolicorte.php'); 
} else { 
	if ($accionconsultarvistasolicorte) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistasolicorte = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistasolicorte', $inicio, $fin, $mov, $accionconsultarvistasolicorte, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de solicitud de programacion de corte</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de solicitudes de programacion [Corte]</font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablvistasolicorte.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistasolicorte.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistasolicorte ( 'vistasolicorte', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistasolicorte"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistasolicorte"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistasolicorte) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistasolicorte"	value="<?php echo $accionconsultarvistasolicorte; ?>"> 
