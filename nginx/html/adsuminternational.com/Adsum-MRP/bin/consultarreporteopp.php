...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">consultar reporte OPP</font></p> 
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
 			...
 			<input type="hidden" name="flagconsultarreporteopp" value="1"> 
			<input type="hidden" name="accionconsultarreporteopp"> 
			...
			<input type="hidden" name="nombtabl" value="reporteopp"> 
		</form>
	</body>
<?php if(!$codigo){ echo " -->"; } ?> 
</html>