<?php 
	...
	if(!$flagdetallarinvplantaresina){ 		
...
<html> 
	<head> 
		<title>Detalle de registro de inventario planta resinas</title> 
...
<?php if(!$codigo){ echo "<!--";} ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Inventario planta resinas</font></p> 
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
							...
							<tr> 
 							...
 							<tr> 
 								<td class="NoiseFooterTD">&nbsp;Kilogramos&nbsp;</td> 
  								<td class="NoiseDataTD"><?php echo $sbreg['invrescantid'] ;  ?></td> 
 							</tr> 
 							<tr> 
 								<td class="NoiseFooterTD">&nbsp;Fecha&nbsp;</td> 
  								<td class="NoiseDataTD"><?php echo $sbreg['invresfecha'] ;  ?></td> 
 							</tr>
 							<tr> 
 								<td class="NoiseFooterTD">&nbsp;Fecha&nbsp;</td> 
  								<td class="NoiseDataTD"><?php echo $sbreg['invreshora'] ;  ?></td> 
 							</tr>
						</table> 
					</td>
				</tr>
 			...
 			<input type="hidden" name="flagdetallarinvplantaresina" value="1"> 
			<input type="hidden" name="acciondetallarinvplantaresina">
