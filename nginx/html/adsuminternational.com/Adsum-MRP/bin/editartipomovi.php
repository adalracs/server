...
ob_start();
	...
	if($accioneditartipomovi) 
	{ 
		include ( 'editatipomovi.php'); 
		$flageditartipomovi = 1;
	}
ob_end_flush();
	if(!$flageditartipomovi)
	{
		include ( '../src/FunGen/sesion/fnccarga.php');
		$sbreg = fnccarga($nombtabl,$radiobutton);
		if (!$sbreg)
			include( '../src/FunGen/fnccontfron.php');
		$tipmovtipo = $sbreg[tipmovtipo];
	}
?>
<html> 
	<head> 
		<title>Editar registro de tipo de movimiento</title> 
...
<?php endif; ?> 
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr>
								...
								<td width="80%" class="NoiseDataTD"><input type="text" name="tipmovnombre" size="50"	value="<?php if(!$flageditartipomovi){ echo $sbreg[tipmovnombre];}else {echo $tipmovnombre; }?>"></td> 
 							</tr> 
							<tr>
							...
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="tipmovdescri" rows="3" cols="50"><?php if(!$flageditartipomovi){ echo $sbreg[tipmovdescri];}else{ echo $tipmovdescri;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accioneditartipomovi">
			<input type="hidden" name="tipmovcodigo" value="<?php  if(!$flageditartipomovi){ echo $sbreg[tipmovcodigo];}else{ echo $tipmovcodigo;}?>">
