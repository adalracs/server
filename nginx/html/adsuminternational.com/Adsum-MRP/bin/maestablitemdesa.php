...
ob_start(); 
	...
	if($accionborraritemdesa) 
		include ( 'borraitemdesa.php'); 
	else 
	{ 
		if($accionconsultaritemdesa) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultaritemdesa = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('itemdesa',$inicio,$fin,$mov,$accionconsultaritemdesa,$recarreglo); 
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablitemdesa.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'itedescodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregitemdesa('itemdesa', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="itemdesa"> 
