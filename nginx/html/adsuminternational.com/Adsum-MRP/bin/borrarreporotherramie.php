...
<html> 
<head> 
<title>Borrar registro de reporotherramie</title> 
...
if(!$flagborrarreporotherramie){ echo $sbreg[rephercodigo];}else{ echo 
$rephercodigo; } ?>"> 
</td> 
</tr> 
<tr> 
...
if(!$flagborrarreporotherramie){ echo $sbreg[reportcodigo];}else{ echo 
...
if(!$flagborrarreporotherramie){ echo $sbreg[transhercodigo];}else{ echo 
...
onclick="form1.accionborrarreporotherramie.value =  1; 
form1.action='maestablreporotherramie.php';"  width="86" height="18" 
...
alt="Cancelar" border=0> 
 ...
 <input type="hidden" name="flagborrarreporotherramie" value="1"> 
<input type="hidden" name="accionborrarreporotherramie"> 
