...
ob_start(); 
	...
	var_dump($$_SERVER["SCRIPT_FILENAME"]);die;
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="600">
 			...
 			<input type="hidden" name="sourcetable" value="proveedo"> 
			...
			<input type="hidden" name="proveecodigo" value="<?php if($accionconsultarproveedo) echo $proveecodigo; ?>">
			<input type="hidden" name="proveenombre" value="<?php if($accionconsultarproveedo) echo $proveenombre; ?>">
			<input type="hidden" name="proveerepleg" value="<?php if($accionconsultarproveedo) echo $proveerepleg; ?>">
			<input type="hidden" name="proveetelefo" value="<?php if($accionconsultarproveedo) echo $proveetelefo; ?>">
			<input type="hidden" name="proveefax" value="<?php if($accionconsultarproveedo) echo $proveefax; ?>">
			<input type="hidden" name="proveepais" value="<?php if($accionconsultarproveedo) echo $proveepais; ?>">
			<input type="hidden" name="proveedirecc" value="<?php if($accionconsultarproveedo) echo $proveedirecc; ?>">
			<input type="hidden" name="proveeurl" value="<?php if($accionconsultarproveedo) echo $proveeurl; ?>">
			<input type="hidden" name="proveeemail" value="<?php if($accionconsultarproveedo) echo $proveeemail; ?>">
			<input type="hidden" name="proveenota" value="<?php if($accionconsultarproveedo) echo $proveenota; ?>">
			<input type="hidden" name="proestcodigo" value="<?php if($accionconsultarproveedo) echo $proestcodigo; ?>">
			<input type="hidden" name="proveepostal" value="<?php if($accionconsultarproveedo) echo $proveepostal; ?>">
			<input type="hidden" name="proveecontac" value="<?php if($accionconsultarproveedo) echo $proveecontac; ?>">
			<input type="hidden" name="proveetelcon" value="<?php if($accionconsultarproveedo) echo $proveetelcon; ?>">
			<input type="hidden" name="ciudadcodigo" value="<?php if($accionconsultarproveedo) echo $ciudadcodigo; ?>">
			<input type="hidden" name="deptocodigo" value="<?php if($accionconsultarproveedo) echo $deptocodigo; ?>">
			<input type="hidden" name="tipprocodigo" value="<?php if($accionconsultarproveedo) echo $tipprocodigo; ?>">
