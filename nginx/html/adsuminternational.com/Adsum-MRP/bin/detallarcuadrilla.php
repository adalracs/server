...
<html> 
	<head> 
		<title>Detalle de registro de cuadrilla</title> 
		...
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<div style="width: 850px; margin:0 auto;" >
				<div id="tabscuadrilla">
					<ul>
						<li><a href="#tabs-1">Cuadrilla</a></li>
						<li><a href="#tabs-2"><span class="ui-icon ui-icon-calendar" style="float: left; margin-right: .3em;"></span>Calendario - Turno</a></li>
						<li><a href="#tabs-3"><span class="ui-icon ui-icon-wrench" style="float: left; margin-right: .3em;"></span>Item's / Herramienta</a></li>
					</ul>
					<div id="tabs-1">
  					...
  					<div id="tabs-3">
						<?php $noAjax = true;  include '../src/FunjQuery/jquery.tabs/phpscripts/jquery.inv_tecnicos.php'; ?>
					</div>
				</div>
			</div>
 			<input type="hidden" name="flagdetallarcuadrilla" value="1"> 
			<input type="hidden" name="acciondetallarcuadrilla">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="detallar"> 			
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">	  		
			<input type="hidden" name="columnas" value="cuadricodigo,cuadrinombre,servicicodigo,cuadriacti"> 
