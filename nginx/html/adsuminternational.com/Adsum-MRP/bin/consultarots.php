...
{
	include ( 'grabaotsequipo.php');
}
    
?>
<body bgcolor="FFFFFF" text="#000000">
<form name="form1" method="post"  enctype="multipart/form-data">
<p><font class="NoiseFormHeaderFont">Ordenes de Trabajo por Equipos</font></p>
...
color="FFFFFF">Ordenes de Trabajo por Equipos</font></span></td></tr>
<tr>
	<td>
...
onclick="window.document.form1.accionnuevoreporte.value = 1" width="86" height="18" alt="Aceptar" border=0>&nbsp;
<?php //onclick="form1.action='reportdisponib.php'; return validaformtimedrep();"  width="86" height="18" alt="Aceptar" border=0>&nbsp;
?>

<input type="image" src="../img/cancelar.gif" border="0" alt="Cancelar" onclick="form1.action='consultarots.php';">
</div>
</td>
 </tr>
 <tr>
