...
function editatipotiempopn($iRegtipotiempopn,&$flageditartipotiempopn,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordtipotiempopn($iRegtipotiempopn,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
$iRegtipotiempopn[tiptiecodigo] = $tiptiecodigo;
$iRegtipotiempopn[tiptienombre] = $tiptienombre;
$iRegtipotiempopn[tiptiedescri] = $tiptiedescri;

editatipotiempopn($iRegtipotiempopn,$flageditartipotiempopn,$campnomb,$codigo);
?> 
