...
ob_start();
	...
	//evento para el array de maquinas para programa de doblado
	//conexion
	$idcon = fncconn();
			...
			<table width="100%" align="center" cellpadding="1" cellspacing="1">
				<tr>
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
		  						<td class="ui-state-default">&nbsp;&nbsp;Programade doblado</td>
							</tr>
							<tr>
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
					        						...
					        						<tr>
														<td class="NoiseFooterTD">
															<div style="height: 450px; margin:0 auto; overflow:auto;">
																<?php $noAjax = true;include 'detallaprogramadoblado.php'; ?>
															</div>
														</td>
													</tr>
						                   		</table>
				...
				<tr>
					<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
						<button id="editarprograma_dbl">Editar programa</button>
					</div></td>
				</tr>
				<tr><td>&nbsp;</td></tr> 
			</table>			
