...
<html> 
	<head> 
		<title>Registros de otservicio</title> 
		...
		<script language="JavaScript">
			function carga_ot(ordtracodigo){
				window.opener.document.form1.ordtracodigo.value=ordtracodigo;
				window.close();
			...
			<table border="0" cellspacing="1" cellpadding="2" align="center" class="NoiseFormTABLE" width="95%"> 
 				...
 				<tr>
  				...
  				<tr> 
  					...
  					<?php 
  						if($reccomact[nuevo]){
  							echo '<input type="image" name="nuevo"  src="../img/nuevo.gif" onclick="form1.action='."'".'ingrnuevotservicio.php'."'".';"  width="86" 
  						...
  						//if($reccomact[consultar]){
  							echo '<input type="image" name="consultar"  src="../img/consulta.gif" onclick="form1.action='."'".'consultarotsercierre.php'."'".';"  width="86" 
					...
					?> 
 					...
 					<td width="42"><input type="image" name="adelanta"  src="../img/adelanta.gif" onClick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablotservicio.php';" alt="Anterior"></td> 
					...
					?> 
 					...
 					<td width="53"><input type="image" name="atras"  src="../img/atrasa.gif" onClick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablotservicio.php';" alt="Siguiente"></td> 
 				</tr> 
 				<tr> 
  					<td colspan="6"><div align="right"> 
   					<?php 
   						if($reccomact[detallar]){
   							echo '<b><input type="image" name="detallar" src="../img/verdetal.gif" onclick="form1.action='."'".'detallarotservicio.php'."'".';"  width="87" 
   						...
   						if($reccomact[borrar]){
   							...
   							else echo 'form1.action='."'".'borrarotservicio.php';

   							echo "'".';"  width="87" height="19" alt="Borrar Registro" border=0></b>'; 
   						}
   						if($reccomact[modificar]){
   							echo '<b><input type="image" name="modificar"  src="../img/modifica.gif" onclick="form1.action='."'".'editarotservicio.php'."'".';"  width="87" height="19"  
 				...
 				<tr> 
  					<td colspan="6"> 
  						<table width="100%" border="0" align="center" cellspacing="2" cellpadding="1"> 
							<tr> 
								<td width="7%" class="NoiseFieldCaptionTD"><span class="style5"><font color="#FFFFFF">Sel.&nbsp;</font></span></td> 
							...
							<?php 
								include ( '../src/FunGen/sesion/fncvisregvistaotsercierre.php');
								$reg[0] = 'ordtracodigo';
								$reg1[0] = 'n';
  				...
  				<tr> 
   					...
   					<td width="42"><input type="image" name="primero"  src="../img/primero.gif" onClick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablotservicio.php';" alt="Primero"></td> 
   					<td width="46"><input type="image" name="adelanta"  src="../img/adelanta.gif" onClick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablotservicio.php';" alt="Anterior"></td> 
   					<td width="50"> 
					<?php 
						echo '<font color="#006699" size="2" face="Arial, Helvetica, sans-serif">'.$intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total].'</font>'; 
					?> 
   					</td> 
   					<td width="53"><input type="image" name="atras2"  src="../img/atrasa.gif" onClick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablotservicio.php';" alt="Siguiente"></td> 
   					<td width="53"><input type="image" name="ultimo"  src="../img/ultimo.gif" onClick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablotservicio.php';" alt="Ultimo"></td> 
  				</tr> 
  				<tr><td colspan="6" class="NoiseErrorDataTD">&nbsp;</td></tr> 
 			</table> 
