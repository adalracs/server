...
function grabatiempopn($iRegtiempopn,&$flagnuevotiempopn,&$campnomb)
{
	$nuconn = fncconn();
	...
	do 
	{ 
		$nuresult = loadrecordtiempopn($nuidtemp,$nuconn); 
		if($nuresult == e_empty) 
		{  
			$iRegtiempopn['tiempocodigo'] = $nuidtemp; 
		} 
		$nuidtemp ++; 
...
//				}
		...
		if($flagerror != 1)
		{
			$result = insrecordtiempopn($iRegtiempopn,$nuconn);
...
grabatiempopn($iRegtiempopn,$flagnuevotiempopn,$campnomb);
?> 
