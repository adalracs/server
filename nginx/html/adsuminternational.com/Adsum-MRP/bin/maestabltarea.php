...
if($accionborrartarea)
{
	include ( 'borratarea.php');
}
else
{
	if($accionconsultartarea)
	{
...
$intervalo = fncaumdec('tarea',$inicio,$fin,$mov,$accionconsultartarea,$recarreglo);
...
<html> 
<head> 
<title>Registros de tarea</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de tareas</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltarea.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevtarea.php'."'".';"  width="86" height="18" 
...
onclick="form1.action='."'".'consultartarea.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltarea.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestabltarea.php';" alt="Siguiente"></td> 
 </tr>
 <tr> 
...
onclick="form1.action='."'".'detallartarea.php'."'".';"  width="87" height="19" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrartarea.php';
...
onclick="form1.action='."'".'editartarea.php'."'".';"  width="87" height="19"  
...
$reg[0] = 'tareacodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('tarea', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?>
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestabltarea.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltarea.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
	        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestabltarea.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltarea.php',$flagcheck); ?></td> 
  </tr> 
 ...
 <input type="hidden" name="nombtabl" value="tarea"> 
<input type="hidden" name="columnas" value="tareacodigo, 
tareanombre, 
tareadescri 
"> 
 <input type="hidden" name="tareacodigo" value="<?php echo $tareacodigo; ?>"> 
 <input type="hidden" name="tareanombre" value="<?php echo $tareanombre; ?>"> 
 <input type="hidden" name="tareadescri" value="<?php echo $tareadescri; ?>"> 
 <input type="hidden" name="accionconsultartarea" value="<?php echo 
$accionconsultartarea; ?>"> 
...
<input type="hidden" name="selcampos" value="tareacodigo, tareanombre">
<!--											-->
