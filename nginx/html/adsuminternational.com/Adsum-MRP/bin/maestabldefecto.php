...
ob_start(); 
	...
	if($accionborrardefecto) 
		include ( 'borradefecto.php'); 
	else 
	{ 
		if($accionconsultardefecto) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultardefecto = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('defecto',$inicio,$fin,$mov,$accionconsultardefecto,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de defecto de calidad</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de defecto de calidad</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabldefecto.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'defectcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('defecto', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="defecto"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="defecto"> 
			...
			<input type="hidden" name="selcampos" value="defectcodigo">
			<!--											-->
