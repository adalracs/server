...
<?php endif; ?> 
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr> 
 								...
 								<td width="78%" class="NoiseDataTD"><input type="text" name="temanombre" id="temanombre"  size="50" value="<?php if(!$flagnuevotema){echo $sbreg[temanombre];}else{ echo $temanombre; }?>"></td> 
 							</tr>
							<tr><td class="ui-state-default" colspan="2"></td></tr>							
 							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["temadescri"] == 1){ $temadescri=null; echo "*";} ?>&nbsp;Descripci&oacute;n</td></tr>
  							<tr><td colspan="2" class="NoiseFooterTD"><textarea name="temadescri" id="temadescri" rows="3" cols="50" wrap="VIRTUAL"><?php if(!$flagnuevotema){echo $sbreg[temadescri];}else {echo $temadescri;}?></textarea></td></tr>
						</table>
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accionnuevotema">  
