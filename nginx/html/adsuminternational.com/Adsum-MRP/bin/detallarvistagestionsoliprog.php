...
ob_start();
	...
	if($acciondetallarvistagestionsoliprog) 
		include ( 'editavistagestionsoliprog.php');

ob_end_flush();

	if(!$flagdetallarvistagestionsoliprog)
	{
		include ( '../src/FunGen/sesion/fnccarga.php');
		$sbreg = fnccarga($nombtabl,$radiobutton);
		if (!$sbreg)
			include( '../src/FunGen/fnccontfron.php');
		//regriso de vistagestionsoliprog
		$idcon = fncconn();
...
<?php if($campnomb || $flagdetallarvistagestionsoliprog): ?>
...
<!-- 	FIN CORTE-REPROCESO -->
     		...
     		<input type="hidden" name="acciondetallarvistagestionsoliprog">
