...
<tr>
	<td><table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		<tr>
          ...
          <td colspan="2">
          	<?php if($campnomb["equipocodigo"] == 1)echo "*"; ?>Equipo&nbsp;<A href="javascript:;" id="equipo" onclick="fncshowspanot(this.id);" style="text-decoration:none;">(+)</A>
          </td>
          <td>
          	<?php if($campnomb["componcodigo"] == 1)echo "*"; ?>Componente&nbsp;<A href="javascript:;" id="componen" onclick="fncshowspanot(this.id);" style="text-decoration:none;">(+)</A>
          </td>
          </tr>
          <tr>
          ...
          <td colspan="2">
          <SPAN id="spnSelect_equipo" style="display:inline;">
		  ...
		  <SPAN id="spnText_equipo" style="display:none;">
		   <INPUT type="text" name="equipocodigo_auto" size="18" value=""/>
		  	   
		  </SPAN>
		  </td>
          <td>
           <SPAN id="spnSelect_componen" style="display:inline;">
		   ...
		   <SPAN id="spnText_componen" style="display:none;">
