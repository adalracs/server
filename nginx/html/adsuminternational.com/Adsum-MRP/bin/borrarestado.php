...
<html> 
<head> 
<title>Borrar registro de estado</title> 
...
<tr> 
 ...
 <td width="65%" class="NoiseDataTD"><?php if(!$flagborrarestado){ 
echo $sbreg[estadocodigo];}else{ echo $estadocodigo; } ?> 
  
 </td> 
 </tr> 
<tr> 
 <td width="35%" class="NoiseFooterTD">&nbsp;N&oacute;mbre</td> 
 <td width="65%" class="NoiseDataTD"><?php if(!$flagborrarestado){ 
...
<tr> 
 ...
 <td width="65%" rowspan="2" class="NoiseDataTD" valign="top"><?php if(!$flagborrarestado){ 
...
onclick="form1.accionborrarestado.value =  1; 
form1.action='maestablestado.php';"  width="86" height="18" alt="Aceptar" 
border=0> 
...
alt="Cancelar" border=0> 
 ...
 <input type="hidden" name="flagborrarestado" value="1"> 
<input type="hidden" name="accionborrarestado"> 
<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
<input type="hidden" name="estadocodigo" value="<?php if(!$flagborrarestado){ echo $sbreg[estadocodigo];}else{ echo $estadocodigo; } ?>">  
</form> 
</body> 
<?php 
if(!$codigo)
