...
<html> 
<head> 
<title>Consultar en Grupo Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionconsultargrupcomp.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
sans-serif">Código componente</font></td> 
                <td width="59%"> 
                  <select name="mecocodi" onChange="submit();"></select> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flagconsultargrupcomp" value="1"> 
<input type="hidden" name="accionconsultargrupcomp"> 
...
mecocodi 
"> 
<input type="hidden" name="nombtabl" value="grupcomp"> 
</form> 
</body> 
<?php 
    if(!$codigo) 
