...
<html> 
<head> 
<title>Editar registro de Tipo Menu Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accioneditartipomeco.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flageditartipomeco){ echo $sbreg[timecodi];}else{ echo $timecodi; } ?>" 
...
if(!$flageditartipomeco){ echo $sbreg[ticonomb];}else{ echo $ticonomb;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flageditartipomeco){ echo $sbreg[ticodesc];}else{ echo $ticodesc;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flageditartipomeco" value="1"> 
<input type="hidden" name="accioneditartipomeco"> 
