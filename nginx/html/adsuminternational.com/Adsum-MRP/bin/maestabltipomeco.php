...
include ( '../src/FunPerPriNiv/pktbltipomeco.php'); 
   include ( '../src/FunGen/sesion/fncalmdat.php'); 
if($accionborrartipomeco) 
{ 
	include ( 'borratipomeco.php'); 
} 
else 
{ 
	if($accioneditartipomeco) 
	{ 
		include ( 'editatipomeco.php'); 
	} 
	else 
	{ 
		if($accionnuevotipomeco) 
		{ 
			include ( 'grabatipomeco.php'); 
		} 
		else 
		{ 
			if($accionconsultartipomeco) 
			{ 
...
<html> 
<head> 
<title>Registros de Tipo Menu Comp</title> 
...
src="../img/nuevo.gif" 
onclick="form1.action='."'".'ingrnuevtipomeco.php'."'".';submit();"  width="86" 
height="18" alt="Nuevo Registro" border=0>'; 
} 
if($consultar){ 
echo '            <input type="image" name="consultar"  
src="../img/consulta.gif" 
onclick="form1.action='."'".'consultartipomeco.php'."'".';submit();"  
...
onclick="foo(2);form1.action='maestabltipomeco.php';submit();" 
alt="Anterior"></td> 
          <td width="57"><font size="2" color="#CC9900">Anterior</font></td> 
          <td width="53"> 
<?php 
	$intervalo = 
fncaumdec('tipomeco',$inicio,$fin,$mov,$accionconsultartipomeco,$recarreglo); 
...
src="../img/atrasa.gif" 
onclick="foo(1);form1.action='maestabltipomeco.php';submit();" 
alt="Siguiente"></td> 
        </tr> 
        <tr> 
          <td colspan="2">&nbsp;</td> 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'timecodi'; 
	$nureturn = fncvisreg('tipomeco',$reg,$idtrans); 
?> 
            </table> 
          </td> 
        </tr> 
...
src="../img/primero.gif" 
onclick="foo(3);form1.action='maestabltipomeco.php';submit();" 
alt="Primero"></td> 
...
src="../img/ultimo.gif" 
onclick="foo(4);form1.action='maestabltipomeco.php';submit();" 
alt="Ultimo"></td> 
        </tr> 
        <tr> 
...
<input type="hidden" name="nombtabl" value="tipomeco"> 
<input type="hidden" name="columnas" value="timecodi, 
ticonomb, 
ticodesc 
"> 
<input type="hidden" name="timecodi" value="<?php echo $timecodi; ?>"> 
<input type="hidden" name="ticonomb" value="<?php echo $ticonomb; ?>"> 
<input type="hidden" name="ticodesc" value="<?php echo $ticodesc; ?>"> 
<input type="hidden" name="accionconsultartipomeco" value="<?php echo 
$accionconsultartipomeco; ?>"> 
