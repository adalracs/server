...
ob_start(); 
	...
	if($accionnuevoajustepn)
		include ( 'grabaajustepn.php');
...
<html> 
	<head> 
		<title>Nuevo registro ajustes y cambios de produccion</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Ajuste y cambios en produccion</font></p> 
...
<?php endif; ?> 
			...
			<input type="hidden" name="accionnuevoajustepn">  
