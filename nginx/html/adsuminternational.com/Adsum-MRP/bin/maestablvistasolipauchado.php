...
include ('../src/FunPerPriNiv/pktblvistasolipauchado.php');
...
if ($accionborrarvistasolipauchado) { 
	include ('borravistasolipauchado.php'); 
} else { 
	if ($accionconsultarvistasolipauchado) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistasolipauchado = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistasolipauchado', $inicio, $fin, $mov, $accionconsultarvistasolipauchado, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de solicitud de programacion de pauchado</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de solicitudes de programacion [Pauchado]</font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablvistasolipauchado.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<td width="10%" class="ui-state-default tbl-head-font">Procedimiento.</td> 
			</tr>
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistasolipauchado.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistasolipauchado ( 'vistasolipauchado', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistasolipauchado"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistasolipauchado"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistasolipauchado) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistasolipauchado"	value="<?php echo $accionconsultarvistasolipauchado; ?>"> 
