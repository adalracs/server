...
if($accionnuevoreportemant)
{
	include ( 'grabaotmantenimiento.php');
}
...
<p><font class="NoiseFormHeaderFont">Mantenimientos</font></p>
...
color="FFFFFF">Mantenimientos</font></span></td></tr>
<tr>
	<td>
		<table width="93%" border="0" cellspacing="1" cellpadding="1" align="center">
          ...
          <tr class="NoiseFooterTD">
									...
									<a onClick="return verocultar(this);" href="javascript:void(0);">Plantas&nbsp;<img id="row"  align="middle"  src="temas/Noise/DescOn.gif" border="0"></a><div style="display: none;">
										...
										<tr><td class="NoiseFieldCaptionTD" colspan="2"></td></tr>
	                        							<tr>
	                              								<td height="250" colspan="2" class="NoiseFooterTD"><iframe src="detallarusuaplantareportes.php?plantall=<?php echo $plantatmp; ?>&arrdata=<?php echo $arrplantas; ?>" frameborder="0" name="plantas" id = "plantagen"  height="250" width="100%" align="absmiddle"></iframe></td>
                            								</tr>
	                            						</table>
          									</div>          								</td>
          							</tr>
...
onclick="window.document.form1.accionnuevoreportemant.value = 1" width="86" height="18" alt="Aceptar" border=0>&nbsp;
