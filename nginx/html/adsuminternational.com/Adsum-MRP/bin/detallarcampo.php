...
<html> 
<head> 
<title>Detalle de registro de Campo</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.acciondetallarcampo.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagdetallarcampo){ echo $sbreg[tablcodi];}else{ echo $tablcodi; } ?>" 
...
if(!$flagdetallarcampo){ echo $sbreg[campcodi];}else{ echo $campcodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagdetallarcampo){ echo $sbreg[campnomb];}else{ echo $campnomb;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagdetallarcampo){ echo $sbreg[campdesc];}else{ echo $campdesc;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagdetallarcampo" value="1"> 
<input type="hidden" name="acciondetallarcampo"> 
