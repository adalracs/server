...
onclick="carga();form1.accionnuevousuagrupcapa.value =  1;form1.action='ingrnuevgrupcapa.php';" 
...
<input type="hidden" name="accionnuevoinsgrupcapa"> 
