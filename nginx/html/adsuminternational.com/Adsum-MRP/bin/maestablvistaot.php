...
include ( '../src/FunPerSecNiv/fncnumreg.php'); //Determina la cantidad de registros de una transacci�n
include ( '../src/FunPerSecNiv/fncfetch.php'); //Trae los datos de un registro
include ( '../src/FunGen/sesion/fnccantrow.php'); //Almacena la cantidad total de registros de la tabla
include ( '../src/FunGen/sesion/fnccantrow1.php'); //Almacena la cantidad total de registros que son resultado de una consulta parametrizada
include ( '../src/FunPerPriNiv/limitscan.php'); //Accesa los registros  de la tabla teniendo en cuenta determinado intervalo
...
include ( '../src/FunGen/sesion/fncalmdat.php'); //Almacena el id de transaccion necesario para cargar la primera forma de datos.
include ( '../src/FunGen/sesion/fnccaf.php'); //Determina a que componentes tiene derecho un usuario
...
<SCRIPT language="JavaScript" src="../src/FunGen/cargarOtestadoot.js" type="text/javascript"></script>
...
onclick="form1.action='consultarvistaot.php';"  width="86" height="18" 
alt="Volver" border=0>
 </td> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablvistaot.php';" alt="Anterior"></td> 
...
onclick="form1.mov.value='mas'; form1.action='maestablvistaot.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
  <td colspan="6">
  <div align="right">&nbsp;</div>
...
<td width="13%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Proceso</font></span></td> 
<td width="13%" class="NoiseFieldCaptionTD"><span class="style5"><font 
...
$reg[0] = 'ordtracodigo';
$reg1[0] = 'n';
$nureturn = fncvisregvistaot('vistaot',$reg,$reg1,$idtrans,null,null);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value='primero'; form1.action='maestablvistaot.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value='menos'; form1.action='maestablvistaot.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value='ultimo'; form1.action='maestablvistaot.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
...
<input type="hidden" name="columnas" value="ordtracodigo,ordtrafecgen,plantacodigo,sistemcodigo,
equipocodigo,componcodigo,tipmancodigo,prioricodigo,ordtradescri,ordtrafecini,ordtrahorini,ordtrafecfin,ordtrahorfin,usuacodi,tiptracodigo,tareacodigo,usutarcodigo,prioricodigo">
