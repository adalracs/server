...
<html> 
<head> 
<title>Editar registro de servicioplanta</title> 
...
if(!$flageditarservicioplanta){ echo $sbreg[serplacodigo];}else{ echo 
$serplacodigo; }?>"> 
 </td> 
 </tr> 
<tr> 
...
if(!$flageditarservicioplanta){ echo $sbreg[plantacodigo];}else{ echo 
$plantacodigo; }?>"> 
 </td> 
 </tr> 
<tr> 
...
if(!$flageditarservicioplanta){ echo $sbreg[servicicodigo];}else{ echo 
$servicicodigo; }?>"> 
 </td> 
 </tr> 
 <tr> 
...
onclick="form1.accioneditarservicioplanta.value =  1;"  width="86" height="18" 
...
if(!$flageditarservicioplanta){ echo $sbreg[serplacodigo];}else{ echo 
$serplacodigo; } ?>"> 
<input type="hidden" name="accioneditarservicioplanta"> 
