...
<html> 
	<head> 
		<title>Consultar tiempo pn</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">consultar tiempo pn</font></p> 
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							...
							<tr>
 							...
 							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Tipo Tiempo</td>
								<td width="83%" class="NoiseDataTD"><select name="tiptiecodigo">
 							...
 							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Tipo Tiempo</td>
								<td width="83%" class="NoiseDataTD"><select name="tiptiecodigo1">
									<option value="">--Seleccione--</option>
									<?php 
 			...
 			<input type="hidden" name="flagconsultartiempopn" value="1"> 
			<input type="hidden" name="accionconsultartiempopn"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="tiptiecodigo, tiptienombre,tiptiecodigo,tiptiecodigo1,tipsolcodigo">
