...
<html>
	<head>
		<title>Inspeccion ordenes de produccion</title>
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post" enctype="multipart/form-data">
			<div class="ui-state-default">
				<?php $optanalisis=1;include ('../def/jquery.maestablbuttons.php'); ?>				
				&nbsp;Filtrar Programa&nbsp;
			...
			<input type="hidden" name="sourcetable" id="sourcetable" value="gestionoppanalisispr"> 
