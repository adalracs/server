...
<html> 
<head> 
<title>Detalle de registro de Usuario-Grupo</title> 
...
<script language="JavaScript"> 
<!-- Begin
function foo(){ form1.acciondetallarusuagrup.value =  1; }
//  End -->
</script> 
</head> 
<?php 
...
if(!$flagdetallarusuagrup){ echo $sbreg[grupcodi];}else{ echo $grupcodi; } ?>" 
...
if(!$flagdetallarusuagrup){ echo $sbreg[usuacodi];}else{ echo $usuacodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagdetallarusuagrup" value="1"> 
<input type="hidden" name="acciondetallarusuagrup"> 
