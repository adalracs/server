<?php 
	...
	if($accionnuevocierrenoconformeppr){ 
		include ( "grabacierrenoconformeppr.php"); 
	}

	if(!$flagnuevocierrenoconformeppr){
...
<?php endif; ?>
				...
				<tr> 
 				...
 				<tr><td class="ui-widget-header"><span class="style5"><font color="FFFFFF">Cierre no conforme</font></span></td></tr>   
 				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center"> 
 							<tr>
 							...
 							<tr><td colspan="2" class="NoiseErrorDataTD"></td></tr>
							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["cienocdescri"]== 1){$cienocdescri = null; echo "*";}?>&nbsp;Descripci&oacute;n Cierre</td></tr>
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="cienocdescri" rows="3" cols="95"><?php echo $cienocdescri; ?></textarea></td></tr>
						</table>
					</td>
				<tr>
			...
			<input type="hidden" name="sourcetable" value="<?php echo "cierrenoconformeppr"; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="nuevo">  
			<input type="hidden" name="accionnuevocierrenoconformeppr"> 
