...
include ( '../src/FunPerPriNiv/pktblreportes.php'); 
include ( '../src/FunGen/sesion/fncalmdat.php'); 
include ( '../src/FunGen/sesion/fnccaf.php');
 
$reccomact.= fnccaf($GLOBALS[usuacodi],$PATH_TRANSLATED); 
if($accionborrarreportes) 
{ 
	include ( 'borrareportes.php'); 
} 
else 
{ 
		if($accionconsultarreportes) 
			{ 
...
onclick="form1.action='."'".'ingrnuevreportes.php'."'".';"  width="86" 
...
onclick="form1.mov.value = 'menos';form1.action='maestablreportes.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('reportes',$inicio,$fin,$mov,$accionconsultarreportes,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablreportes.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarreportes.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarreportes.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'reportcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('reportes',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablreportes.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablreportes.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablreportes.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="reportes"> 
...
"> 
 ...
 <input type="hidden" name="reportcolumn" value="<?php echo $reportcolumn; ?>"> 
 <input type="hidden" name="accionconsultarreportes" value="<?php echo 
$accionconsultarreportes; ?>"> 
