...
?>
          ...
          <tr> 
            ...
            <td width="30%">
            <input size="25" type="text" name="plantacodigo" onFocus="if (!agree)this.blur();" value="<?php
				if($plantacodigo)
				{
					$idcon	= fncconn();
          ...
          <tr> 
            ...
            <td width="30%">
            <input size="30" type="text" name="sistemcodigo" onFocus="if (!agree)this.blur();" value="<?php
				if($sistemcodigo)
				{
					$idcon	= fncconn();
					$arrsistema = loadrecordsistema($sistemcodigo,$idcon);
					echo $arrsistema[sistemnombre];
					fncclose($idcon);
				}
			?>">
            </td>
...
form1.action='maestablequipotimedrep.php';"  width="86" height="18" alt="Aceptar" 
border=0> 
