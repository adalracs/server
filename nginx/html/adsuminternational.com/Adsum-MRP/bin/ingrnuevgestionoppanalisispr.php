<?php 
	...
	if($accionnuevogestionoppanalisispr) 
		include ( "grabagestionoppanalisispr.php");
...
<?php if (! $codigo) echo "<!--"; ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post" enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Analisis calidad orden de produccion programada {OPP}</font></p> 
...
<?php endif; ?>
			...
			<input type="hidden" name="flagnuevogestionoppanalisispr">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="nuevo">  
			<input type="hidden" name="accionnuevogestionoppanalisispr"> 
