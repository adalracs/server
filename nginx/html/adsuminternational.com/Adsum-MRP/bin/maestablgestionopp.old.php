...
if ($accionborrargestionopp) { 
	include ('borragestionopp.php'); 
} else { 
	if ($accionconsultargestionopp) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'vistagestionopp', $inicio, $fin, $mov, $accionconsultargestionopp, $recarreglo ); 
...
<p><font class="NoiseFormHeaderFont">Gestion de ordenes de produccion programada {opp}</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="99%"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablgestionopp.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisreggestionopp.php'); 
				$reg [0] = 'ordoppcodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreggestionopp ( 'gestionopp', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="ordoppcodigo" value="<?php if ($accionconsultargestionopp) { echo $ordoppcodigo; } ?>">  
<input type="hidden" name="accionconsultargestionopp"	value="<?php echo $accionconsultargestionopp; ?>"> 
