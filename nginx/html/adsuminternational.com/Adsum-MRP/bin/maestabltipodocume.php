...
if ($accionborrartipodocume) { 
	include ('borratipodocume.php'); 
} else { 
	if ($accionconsultartipodocume) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'tipodocume', $inicio, $fin, $mov, $accionconsultartipodocume, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de tipodocume</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de tipos de documento</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	<tr> 
		<td class="NoiseErrorDataTD" align="right"> 
	<?php 
	page_position ( $intervalo, 'maestabltipodocume.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				$reg [0] = 'tipdoccodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreg ( 'tipodocume', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="tipodocume"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="tipodocume"> 
<input type="hidden" name="columnas" value="tipdoccodigo, tipdocnombre, tipdocdescri"> 
...
<input type="hidden" name="accionconsultartipodocume"	value="<?php echo $accionconsultartipodocume; ?>"> 
...
<input type="hidden" name="selcampos" value="tipdoccodigo, tipdocnombre, tipdocdescri"><!--					--> 
