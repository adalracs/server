...
ob_start();
	...
	if($accionnuevoequipo)
		include ( 'grabaequipo.php');
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table width="800px" border="0" align="center" cellpadding="1" cellspacing="1" class="ui-widget-content">
<?php if($campnomb): ?>
  						...
  						<table width="99%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
  							<tr> 
								...
								<td class="NoiseErrorDataTD" rowspan="8" width="27%" align="center">
            						<img name="fotoimage" name="fotoimage" alt="Buscar imagen..." width="185" height="175" src="../img/pics_equipos/<?php if(!$flagnuevousuario): ?>no_image.png<?php else: echo $rutafoto; endif; ?>">
          					...
          					<tr> 
								...
								<td class="NoiseDataTD"><?php if($campnomb["usuacodi"] == 1){ $usuacodigo = null;echo "*";}?><input name="usuacodigo" type="text" value="<?php if(!$flagnuevoequipo){ echo $usuacodigo;} else {echo $usuacodigo;} ?>" size="8" onFocus="if(!agree)this.blur();"><input name="usuanombre" type="text"	value="<?php if(!$flagnuevoequipo){ echo $usuanombre;} else {echo $usuanombre;} ?>" size="45" onFocus="if (!agree)this.blur();"></td>
							</tr>
							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["equipocodigo"] == 1){ $equipocodigo=null;echo "*";}?>&nbsp;C&oacute;digo SIGMA</td>
								<td class="NoiseDataTD"><input name="equipocodigo" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipocodigo];} else {echo $equipocodigo;}?>" size="30"></td>
							</tr>
							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["codigosrf"] == 1){ $codigosrf=null;echo "*";}?>&nbsp;Codigo SRF</td>
								<td class="NoiseDataTD"><input name="codigosrf" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[codigosrf];} else {echo $codigosrf;}?>" size="30"></td>
							</tr>
							<tr> 
								<td class="NoiseFooterTD"><?php if($campnomb["equiponombre"] == 1){ $equiponombre=null;echo "*";}?>&nbsp;Nombre</td>
								<td class="NoiseDataTD"><input name="equiponombre" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equiponombre];} else {echo $equiponombre;}?>" size="50"></td>                	
							</tr>         
							<tr>
  					...
  					<td>
  						<table width="99%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
							<tr> 
								...
								<td class="NoiseDataTD" width="30%"><input name="equipofabric" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipofabric];} else {echo $equipofabric;}?>" size="20"></td>
								<td class="NoiseFooterTD" width="20%"><?php if($campnomb["equipomarca"] == 1){ $equipomarca=null;echo "*";}?>&nbsp;Marca</td>
								<td class="NoiseDataTD" width="30%"><input name="equipomarca" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipomarca];} else {echo $equipomarca;}?>" size="20"></td>
							</tr>
							<tr> 
								<td class="NoiseFooterTD"><?php if($campnomb["equipomodelo"] == 1){ $equipomodelo=null;echo "*";}?>&nbsp;Modelo</td>
								<td class="NoiseDataTD"><input name="equipomodelo" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipomodelo];} else {echo $equipomodelo;}?>" size="20"></td>
								<td class="NoiseFooterTD"><?php if($campnomb["equiposerie"] == 1){ $equiposerie=null;echo "*";}?>&nbsp;No. serie</td>
								<td class="NoiseDataTD"><input name="equiposerie" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equiposerie];} else {echo $equiposerie;}?>" size="20"></td>
							</tr>
							<tr> 
								<td class="NoiseFooterTD"><?php if($campnomb["equipocinv"] == 1){ $equipocinv=null;echo "";}?>&nbsp;No. inventario</td>
								<td class="NoiseDataTD"><input name="equipocinv" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipocinv];} else {echo $equipocinv;}?>" size="20"></td>
								<td class="NoiseFooterTD"><?php if($campnomb["equipoubicac"] == 1){ $equipoubicac=null;echo "*";}?>&nbsp;Ubicaci&oacute;n</td>
								<td class="NoiseDataTD"><input name="equipoubicac" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipoubicac];} else {echo $equipoubicac;}?>" size="20"></td>
							</tr>
							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["equipoviduti"] == 1){ $equipoviduti=null;echo "*";}?>&nbsp;Vida util</td>
								<td class="NoiseDataTD"><input name="equipoviduti" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipoviduti];} else {echo $equipoviduti;}?>" size="14"></td>
							...
							<tr> 
								...
								<td class="NoiseDataTD"><input name="equiponpas" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equiponpas];} else {echo $equiponpas;}?>" size="20"></td>
  					...
  					<td>
  						<table width="99%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
							<tr> 
								...
								<td class="NoiseDataTD" width="30%"><input name="equipovolta" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipovolta];} else {echo $equipovolta;}?>" size="20"></td>
								<td class="NoiseFooterTD" width="20%">&nbsp;Corriente</td>
								<td class="NoiseDataTD" width="30%"><input name="equipocorrie" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipocorrie];} else {echo $equipocorrie;}?>" size="20"></td>
							</tr>
							<tr> 
								<td class="NoiseFooterTD">&nbsp;Potencia</td>
								<td class="NoiseDataTD"><input name="equipopoten" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equipopoten];} else {echo $equipopoten;}?>" size="20"></td>
								<td class="NoiseFooterTD">&nbsp;Nivel de tensi&oacute;n</td>
								<td class="NoiseDataTD"><input name="equiponivten" type="text"	value="<?php if(!$flagnuevoequipo){ echo $sbreg[equiponivten];} else {echo $equiponivten;}?>" size="20"></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td>
						...
						<?php
							...
							$idcon = fncconn();
							floadtipoequicamperequipo($tipequcodigo, $campnomb, $flagnuevoequipo, $idcon, $iRegequicamper);
							fncclose($idcon);
						?>
						</span>
					</td>
...
//								include('../src/FunGen/floadtipoequicamperequipo.php');
//								$idcon = fncconn();
//								floadtipoequicamperequipo($tipequcodigo, $campnomb, $flagnuevoequipo, $idcon);
//								fncclose($idcon);
//							}
				  		?>
          						<!-- ** ** ** -->
			...
			<input type="hidden" name="accionnuevoequipo"> 
			<input type="hidden" name="equipoacti" value="1"> 
			<input type="hidden" name="equipotipo" value=""> 
			...
			<input type="hidden" id="rutafoto" name="rutafoto" value="<?php if($flagnuevoequipo){ echo $rutafoto; } ?>">
		</form>
