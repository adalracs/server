...
<html> 
<head> 
<title>Borrar registro de tipofall</title> 
...
align="center"> 
 ...
 <td width="25%">C&oacute;digo</td> 
  <td width="25%"> 
   ...
   if(!$flagborrartipofall){ echo $sbreg[tipfalcodigo];}else{ echo $tipfalcodigo;}
?>" onFocus="if (!agree)this.blur();" > 
             ...
             <tr>
               ...
               if(!$flagborrartipofall){ echo $sbreg[tipfalnombre];}else{ echo $tipfalnombre;}
?>" onFocus="if (!agree)this.blur();" ></td>
 ...
 <td width="25%">Descripci&oacute;n</td> 
  <td width="25%" rowspan="2"> 
    ...
    if(!$flagborrartipofall){ echo $sbreg[tipfaldescri];}else{ echo $tipfaldescri;}
?>
    </textarea> 
  </td> 
 </tr>
...
onclick="form1.accionborrartipofall.value =  1; 
...
alt="Cancelar" border=0> 
 ...
 <input type="hidden" name="flagborrartipofall" value="1"> 
<input type="hidden" name="accionborrartipofall"> 
