...
if ($accionborrarclaseusuario) { 
	include ('borraclaseusuario.php'); 
} else { 
	if ($accionconsultarclaseusuario) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'claseusuario', $inicio, $fin, $mov, $accionconsultarclaseusuario, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de claseusuario</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de claseusuario</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	<tr> 
		<td class="NoiseErrorDataTD" align="right"> 
	<?php 
	page_position ( $intervalo, 'maestablclaseusuario.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<td width="45%" class="ui-state-default">clausucodigo</td> 
				...
				$reg [0] = 'clausucodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreg ( 'claseusuario', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="claseusuario"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="claseusuario"> 
<input type="hidden" name="columnas" value="clausucodigo, clausunombre, clausudescri"> 
...
<input type="hidden" name="accionconsultarclaseusuario"	value="<?php echo $accionconsultarclaseusuario; ?>"> 
...
<input type="hidden" name="selcampos" value="clausucodigo, clausunombre, clausudescri"><!--					--> 
