<?php	
	...
	//conexion
	$idcon = fncconn();
	//equipos del sistema de corte {2}
	$rs_equipo = dinamicscanopequipo(array('sistemcodigo' => 2, 'tipequcodigo' => 3),array('sistemcodigo' => '=', 'tipequcodigo' => '='),$idcon);
...
<html>
	...
	<form name="form1" method="post"  enctype="multipart/form-data">
		<div id="programacorte" style="width:900px;align:center;margin-left:20px;">
			<ul>
			<?php 
			...
			<?php 
				...
				for($a = 0;$a < $nr_equipo;$a++)
				{
					...
					$rsCorte = dinamicscanopprogramacorte1(array('equipocodigo' => $obj_equipo),array('equipocodigo' => '='),$idcon);
				...
				<ul id="<?php echo $obj_sortable ?>" class="connectedSortable ui-helper-reset">
					<?php 
						...
						for($b = 0;$b < $nrCorte;$b++)
						{
							...
							$METROSCORTE = ($rwCorte['ordoppcantkg'])? $rwCorte['ordoppcantkg'] : '---' ;
							...
							$checked = '';
							if($rwCorte['ordoppcomfir'] > 0)
							{
								$checked = 'checked';
								$arroppview = ($arroppview)? $arroppview.','.$rwCorte['ordoppcodigo'] : $rwCorte['ordoppcodigo'];
							}
					...
					?>
					<li class="ui-state-default"  id="<?php echo $rwCorte['ordoppcodigo'] ?>">
						<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
							<tr <?php echo $complement ?> >
								...
								<td width="5%" class="cont-line">&nbsp;<input type="checkbox" id="chkoppview" name="chkoppview" <?php echo $checked ?> onclick="setSelectionRow(this.value, document.getElementById('arroppview').value, ',', 'arroppview');" value="<?php echo $rwCorte['ordoppcodigo'] ?>"></td>
							</tr>
						</table>
					</li>
					<?php 
		...
		<table width="100%" align="center" cellpadding="1" cellspacing="1">
			...
			<tr>
				<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
					<button id="editaprograma_cor">Editar [programa]</button>
					<button id="cancelarprograma_cor">Atras</button></div>
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr> 
		</table>
