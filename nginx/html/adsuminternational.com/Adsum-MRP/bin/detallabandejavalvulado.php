<?php	
	...
	//conexion
	$idcon = fncconn();
	//validacion de filtros para la bandeja de valvulado
	if($plantacodigo)
	{
		$record['plantacodigo'] = $plantacodigo;
		$recordop['plantacodigo'] = '=';
		$rsOp = dinamicscanopvistabandejavalvulado($record, $recordop, $idcon);
	}
	else
	{
		$rsOp = fullscanvistabandejavalvulado($idcon);
	}
