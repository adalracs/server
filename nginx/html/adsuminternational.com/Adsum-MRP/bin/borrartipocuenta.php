	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
      		...
      		<input type="hidden" name="tipcuecodigo1" value="<?php echo $tipcuecodigo; ?>">
	  		<input type="hidden" name="accionborrartipocuenta">
	  		<input type="hidden" name="flagborrartipocuenta" value="1">
