...
*/
    ...
    */
	...
	class procesos_admin extends rs_server
	{
		...
		/*
		Propiedad intelectual de adsum (c).
		Funcion         : mostrarCiudades
		Decripcion      : realiza la consulta a la base de datos
		Parametros      : $paramaters		el valor del atributo del formulario
		Retorno         : $str		lista de los hijos de Departamento
		Autor           : ariascos - lfolaya - jcortes
		Fecha           : 15-feb-2008
		*/	
		function mostrarCiudad($paramaters)
		{

			$idcon = fncconn();
			$str = loadrecordciudadproc($paramaters,$idcon);
    ...
    */
    ...
    $oRS = new procesos_admin( array( 'mostrarCiudad'));
