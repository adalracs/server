...
<html> 
	<head> 
		<title>Borrar registro de analisis materias primas</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
 			...
 			<input type="hidden" name="analiscodigo" value="<?php echo $sbreg[analiscodigo]; ?>">
			<input type="hidden" name="accionborraranalisismp">
			<input type="hidden" name="flagborraranalisismp" value="1">
