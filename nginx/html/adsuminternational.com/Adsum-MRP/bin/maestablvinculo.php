...
include ( '../src/FunPerPriNiv/pktblvinculo.php'); 
...
if($accionborrarvinculo) 
{ 
	include ( 'borravinculo.php'); 
} 
else 
{ 
		if($accionconsultarvinculo) 
			{ 
...
<html> 
<head> 
<title>Registros de vinculo</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de vinculo</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablvinculo.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('vinculo',$inicio,$fin,$mov,$accionconsultarvinculo,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablvinculo.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
<td width="24%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Barra</font></span></td> 
<td width="24%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Estado</font></span></td> 
</tr> 
<?php 
include ( '../src/FunGen/sesion/fncvisregvinculo.php'); 
	$reg[0] = 'vinculcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregvinculo('vinculo',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablvinculo.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablvinculo.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablvinculo.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
...
vinculdescri 
"> 
 <input type="hidden" name="vinculcodigo" value="<?php echo $vinculcodigo; ?>"> 
 <input type="hidden" name="estadocodigo" value="<?php echo $estadocodigo; ?>"> 
 <input type="hidden" name="barracodigo" value="<?php echo $barracodigo; ?>"> 
 <input type="hidden" name="vinculnombre" value="<?php echo $vinculnombre; ?>"> 
 <input type="hidden" name="vinculrefere" value="<?php echo $vinculrefere; ?>"> 
 <input type="hidden" name="vinculdescri" value="<?php echo $vinculdescri; ?>"> 
 <input type="hidden" name="accionconsultarvinculo" value="<?php echo 
$accionconsultarvinculo; ?>"> 
