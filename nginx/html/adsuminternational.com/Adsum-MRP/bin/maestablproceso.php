...
include ('../src/FunPerPriNiv/pktblproceso.php'); 
include ('../src/FunGen/sesion/fncalmdat.php'); 
include ('../src/FunGen/sesion/fnccaf.php'); 
$reccomact = fnccaf ( $GLOBALS [usuacodi], $_SERVER ["SCRIPT_FILENAME"] ); 
 
if ($accionborrarproceso) { 
	include ('borraproceso.php'); 
} else { 
	if ($accionconsultarproceso) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'proceso', $inicio, $fin, $mov, $accionconsultarproceso, $recarreglo ); 
...
<p><font class="NoiseFormHeaderFont">Listado de proceso</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" 
	class="ui-widget-content"> 
	<tr> 
		<td class="NoiseErrorDataTD" align="right"> 
	<?php 
	page_position ( $intervalo, 'maestablproceso.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				$reg [0] = 'procescodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreg ( 'proceso', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="proceso"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="proceso"> 
<input type="hidden" name="columnas" value="procescodigo, procesnombre"> 
<input type="hidden" name="procescodigo" value="<?php if ($accionconsultarproceso) { echo $procescodigo; } ?>"> 
<input type="hidden" name="procesnombre" value="<?php if ($accionconsultarproceso) { echo $procesnombre; } ?>"> 
<input type="hidden" name="accionconsultarproceso"	value="<?php echo $accionconsultarproceso; ?>"> 
...
<input type="hidden" name="selcampos" value="procescodigo, procesnombre"><!--					--> 
