...
<html> 
  <head> 
    <title>Consultar tipo de operacion</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
  <body bgcolor="FFFFFF" text="#000000"> 
    <form name="form1" method="post"  enctype="multipart/form-data"> 
        ...
        <tr> 
            <td> 
              ...
              <tr>
                ...
                <td width="80%" class="NoiseDataTD"><input type="text" name="tipopecodigo" size="30" value="<?php echo $tipopecodigo; ?>"></td> 
              </tr>
              <tr>
                <td width="20%" class="NoiseFooterTD">&nbsp;Nombre</td>
                <td width="80%" class="NoiseDataTD"><input type="text" name="tipopenombre" size="30" value="<?php echo $tipopenombre; ?>"></td> 
              </tr>
            </table> 
            </td> 
        </tr> 
      ...
      <input type="hidden" name="flagconsultartipooper" value="1"> 
      <input type="hidden" name="accionconsultartipooper"> 
      <input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
      <input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
      <input type="hidden" name="sourceaction" value="consultar">
      <input type="hidden" name="columnas" value="tipopecodigo, tipopenombre">
