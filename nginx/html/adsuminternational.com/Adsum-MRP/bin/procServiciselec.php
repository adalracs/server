...
class procesos_admin extends rs_server
{
	...
	Fecha           : 27-DIC-2005
	*/
	function mostrarServiciselec($paramaters)
	{
		$idcon = fncconn();
		...
		{
			$arrservicio = loadrecordservicio($valposic[$i], $idcon);
			$negocinomb  = loadrecordnegocio($arrservicio["negocicodigo"], $idcon);
			
			$result = loadrecordserviciselec($valposic[$i],$idcon);
			
			$str = $str.$result." / ".$negocinomb["negocinombre"].",";
		}
...
*/
$oRS = new procesos_admin( array('mostrarServiciselec'));
