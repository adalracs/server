...
<html> 
	<head> 
		<title>Borrar de registro de negocio</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="470">
 			...
 			<input type="hidden" name="flagborrarnegocio" value="1">
 			<input type="hidden" name="negocicodigo1" value="<?php if(!$flagborrarnegocio){ echo $sbreg[negocicodigo];}else{ echo $negocicodigo1; } ?>">
			<input type="hidden" name="accionborrarnegocio">
