...
if($accionborrarusuagrupcapa)
{
	include ( 'borrausuagrupcapa.php');
}
else
{
	if($accionconsultarusuagrupcapa)
	{
//		include ( '../src/FunGen/sesion/fncalmdatc.php');
		...
		if(!$nusw){
			$accionconsultarusuagrupcapa = 0;
		}
	}
}
include ( '../src/FunGen/sesion/fncaumdec.php');
include('../src/FunGen/fncpageposition.php');
$intervalo = fncaumdec('usuagrupcapa',$inicio,$fin,$mov,$accionconsultarusuagrupcapa,$recarreglo); 
...
<html>
<head> 
<title>Registros de usuagrupcapa</title> 
...
<p><font class="NoiseFormHeaderFont">Listado grupo de empleados</font><br><br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablusuagrupcapa.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevusuagrupcapa.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarusuagrupcapa.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablusuagrupcapa.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablusuagrupcapa.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarusuagrupcapa.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarusuagrupcapa.php';
...
onclick="form1.action='."'".'editarusuagrupcapa.php'."'".';"  width="87" 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregusuagrupcapa.php'); 
	$reg[0] = 'usugrucodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregusuagrupcapa('usuagrupcapa', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablusuagrupcapa.php';" 
alt="Primero"></td> 
...
'menos';form1.action='maestablusuagrupcapa.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablusuagrupcapa.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablusuagrupcapa.php',$flagcheck); ?></td> 
...
usuacodi
">
 <input type="hidden" name="usugrucodigo" value="<?php echo $usugrucodigo; ?>"> 
 <input type="hidden" name="grucapcodigo" value="<?php echo $grucapcodigo; ?>"> 
 <input type="hidden" name="usuacodi" value="<?php echo $usuacodi;?>"> 
 <input type="hidden" name="accionconsultarusuagrupcapa" value="<?php echo $accionconsultarusuagrupcapa; ?>"> 
...
<input type="hidden" name="selcampos" value="usugrucodigo, grucapcodigo">
<!--											-->
