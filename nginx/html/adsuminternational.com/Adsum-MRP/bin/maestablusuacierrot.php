...
<p><font class="NoiseFormHeaderFont">Listado de Colaboradores</font><br><br></p> 
...
onclick="form1.action='."'".'consultarusuacierreot.php'."'".';"  width="86" 
...
onclick="form1.mov.value='menos';form1.action='maestablusuacierrot.php';" alt="Anterior"></td> 
...
onclick="form1.mov.value='mas';form1.action='maestablusuacierrot.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregusuacierreot.php'); 
	$reg[0] = 'usuacodi'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregusuacierreot('usuario',$reg,$reg1,$idtrans,$arreglo_aux); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value='primero';form1.action='maestablusuacierrot.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"
src="../img/adelanta.gif" onclick="form1.mov.value='menos';form1.action='maestablusuacierrot.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value='ultimo';form1.action='maestablusuacierrot.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
...
<input type="hidden" name="empleacod"> 
 </form> 
 </body> 
<?php 
if(!$codigo) 
