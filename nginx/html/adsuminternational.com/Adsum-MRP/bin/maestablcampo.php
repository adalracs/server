...
if($accionborrarcampo) 
{ 
	include ( 'borracampo.php'); 
} 
else 
{ 
	if($accioneditarcampo) 
	{ 
		include ( 'editacampo.php'); 
	} 
	else 
	{ 
		if($accionnuevocampo) 
		{ 
			include ( 'grabacampo.php'); 
		} 
		else 
		{ 
			if($accionconsultarcampo) 
			{ 
...
<html> 
<head> 
<title>Registros de Campo</title> 
...
src="../img/nuevo.gif" 
onclick="form1.action='."'".'ingrnuevcampo.php'."'".';submit();"  width="86" 
height="18" alt="Nuevo Registro" border=0>'; 
} 
if($consultar){ 
echo '            <input type="image" name="consultar"  
src="../img/consulta.gif" 
onclick="form1.action='."'".'consultarcampo.php'."'".';submit();"  width="86" 
...
onclick="foo(2);form1.action='maestablcampo.php';submit();" 
alt="Anterior"></td> 
          <td width="57"><font size="2" color="#CC9900">Anterior</font></td> 
          <td width="53"> 
<?php 
	$intervalo = 
fncaumdec('campo',$inicio,$fin,$mov,$accionconsultarcampo,$recarreglo); 
...
src="../img/atrasa.gif" 
onclick="foo(1);form1.action='maestablcampo.php';submit();" 
alt="Siguiente"></td> 
        </tr> 
        <tr> 
          <td colspan="2">&nbsp;</td> 
...
size ="2" color="#006699">selec</font></b></td> 
                <td width="30%"><b><font size="2" face="Arial,Helvetica, 
sans-serif" color="#006699">Codigo de la tabla</font></b></td> 
                <td width="30%"><b><font size="2" face="Arial,Helvetica, 
sans-serif" color="#006699">Codigo del campo</font></b></td> 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'tablcodi'; 
	$reg[1] = 'campcodi'; 
	$nureturn = fncvisreg('campo',$reg,$idtrans); 
?> 
            </table> 
          </td> 
        </tr> 
...
src="../img/primero.gif" 
onclick="foo(3);form1.action='maestablcampo.php';submit();" alt="Primero"></td> 
...
src="../img/ultimo.gif" 
onclick="foo(4);form1.action='maestablcampo.php';submit();" alt="Ultimo"></td> 
        </tr> 
        <tr> 
...
<input type="hidden" name="campcodi" value="<?php echo $campcodi; ?>"> 
<input type="hidden" name="campnomb" value="<?php echo $campnomb; ?>"> 
<input type="hidden" name="campdesc" value="<?php echo $campdesc; ?>"> 
<input type="hidden" name="accionconsultarcampo" value="<?php echo 
$accionconsultarcampo; ?>"> 
