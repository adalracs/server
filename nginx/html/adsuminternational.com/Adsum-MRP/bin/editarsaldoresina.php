...
<html> 
	<head> 
		<title>Editar registro de saldo de resina</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Saldo de resina</font></p> 
...
<?php endif; ?>
			...
			<input type="hidden" name="accioneditarsaldoresina">
