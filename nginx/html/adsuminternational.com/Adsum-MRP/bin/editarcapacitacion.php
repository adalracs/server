...
ob_start();
	...
	if(!$flageditarcapacitacion)
	{
		...
		include 'detallacapacitacion.php';
	}
	$idcon = fncconn();
...
<html> 
	<head> 
		<title>Editar registro de capacitacion</title> 
...
<?php else: ?> 		
				...
				<?php if($sbreg['capacicalifi']) { ?>
				<tr><td><div class="ui-widget">
					<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;"> 
						<p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span> 
						<strong>Advertencia:</strong> La capacitaci&oacute;n ya se encuentra calificada, si realiza cambios en esta capacitaci&oacute;n las calificaciones seran eliminadas</p>
					</div>
				</div></td></tr>
				<?php } ?>	
<?php endif; ?>
				...
				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
 							...
 							<tr>
								<td width="10%" class="NoiseFooterTD"><?php if($campnomb["ubicapcodigo"] == 1){ $cursoubicac = null; echo "*";}?>&nbsp;Ubicacion&nbsp;</td>
            			...
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">
            				<tr>
            					<td>
									...
									<div id="totalhoras">Total tiempo: <?php echo $hor ?> hr. <?php echo $min ?> min. </div>
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
							...
							<!--<tr>
								...
								<b>inicio&nbsp;</b><input type="text" name="curgrufecini" id="curgrufecini"size="15"	value="<?php if(!$flageditarcapacitacion){echo $sbreg[curgrufecini];}else{echo $curgrufecini;}?>"/>
								<b>fin&nbsp;</b><input type="text" name="curgrufecfin" id="curgrufecfin"size="15"	value="<?php if(!$flageditarcapacitacion){echo $sbreg[curgrufecfin];}else{echo $curgrufecfin;}?>"/>
								</td>
							</tr>
							<tr>
								...
								<td width="10%" class="NoiseDataTD">
								<b>inicio&nbsp;</b><input type="text" name="curgruhorini" id="curgruhorini" size="15"	value="<?php if(!$flageditarcapacitacion){echo $sbreg[curgruhorini];}else{echo $curgruhorini;}?>"/>
								<b>fin&nbsp;</b><input type="text" name="curgruhorfin" id="curgruhorfin"  size="15"	value="<?php if(!$flageditarcapacitacion){echo $sbreg[curgruhorfin];}else{echo $curgruhorfin;}?>"/>
								</td>
							</tr>
 							--><tr>
							...
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="capaciobjeti" rows="3" cols="63"><?php if(!$flageditarcapacitacion){ echo $sbreg[capaciobjeti];}else{ echo $capaciobjeti;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
 				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="capacicodigo" value="<?php if(!$flageditarcapacitacion){ echo $sbreg[capacicodigo];}else{ echo $capacicodigo; } ?>"> 
