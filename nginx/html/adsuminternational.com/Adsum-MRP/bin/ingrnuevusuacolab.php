		...
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="2" align="center" class="NoiseFormTABLE" width="60%"> 
				...
				<tr> 
  						...
  						<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">
							...
							<tr>
								...
								?>
          							...
          							<tr class="NoiseErrorDataTD">
            							...
            							<td colspan="3"><input name="usuadocume" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuadocume];}else{ echo $usuadocume;} ?>" size="18"></td>
          							</tr>  
          							<tr>
            							<td class="NoiseFooterTD"><?php if($campnomb["usuanombre"] == 1){ $usuanombre = null; echo "*";}?>&nbsp;Nombre</td>
            							<td class="NoiseFooterTD"><input name="usuanombre" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuanombre];}else{ echo $usuanombre;} ?>" size="18"></td>
            							<td class="NoiseFooterTD"><?php if($campnomb["usuapriape"] == 1){ $usuapriape = null; echo "*";} ?>&nbsp;Apellido</td>
            							<td class="NoiseFooterTD"><input name="usuapriape" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuapriape];}else{ echo $usuapriape;} ?>" size="14"></td>
          							</tr>
          							<tr>
            							<td width="22%" class="NoiseFooterTD"><?php if($campnomb["usuasegape"] == 1){ $usuasegape = null; echo "*";}?>&nbsp;Seg. Apellido</td>
            							<td class="NoiseFooterTD"><input name="usuasegape" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuasegape];}else{ echo $usuasegape;} ?>" size="18"></td>
            							<td class="NoiseFooterTD"><?php if($campnomb["usuatelefo"] == 1){ $usuatelefo = null; echo "*";} ?>&nbsp;Tel&eacute;fono</td>
            							<td class="NoiseFooterTD"><input name="usuatelefo" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuatelefo];}else{ echo $usuatelefo;} ?>" size="14"></td>
          							</tr>
          							<tr>
            							<td class="NoiseFooterTD"><?php if($campnomb["usuatelef2"] == 1){ $usuatelef2 = null; echo "*";} ?>&nbsp;Seg. Tel&eacute;fono</td>
            							<td class="NoiseFooterTD"><input name="usuatelef2" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuatelef2];}else{ echo $usuatelef2;} ?>" size="18"></td>
            							<td class="NoiseFooterTD"><?php if($campnomb["usuavalhor"] == 1){ $usuavalhor = null; echo "*";} ?>&nbsp;Valor hora</td>
            							<td class="NoiseFooterTD"><input name="usuavalhor" type="text" value="<?php if(!$flagnuevousuario){ echo 0;}else{ echo $usuavalhor;} ?>" size="14"></td>
          							</tr>
          							<tr>
							...
							<tr>
          							...
          							<tr>
            							...
            							<td class="NoiseFooterTD"><input name="usuatelcon" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuatelcon];}else{ echo $usuatelcon;} ?>" size="18"></td>
 				...
 				<tr> 
					<td><div align="center"> 
  						<input type="image" name="aceptar"  src="../img/aceptar.gif" onclick="form1.accionnuevousuario.value =  1;"  width="86" height="18" alt="Aceptar" border=0> 
...
<?php if($campnomb){ echo '<font face="Verdana" >Corregir los campos marcados con *</font>';} ?>
			...
			<input type= "hidden" name ="usuacodigo" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuacodigo];} else {echo $usuacodigo;}?>">
