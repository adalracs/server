...
<html> 
<head> 
<title>Borrar registro de Grupo Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionborrargrupcomp.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagborrargrupcomp){ echo $sbreg[grupcodi];}else{ echo $grupcodi; } ?>" 
...
if(!$flagborrargrupcomp){ echo $sbreg[mecocodi];}else{ echo $mecocodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagborrargrupcomp" value="1"> 
<input type="hidden" name="accionborrargrupcomp"> 
