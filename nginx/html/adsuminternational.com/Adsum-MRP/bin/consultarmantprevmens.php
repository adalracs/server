...
<p><font class="NoiseFormHeaderFont">Indice de cumplimiento de mantenimiento</font></p>
<table border="0" cellspacing="1" cellpadding="2" align="center" class="NoiseFormTABLE" width="70%">
	...
	<tr>
		...
		<font color="FFFFFF">Mantenimientos</font></span></td>
	</tr>
	<tr>
		<td><table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="93%" border="0" cellspacing="1" cellpadding="1" align="center">
              <tr class="NoiseFooterTD">
                <td colspan="5" class="NoiseFooterTD">Ubique aqu&iacute; la(s) 
                  planta(s) sobre la que quiera consultar
                  <table width="100%" border="0" cellspacing="1" cellpadding="0"
					align="center">
                        ...
                        <tr>
                          <td height="350" colspan="2" class="NoiseFooterTD"><iframe	src="detallarusuaplantareportes.php?plantall=<?php
							echo $plantatmp; ?>&arrdata=<?php echo $arrplantas;	?>"
							frameborder="0" name="plantas" id="plantagen" height="350" width="100%" 
							align="absmiddle"></iframe></td>
                        </tr>
                    </table>
                  </td>
              </tr>
            ...
            <td><table width="93%" border="0" cellspacing="1" cellpadding="1" align="center">
              <tr class="NoiseFooterTD">
                <td colspan="5" class="NoiseFooterTD">Tipos de trabajo</td>
              </tr>
                      <?php
				$nuConn = fncconn ();
	...
	<tr>
		...
		onclick="form1.action='detallarepomantprevmes.php';" width="86"	height="18" alt="Aceptar" border=0>
&nbsp;<input type="image" src="../img/cancelar.gif" border="0" alt="Cancelar" onClick="form1.action='main.php';"></div>
		</td>
	</tr>
	<tr>
		<td class="NoiseErrorDataTD">&nbsp;</td>
...
<input type="text" name="strdataload" size="1" value=""	style="border: none; color: #FFFFFF;"
	onFocus="sendReq(this.value); this.value=''; this.blur();"> <!-- Data: EQUIPOS|e COMPONETNES|c -->
