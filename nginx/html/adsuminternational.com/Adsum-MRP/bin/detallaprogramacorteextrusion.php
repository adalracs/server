<!--  division contenedora del programa de corte extrusion-->
<?php 
ini_set("display_errors", 1);
	if(!$noAjax)
	{
		//primer nivel
		require_once ( '../src/FunPerPriNiv/pktblprogramacorteextrusion.php');
		...
		require_once ( '../src/FunPerPriNiv/pktblopcorteextrusion.php');
...
<div id="programacorteextrusion">
	...
	<div id="<?php echo $obj_tab ?>" style="height: 350px; margin:0 auto; overflow:auto;">
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include '../src/FunjQuery/jquery.visors/gestionopp/jquery.programacxt.php';
        			break;
    			case "reporteopp":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programacxt.php';
        			break;
    			case "gestionopparte":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programacxt.php';
        			break;
        		...
        		case "gestionopprequisicion":
        			include '../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programacxt.php';
        			break;
        		case "gestionoppanalisispr":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programacxt.php';
        			break;
        		default:
       				include '../src/FunjQuery/jquery.visors/programacion/jquery.programacxt.php';
       				break;
			}
