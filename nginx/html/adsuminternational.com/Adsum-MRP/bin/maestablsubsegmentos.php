...
if($accionborrarsubsegmentos)
{
	include ( 'borrasubsegmentos.php');
}
else
{
	if($accionconsultarsubsegmentos)
	{
...
<html> 
<head> 
<title>Registros de subsegmentos</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de subsegmentos</font><br><br></p> 
...
onclick="form1.action='."'".'ingrnuevsubsegmentos.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarsubsegmentos.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablsubsegmentos.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
 $intervalo = fncaumdec('subsegmentos',$inicio,$fin,$mov,$accionconsultarsubsegmentos,$recarreglo);
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablsubsegmentos.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarsubsegmentos.php'."'".';"  width="87" 
...
onclick="';
   	...
   	else echo 'form1.action='."'".'borrarsubsegmentos.php';
...
onclick="form1.action='."'".'editarsubsegmentos.php'."'".';"  width="87" height="19"  
...
<td width="15%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Segmento</font></span></td>
<td width="30%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Subsegmento</font></span></td>  
</tr> 
<?php 
include ( '../src/FunGen/sesion/fncvisregsubsegmentos.php');
$reg[0] = 'subsegcodigo';
$reg1[0] = 'n';
$nureturn = fncvisregsubsegmentos('subsegmentos', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?>
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablsubsegmentos.php';" 
alt="Primero"></td> 
...
'menos';form1.action='maestablsubsegmentos.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablsubsegmentos.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
...
subsegdescri
"> 
 <input type="hidden" name="subsegcodigo" value="<?php echo $subsegcodigo; ?>"> 
 <input type="hidden" name="subsegmencod" value="<?php echo $subsegmencod; ?>"> 
 <input type="hidden" name="subsegnombre" value="<?php echo $subsegnombre; ?>"> 
 <input type="hidden" name="subsegdescri" value="<?php echo $subsegdescri; ?>"> 
 <input type="hidden" name="accionconsultarsubsegmentos" value="<?php echo 
$accionconsultarsubsegmentos; ?>"> 
...
<input type="hidden" name="selcampos" value="subsegcodigo,subsegnombre">
<!--											-->
