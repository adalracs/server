...
if($accionborrarpriorida)
{
	include ( 'borrapriorida.php');
}
else
{
	if($accionconsultarpriorida)
	{
...
$intervalo = fncaumdec('priorida',$inicio,$fin,$mov,$accionconsultarpriorida,$recarreglo);
...
<html> 
<head> 
<title>Registros de prioridad</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de prioridades</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablpriorida.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevpriorida.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarpriorida.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablpriorida.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablpriorida.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarpriorida.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarpriorida.php';
...
onclick="form1.action='."'".'editarpriorida.php'."'".';"  width="87" 
...
$reg[0] = 'prioricodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('priorida', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablpriorida.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablpriorida.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
	        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablpriorida.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablpriorida.php',$flagcheck); ?></td> 
  </tr> 
 ...
 <input type="hidden" name="nombtabl" value="priorida"> 
<input type="hidden" name="columnas" value="prioricodigo, 
priorinombre, 
prioridescri 
"> 
 <input type="hidden" name="prioricodigo" value="<?php echo $prioricodigo; ?>"> 
 <input type="hidden" name="priorinombre" value="<?php echo $priorinombre; ?>"> 
 <input type="hidden" name="prioridescri" value="<?php echo $prioridescri; ?>"> 
 <input type="hidden" name="accionconsultarpriorida" value="<?php echo 
$accionconsultarpriorida; ?>"> 
...
<input type="hidden" name="selcampos" value="prioricodigo, priorinombre">
<!--											-->
