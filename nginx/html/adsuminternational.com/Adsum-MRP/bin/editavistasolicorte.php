...
for($a = 0;$a < $nr_op;$a++){
	...
	$iRegopcorte[ordprocalib] = $$obj_calibre;
	$iRegopcorte[ordprocantid] = $$obj_cant_kg;
	$iRegopcorte[ordproanchop] = $$obj_ancho;
	$iRegopcorte[ordproanchom] = $ancho;
	$iRegopcorte[ordpropista] = $nropistas;
	$iRegopcorte[ordprometros] = $$obj_cant_mt;	
...
//desconectar
$flageditarvistasolicorte = 1;
fncclose($idcon);
fncmsgerror(editaEx);
echo '<script language="javascript">';
echo '<!--//'."\n";
echo 'location ="maestablvistasolicorte.php?codigo='.$codigo.';"';
echo '//-->'."\n";
echo '</script>';
?>