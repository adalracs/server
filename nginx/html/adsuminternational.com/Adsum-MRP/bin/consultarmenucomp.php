...
<html> 
<head> 
<title>Consultar en Menu Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionconsultarmenucomp.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
color="669999"><b><font size="3" face="Arial, Helvetica, sans-serif"> <font color="#006699">Consulta 
...
if(!$flagconsultarmenucomp){ echo $sbreg[mecocodi];}else{ echo $mecocodi; } 
?>">
                  </td>
                </tr>
                <tr> 
...
if(!$flagconsultarmenucomp){ echo $sbreg[mecocopa];}else{ echo $mecocopa;} ?>">
                  </td>
                </tr>
                <tr> 
                  <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagconsultarmenucomp){ echo $sbreg[mecoorde];}else{ echo $mecoorde;} ?>">
                  </td>
                </tr>
                <tr> 
                  <td width="41%"><font size="2" face="Arial, Helvetica, 
sans-serif">Código tipo de comp</font></td>
                  <td width="59%"> 
                    <select name="timecodi" onChange="submit();">
                    </select>
                  </td>
                </tr>
                <tr> 
...
if(!$flagconsultarmenucomp){ echo $sbreg[meconomb];}else{ echo $meconomb;} ?>">
                  </td>
                </tr>
                <tr> 
                  <td width="41%"><font size="2" face="Arial, Helvetica, 
...
rows="3"><?php if(!$flagconsultarmenucomp){echo $sbreg[mecoscri];}else{ echo 
$mecoscri;} ?></textarea>
                  </td>
                </tr>
                <tr> 
...
if(!$flagconsultarmenucomp){ echo $sbreg[mecoacra];}else{ echo $mecoacra;} ?>">
                  </td>
                </tr>
              </table>
            </td>
...
height="18" alt="Aceptar" border=0>
                <input type="image" src="../img/cancelar.gif" 
...
<input type="hidden" name="flagconsultarmenucomp" value="1"> 
<input type="hidden" name="accionconsultarmenucomp"> 
...
<input type="hidden" name="columnas" value="mecocodi, 
mecocopa, 
mecoorde, 
timecodi, 
meconomb, 
