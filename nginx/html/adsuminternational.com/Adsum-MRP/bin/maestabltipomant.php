...
if($accionborrartipomant)
{
	include ( 'borratipomant.php');
}
else
{
	if($accionconsultartipomant)
	{
...
$intervalo = fncaumdec('tipomant',$inicio,$fin,$mov,$accionconsultartipomant,$recarreglo);
...
<html> 
<head> 
<title>Registros de tipo de mantenimiento</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de tipos de mantenimientos</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipomant.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevtipomant.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultartipomant.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipomant.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestabltipomant.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallartipomant.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrartipomant.php';
...
onclick="form1.action='."'".'editartipomant.php'."'".';"  width="87" 
...
$reg[0] = 'tipmancodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('tipomant', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestabltipomant.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipomant.php';" 
alt="Anterior"></td>
   <td width="50">
<?php 
	        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestabltipomant.php';" alt="Ultimo"></td> 
  </tr>
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipomant.php',$flagcheck); ?></td>  
  </tr> 
 ...
 <input type="hidden" name="nombtabl" value="tipomant"> 
<input type="hidden" name="columnas" value="tipmancodigo, 
tipmannombre, 
tipmandescri
"> 
 <input type="hidden" name="tipmancodigo" value="<?php echo $tipmancodigo; ?>"> 
 <input type="hidden" name="tipmannombre" value="<?php echo $tipmannombre; ?>"> 
 <input type="hidden" name="tipmandescri" value="<?php echo $tipmandescri; ?>"> 
 <input type="hidden" name="accionconsultartipomant" value="<?php echo
$accionconsultartipomant; ?>"> 
...
<input type="hidden" name="selcampos" value="tipmancodigo, tipmannombre">
<!--											-->
