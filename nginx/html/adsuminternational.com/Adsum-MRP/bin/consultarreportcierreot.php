...
<html> 
	<head>
		<title>Consultar en cierre orden de trabajo</title> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="800">
  				...
  				<tr>
					<td>
       					<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
       						...
       						<tr>
          						<td class="NoiseFooterTD">&nbsp;Fecha de cierre</td>
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
							<tr>
								<td class="NoiseFooterTD" width="20%">&nbsp;Fecha de inicio</td>
								<td class="NoiseDataTD" width="30%"><input type="text" name="ordtrafecini" id="ordtrafecini" size="8"></td>
								<td class="NoiseFooterTD" width="24%">&nbsp;Fecha estimada a finalizar</td>
...
<!--				</tr>-->
 			...
 			<input type="hidden" name="flagconsultarreportcierreot" value="1"> 
			<input type="hidden" name="accionconsultarreportcierreot"> 
  			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar"> 
			<input type="hidden" name="cierothorfin"> 
