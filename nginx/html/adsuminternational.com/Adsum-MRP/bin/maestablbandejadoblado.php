...
ini_set('display_errors',1);
	...
	//conexion
	$idcon = fncconn();
	$rs_equipo = fullscanprogramadobladodisctequipo($idcon);
	...
	for($a = 0;$a < $nr_equipo;$a++)
	{
		...
		if($equipo)
			$rs_opp = dinamicscanopprogramadoblado1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
...
<html>
	<head>
		<title>Bandeja de solicitudes doblado</title>
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<p><font class="NoiseFormHeaderFont">{Doblado}</font></p>			
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
									<tr>
										<td>
											<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
												<tr>
		  											<td class="ui-state-default">&nbsp;&nbsp;op de doblado
						       							<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
						       								<tr>
																<td class="NoiseFooterTD">
																	<div id="detallebandejadoblado" style="height: 350px; margin:0 auto; overflow:auto;">
																		<?php $noAjax = true;include 'detallabandejadoblado.php'; ?>
																	</div>
																</td>
															</tr>
						                   				</table>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[nuevo] && !$flagcheck)
										echo '<button id="generaropp_dbl">Generar [opp]</button>&nbsp';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
													...
													<tr>
			  											<td class="ui-state-default">&nbsp;&nbsp;
							        						<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
							        							<tr>
																	<td class="NoiseFooterTD">
																		<div id="detalleordendoblado" style="height: 350px; margin:0 auto; overflow:auto;">
																			<?php $noAjax = true;include 'detallaordendoblado.php'; ?>
																		</div>
																	</td>
																</tr>
							                   				</table>						                   				
								...
								<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
									<?php  		
										if($reccomact[modificar] && !$flagcheck)
											echo '<button id="editaropp_dbl">Editar [opp]</button>';
									?>
								</div></td>
							</tr>
							<tr><td>&nbsp;</td></tr> 
