...
ob_start(); 
	...
	if($accionborraritemestado) 
		include ( 'borraitemestado.php'); 
	else 
	{ 
		if($accionconsultaritemestado) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultaritemestado = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('itemestado',$inicio,$fin,$mov,$accionconsultaritemestado,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de estado de item</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de estados de item</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablitemestado.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'itestacodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('itemestado', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="itemestado"> 
			...
			<input type="hidden" name="selcampos" value="itestacodigo, itestanombre">
			<!--											-->
