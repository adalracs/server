...
if($accionnuevoclaseusuario) { 
	include ( 'grabaclaseusuario.php'); 
} 
?> 
...
<html> 
<head> 
<title>Nuevo registro de claseusuario</title> 
	...
	<tr> 
		...
		<table width="95%" border="0" cellspacing="1" cellpadding="1" align="center"> 
			...
			<tr> 
				...
				<td width="59%"> 
				<input type="text" name="clausucodigo"	value="<?php if(!$flagnuevoclaseusuario){ echo $sbreg[clausucodigo];}else{ echo $clausucodigo; }?>"> 
				</td> 
			</tr> 
			<tr> 
				<td width="41%" class="NoiseFooterTD"> 
				...
				<td width="59%"> 
				<input type="text" name="clausunombre"	value="<?php if(!$flagnuevoclaseusuario){ echo $sbreg[clausunombre];}else{ echo $clausunombre; }?>"> 
				</td> 
			</tr> 
			<tr> 
				<td width="41%" class="NoiseFooterTD"> 
				...
				<td width="59%"> 
				<input type="text" name="clausudescri"	value="<?php if(!$flagnuevoclaseusuario){ echo $sbreg[clausudescri];}else{ echo $clausudescri; }?>"> 
				</td> 
			</tr> 
		</table> 
		</td> 
...
?> 
<input type="hidden" name="clausucodigo" value="<?php if(!$flagnuevoclaseusuario){ echo $sbreg[clausucodigo];}else{ echo $clausucodigo; } ?>"> 
<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
<input type="hidden" name="sourceaction" value="nuevo"> 
<input type="hidden" name="accionnuevoclaseusuario"> 
