<?php 
	...
	if($accioncalificarproducto)
		include ( 'calificaproducto.php');
	
	if(!$flagcalificarproducto) 
	{ 
		...
		//nota hay que asignar la varible calificar_ si esta en venta de calificar. 
...
<html> 
	<head> 
		<title>calificar registro de producto</title> 
...
<?php if (! $codigo) echo "<!--"; ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post" enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Calificar &Iacute;tem</font></p> 
...
<?php endif; ?>
				...
				<tr><td class="ui-widget-header"><span class="style5"><font color="FFFFFF"> calificar registro</font></span></td></tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						...
						<div id="tabitems">
							...
							<?php include '../src/FunjQuery/jquery.tabs/items/jquery.itemgeneral.cal.php' ?>
							<?php if($tipevecodigo != 3){?>
								<?php if($tipitecodigo == 1) include '../src/FunjQuery/jquery.tabs/items/jquery.bolsaflowpack.cal.php' ?>
								<?php if($tipitecodigo == 2) include '../src/FunjQuery/jquery.tabs/items/jquery.bolsalateral.cal.php' ?>
								<?php if($tipitecodigo == 3) include '../src/FunjQuery/jquery.tabs/items/jquery.bolsapouchdoypack.cal.php' ?>
								<?php if($tipitecodigo == 4) include '../src/FunjQuery/jquery.tabs/items/jquery.bolsapouchlateral.cal.php' ?>
								<?php if($tipitecodigo == 5) include '../src/FunjQuery/jquery.tabs/items/jquery.capuchon.cal.php' ?>
								<?php if($tipitecodigo == 6) include '../src/FunjQuery/jquery.tabs/items/jquery.lamina.cal.php' ?>
							<?php }else{?>
			...
			<input type="hidden" name="modulocodigo" id="modulocodigo" value="2"><!-- modulo de ventas -->
			...
			<input type="hidden" name="accioncalificarproducto">
			<input type="hidden" name="produccodigo" id="produccodigo" value="<?php if(!$accioncalificarproducto){echo $sbreg['produccodigo'];}else{echo $produccodigo;} ?>" />
			<input type="hidden" name="pedvencodigo" value="<?php if(!$flagcalificarproducto){ echo $sbreg[pedvencodigo];}else{ echo $pedvencodigo; }?>">  
			...
			<input type="hidden" name="arrRatings" id="arrRatings" value="<?php echo $arrRatings ?>" />
			<input type="hidden" name="sourceaction" id="sourceaction" value="calificar"> 
