	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">			
			<div style="height: 450px;">
				<?php $noAjax = true;include 'detallaprogramaflexo.php'; ?>
			</div>
			<table width="100%" align="center" cellpadding="1" cellspacing="1">
									...
									<td class="ui-state-default">&nbsp;&nbsp;<?php echo cargaequiponombre($equipo,$idcon) ?>
										<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
											<tr>
												...
												<td width="10%"  class="NoiseDataTD">&nbsp;<span id="total_und_lbl"><?php echo number_format($$total_equipound, 0, ',', '.') ?></span></td>
												<td width="15%"  class="NoiseFooterTD">&nbsp;<b>Total Kilogramos.</b></td>
												<td width="10%"  class="NoiseDataTD">&nbsp;<span id="total_kgs_lbl"><?php echo number_format($$total_equipokgs, 0, ',', '.') ?></span></td>
												<td width="15%"  class="NoiseFooterTD">&nbsp;<b>Total Metros.</b></td>
												<td width="10%"  class="NoiseDataTD">&nbsp;<span id="total_mts_lbl"><?php echo number_format($$total_equipomts, 0, ',', '.') ?></span></td>
											</tr>
										</table>
									</td>
								</tr>
				...
				<tr>
					<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
						<button id="editarprograma_flx">Editar programa</button>
					</div></td>
				</tr>
				<tr><td>&nbsp;</td></tr> 
			</table>
