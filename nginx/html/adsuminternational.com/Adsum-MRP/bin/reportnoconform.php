...
<BR />
<?php 
include("../src/FunGen/fnccalcnoconform.php");
ob_start();
fnccalcnoconform($fecini, $fecfin);
...
onclick="window.open('detallanoconformprint.php','printReport','status=no,menubar=no,scrollbars=yes,resizable=yes,left=600,width=600,height=500'); return false;"  width="86" height="18" alt="Aceptar"
border=0>
</div>
</form>
</body>
