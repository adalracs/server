...
if($accionborrartransitemtemp)
{
	include ( 'borratransitemtemp.php');
}
else
{
	if($accionconsultartransitemtemp)
	{
		...
		if(!$nusw){
			$accionconsultartransitemtemp = 0;
		}
	}
}
...
<html> 
<head> 
<title>Registros de transitemtemp</title> 
...
Entrada/Salida Items Temporales</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestabltransitemtemp.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
  $intervalo = fncaumdec
  ('transitemtemp',$inicio,$fin,$mov,$accionconsultartransitemtemp,$recarreglo);
...
onclick="form1.mov.value = 'mas';form1.action='maestabltransitemtemp.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallartransitemtemp.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
   }
   if($reccomact[borrar]){
   	echo '<b><input type="image" name="borrar"  src="../img/borrar.gif"
onclick="form1.action='."'".'borrartransitemtemp.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editartransitemtemp.php'."'".';"  width="87" 
...
*/
$nureturn = fncvisreg('transitemtemp',$reg,$reg1,$idtrans,$arr_borrar,$flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestabltransitemtemp.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestabltransitemtemp.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestabltransitemtemp.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
...
usuacodi 
"> 
 <input type="hidden" name="traitempcodigo" value="<?php echo $traitempcodigo; 
?>"> 
 ...
 <input type="hidden" name="traitempfecha" value="<?php echo $traitempfecha; 
?>"> 
 <input type="hidden" name="traitempcantid" value="<?php echo $traitempcantid; 
?>"> 
 <input type="hidden" name="traitemptotal" value="<?php echo $traitemptotal; 
?>"> 
 <input type="hidden" name="usuacodi" value="<?php echo $usuacodi; ?>"> 
 <input type="hidden" name="accionconsultartransitemtemp" value="<?php echo 
$accionconsultartransitemtemp; ?>"> 
