...
<html> 
<head> 
<title>Borrar registro de claseusuario</title> 
...
<input type="hidden" name="flagborrarclaseusuario" value="1"> 
<input type="hidden" name="accionborrarclaseusuario"> 
