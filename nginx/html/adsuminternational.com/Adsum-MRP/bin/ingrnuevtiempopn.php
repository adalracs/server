...
ob_start(); 
	...
	if($accionnuevotiempopn)
		include ( 'grabatiempopn.php');
...
<html> 
	<head> 
		<title>Nuevo registro tiempo pn</title> 
...
<?php endif; ?> 
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center"> 
 							<tr>
								...
								<td width="75%" class="NoiseDataTD"><input type="text" name="tiemponombre" size="30"	value="<?php if(!$flagnuevotiempopn){ echo $sbreg[tiemponombre];}else {echo $tiemponombre; }?>"></td>
 							</tr>
 							<tr>
							...
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="tiempodescri" rows="3" cols="63"><?php if(!$flagnuevotiempopn){ echo $sbreg[tiempodescri];}else{ echo $tiempodescri;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accionnuevotiempopn">  
