...
ob_start();
	...
	if($accionborrarclasifallelec)
		include ( 'borraclasifallelec.php');
	else
	{
		if($accionconsultarclasifallelec)
		{
			$nusw = 0;
			...
			if(!$nusw)
				$accionconsultarclasifallelec = 0;
		}
	}
	include ( '../src/FunGen/sesion/fncaumdec.php');
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('clasifallelec',$inicio,$fin,$mov,$accionconsultarclasifallelec,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de clasificacion fallas electricas</title> 
...
<?php if(!$codigo){ echo "<!--";} ?> 
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de clasificaci&oacute;n de fallas el&eacute;ctricas</font></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550"> 
 				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablclasifallelec.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
 				...
 				<tr> 
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								<td width="8%" class="ui-state-default">Sel.</td> 
								<td width="10%" class="ui-state-default">C&oacute;digo</td> 
								<td width="40%" class="ui-state-default">Nombre</td> 
								<td width="21%" class="ui-state-default">&Delta;1 (O/S)</td> 
								<td width="21%" class="ui-state-default">&Delta;2 (O/A)</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregclasifallelec.php');
								$reg[0] = 'cfalelcodigo';
								$reg1[0] = 'n';
								$nureturn = fncvisreg('clasifallelec', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="fin" value="<?php echo $intervalo[fin]; ?>">
  			<input type="hidden" name="sourcetable" value="clasifallelec"> 
			...
			<input type="hidden" name="columnas" value="cfalelcodigo,cfalelnombre,cfaleldescri,cfalelhcolor"> 
 			<input type="hidden" name="cfalelcodigo" value="<?php if($accionconsultarclasifallelec) echo $cfalelcodigo; ?>"> 
			...
			<input type="hidden" name="selcampos" value="cfalelcodigo, cfalelnombre">
			<!--											-->
