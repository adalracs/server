...
onclick="form1.action='."'".'consultaritemproveedo.php'."'".';"  width="86" 
height="18" alt="Consultar" border=0>';
?> 
 </td> 
 <td width="42"> 
  <input type="image" name="adelanta"  src="../img/adelanta.gif" 
onclick="cargarcheck(this.form); form1.mov.value = 'menos';form1.action='maestablitemproveedo.php';" alt="Anterior"></td> 
...
onclick="cargarcheck(this.form); form1.mov.value = 'mas';form1.action='maestablitemproveedo.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="cargarcheck(this.form); form1.mov.value = 'primero';form1.action='maestablitemproveedo.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="cargarcheck(this.form); form1.mov.value = 'menos';form1.action='maestablitemproveedo.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php  
...
onclick="cargarcheck(this.form); form1.mov.value = 'ultimo';form1.action='maestablitemproveedo.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
