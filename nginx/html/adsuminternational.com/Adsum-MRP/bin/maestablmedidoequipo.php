...
ob_start(); 
	...
	if($accionborrarmedidoequipo) 
		include ( 'borramedidoequipo.php'); 
	else 
	{ 
		if($accionconsultarmedidoequipo) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarmedidoequipo = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('medidoequipo',$inicio,$fin,$mov,$accionconsultarmedidoequipo,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de medidores por equipo</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de medidores por equipo</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablmedidoequipo.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="60%" class="ui-state-default">Equipo</td> 
								<td width="25%" class="ui-state-default">Tipo Medidor</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregmedidoequipo.php'); 
								$reg[0] = 'medequcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregmedidoequipo('medidoequipo', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="medidoequipo"> 
			...
			<input type="hidden" name="selcampos" value="medequcodigo">
			<!--											-->
