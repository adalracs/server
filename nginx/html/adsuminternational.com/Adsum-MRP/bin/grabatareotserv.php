<?php
	...
	if(!$nota || !$clientfecsol || !$otestacodigo){
		...
		if($datedif < 0){
			echo '<SCRIPT LANGUAGE="JavaScript">alert("Error:\n La fecha de registrada debe ser mayor a la fecha de carga");</script>';
			$flagnuevotareot=1;
		}else{
			$idcoon = fncconn();
			...
			$iRegtareot[usuacodi] = $GLOBALS['usuacodi']; 
			...
			echo 'location = "maestabltareotserv.php?codigo='.$codigo.'";';
			echo '//-->'."\n";
			echo '</script>';
		}
	}
