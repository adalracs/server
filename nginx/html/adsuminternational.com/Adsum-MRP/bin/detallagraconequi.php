...
<html>
	<head>
		...
		<script type="text/javascript">
			swfobject.embedSWF("../src/FunChart/open-flash-chart.swf", "graph_data", "1000", "450", "9.0.0", "expressInstall.swf", {"data-file":"../src/FunChart/ofc.graph.charts/ofc.graconequi.php?parameter=<?php echo $medequcodigo ?>[::]<?php echo $consulfecini ?>[::]<?php echo $consulfecfin ?>","loading":"Escribiendo la grafica..."},false);
		</script>
		<script type="text/javascript">
			OFC = {};
	...
	<body bgcolor="FFFFFF" text="#000000">
		<p><font class="NoiseFormHeaderFont">Grafica  Consumo de Equipo</font></p>
