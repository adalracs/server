...
include ('../src/FunPerPriNiv/pktblvistasolidoblado.php');
...
if ($accionborrarvistasolidoblado) { 
	include ('borravistasolidoblado.php'); 
} else { 
	if ($accionconsultarvistasolidoblado) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistasolidoblado = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistasolidoblado', $inicio, $fin, $mov, $accionconsultarvistasolidoblado, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de solicitud de programacion de doblado</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de solicitudes de programacion [Doblado]</font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablvistasolidoblado.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistasolidoblado.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistasolidoblado ( 'vistasolidoblado', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistasolidoblado"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistasolidoblado"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistasolidoblado) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistasolidoblado"	value="<?php echo $accionconsultarvistasolidoblado; ?>"> 
