...
ob_start();
	...
	//evento para el array de maquinas para programa de corte extrusion
	//conexion
	$idcon = fncconn();
	//sql para traer los equipos necesarios en el  tab programa de corte extrusion
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<div style="height: 450px;">
				<?php $noAjax = true;include 'detallaprogramacorteextrusion.php'; ?>
			</div>
			<table width="100%" align="center" cellpadding="1" cellspacing="1">
				...
				<tr>
					<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
						<button id="editarprograma_cxt">Editar programa</button>
					</div></td>
				</tr>
				<tr><td>&nbsp;</td></tr> 
			</table>
