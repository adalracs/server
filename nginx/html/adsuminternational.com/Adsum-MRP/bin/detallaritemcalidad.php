	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
            			...
            			<table width="95%" border="0" cellspacing="1" cellpadding="1" align="center"> 
							...
							<tr> 
 							...
 							<tr> 
 							 ...
 							 <tr> 
 								<td class="NoiseFooterTD">&nbsp;Plan Inspecci&oacute;n</td> 
  								<td class="NoiseDataTD"><?php echo ($sbreg["tipitemnombre"])? carganombretipoitemdesa($sbreg["tipitemnombre"],$idcon): "---" ; ?></td> 
 							</tr> 
 							<tr> 
 								<td class="NoiseFooterTD">&nbsp;Especificaci&oacute;n</td> 
  								<td class="NoiseDataTD"><?php echo ($sbreg["itedesespeci"])? $sbreg["itedesespeci"] : "---" ; ?></td> 
 							</tr> 
						</table> 
					</td>
				</tr>
 			...
 			<input type="hidden" name="flagdetallaritemcalidad" value="1"> 
			<input type="hidden" name="acciondetallaritemcalidad">
			...
			<input type="hidden" name="itedescodigo" value="<?php if($accionconsultaritemcalidad) echo $itedescodigo; ?>"> 
 			...
 			<input type="hidden" name="accionconsultaritemcalidad" value="<?php echo $accionconsultaritemcalidad; ?>">
		</form> 
	</body> 
<?php if(!$codigo){ echo " -->"; } ?> 
</html>