...
if($accionborrarreporotherramie) 
{ 
	include ( 'borrareporotherramie.php'); 
} 
else 
{ 
		if($accionconsultarreporotherramie) 
			{ 
				...
				if(!$nusw){ 
					$accionconsultarreporotherramie = 0; 
				} 
			} 
	} 
...
<html> 
<head> 
<title>Registros de reporotherramie</title> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablreporotherramie.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec ('reporotherramie',$inicio,$fin,$mov,$accionconsultarreporotherramie,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablreporotherramie.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarreporotherramie.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarreporotherramie.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarreporotherramie.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'rephercodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('reporotherramie',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
'primero';form1.action='maestablreporotherramie.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablreporotherramie.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 
'ultimo';form1.action='maestablreporotherramie.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
 ...
 <input type="hidden" name="nombtabl" value="reporotherramie"> 
<input type="hidden" name="columnas" value="rephercodigo, 
reportcodigo, 
transhercodigo 
"> 
 <input type="hidden" name="rephercodigo" value="<?php echo $rephercodigo; ?>"> 
...
?>"> 
 <input type="hidden" name="accionconsultarreporotherramie" value="<?php echo 
$accionconsultarreporotherramie; ?>"> 
