...
ini_set('display_errors',1);
	...
	{ 
		...
		for( $a = 0; $a < $nrRequisicionItemDesa; $a++)
		{
			...
			$obj_reqitecantre = $rwRequisicionItemDesa["itedescodigo"];
 									...
 									<div id="seccionRecRequisicion">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
											...
											<tr>
												...
												<td width="15%" class="NoiseFooterTD cont-field-b">&nbsp;<?php echo number_format($$obj_reqitecantre, 2, ",", "."); ?></td>
											</tr>	
											<?php
