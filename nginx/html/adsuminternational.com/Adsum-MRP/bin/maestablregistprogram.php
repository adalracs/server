...
if($accionborrarregistprogram) 
{ 
	include ( 'borraregistprogram.php'); 
} 
else 
{ 
		if($accionconsultarregistprogram) 
			{ 
//				include ( '../src/FunGen/sesion/fncalmdatc.php'); 
				...
				if(!$nusw){ 
					$accionconsultarregistprogram = 0; 
				} 
			} 
	} 
...
<html> 
<head> 
<title>Registros de registprogram</title> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablregistprogram.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('registprogram',$inicio,$fin,$mov,$accionconsultarregistprogram,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablregistprogram.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarregistprogram.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarregistprogram.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarregistprogram.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'regprocodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('registprogram',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablregistprogram.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablregistprogram.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablregistprogram.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="registprogram"> 
<input type="hidden" name="columnas" value="regprocodigo, 
progracodigo, 
regprovalor, 
regprofecha, 
regprohora, 
regpronota 
"> 
 <input type="hidden" name="regprocodigo" value="<?php echo $regprocodigo; ?>"> 
 <input type="hidden" name="progracodigo" value="<?php echo $progracodigo; ?>"> 
 <input type="hidden" name="regprovalor" value="<?php echo $regprovalor; ?>"> 
 <input type="hidden" name="regprofecha" value="<?php echo $regprofecha; ?>"> 
 <input type="hidden" name="regprohora" value="<?php echo $regprohora; ?>"> 
 <input type="hidden" name="regpronota" value="<?php echo $regpronota; ?>"> 
 <input type="hidden" name="accionconsultarregistprogram" value="<?php echo 
$accionconsultarregistprogram; ?>"> 
