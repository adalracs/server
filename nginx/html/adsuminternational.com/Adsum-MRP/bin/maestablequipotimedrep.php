...
onclick="form1.action='."'".'consultarequipotimedrep.php'."'".';"  width="86" 
...
onclick="form1.mov.value = 'menos'; form1.action='maestablequipotimedrep.php';" alt="Anterior"></td> 
...
onclick="form1.mov.value = 'mas'; form1.action='maestablequipotimedrep.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
<?php
	include ( '../src/FunGen/sesion/fncvisregequipotimedrep.php');
	$reg[0] = 'equipocodigo';
	$reg1[0] = 'n';
	$nureturn = fncvisregequipotimedrep('equipo',$reg,$reg1,$idtrans);
?>
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero'; form1.action='maestablequipotimedrep.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 'menos'; form1.action='maestablequipotimedrep.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo'; form1.action='maestablequipotimedrep.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
