...
ini_set('display_errors',1);
	...
	if($accionborrardesperdiciopn) 
		include ( 'borratipotiempopn.php'); 
	else 
	{ 
		if($accionconsultartipotiempopn) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultartipotiempopn = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('tipotiempopn',$inicio,$fin,$mov,$accionconsultartipotiempopn,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de tipos de tiempo pn </title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de tipos de tiempo pn</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipotiempopn.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'tiptiecodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('tipotiempopn', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="tipotiempopn"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="tipotiempopn"> 
			<input type="hidden" name="columnas" value="tiptiecodigo,tiptienombre,tiptiedescri, tipsolcodigo"> 
			...
			<input type="hidden" name="selcampos" value="tiptiecodigo">
			<!--											-->
