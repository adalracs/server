...
size="3"><b><font color="#006699">Detallar Categoria</font></b></font></td>
        </tr>
        <tr>
...
<td width="59%">
<input type="text" name="categocodigo" value="<?php
if(!$flagdetallarcategoria){ echo $sbreg[categocodigo];}else{ echo
$categocodigo; } ?>" onFocus="if (!agree)this.blur();" >
</td>
</tr>
<tr>
 <td width="41%"><font size="2" face="Arial, Helvetica, sans-serif">Nombre</font></td>
  <td width="59%">
   <input type="text" name="categonombre" value="<?php
if(!$flagdetallarcategoria){ echo $sbreg[categonombre];}else{ echo
$categonombre;} ?>" onFocus="if (!agree)this.blur();" >
  </td>
 </tr>
<tr>
 <td width="41%"><font size="2" face="Arial, Helvetica, sans-serif">Descripci&oacute;n</font></td>
 <td width="59%" rowspan="2">
  <textarea name="categodescri" cols="24" wrap="VIRTUAL" rows="3" onFocus="if
(!agree)this.blur();" ><?php if(!$flagdetallarcategoria){ echo
$sbreg[categodescri];}else{ echo $categodescri;} ?></textarea>
 </td>
 </tr>
<tr>
  <td>&nbsp;</td>
...
height="18" alt="Aceptar" border=0></div></td>
 ...
 <input type="hidden" name="flagdetallarcategoria" value="1">
<input type="hidden" name="acciondetallarcategoria">
