...
ob_start(); 
	...
	if($accionconsultaritemfinanciero) 
	{ 
		$nusw = 0; 
		...
		if(!$nusw)
			$accionconsultaritemfinanciero = 0; 
	} 

	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('itemdesa',$inicio,$fin,$mov,$accionconsultaritemfinanciero,$recarreglo); 
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablitemfinanciero.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="45%" class="ui-state-default">Grupo gerencial</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregitemfinanciero.php'); 
								$reg[0] = 'itedescodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregitemfinanciero('itemdesa', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="itemfinanciero"> 
