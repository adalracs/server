...
<html> 
	<head> 
		<title>Detalle registro de proveedor</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="acciondetallarproveedo1">
			<input type="hidden" name="flagdetallarproveedo1" value="1">
