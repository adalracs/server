...
ob_start(); 
	...
	if($accionborrargrupcapa) 
		include ( 'borragrupcapa.php'); 
	else 
	{ 
		if($accionconsultargrupcapa) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultargrupcapa = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('grupcapa',$inicio,$fin,$mov,$accionconsultargrupcapa,$recarreglo); 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de grupos</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablgrupcapa.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'grucapcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('grupcapa', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="nombtabl" value="grupcapa"> 
			...
			<input type="hidden" name="selcampos" value="grucapcodigo">
			<!--											-->
