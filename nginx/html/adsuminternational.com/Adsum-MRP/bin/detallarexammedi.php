...
<html> 
<head> 
<title>Detalle de registro de exammedi</title> 
...
echo $sbreg[examedperiod];} else {echo $examedperiod;}?>" size="15" onFocus="if (!agree)this.blur();">&nbsp;&nbsp;d&iacute;as</td>
              </tr>
              <tr>
...
alt="Aceptar" border=0> 
 ...
 <input type="hidden" name="flagdetallarexammedi" value="1"> 
<input type="hidden" name="acciondetallarexammedi"> 
