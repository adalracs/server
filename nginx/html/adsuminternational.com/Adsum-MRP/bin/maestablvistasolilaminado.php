...
include ('../src/FunPerPriNiv/pktblvistasolilaminado.php');
...
if ($accionborrarvistasolilaminado) { 
	include ('borravistasolilaminado.php'); 
} else { 
	if ($accionconsultarvistasolilaminado) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistasolilaminado = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistasolilaminado', $inicio, $fin, $mov, $accionconsultarvistasolilaminado, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de solicitud de programacion de laminacion</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de solicitudes de programacion [Laminado]</font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablvistasolilaminado.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistasolilaminado.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistasolilaminado ( 'vistasolilaminado', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistasolilaminado"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistasolilaminado"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistasolilaminado) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistasolilaminado"	value="<?php echo $accionconsultarvistasolilaminado; ?>"> 
