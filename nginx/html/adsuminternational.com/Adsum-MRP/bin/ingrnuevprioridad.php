...
if($accionnuevoprioridad) 
{ 
	include ( 'grabaprioridad.php'); 
} 
ob_end_flush(); 
?> 
...
<html> 
<head> 
<title>Nuevo registro de prioridad</title> 
...
echo "*";}?>Nombre</td> 
 <td width="59%"> 
  <input type="text" name="priorinombre"	value="<?php if(!$flagnuevoprioridad){ 
echo $sbreg[priorinombre];}else{ echo $priorinombre; }?>"> 
 </td> 
 </tr> 
<tr> 
...
echo "*";}?>Descripci&oacute;n</td> 
 <td width="59%"> 
  <textarea name="prioridescri"	cols="24" wrap="VIRTUAL" rows="3"><?php if(!$flagnuevoprioridad){ 
...
onclick="form1.accionnuevoprioridad.value =  1;"  width="86" height="18" 
...
*</font>';} 
?> 
<input type="hidden" name="prioricodigo" value="<?php if(!$flagnuevoprioridad){ 
echo $sbreg[prioricodigo];}else{ echo $prioricodigo; } ?>"> 
<input type="hidden" name="accionnuevoprioridad"> 
