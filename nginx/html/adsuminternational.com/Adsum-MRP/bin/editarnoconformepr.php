<?php 
	...
	if($accioneditarnoconformepr) 
	{ 
		include ( 'editanocomformepr.php'); 
		$flageditarnocomformepr = 1;
	}


	if(!$flageditarnocomformepr)
	{
...
<html> 
	<head> 
		<title>Editar registro de no conforme</title> 
...
<?php endif; ?>
 				...
 				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center"> 
            				<tr>
								<td width="20%" class="NoiseFooterTD"><?php if($campnomb["defectcodigo"]== 1){$defectcodigo = null; echo "*";}?>&nbsp;Defecto</td>
								<td width="80%" class="NoiseDataTD">&nbsp;
									<select name="defectcodigo" id="defectcodigo">
										<option value="">--Seleccione--</option>
										<?php
											include("../src/FunGen/floaddefecto.php");
											floaddefecto($defectcodigo,$idcon)
										?>
									</select>
								</td> 
 							</tr>
							<tr><td colspan="2" class="NoiseErrorDataTD"></td></tr>
							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["nocomdescri"]== 1){$nocomdescri = null; echo "*";}?>&nbsp;Problema y Descripci&oacute;n</td></tr>
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="nocomdescri" rows="3" cols="95"><?php echo $nocomdescri; ?></textarea></td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr>
			...
			<input type="hidden" name="accioneditarnoconformepr">
