...
ini_set('display_errors',1);
	include_once ( '../src/FunPerPriNiv/pktblgrupogerencial.php');
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							...
							<tr>
 							...
 							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Grupo gerencial</td>
								<td width="83%" class="NoiseDataTD">
									<select name="grugercodigo" id="grugercodigo">
										<option value="">--Seleccione--</option>
										<?php
											include("../src/FunGen/floadgrupogerencial.php");
											floadgrupogerencial($grugercodigo, $idcon);
										?>
									</select>
								</td>
 							</tr>
 			...
 			<input type="hidden" name="flagconsultaritemfinanciero" value="1"> 
			<input type="hidden" name="accionconsultaritemfinanciero"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="itedescodigo, itedesnombre, grugercodigo">
