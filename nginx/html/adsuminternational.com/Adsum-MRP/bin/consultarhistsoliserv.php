...
<html> 
	<head> 
		<title>Consultar registro en historial solicitudes de servicio</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="#FFFFFF" class="NoisePageBODY">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<p><font class="NoiseFormHeaderFont">Historial solicitudes de servicio</font></p> 
			...
			<input type="hidden" name="sourceaction" value="consultar"> 			
	 		<input type="hidden" name="accionconsultarhistsoliserv" value="1"> 
