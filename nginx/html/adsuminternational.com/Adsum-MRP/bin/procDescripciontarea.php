...
*/
    ...
    */
	...
	class procesos_admin extends rs_server
	{
		...
		/*
		Propiedad intelectual de adsum (c).
		Funcion         : mostrarTareadescripcion
		Decripcion      : realiza la consulta a la base de datos
		Parametros      : $paramaters		el valor del atributo del formulario
		Retorno         : $str		lista la descripcion de la tarea
		Autor           : ariascos - lfolaya - jcortes
		Fecha           : 11-may-2007
		*/	
		function mostrarTareadescripcion($paramaters)
		{
			$idcon = fncconn();
			$str = loadrecordtareadescripcion($paramaters,$idcon);
    ...
    */
    ...
    $oRS = new procesos_admin( array( 'mostrarTareadescripcion'));
