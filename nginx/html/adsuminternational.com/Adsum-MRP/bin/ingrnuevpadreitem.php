...
ob_start(); 
	...
	if($accionnuevopadreitem)
		include ( 'grabapadreitem.php');
...
<html> 
	<head> 
		<title>Nuevo registro de padre item</title> 
...
<?php endif; ?> 
  					...
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">  
 							<tr>
								...
								<td width="40%" class="NoiseDataTD" colspan="2"><input type="text" name="paditenombre" size="30"	value="<?php if(!$flagnuevopadreitem){ echo $sbreg[paditenombre];}else {echo $paditenombre; }?>"></td>
 							</tr>
 							<tr>
								<td width="10%" class="NoiseFooterTD"><?php if($campnomb["paditeextrui"] == 1){ $paditeextrui = null; echo "*";}?>&nbsp;Extruido&nbsp;</td>
								<td width="40%" class="NoiseDataTD" colspan="2"><select name="paditeextrui" id="paditeextrui">
 							...
 							<tr>
								...
								<td width="40%" class="NoiseDataTD" colspan="2"><select name="paditepigmen" id="paditepigmen">
								<option value="">--Seleccione--</option>
 							...
 							<tr>
								...
								<td width="30%" class="NoiseDataTD"><input type="text" name="paditedensid" size="7" value="<?php if(!$flagnuevopadreitem){ echo $sbreg[paditedensid];}else {echo $paditedensid; }?>"></td> 
 							</tr>
 							<tr>
 							...
 							<tr>
								...
								<td width="30%" class="NoiseDataTD"><input type="text" name="paditelamind" size="7" value="<?php if(!$flagnuevopadreitem){ echo $sbreg[paditelamind];}else {echo $paditelamind; }?>"></td> 
 							</tr>
 							<tr>
								<td width="10%" class="NoiseFooterTD"><?php if($campnomb["paditeflexo"] == 1){ $paditeflexo = null; echo "*";}?>&nbsp;Flexo (mm)&nbsp;</td>
								<td width="30%" class="NoiseDataTD"><input type="text" name="paditeflexo" size="7" value="<?php if(!$flagnuevopadreitem){ echo $sbreg[paditeflexo];}else {echo $paditeflexo; }?>"></td> 
 							</tr>
 							<tr>
 								<td colspan="2">
							...
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><textarea name="paditedescri" rows="3" cols="63"><?php if(!$flagnuevopadreitem){ echo $sbreg[paditedescri];}else{ echo $paditedescri;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accionnuevopadreitem">  
