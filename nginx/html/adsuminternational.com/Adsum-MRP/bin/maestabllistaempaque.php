...
if ($accionborrarlistaempaque) { 
	include ('borralistaempaque.php'); 
} else { 
	if ($accionconsultarlistaempaque) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'vistalistaempaque', $inicio, $fin, $mov, $accionconsultarlistaempaque, $recarreglo ); 
...
<html> 
<head> 
<title>ordenes de entrega {listaempaque}</title> 
...
<p><font class="NoiseFormHeaderFont">Gestion Listado de Empaque</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="70%"> 
	<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestabllistaempaque.php', $flagcheck ); ?></td></tr> 
	<tr><td>&nbsp;</td></tr> 
	<tr><td>&nbsp;</td></tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				$reg [0] = 'lisempcodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreglistaempaque ( 'vistalistaempaque', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> 
		...
		page_position ( $intervalo, 'maestabllistaempaque.php', $flagcheck ); 
		?></td> 
	</tr> 
</table> 
...
<input type="hidden" name="sourcetable" value="listaempaque"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistalistaempaque"> 
<input type="hidden" name="columnas" value="lisempcodigo"> 
<input type="hidden" name="lisempcodigo" value="<?php if ($accionconsultarlistaempaque) { echo $lisempcodigo; } ?>">  
<input type="hidden" name="accionconsultarlistaempaque"	value="<?php echo $accionconsultarlistaempaque; ?>"> 
