...
<?php if (! $codigo) echo "<!--"; ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post" enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Borrar Analisis calidad orden de produccion programada {OPP}</font></p> 
...
<?php endif; ?>
			...
			<input type="hidden" name="accionborraranalisispr">
			<input type="hidden" name="flagborraranalisispr" value="1">
