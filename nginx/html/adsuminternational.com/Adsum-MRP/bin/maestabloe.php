...
$intervalo = fncaumdec ( 'vistaoe', $inicio, $fin, $mov, $accionconsultaroe, $recarreglo ); 
...
<p><font class="NoiseFormHeaderFont">Gestion de ordenes de entrega</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="70%"> 
	<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestabloe.php', $flagcheck ); ?></td></tr> 
	<tr><td>&nbsp;</td></tr> 
	<tr><td>&nbsp;</td></tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				$reg [0] = 'ordentcodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregoe ( 'vistaoe', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> 
		...
		page_position ( $intervalo, 'maestabloe.php', $flagcheck ); 
		?></td> 
	</tr> 
</table> 
...
<input type="hidden" name="sourcetable" value="oe"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistaoe"> 
<input type="hidden" name="columnas" value="ordentcodigo"> 
<input type="hidden" name="ordentcodigo" value="<?php if ($accionconsultaroe) { echo $ordentcodigo; } ?>">  
<input type="hidden" name="accionconsultaroe"	value="<?php echo $accionconsultaroe; ?>"> 
