...
ob_start();
	...
	if($accionborrarsubzona)
		include ( 'borrasubzona.php');
	else
	{
		if($accionconsultarsubzona)
		{
			$nusw = 0;
			...
			if(!$nusw)
				$accionconsultarsubzona = 0;
		}
	}
	include ( '../src/FunGen/sesion/fncaumdec.php');
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('subzona',$inicio,$fin,$mov,$accionconsultarsubzona,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de sub zona</title> 
...
<?php if(!$codigo){ echo "<!--";} ?> 
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de sub zonas</font></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550"> 
 				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablsubzona.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="38%" class="ui-state-default">Sub Zona</td> 
								<td width="38%" class="ui-state-default">Zona</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregsubzona.php');
								$reg[0] = 'subzoncodigo';
								$reg1[0] = 'n';
								$nureturn = fncvisreg('subzona', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="fin" value="<?php echo $intervalo[fin]; ?>">
  			<input type="hidden" name="sourcetable" value="subzona"> 
 			<input type="hidden" name="selstar" id="selstar" value="0">  
 			<input type="hidden" name="nombtabl" value="subzona"> 
			<input type="hidden" name="columnas" value="subzoncodigo,subzonnombre,subzondescri,zonacodigo"> 
			...
			<input type="hidden" name="selcampos" value="subzoncodigo, subzonnombre">
			<!--											-->
