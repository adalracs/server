...
include ( '../src/FunPerPriNiv/pktbexammedi.php'); 
...
<html> 
<head> 
<title>Registros de ex&aacute;menes m&eacute;dicos</title> 
...
<script language="JavaScript" src="../src/FunGen/cargarExammediBusqueda.js" type="text/javascript"></script>
</head>
<?php 
    if(!$codigo)
    { echo "<!--";}
...
?>
cargarExammediusuarioBusqueda('<?php  echo $nombtabl?>','<?php  echo $accionconsultarexammedi?>',recarreglo);
"
