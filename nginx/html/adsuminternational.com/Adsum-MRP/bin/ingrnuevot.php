...
<!--      								<SCRIPT type=text/javascript>Event.observe($('equipocodigo'),'keyup', function(f){ if (f.keyCode==113)filtradorselect('equipocodigo')} );</SCRIPT>	-->
		  					...
		  					<tr>
		  						...
		  						<td class="NoiseDataTD"><select name="tipcomcodigo" id="tipcomcodigo" onchange="accionLoadSelect(this.value, 'componen', 'componcodigo');" >
            						...
            						<?php
										...
										floadtipocomponequipo($equipocodigo,$tipcomcodigo,$idcon);
									?>
          						</select></td>
							</tr>
		  					<tr>
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
							...
							<tr><td colspan="2" class="NoiseDataTD"><textarea name="ordtradescri" cols="86" rows="2" wrap="VIRTUAL"><?php if(!$flagnuevoot){echo $sbreg["ordtradescri"];}else{ echo $ordtradescri;}?></textarea></td></tr>
						</table>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
		  					<tr>
			  					<td colspan="3" class="NoiseFooterTD"><input type="button" name="radio3" value="Buscar herramientas" onFocus="cargarTransacherram(document.form1.loadherram.value);"  onClick="window.open('ingrnuevtransacherramieot.php?codigo=<?php echo $codigo?>&flagsoliot=<?php echo $flagsoliot;?>','','status=no,menubar=no,scrollbars=yes,resizable=yes,left=300,width=800,height=600');" width="86" height="18" alt="Cancelar" border=0 href="#" target="_parent"></td>
			  					<td colspan="3" class="NoiseFooterTD"><input type="button" name="radio4" value="     Buscar item       " onFocus="cargarTransacitem(document.form1.loaditem.value);" onClick="window.open('ingrnuevtransacitemot.php?codigo=<?php echo $codigo?>&flagsoliotitem=<?php echo $flagsoliotitem;?>','','status=no,menubar=no,scrollbars=yes,resizable=yes,left=300,width=800,height=600');" width="86" height="18" alt="Cancelar" border=0 href="#" target="_parent"></td>
		  					</tr>
							<tr>
		  						<td colspan="3" class="NoiseErrorDataTD"><select name="herramcodigo" size="3">
            							<?php
            								if($flagnuevoot){
								...
								?>
		  						...
		  						<td colspan="3" class="NoiseErrorDataTD"><select name="itemcodigo" size="3">
		    						<?php
		    							if($flagnuevoot){
