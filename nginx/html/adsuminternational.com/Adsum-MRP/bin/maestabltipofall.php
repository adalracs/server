...
if($accionborrartipofall)
{
	include ( 'borratipofall.php');
}
else
{
	if($accionconsultartipofall)
	{
...
$intervalo = fncaumdec('tipofall',$inicio,$fin,$mov,$accionconsultartipofall,$recarreglo);
...
<html> 
<head> 
<title>Registros de tipo de falla</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de tipos de fallas</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipofall.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevtipofall.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultartipofall.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipofall.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestabltipofall.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallartipofall.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrartipofall.php';
...
onclick="form1.action='."'".'editartipofall.php'."'".';"  width="87" 
...
$reg[0] = 'tipfalcodigo';
$reg1[0] = 'n';
$nureturn = fncvisreg('tipofall', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestabltipofall.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabltipofall.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
  	        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestabltipofall.php';" alt="Ultimo"></td> 
  </tr>
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipofall.php',$flagcheck); ?></td> 
  </tr> 
...
"> 
 ...
 <input type="hidden" name="tipfalnombre" value="<?php echo $tipfalnombre; ?>"> 
 <input type="hidden" name="tipfaldescri" value="<?php echo $tipfaldescri; ?>"> 
 <input type="hidden" name="accionconsultartipofall" value="<?php echo 
$accionconsultartipofall; ?>"> 
...
<input type="hidden" name="selcampos" value="tipfalcodigo, tipfalnombre">
<!--											-->
