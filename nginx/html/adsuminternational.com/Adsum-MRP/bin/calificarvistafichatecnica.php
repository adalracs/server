<?php 
	...
	if($accioncalificarvistafichatecnica)
		include ( 'calificavistafichatecnica.php');
	
	if(!$flagcalificarvistafichatecnica) 
	{ 
...
<?php if (! $codigo) echo "<!--"; ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post" enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Calificar &Iacute;tem [Ficha Tecnica]</font></p> 
...
<?php endif; ?>
			...
			<input type="hidden" name="modulocodigo" id="modulocodigo" value="2"><!-- modulo de bandeja pv -->
			...
			<input type="hidden" name="accioncalificarvistafichatecnica">
			...
			<input type="hidden" name="produccodigo" id="produccodigo" value="<?php if(!$accioncalificarvistafichatecnica){echo $sbreg['produccodigo'];}else{echo $produccodigo;} ?>" />
		</form>
