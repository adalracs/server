...
<tr>
	<td><div align="center">
	  <!-- <input type="image" name="aceptar"  src="../img/aceptar.gif" onclick="carga(); form1.accionnuevoot.value = 1;" width="86" height="18" alt="Aceptar" border=0>-->
...
<!-- Hidden SPAN -->
<!--<SPAN id="printFrame3" style="display:none;">
<CENTER>
<?php
...
<tr bgcolor="#F2F3F8">
  <td width="40%"><B>Fecha:</B>&nbsp;<?= $fecha; ?></td>
  <td width="30%"><B>N&uacute;mero OT:</B>&nbsp;<?= $idcodigo; ?></td>
  <td><B>Estado:</B>&nbsp;<?= $arrotestado['otestanombre']; ?></td>
</tr>
<tr bgcolor="#F8FAFB">
 <td colspan="2"><B>Tipo de mantenimiento:</B>&nbsp;<?= $arrtipomant['tipmannombre']; ?></td>
 <td><B>Prioridad:</B>&nbsp;<?= $arrpriorida['priorinombre']; ?></td>
</tr>
<tr>
 <td bgcolor="#E8F0F6" colspan="3"><B>Planta</B></td>
</tr>
<tr bgcolor="#F8FAFB">
 <td><B>C&oacute;digo:</B>&nbsp;<?= $plantacodigo; //$arrplanta['plantacodigo']; ?></td>
 <td><B>Nombre:</B>&nbsp;<?= $arrplanta['plantanombre']; ?></td>
 <td>&nbsp;</td>
</tr>
<tr>
...
<tr bgcolor="#F8FAFB">
 <td><B>C&oacute;digo:</B>&nbsp;<?= $sistemcodigo; //$arrsistema['sistemcodigo']; ?></td>
 <td><B>Nombre:</B>&nbsp;<?= $arrsistema['sistemnombre']; ?></td>
 <td>&nbsp;</td>
</tr>
<tr>
...
<tr bgcolor="#F8FAFB">
 <td><B>C&oacute;digo:</B>&nbsp;<?= $equipocodigo; //$arrequipo['equipocodigo']; ?></td>
 <td><B>Nombre:</B>&nbsp;<?= $arrequipo['equiponombre']; ?></td>
 <td>&nbsp;</td>
</tr>
<tr>
...
<tr bgcolor="#F8FAFB">
 <td colspan="3"><?= $ordtradescri; ?></td>
</tr>
<tr>
 <td bgcolor="#E8F0F6" colspan="3"><B>Horarios</B></td>
</tr>
<tr bgcolor="#F8FAFB">
 <td><B>Fecha de inicio:</B>&nbsp;<?= $ordtrafecini; ?> </td>
 <td colspan="2"><B>Hora de inicio:</B>&nbsp;<?= $horini.":".$minini; if ($pasadmerini) echo " PM"; else echo " AM"; ?></td>
</tr>
<tr bgcolor="#F8FAFB">
 <td><B>Fecha de fin:</B>&nbsp;<?= $ordtrafecfin; ?> </td>
 <td colspan="2"><B>Hora de fin:</B>&nbsp;<?= $horfin.":".$minfin; if ($pasadmerfin) echo " PM"; else echo " AM"; ?></td>
</tr>
<tr>
...
<tr bgcolor="#EBF0FA">
 <td><B>Encargado</B></td>
 <td><B>C&oacute;digo:</B>&nbsp;<?= $empleacod;//$arrUsuLider['usuacodi'];?></td>
 <td><B>Nombre:</B>&nbsp;<?=   $empleanomb; //$arrUsuLider['usuanombre'];?></td>
</tr>
<tr>
	<td><B>Auxiliares</B></td>
<td>&nbsp;</td>
<td>
<SCRIPT>
...
<tr>
 <td><B>Tipo de trabajo:</B>&nbsp;<?= $arrtipotrab['tiptranombre']; ?></td>
 <td colspan="2"><B>Tarea:</B>&nbsp;<?= $arrtarea['tareanombre']; ?></td>
</tr>
<tr>
