...
function editacentcost($iRegcentcost,&$flageditarcentcost,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordcentcost($iRegcentcost,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
$iRegcentcost["cencoscodigo"] = $cencoscodigo;
...
editacentcost($iRegcentcost,$flageditarcentcost,$campnomb,$codigo);
