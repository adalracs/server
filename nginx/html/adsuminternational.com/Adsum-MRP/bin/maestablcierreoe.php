...
include ('../src/FunPerPriNiv/pktblvistacierreoe.php');
...
if ($accionborrarcierreoe) { 
	include ('borracierreoe.php'); 
} else { 
	if ($accionconsultarcierreoe) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'vistacierreoe', $inicio, $fin, $mov, $accionconsultarcierreoe, $recarreglo ); 
...
<html> 
<head> 
<title>ordenes de entrega {oe}</title> 
...
<p><font class="NoiseFormHeaderFont">Cierre de ordenes de entrega</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="70%"> 
	<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablcierreoe.php', $flagcheck ); ?></td></tr> 
	<tr><td>&nbsp;</td></tr> 
	<tr><td>&nbsp;</td></tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregoe.php'); 
				$reg [0] = 'ordentcodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregoe ( 'vistacieerreoe', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> 
		...
		page_position ( $intervalo, 'maestablcierreoe.php', $flagcheck ); 
		?></td> 
	</tr> 
</table> 
...
<input type="hidden" name="sourcetable" value="cierreoe"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistacierreoe"> 
<input type="hidden" name="columnas" value="ordentcodigo"> 
<input type="hidden" name="ordentcodigo" value="<?php if ($accionconsultarcierreoe) { echo $ordentcodigo; } ?>">  
<input type="hidden" name="accionconsultarcierreoe"	value="<?php echo $accionconsultarcierreoe; ?>"> 
