...
<html> 
<head> 
<title>Consultar de OT Proyecto</title> 
...
<body bgcolor="FFFFFF" text="#000000">
 <font class="NoiseFormHeaderFont">Orden de Proyecto</font>
...
form1.action='maestablproyotservicio.php';"  width="86" height="18" alt="Aceptar" 
border=0> 
  <input type="image" name="cancelar" src="../img/cancelar.gif" 
onclick="form1.action='maestablproyotservicio.php';"  width="86" height="18" 
