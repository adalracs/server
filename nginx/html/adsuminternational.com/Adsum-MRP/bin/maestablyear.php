...
include ( '../src/FunPerPriNiv/pktblyear.php'); 
include ( '../src/FunGen/sesion/fncalmdat.php'); 
include ( '../src/FunGen/sesion/fnccaf.php'); 
$reccomact.= fnccaf($GLOBALS[usuacodi],$PATH_TRANSLATED); 
if($accionborraryear) 
{ 
	include ( 'borrayear.php'); 
} 
else 
{ 
		if($accionconsultaryear) 
			{ 
...
<p><font class="NoiseFormHeaderFont">Listado de A&ntilde;os</font><br><br></p> 
...
onclick="form1.action='."'".'ingrnuevyear.php'."'".';"  width="86" height="18" 
alt="Nuevo Registro" border=0>'; 
} 
if($reccomact[consultar]){ 
echo '       <input type="image" name="consultar"  src="../img/consulta.gif" 
onclick="form1.action='."'".'consultaryear.php'."'".';"  width="86" height="18" 
alt="Consultar" border=0>'; 
} 
?> 
 </td> 
 <td width="42"> 
  <input type="image" name="adelanta"  src="../img/adelanta.gif" 
onclick="form1.mov.value = 'menos';form1.action='maestablyear.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('year',$inicio,$fin,$mov,$accionconsultaryear,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablyear.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
color="#FFFFFF">Descripci�n</font></span></td> 
<td width="20%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Estado</font></span></td> 
</tr>  
<?php 
include ( '../src/FunGen/sesion/fncvisregyear.php'); 
	$reg[0] = 'yearcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregyear('year',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablyear.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablyear.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablyear.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="year"> 
<input type="hidden" name="columnas" value="yearcodigo, 
yearnombre, 
yeardescri, 
yearestado 
"> 
 <input type="hidden" name="yearcodigo" value="<?php echo $yearcodigo; ?>"> 
 <input type="hidden" name="yearnombre" value="<?php echo $yearnombre; ?>"> 
 <input type="hidden" name="yeardescri" value="<?php echo $yeardescri; ?>"> 
 <input type="hidden" name="yearestado" value="<?php echo $yearestado; ?>"> 
 <input type="hidden" name="accionconsultaryear" value="<?php echo 
$accionconsultaryear; ?>"> 
