...
ob_start();
	...
	for($a = 0;$a < $nr_equipo;$a++)
	{
		...
		if($equipo)
			$rs_opp = dinamicscanopprogramacorte1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
...
<!--			<p><font class="NoiseFormHeaderFont">{Corte}</font></p>			-->
			<div id="bandejaotgeneral" style="width:900px;align:center;margin-left:20px;">
				<ul>
					<li><a href="#tabs-1"><span class="ui-icon ui-icon-clipboard" style="float: left; margin-right: .3em;"></span>Bandeja corte.</a></li>
				...
				<div id="tabs-1">
					<table width="860px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
			    		<tr>
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
											...
											<div id="filopsbandejaop" style="padding: 2px 2px 2px 2px; display:block;" >
						        				<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center">
						        					<tr>
														...
														<td width="10%"  class="NoiseFooterTD">&nbsp;Ancho corte</td>
														<td width="40%"  class="NoiseFooterTD">&nbsp;<select name="ordproancmat" id="ordproancmat" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php
																include ('../src/FunGen/floadvistabandejacorte.php');
																floadvistabandejacorte_anchom($ordproancmat,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
		  								<td class="ui-state-default">
											<div id="detallebandejacorte" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallabandejacorte.php'; ?>
											</div>
										</td>
									</tr>
									<tr>
								...
								<div class="ui-buttonset">
									<?php  		
										if($reccomact[nuevo] && !$flagcheck)
											echo '<button id="generaropp_cor">Generar [opp]</button>&nbsp';
									?>
								</div>
							</td>
						</tr>
			    		...
			    		<tr>
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
											...
											<div id="filopsbandejaopp" style="padding: 2px 2px 2px 2px; display:block;" >
						        				<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
						        					<tr>
														...
														<td width="10%"  class="NoiseFooterTD">&nbsp;Ancho corte</td>
														<td width="40%"  class="NoiseFooterTD">&nbsp;<select name="ordproancmat_opp" id="ordproancmat_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejacorte_anchomopp($ordproancmat_opp,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
										<td class="ui-state-default">
											<div id="detalleordencorte" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallaordencorte.php'; ?>
											</div>
										</td>
									</tr>
									<tr>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[modificar] && !$flagcheck)
										echo '<button id="editaropp_cor">Editar [opp]</button>';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
