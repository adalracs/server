...
<html>
<head>
<title>Consulta de las programaci&oacute;nes de las OT</title>
...
<p><font class="NoiseFormHeaderFont">Programaci&oacute;n de las OT</font></p>
...
color="FFFFFF">Rango de busqueda</font></span></td></tr>
<tr>
	<td>
...
onclick="form1.action='reporteprogramacionesot.php';"  width="86" height="18" alt="Aceptar" border=0>&nbsp;
<input type="image" src="../img/cancelar.gif" border="0" alt="Cancelar" onclick="form1.action='consultarprogramacionesot.php';">
</div>
</td>
 </tr>
 <tr>
...
<input type="hidden" name="cfecini" value="<?php echo $fecini; ?>">
<input type="hidden" name="cfecfin" value="<?php echo $fecfin; ?>">
