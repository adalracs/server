...
ob_start();
	...
	include ( '../src/FunPerPriNiv/pktblvistasoliextru.php');
...
ob_end_flush();
	...
	$idcon = fncconn();
	$rs_equipo = fullscanprogramaextrusiondisctequipo($idcon);
	...
	for($a = 0;$a < $nr_equipo;$a++)
	{
		...
		$rs_opp = dinamicscanopprogramaextrusion1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			...
			<div id="bandejaotgeneral" style="width:900px;align:center;margin-left:20px;">
				<ul>
					<li><a href="#tabs-1"><span class="ui-icon ui-icon-clipboard" style="float: left; margin-right: .3em;"></span>Bandeja extrusi&oacute;n.</a></li>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
						        				...
						        				<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
						        					<tr>
														...
														<td width="40%"  class="NoiseFooterTD"><select name="formulnumero" id="formulnumero" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php
																include ('../src/FunGen/floadvistabandejaextrusion.php');
																floadvistabandejaextrusion_mezcla($formulnumero,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														...
														<td class="NoiseFooterTD"><select name="ordprocalibr" id="ordprocalibr" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejaextrusion_calibre($ordprocalib,$idcon);
															?>
														</select></td>
														<td width="10%"  class="NoiseFooterTD">&nbsp;Ancho Ext.</td>
														<td width="40%"  class="NoiseFooterTD"><select name="ordproancext" id="ordproancext" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejaextrusion_ancho($ordproancext,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														...
														<td class="NoiseFooterTD" colspan="3"><select name="paditecodigo" id="paditecodigo" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejaextrusion_material($paditecodigo,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
										<td class="ui-state-default">
											<div id="detallebandejaextrusion" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallabandejaextrusion.php'; ?>
											</div>
										</td>
									</tr>
									<tr>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[simular] && !$flagcheck)
										echo '<button id="simularopp_ext">Simular [opp]</button>';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
			    		...
			    		<tr>
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
						        				...
						        				<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
						        					<tr>
														...
														<td width="40%"  class="NoiseFooterTD"><select name="formulnumero_opp" id="formulnumero_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejaextrusion_mezclaopp($formulnumero_opp,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														...
														<td class="NoiseFooterTD"><select name="ordprocalibr_opp" id="ordprocalibr_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejaextrusion_calibreopp($ordprocalibr_opp,$idcon);
															?>
														</select></td>
														<td width="10%"  class="NoiseFooterTD">&nbsp;Ancho Ext.</td>
														<td width="40%"  class="NoiseFooterTD"><select name="ordproancext_opp" id="ordproancext_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejaextrusion_anchoopp($ordproancext_opp,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														...
														<td class="NoiseFooterTD" colspan="3"><select name="paditecodigo_opp" id="paditecodigo_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php																
																floadvistabandejaextrusion_materialopp($paditecodigo_opp,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
										<td class="ui-state-default">
											<div id="detalleordenextrusion" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallaordenextrusion.php'; ?>
											</div>
										</td>
									</tr>	
									<tr>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[modificar] && !$flagcheck)
										echo '<button id="editaropp_ext">Editar [opp]</button>';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
