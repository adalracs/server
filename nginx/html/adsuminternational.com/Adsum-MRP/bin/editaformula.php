...
function editaformula(&$iRegformula,&$flageditarformula,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordformula($iRegformula,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
$iRegformula[formulcodigo] = $formulcodigo;
...
editaformula($iRegformula,$flageditarformula,$campnomb,$codigo);
