...
if($accionconsultarservicioplanta)
{
	$nusw = 0;
	...
	if(!$nusw){
		$accionconsultarservicioplanta = 0;
	}
}
...
<p><font class="NoiseFormHeaderFont">Listado de Servicio</font><br><br></p> 
...
onclick="cargarcheck(this.form); form1.accionconsultarservicioplanta.value= 1;
window.opener.document.form1.arreglo_aux.value = window.document.form1.arreglo_aux.value;
window.opener.document.form1.opnServicio.focus();
window.close();"  width="86" 
height="18" alt="Adicionar Registro" border=0>&nbsp;'; 
  echo '<input type="image" name="consultar"  src="../img/consulta.gif"
onclick="form1.action='."'".'consultarservicioplanta.php'."'".';"  width="86" 
height="18" alt="Consultar" border=0>'; 
?> 
 </td> 
 <td width="42"> 
  <input type="image" name="adelanta"  src="../img/adelanta.gif" 
onclick="cargarcheck(this.form); form1.mov.value='menos'; form1.action='maestablservicioplanta.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
  $intervalo = fncaumdec('servicio',$inicio,$fin,$mov,$accionconsultarservicioplanta,$recarreglo);
...
onclick="cargarcheck(this.form); form1.mov.value='mas'; form1.action='maestablservicioplanta.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
<?php 
include ( '../src/FunGen/sesion/fncvisregservicioplanta.php');
$reg[0] = 'servicicodigo';
$reg1[0] = 'n';
$nureturn = fncvisregservicioplanta('servicio', $reg, $reg1, $idtrans, $arreglo_aux);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="cargarcheck(this.form); form1.mov.value='primero'; form1.action='maestablservicioplanta.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="cargarcheck(this.form); form1.mov.value='menos'; form1.action='maestablservicioplanta.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="cargarcheck(this.form); form1.mov.value='mas'; form1.action='maestablservicioplanta.php';" alt="Siguiente"></td> 
   <td width="53"><input type="image" name="ultimo"  src="../img/ultimo.gif" 
onclick="cargarcheck(this.form);form1.mov.value='ultimo';form1.action='maestablservicioplanta.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
...
servicidescri"> 
 ...
 <input type="hidden" name="accionconsultarservicioplanta" value="<?php echo $accionconsultarservicioplanta; ?>"> 
