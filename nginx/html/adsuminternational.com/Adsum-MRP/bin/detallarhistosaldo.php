	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
 			...
 			<input type="hidden" name="flagdetallarhistosaldo" value="1"> 
			<input type="hidden" name="acciondetallarhistosaldo">
			...
			<input type="hidden" name="itedescodigo" value="<?php if($accionconsultarhistosaldo) echo $itedescodigo; ?>"> 
 			<input type="hidden" name="saldoubicaci" value="<?php if($accionconsultarhistosaldo) echo $saldoubicaci; ?>"> 
 			<input type="hidden" name="saldoposicio" value="<?php if($accionconsultarhistosaldo) echo $saldoposicio; ?>"> 
 			<input type="hidden" name="saldoformula" value="<?php if($accionconsultarhistosaldo) echo $saldoformula; ?>"> 
 			<input type="hidden" name="saldocantkgs" value="<?php if($accionconsultarhistosaldo) echo $saldocantkgs; ?>"> 
 			<input type="hidden" name="saldocantmts" value="<?php if($accionconsultarhistosaldo) echo $saldocantmts; ?>"> 
