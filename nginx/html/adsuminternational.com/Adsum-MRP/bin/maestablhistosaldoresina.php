<?php 
include ( "../src/FunPerPriNiv/pktblvistahistosaldoresina.php");
...
if ($accionconsultarhistosaldoresina) { 
	$nusw = 0; 
	...
	if (! $nusw) { 
		$accionconsultarhistosaldoresina = 0; 
	} 
} 
...
$intervalo = fncaumdec ( "vistahistosaldoresina", $inicio, $fin, $mov, $accionconsultarhistosaldoresina, $recarreglo ); 
...
<html> 
<head> 
<title>Historial de saldo resinas</title> 
...
<p><font class="NoiseFormHeaderFont">Historial de saldos resinas</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="900"> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablhistosaldoresina.php', $flagcheck ); ?></td> </tr> 
	<tr> <td>&nbsp;</td> </tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregsaldoresina.php'); 
				$reg [0] = 'saldocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregsaldoresina ( 'vistahistosaldoresina', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> <td>&nbsp;</td> </tr> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablhistosaldoresina.php', $flagcheck ); ?></td> 
	</tr> 
</table> 
<input type="hidden" name="codigo" value="<?php echo $codigo; ?>"> 
<input type="hidden" name="inicio" value="<?php echo $intervalo ['inicio'];	?>"> 
<input type="hidden" name="fin"	value="<?php echo $intervalo ['fin'];	?>"> 
<input type="hidden" name="sourcetable" value="histosaldoresina"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="saldo"> 
<input type="hidden" name="columnas" value="ordoppcodigo"> 
<input type="hidden" name="ordoppcodigo" value="<?php if ($accionconsultarhistosaldoresina) { echo $ordoppcodigo; } ?>">  
<input type="hidden" name="accionconsultarhistosaldoresina"	value="<?php echo $accionconsultarhistosaldoresina; ?>"> 
