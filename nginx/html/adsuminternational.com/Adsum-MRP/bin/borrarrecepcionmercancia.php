<?php 
	...
	if(!$flagborrarrecepcionmercancia)
	{
...
<html> 
	<head> 
		<title>Borrar registro de recepcion de mercancia</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="accionborrarrecepcionmercancia">
			<input type="hidden" name="flagborrarrecepcionmercancia" value="1">
