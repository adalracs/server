...
$iRegequipo[equiponombre] = $equiponombre;
$iRegequipo[equipodescri] = $equipodescri;
$iRegequipo[equipofabric] = $equipofabric;
$iRegequipo[equipomarca] = $equipomarca;
$iRegequipo[equipomodelo] = $equipomodelo;
$iRegequipo[equiposerie] = $equiposerie;
...
$iRegequipo[equiponivten] = $equiponivten;
...
if(!$flagnuevoequipo)
{
	...
	{	
		...
		rename('../img/pics_equipos/'.$rutafoto, '../img/pics_equipos/equipo'.$equipocod.'.'.$arr_img[count($arr_img) - 1]);
	}
