...
function editafabricante($iRegfabricante,&$flageditarfabricante,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordfabricante($iRegfabricante,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editafabricante($iRegfabricante,$flageditarfabricante,$campnomb,$codigo);
?> 
