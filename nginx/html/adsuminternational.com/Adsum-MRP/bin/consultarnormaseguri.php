...
<html> 
<head> 
<title>Consultar en normaseguri</title> 
...
align="center"> 
<tr> 
 <td width="28%" class="NoiseFooterTD">&nbsp;C&oacute;digo</td> 
...
<tr> 
 <td width="28%" class="NoiseFooterTD">&nbsp;Nombre</td> 
 <td width="72%" class="NoiseDataTD"> 
...
<tr> 
 <td width="28%" class="NoiseFooterTD">&nbsp;Descripci&oacute;n</td> 
 <td width="72%" rowspan="2" class="NoiseDataTD"> 
  <textarea name="norsegdescri" rows="3" cols="30" wrap="VIRTUAL"><?php if(!$flagconsultarnormaseguri){ echo $sbreg[norsegdescri];}else{ echo $norsegdescri; }?></textarea> 
 </td> 
 </tr> 
...
onclick="form1.accionconsultarnormaseguri.value =  
1;form1.action='maestablnormaseguri.php';"  width="86" height="18" 
...
<input type="hidden" name="accionconsultarnormaseguri"> 
