...
include ('../src/FunPerPriNiv/pktblvistasaldo.php');
...
if ($accionborrarsaldo) { 
	include ('borrasaldo.php'); 
} else { 
	if ($accionconsultarsaldo) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'vistasaldo', $inicio, $fin, $mov, $accionconsultarsaldo, $recarreglo ); 
...
<html> 
<head> 
<title>Gestion de saldo laminas</title> 
...
<p><font class="NoiseFormHeaderFont">Gestion de saldos laminas</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="900"> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablsaldo.php', $flagcheck ); ?></td> </tr> 
	<tr> <td>&nbsp;</td> </tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				$reg [0] = 'saldocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregsaldo ( 'vistasaldo', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> <td>&nbsp;</td> </tr> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablsaldo.php', $flagcheck ); ?></td> 
	</tr> 
</table> 
...
<input type="hidden" name="ordoppcodigo" value="<?php if ($accionconsultarsaldo) { echo $ordoppcodigo; } ?>">  
