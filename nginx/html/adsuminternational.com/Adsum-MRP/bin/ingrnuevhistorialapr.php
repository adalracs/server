<?php 
	...
	if($accionnuevohistorialapr){ 
		include ( 'grabanoconformepr.php'); 
		$flagnuevohistorialapr = $flagnuevonoconformepr;
	}

	if(!$flagnuevohistorialapr)
	{
...
<?php endif; ?>
			...
			<input type="hidden" name="accionnuevohistorialapr"> 
