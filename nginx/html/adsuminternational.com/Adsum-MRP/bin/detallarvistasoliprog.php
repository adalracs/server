...
ob_start();
	...
	if($acciondetallarvistasoliprog) 
		include ( 'editavistasoliprog.php');

ob_end_flush();

	if(!$flagdetallarvistasoliprog)
	{
...
<?php if($campnomb || $flagdetallarvistasoliprog): ?>
...
<!-- 	INICIO SOLICITUD -->
										<div id="tabs_solicitud">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.solicitud.det.php'; ?>
										</div>
<!-- 	FIN SOLICITUD -->
<!-- 	INICIO EXTRUSION -->
									<?php if($arrProceso['tabs_solicitud']['ext'][0] > 0){?>
										<div id="tabs_extrusion">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.extrusion.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN EXTRUSION -->
<!-- 	LAMINADO -->
									<?php if($arrProceso['tabs_solicitud']['lmn'][0] > 0){?>
										<div id="tabs_laminado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.laminado.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN LAMINADO -->
<!-- 	FLEXOGRAFIA -->
									<?php if($arrProceso['tabs_solicitud']['flx'][0] > 0){?>
										<div id="tabs_flexografia">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.flexografia.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN FLEXOGRAFIA -->
<!-- 	CORTE -->
									<?php if($arrProceso['tabs_solicitud']['cor'][0] > 0){?>
										<div id="tabs_corte">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.corte.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN CORTE -->
<!-- 	SELLADO -->
									<?php if($arrProceso['tabs_solicitud']['sld'][0] > 0){?>
										<div id="tabs_sellado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.sellado.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN SELLADO -->
<!-- 	PAUCHADO -->
									<?php if($arrProceso['tabs_solicitud']['pch'][0] > 0){?>
										<div id="tabs_pauchado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.pauchado.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN PAUCHADO -->
<!-- 	DOBLADO -->
									<?php if($arrProceso['tabs_solicitud']['dbl'][0] > 0){?>
										<div id="tabs_doblado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.doblado.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN DOBLADO -->
<!-- 	MICROPERFORADO -->
									<?php if($arrProceso['tabs_solicitud']['mcr'][0] > 0){?>
										<div id="tabs_microperforado">
											<?php include '../src/FunjQuery/jquery.tabs/soliprog/jquery.microperforado.det.php'; ?>
										</div>
									<?php }?>
<!-- 	FIN MICROPERFORADO -->
<!-- 	CORTE-REPROCESO -->
...
<!-- 	FIN CORTE-REPROCESO -->
     		...
     		<input type="hidden" name="acciondetallarvistasoliprog">
