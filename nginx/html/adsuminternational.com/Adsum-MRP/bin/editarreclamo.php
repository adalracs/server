...
if ($accioneditarreclamo) { 
	include ('editareclamo.php'); 
	$flageditarreclamo = 1; 
} 
...
<html> 
	<head> 
		<title>editar registro de reclamo</title> 
...
<?php endif; ?> 
  					...
  					<td> 
            			<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							...
							<tr>
								...
								<?php if(!$flageditarreclamo){$servicicodigo = $sbreg[servicicodigo];}?>
 							...
 							<tr>
								...
								<td width="25%" class="NoiseDataTD"><input type="text" name="reclamfecrec" id="reclamfecrec" size="20" value="<?php if(!$flageditarreclamo){ echo $sbreg[reclamfecrec];}else {echo $reclamfecrec; }?>" onfocus="this.blur();"/></td>
 							...
 							<tr>
								...
								<td width="25%" class="NoiseDataTD"><input type="text" name="reclamclinom" id="reclamclinom" size="33" value="<?php if(!$flageditarreclamo){echo $sbreg[reclamclinom];}else{echo $reclamclinom;} ?>" /><input type="hidden" name="reclamnit" id="reclamnit" value="<?php if(!$flageditarreclamo){echo $sbreg[reclamnit];}else{echo $reclamnit;} ?>" /></td>
							...
							<tr>
 							...
 							<tr>
								...
								<td width="25%" class="NoiseDataTD"><input type="text" name="reclamnomcon" size="33"	value="<?php if(!$flageditarreclamo){ echo $sbreg[reclamnomcon];}else {echo $reclamnomcon; }?>"></td>
 								<td width="25%" class="NoiseFooterTD"><?php if($campnomb["reclamcargo"] == 1){ $reclamcargo = null; echo "*";}?>&nbsp;Cargo&nbsp;</td>
								<td width="35%" class="NoiseDataTD"><input type="text" name="reclamcargo" size="20"	value="<?php if(!$flageditarreclamo){ echo $sbreg[reclamcargo];}else {echo $reclamcargo; }?>"></td>
 							</tr>  
 							<tr>
								...
								<?php if(!$flageditarreclamo){$ciudadcodigo = $sbreg[ciudadcodigo];}?>
								<option value=""></option>
								<?php 
								...
								<td width="35%" class="NoiseDataTD"><input type="text" name="reclamtelefono" size="20"	value="<?php if(!$flageditarreclamo){ echo $sbreg[reclamtelefono];}else {echo $reclamtelefono; }?>"></td>
 							</tr> 
 							<tr>
								<td width="15%" class="NoiseFooterTD"><?php if($campnomb["reclammail"] == 1){ $reclammail = null; echo "*";}?>&nbsp;E-Mail</td>
								<td width="25%" class="NoiseDataTD"><input type="text" name="reclammail" size="33"	value="<?php if(!$flageditarreclamo){ echo $sbreg[reclammail];}else {echo $reclammail; }?>"></td>
							...
							<tr><td colspan="4" rowspan="2" class="NoiseDataTD"><textarea name="reclamdescri" rows="2" cols="95"><?php if(!$flageditarreclamo){ echo $sbreg[reclamdescri];}else{ echo $reclamdescri;} ?></textarea>  </td></tr>
							<tr>
 								<td colspan="4" class="NoiseFooterTD"></td>
 							</tr>
							<tr>
								<td width="15%" class="NoiseFooterTD"><?php if($campnomb["acuercodigo"] == 1){ $acuercodigo = null; echo "*";}?>&nbsp;Acuerdos con el cliente</td>
								<td width="25%" class="NoiseDataTD"><input type="text" name="acuercodigo" size="33"	value="<?php if(!$flageditarreclamo){ echo $sbreg[acuercodigo];}else {echo $acuercodigo; }?>"></td>
 								<td width="25%" class="NoiseFooterTD"><?php if($campnomb["reclamotros"] == 1){ $reclamotros = null; echo "*";}?>&nbsp;Otros&nbsp;</td>
								<td width="35%" class="NoiseDataTD"><input type="text" name="reclamotros" size="20"	value="<?php if(!$flageditarreclamo){ echo $sbreg[reclamotros	];}else {echo $reclamotros; }?>"></td>
 							</tr> 
						</table> 
  					</td> 
 				</tr> 
			...
			<input type="hidden" name="accioneditarreclamo">  
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="editar">						
			<input type="hidden" name="reclamfecrad" value="<?php echo date('Y-m-d');?>">						
			<input type="hidden" name="reclamcodigo" value="<?php if(!$flageditarreclamo){echo $sbreg[reclamcodigo];}else{echo $reclamcodigo;}?>">						
