<?php
	include ( '../src/FunPerPriNiv/pktblvistabandejavalvulado.php');
	...
	if($accionnuevoopp)
		include ( 'grabaopp_vlv.php');
		
	$idcon = fncconn();
?>
<html> 
	<head> 
		<title>Nuevo registro de orden de produccion valvulado programadas</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Orden de valvulado</font></p> 
...
<?php endif; ?>
				...
				<?php 
					...
					if($arrop) $arrObject = explode(',',$arrop);
      				for ($a = 0; $a < count($arrObject); $a++)
      				{
      					...
      					$rwVistaop = loadrecordvistabandejavalvulado($arrObject[$a],$idcon);
      					$ordoppanchot = $rwVistaop['ordproancvlv'];
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">		
							...
							<tr>
								<td colspan="6" class="NoiseDataTD">&nbsp;Orden de producci&oacute;n generada apartir de la solicitud de valvulado (#<?php echo str_pad($rwSoliprog['solprocodigo'], 4, "0", STR_PAD_LEFT) ?>) de <b><?php echo  cargausuanombre($rwSoliprog['usuacodi'],$idcon) ?></b></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="NoiseDataTD">&nbsp;<?php echo $rwVistaop['ordproanchop'] ?></td>
            					...
            					<td width="30%" class="NoiseDataTD">
            						<select name="equipocodigo" id="equipocodigo" onchange="reladlistVelocidadpn();reladlistAjsutepn();">
		            					...
		            					<?php
											...
											floadequipoop_vlv($equipocodigo,$idcon);
				    					?>
									</select>
		  						</td>
		  					...
		  					<tr>
 								<td colspan="2">
 									<div id="listavelocidadpn">
 										<?php 
 											$noAjax = true;
 											$tipsolcodigo = 12;//id tiposoliprog valvulado
				...
				<tr>
					<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
						<button id="aceptaropp_vlv">Aceptar</button>&nbsp;&nbsp;&nbsp;&nbsp;
						<button id="cancelaropp_vlv">Cancelar</button>
					</div></td>
				</tr>
				<tr><td>&nbsp;</td></tr> 
				<tr><td class="NoiseErrorDataTD">&nbsp;</td></tr> 
