...
<html> 
<head> 
<title>Detalle de registro de reportotitem</title> 
...
if(!$flagdetallarreportotitem){ echo $sbreg[repitemcodigo];}else{ echo 
$repitemcodigo; } ?>"> 
</td> 
</tr> 
<tr> 
...
if(!$flagdetallarreportotitem){ echo $sbreg[reportcodigo];}else{ echo 
...
if(!$flagdetallarreportotitem){ echo $sbreg[transitecodigo];}else{ echo 
...
alt="Aceptar" border=0> 
 ...
 <input type="hidden" name="flagdetallarreportotitem" value="1"> 
<input type="hidden" name="acciondetallarreportotitem"> 
