...
ob_start();
	...
	if($accioneditarvistasolidoblado) 
		include ( 'editavistasolidoblado.php');

ob_end_flush();

	if(!$flageditarvistasolidoblado)
	{
		include ( '../src/FunGen/sesion/fnccarga.php');
		$sbreg = fnccarga($nombtabl,$radiobutton);
		if (!$sbreg)
			include( '../src/FunGen/fnccontfron.php');
		//regriso de vistasolidoblado
		$idcon = fncconn();
...
<html> 
	<head> 
    	<title>Editar registro de solicitud de programacion de doblado</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Solicitud de programacion doblado</font></p> 
...
<?php endif; ?>
					...
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
							<tr class="ui-widget-header">
								<td width="50%" class="cont-title">&nbsp;Solicitud de programacion doblado No.&nbsp;{<?php echo $solprocodigo; ?>}</td>
				...
				<tr>
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center"  class="ui-widget-content">
							<tr class="ui-state-default"><td class="cont-title">&nbsp;Informacion de doblado </td></tr>
						</table>	
						<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							<tr>
     		...
     		<input type="hidden" name="accioneditarvistasolidoblado">
