...
ob_start(); 
	...
	if($accionborrartema) 
		include ( 'borratema.php'); 
	else 
	{ 
		if($accionconsultartema) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultartema = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('tema',$inicio,$fin,$mov,$accionconsultartema,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de temas</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de temas</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltema.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'temacodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('tema', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="tema"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="tema"> 
			<input type="hidden" name="columnas" value="temacodigo,temanombre,temaobjeti"> 
			...
			<input type="hidden" name="temaobjeti" value="<?php if($accionconsultartema) echo $temaobjeti; ?>">
			...
			<input type="hidden" name="selcampos" value="temacodigo">
			<!--											-->
