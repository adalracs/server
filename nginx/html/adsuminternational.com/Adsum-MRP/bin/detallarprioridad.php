...
<html> 
<head> 
<title>Detalle de registro de prioridad</title> 
...
if(!$flagdetallarprioridad){ echo $sbreg[prioricodigo];}else{ echo 
...
if(!$flagdetallarprioridad){ echo $sbreg[priorinombre];}else{ echo 
$priorinombre; } ?>" onFocus="if (!agree)this.blur();" > 
 </td> 
 </tr> 
<tr> 
...
if(!$flagdetallarprioridad){ echo $sbreg[prioridescri];}else{ echo $prioridescri; } ?></textarea> 
...
<a href= "javascript:;"><input type="image" name="cancelar2" src="../img/ayuda.gif" width="86" height="18" alt="Cancelar" border=0></a> 
 ...
 <input type="hidden" name="flagdetallarprioridad" value="1"> 
<input type="hidden" name="acciondetallarprioridad"> 
