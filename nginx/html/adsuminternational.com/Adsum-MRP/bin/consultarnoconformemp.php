	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
 			...
 			<input type="hidden" name="flagconsultarnocomformemp" value="1"> 
			<input type="hidden" name="accionconsultarnoconformemp"> 
			...
			<input type="hidden" name="nombtabl" value="nocomformemp"> 
		</form>
	</body>
<?php if(!$codigo){ echo " -->"; } ?> 
</html>