...
if($accionborrarprioridad) 
{ 
	include ( 'borraprioridad.php'); 
} 
else 
{ 
		if($accionconsultarprioridad) 
			{ 
...
<p><font class="NoiseFormHeaderFont">Listado de prioridad</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablprioridad.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php 
	$intervalo = fncaumdec 
('prioridad',$inicio,$fin,$mov,$accionconsultarprioridad,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablprioridad.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarprioridad.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarprioridad.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarprioridad.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'prioricodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('prioridad',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablprioridad.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablprioridad.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestablprioridad.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
...
"> 
 ...
 <input type="hidden" name="accionconsultarprioridad" value="<?php echo 
$accionconsultarprioridad; ?>"> 
