...
<html> 
<head> 
<title>Borrar registro de tipocump</title> 
...
align="center"> 
 ...
 <td width="25%">C&oacute;digo</td> 
  <td width="25%"> 
   ...
   if(!$flagborrartipocump){ echo $sbreg[tipcumcodigo];}else{ echo $tipcumcodigo;}
?>" onFocus="if (!agree)this.blur();" > 
             ...
             <tr>
               ...
               if(!$flagborrartipocump){ echo $sbreg[tipcumnombre];}else{ echo $tipcumnombre;}
?>" onFocus="if (!agree)this.blur();" ></td>
 ...
 <td width="25%">Descripci&oacute;n</td> 
  <td width="25%" rowspan="2"> 
    ...
    if(!$flagborrartipocump){ echo $sbreg[tipcumdescri];}else{ echo $tipcumdescri;}
?>
    </textarea> 
  </td> 
 </tr>
...
onclick="form1.accionborrartipocump.value =  1; 
...
alt="Cancelar" border=0> 
 ...
 <input type="hidden" name="flagborrartipocump" value="1"> 
<input type="hidden" name="accionborrartipocump"> 
