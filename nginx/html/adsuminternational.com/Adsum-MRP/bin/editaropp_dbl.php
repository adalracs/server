<?php
	...
	if(!$flageditaropp)
	{
		...
		$rsOrdproduccion = dinamicscanopopdoblado(array('ordoppcodigo' => $arropp),array('ordoppcodigo' => '='),$idcon);
...
<html> 
	<head> 
		<title>editar registro de orden de produccion doblado programadas</title> 
				...
				<?php 
					...
					if($arrop) $arrObject = explode(',',$arrop);
      				for ($a = 0; $a < count($arrObject); $a++)
      				{
      					...
      					$rwVistaop = loadrecordopdoblado($arrObject[$a],$idcon);
