...
ob_start(); 
	...
	if($accionborrarmateapoy) 
		include ( 'borramateapoy.php'); 
	else 
	{ 
	...
	$intervalo = fncaumdec('mateapoy',$inicio,$fin,$mov,$accionconsultarmateapoy,$recarreglo); 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de material de apoyo</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablmateapoy.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'matapocodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('mateapoy', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="mateapoy"> 
			...
			<input type="hidden" name="selcampos" value="matapocodigo">
			<!--											-->
