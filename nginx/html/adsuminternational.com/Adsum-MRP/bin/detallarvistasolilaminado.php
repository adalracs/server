...
ob_end_flush();
	...
	if(!$flagdetallarvistasolilaminado)
	{
...
<?php endif; ?>
					...
					<td>
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
							<tr class="ui-widget-header">
								<td width="50%" class="cont-title">&nbsp;Solicitud de programacion laminado No.&nbsp;{<?php echo $solprocodigo; ?>}</td>
     		...
     		<input type="hidden" name="flagdetallarvistasolilaminado" value="1"> 
     		<input type="hidden" name="acciondetallarvistasolilaminado">
