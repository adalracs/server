...
<BR />
<?php 
include("../src/FunGen/fnccalcdisponib.php");
ob_start();
fnccalcdisponib($strdata, $fecini, $fecfin);
...
onclick="window.open('detalladisponibprint.php','printReport','status=no,menubar=no,scrollbars=yes,resizable=yes,left=600,width=600,height=500'); return false;"  width="86" height="18" alt="Aceptar"
border=0>
</div>
</form>
</body>
