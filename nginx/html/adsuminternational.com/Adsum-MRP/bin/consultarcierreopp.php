...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">consultar cierre OPP</font></p> 
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
 			...
 			<input type="hidden" name="flagconsultarcierreopp" value="1"> 
			<input type="hidden" name="accionconsultarcierreopp"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="ordoppcodigo, ordprofecgen, prograindice, procedcodigo, pedvennumero, produccoduno">
			<input type="hidden" name="nombtabl" value="cierreopp"> 
		</form>
	</body>
<?php if(!$codigo){ echo " -->"; } ?> 
</html>