...
function grabadesperdiciopn($iRegdesperdiciopn,&$flagnuevodesperdiciopn,&$campnomb)
{
	$nuconn = fncconn();
	...
	do 
	{ 
		$nuresult = loadrecorddesperdiciopn($nuidtemp,$nuconn); 
		if($nuresult == e_empty) 
		{  
			$iRegdesperdiciopn[despercodigo] = $nuidtemp; 
		} 
		$nuidtemp ++; 
...
//				}
		...
		if($flagerror != 1)
		{
			$result = insrecorddesperdiciopn($iRegdesperdiciopn,$nuconn);
...
grabadesperdiciopn($iRegdesperdiciopn,$flagnuevodesperdiciopn,$campnomb);
?> 
