<?php 
	...
	include ( '../src/FunPerPriNiv/pktblcierrenoconformeppr.php');
	include ("../src/FunGen/cargainput.php");

	if(!$flagdetallarcierrenocomformeppr){
		...
		$rwCierreNoConformeppr = loadrecordultimacierrenoconformeppr($nocomcodigo,$idcon);

		$cienoccodigo = $rwCierreNoConformeppr["cienoccodigo"];
		$nocomcodigo = $rwCierreNoConformeppr["nocomcodigo"];
		$tipcumcodigo = $rwCierreNoConformeppr["tipcumcodigo"];
		$cienocfecha = $rwCierreNoConformeppr["cienocfecha"];
		$cienochora = $rwCierreNoConformeppr["cienochora"];
		$usuacodigo3 = $rwCierreNoConformeppr["usuacodi"];
		$cienocdescri = $rwCierreNoConformeppr["cienocdescri"];
	...
	$idcon = fncconn();
	//echo date("Y-m-d", strtotime(" 2012-07-11 + 540 days"));
?>
<html>
	<head> 
...
<?php endif; ?>
				...
				<tr> 
 				...
 				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center"> 
 							...
 							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Fecha</td>
								<td width="80%" class="NoiseDataTD">&nbsp;<?php echo ($cienocfecha)? $cienocfecha : "---" ; ?></td> 
 							</tr>
 							<tr>
 				...
 				<tr><td class="ui-widget-header"><span class="style5"><font color="FFFFFF">Cierre de la no conformidad</font></span></td></tr> 
 				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center"> 
 							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;C&oacute;digo</td>
								<td width="80%" class="NoiseDataTD">&nbsp;<?php echo ($cienoccodigo)? $cienoccodigo : "---" ; ?></td> 
 							</tr>
 							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Usuario</td>
								<td width="80%" class="NoiseDataTD">&nbsp;<?php echo ($usuacodigo3)? cargausuanombre($usuacodigo3,$idcon) : "---" ; ?></td> 
 							</tr>
 							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Fecha</td>
								<td width="80%" class="NoiseDataTD">&nbsp;<?php echo ($cienochora)? $cienochora : "---" ; ?></td> 
 							</tr>
 							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Hora</td>
								<td width="80%" class="NoiseDataTD">&nbsp;<?php echo ($gesnochora)? $gesnochora : "---" ; ?></td> 
 							...
 							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Cumplimiento</td>
								<td width="80%" class="NoiseDataTD">&nbsp;<?php echo ($tipcumcodigo)? cargatipcumnombre($tipcumcodigo,$idcon) : "---" ; ?></td> 
 							</tr>
 							<tr><td colspan="2" class="NoiseErrorDataTD"></td></tr>
							<tr><td colspan="2" class="NoiseFooterTD">&nbsp;Descripci&oacute;n</td></tr>
							<tr><td colspan="2" rowspan="2" class="NoiseDataTD"><?php echo $cienocdescri; ?></td></tr>
 						</table>
 					</td>
 				</td>  
				<tr>
			...
			<input type="hidden" name="acciondetallarcierrenoconformeppr">
			<input type="hidden" name="flagdetallarcierrenoconformeppr" value="1">
