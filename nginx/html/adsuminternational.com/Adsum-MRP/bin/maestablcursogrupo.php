...
if($accionborrarcursogrupo)
{
	include ( 'borracursogrupo.php');
}
else
{
	if($accionconsultarcursogrupo)
	{
		...
		if(!$nusw){
			$accionconsultarcursogrupo = 0;
		}
	}
}
include ( '../src/FunGen/sesion/fncaumdec.php');
include('../src/FunGen/fncpageposition.php');
  $intervalo = fncaumdec('cursogrupo',$inicio,$fin,$mov,$accionconsultarcursogrupo,$recarreglo);
...
<html> 
<head> 
<title>Registros de capacitaci&oacute;n</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de capacitaciones</font><br><br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE" width="70%"> 
 <tr> 
  <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablcursogrupo.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
<?php 
...
onclick="form1.action='."'".'ingrnuevcursogrupo.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarcursogrupo.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablcursogrupo.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablcursogrupo.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarcursogrupo.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarcursogrupo.php';
...
onclick="form1.action='."'".'editarcursogrupo.php'."'".';"  width="87" 
...
color="#FFFFFF">Curso</font></span></td> 
<td width="10%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Grupo</font></span></td> 
<td width="24%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Material de apoyo</font></span></td> 
<td width="18%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Inicio</font></span></td>
<td width="16%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Fin</font></span></td>
</tr> 
                  <tr>           
<?php 
include ( '../src/FunGen/sesion/fncvisregcursogrupo.php');
$reg[0] = 'curgrucodigo';
$reg1[0] = 'n';
$nureturn = fncvisregcursogrupo('cursogrupo', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablcursogrupo.php';" 
alt="Primero"></td> 
...
'menos';form1.action='maestablcursogrupo.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?>
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablcursogrupo.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
  <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablcursogrupo.php',$flagcheck); ?></td> 
...
curgruhorari
">
 <input type="hidden" name="curgrucodigo" value="<?php echo $curgrucodigo; ?>"> 
 ...
 <input type="hidden" name="matapocodigo" value="<?php echo $matapocodigo; ?>"> 
 <input type="hidden" name="curgrufecini" value="<?php echo $curgrufecini; ?>"> 
 <input type="hidden" name="curgrufecfin" value="<?php echo $curgrufecfin; ?>"> 
 <input type="hidden" name="curgruhorini" value="<?php echo $curgruhorini; ?>"> 
 <input type="hidden" name="curgruhorfin" value="<?php echo $curgruhorfin; ?>"> 
 <input type="hidden" name="curgruhorari" value="<?php echo $curgruhorari; ?>"> 
 <input type="hidden" name="accionconsultarcursogrupo" value="<?php echo $accionconsultarcursogrupo; ?>"> 
...
<input type="hidden" name="selcampos" value="curgrucodigo, curgrufecini, curgrufecfin, curgruhorini, curgruhorfin">
<!--											-->
