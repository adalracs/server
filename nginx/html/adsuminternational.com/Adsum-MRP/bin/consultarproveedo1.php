...
align="center"> 
 ...
 <td width="16%">C&oacute;digo</td> 
  <td> <input type="text" name="proveecodigo"	value="<?php if(!$flagconsultarproveedo1){ 
...
<tr> 
 <td width="16%">Representante legal </td> 
  <td width="40%"> 
   <input name="proveerepleg" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
echo $sbreg[proveerepleg];}else {echo $proveerepleg;}?>" size="35"> 
  </td> 
 <td>Tel&eacute;fono</td>
  <td width="27%"> 
   <input name="proveetelefo" type ="text"	value="<?php if(!$flagconsultarproveedo1){ 
...
<tr> 
 <td width="16%">Fax</td> 
  <td> 
   <input name="proveefax" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
echo $sbreg[proveefax];}else {echo $proveefax;}?>" size="25"> 
  </td> 
 <td>Pa&iacute;s</td>
  <td width="27%"> 
   <input name="proveepais" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
...
<tr> 
 <td width="16%">Ciudad</td> 
  <td> 
   <input name="proveeciudad" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
echo $sbreg[proveeciudad];}else {echo $proveeciudad;}?>" size="25"> 
  </td> 
 <td>C&oacute;digo postal</td>
  <td width="27%"> 
   <input name="proveepostal" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
...
<tr> 
 <td width="16%">Direcci&oacute;n</td>
  <td> 
  <input name="proveedirecc" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
echo $sbreg[proveedirecc];}else {echo $proveedirecc;}?>" size="25">
   </td> 
 <td width="13%">E-mail</td>
  <td width="27%"> 
   <input name="proveeemail" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
echo $sbreg[proveeemail];}else {echo $proveeemail;}?>" size="16">
 ...
 <td width="16%">URL</td> 
   <td colspan="3"> 
   <input name="proveeurl" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
echo $sbreg[proveeurl];}else {echo $proveeurl;}?>" size="35">
 ...
 <td width="16%">Contacto</td> 
  <td> 
  <input name="proveecontac" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
echo $sbreg[proveecontac];}else {echo $proveecontac;}?>" size="35">
   </td> 
 <td>Tel&eacute;fono</td>
  <td width="27%"> 
   <input name="proveetelcon" type="text"	value="<?php if(!$flagconsultarproveedo1){ 
...
<tr> 
 <td width="16%">Nota</td> 
  <td colspan="3" rowspan="2"> 
    <textarea name="proveenota" cols="63" rows="3" wrap="VIRTUAL"><?php if(!$flagconsultarproveedo1){ 
...
onclick="form1.accionconsultarproveedo1.value =  1; 
form1.action='maestablproveedo1.php';"  width="86" height="18" alt="Aceptar" 
border=0> 
  <input type="image" name="cancelar" src="../img/cancelar.gif" 
onclick="form1.action='maestablproveedo.php';"  width="86" height="18" 
alt="Cancelar" border=0> 
 ...
 <input type="hidden" name="flagconsultarproveedo1" value="1"> 
<input type="hidden" name="accionconsultarproveedo1"> 
...
proveetelcon 
"> 
<input type="hidden" name="nombtabl" value="proveedo1"> 
</form> 
</body> 
<?php 
    if(!$codigo) 
