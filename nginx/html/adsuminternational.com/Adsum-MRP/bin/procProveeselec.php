...
class procesos_admin extends rs_server
{
	...
	Fecha           : 27-DIC-2005
	*/
	function mostrarProveeselec($paramaters)
	{
		$idcon = fncconn();
		...
		{
			$arrservicio = loadrecordproveedo($valposic[$i], $idcon);
			
			$str = $str.$arrservicio["proveecodigo"].",".$arrservicio["proveenombre"].",";
			unset($arrservicio);
		}
...
*/
$oRS = new procesos_admin( array('mostrarProveeselec'));
