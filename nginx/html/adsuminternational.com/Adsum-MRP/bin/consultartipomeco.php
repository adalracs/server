...
<html> 
<head> 
<title>Consultar en Tipo Menu Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionconsultartipomeco.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagconsultartipomeco){ echo $sbreg[timecodi];}else{ echo $timecodi; } 
?>"> 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagconsultartipomeco){ echo $sbreg[ticonomb];}else{ echo $ticonomb;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagconsultartipomeco){ echo $sbreg[ticodesc];}else{ echo $ticodesc;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
src="../img/aceptar.gif" 
onclick="foo();form1.action='maestabltipomeco.php';submit();"  width="86" 
...
<input type="hidden" name="flagconsultartipomeco" value="1"> 
<input type="hidden" name="accionconsultartipomeco"> 
