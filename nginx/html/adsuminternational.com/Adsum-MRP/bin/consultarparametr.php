...
<html> 
<head> 
<title>Consultar en Parametro</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionconsultarparametr.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
sans-serif">Código</font></td> 
                <td width="59%"> 
                  <select name="moducodi" onChange="submit();"></select> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if($flagconsultarparametr){ echo $paracodi; } ?>" > 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagconsultarparametr){ echo $sbreg[paradesc];}else{ echo $paradesc;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagconsultarparametr){ echo $sbreg[paravalo];}else{ echo $paravalo;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagconsultarparametr){ echo $sbreg[parapres];}else{ echo $parapres;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
src="../img/aceptar.gif" 
onclick="foo();form1.action='maestablparametr.php';submit();"  width="86" 
...
<input type="hidden" name="flagconsultarparametr" value="1"> 
<input type="hidden" name="accionconsultarparametr"> 
...
<input type="hidden" name="columnas" value="moducodi, 
paracodi, 
paradesc, 
paratipa, 
paravalo, 
parapres 
"> 
<input type="hidden" name="nombtabl" value="parametr"> 
</form> 
</body> 
<?php 
    if(!$codigo) 
