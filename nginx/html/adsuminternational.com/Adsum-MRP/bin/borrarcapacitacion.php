...
<html> 
	<head> 
		<title>Borrar de registro de capacitaci&oacute;n</title> 
...
<?php if(!$codigo){ echo "<!--";} ?> 
  	<body bgcolor="FFFFFF" text="#000000"> 
    	<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="flagborrarcapacitacion" value="1"> 
			<input type="hidden" name="accionborrarcapacitacion">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="borrar"> 	
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>"> 
			<input type="hidden" name="capacicodigo" value="<?php echo $sbreg[capacicodigo]; ?>"> 
		</form> 
	</body> 
<?php if(!$codigo){ echo " -->"; } ?> 
</html> 
