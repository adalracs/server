...
align="center"> 
<tr> 
 <td width="41%">Numero del reporte</td> 
 <td width="59%"> 
...
$ordtracodigo; }?>"> 
 ...
 <td width="59%">
  <input type="button" name="buscar" value="Buscar OT" 
  onclick="window.open('consultarotsecunddos.php?codigo=<?php 
  echo $codigo?>','cal1','status=no,menubar=no,scrollbars=yes,resizable=yes,left=300,width=800,height=600');"
...
<tr> 
 ...
 <td width="59%"> 
   <select name="tiptracodigo">
			...
			$idcon = fncconn();
			floadtipotrab($tipotrabaj,$idcon); 
			fncclose($idcon);
...
onclick="form1.accionconsultarreportot.value =  1;form1.action='maestablrepcierreotaux.php';" width="86" height="18" 
