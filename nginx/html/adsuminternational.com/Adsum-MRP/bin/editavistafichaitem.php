<?php 
	...
	//$flageditarvistafichaitem = $flagnuevovistaitemfichatecnica;	
	if(!$flageditarvistafichaitem)
	{
		...
		$iRegproductoseguimiento['prosegnombre']= "Editado FT {OK}";
		...
		$iRegproductoseguimiento['modulocodigoorg']= 7;//var conf modulo de bandeja FT
		...
		echo '<!--//'."\n";
		echo 'location ="maestablvistafichaitem.php?codigo='.$codigo.';"';
		echo '//-->'."\n";
		echo '</script>';
	}
?>