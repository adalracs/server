			...
			$(function(){			
					...
					$("#ordcomcodcli").autocomplete({
						...
						select: function(event, ui) {
							...
							ui.item ? document.getElementById('codcliente').value = ui.item.id : document.getElementById('codcliente').value = "";
						}
					});
				...
				<tr> 
  					<td> 
            			<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">
                            ...
                            <tr>
 								<td colspan="2">
 									<div class="ui-buttonset ui-state-default NoiseDataTD" style="width:100%; padding: 1px;">&nbsp;
										<?php if($campnomb["modulonombre"] == 1){ $modulonombre = null; echo "*";}?>
                            ...
                            <tr>
                              <td colspan="2"><div class="ui-buttonset ui-state-default NoiseDataTD" style="width:100%; padding: 1px;">&nbsp;
						...
						<tr >
							  ...
							  <?php if($campnomb["codcliente"] == 1){ $codcliente = null; echo "*";}?>&nbsp;Cliente&nbsp;
							  </span></td>
							  <td class="NoiseDataTD">
							  <span  id="divcliente2" style="display : <?php echo ($nivalacodigo == 2)? 'block' : 'none'  ; ?>" >
							    ...
							    <input type="hidden" name="codcliente" id="codcliente" size="60">
							  </span>  
					    </tr>
						<tr>
								  <td colspan="2">
