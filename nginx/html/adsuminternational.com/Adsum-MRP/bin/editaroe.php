...
ob_end_flush();
	if(!$flageditaroe)
	{
		...
		$oeestacodigo = $sbreg['oeestacodigo'];
		$plantacodigo = $sbreg['plantacodigo'];
		$ordentnumept = $sbreg['ordentnumept'];
		$ordentdescri = $sbreg['ordentdescri'];
							...
							<tr>
								<td>
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
										...
										<tr><td colspan="4" rowspan="2" class="NoiseDataTD"><textarea name="ordentdescri" rows="3" cols="63"><?php if(!$flageditaroe){ echo $sbreg[ordentdescri];}else{ echo $ordentdescri;} ?></textarea>  </td></tr>
									</table>
								</td>
							</tr>
							<tr>
