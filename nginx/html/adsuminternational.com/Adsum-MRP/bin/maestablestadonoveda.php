...
ob_start();
	...
	if($accionborrarestadonoveda)
		include ( 'borraestadonoveda.php');
	else
	{
		if($accionconsultarestadonoveda)
		{
			$nusw = 0;
			...
			if(!$nusw)
				$accionconsultarestadonoveda = 0;
		}
	}
	include ( '../src/FunGen/sesion/fncaumdec.php');
	include('../src/FunGen/fncpageposition.php');
	$intervalo = fncaumdec('estadonoveda',$inicio,$fin,$mov,$accionconsultarestadonoveda,$recarreglo); 
...
<?php if(!$codigo){ echo "<!--";} ?> 
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de novedades</font></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550"> 
 				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablestadonoveda.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="80%" class="ui-state-default">Novedad</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisreg.php');
								$reg[0] = 'estnovcodigo';
								$reg1[0] = 'n';
								$nureturn = fncvisreg('estadonoveda', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="fin" value="<?php echo $intervalo[fin]; ?>">
  			<input type="hidden" name="sourcetable" value="estadonoveda"> 
			...
			<input type="hidden" name="selcampos" value="estnovcodigo, estnovnombre">
			<!--											-->
