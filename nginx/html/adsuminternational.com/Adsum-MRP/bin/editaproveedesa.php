...
function editaproveedesa($iRegproveedesa,&$flageditarproveedesa,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordproveedesa($iRegproveedesa,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editaproveedesa($iRegproveedesa,$flageditarproveedesa,$campnomb,$codigo);
?> 
