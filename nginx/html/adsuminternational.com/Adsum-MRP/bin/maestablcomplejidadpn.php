...
ini_set('display_errors',1);
	...
	if($accionborrardesperdiciopn) 
		include ( 'borracomplejidadpn.php'); 
	else 
	{ 
		if($accionconsultarcomplejidadpn) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarcomplejidadpn = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('complejidadpn',$inicio,$fin,$mov,$accionconsultarcomplejidadpn,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de complejidad produccion </title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de complejidad produccion</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablcomplejidadpn.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'complecodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('complejidadpn', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="complejidadpn"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="complejidadpn"> 
			<input type="hidden" name="columnas" value="complecodigo,complenombre,compledescri"> 
			...
			<input type="hidden" name="selcampos" value="complecodigo">
			<!--											-->
