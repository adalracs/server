...
ob_start(); 
	...
	include ( '../src/FunPerPriNiv/pktblvistaanalisismp.php');
	...
	if($accionborraranalisismp)
		include ( 'borraanalisismp.php');
	else
	{
		if($accionconsultaranalisismp)
		{
			$nusw = 0;
	...
	include('../src/FunGen/fncpageposition.php');
  	...
  	$intervalo = fncaumdec('vistaanalisismp',$inicio,$fin,$mov,$accionconsultaranalisismp,$recarreglo);
...
<html>
	<head> 
		<title>Registros de analisis de materias primas</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de analisis de materias primas</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="950">
				<tr><td class="NoiseErrorDataTD" align="right"><?php page_position($intervalo,'maestablanalisismp.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'analiscodigo';
								$reg1[0] = 'n';
								$nureturn = fncvisreganalisismp('vistaanalisismp', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="analisismp"> 
			...
			<input type="hidden" name="analiscodigo" value="<?php if($accionconsultaranalisismp) echo $analiscodigo; ?>">
			<input type="hidden" name="proveecodigo" value="<?php if($accionconsultaranalisismp) echo $proveecodigo; ?>">
			<input type="hidden" name="analisnolote" value="<?php if($accionconsultaranalisismp) echo $analisnolote; ?>">
			<input type="hidden" name="itedescodigo" value="<?php if($accionconsultaranalisismp) echo $itedescodigo; ?>">
			<input type="hidden" name="usuacodi" value="<?php if($accionconsultaranalisismp) echo $usuacodi; ?>">
			<input type="hidden" name="analisfecha" value="<?php if($accionconsultaranalisismp) echo $analisfecha; ?>">
			<input type="hidden" name="estanacodigo" value="<?php if($accionconsultaranalisismp) echo $estanacodigo; ?>">
			<input type="hidden" name="analisdescri" value="<?php if($accionconsultaranalisismp) echo $analisdescri; ?>">
			<input type="hidden" name="accionconsultaranalisismp" value="<?php echo $accionconsultaranalisismp; ?>">
