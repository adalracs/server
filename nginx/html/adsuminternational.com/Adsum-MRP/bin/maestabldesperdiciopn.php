...
ini_set('display_errors',1);
	...
	if($accionborrardesperdiciopn) 
		include ( 'borradesperdiciopn.php'); 
	else 
	{ 
		if($accionconsultardesperdiciopn) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultardesperdiciopn = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('desperdiciopn',$inicio,$fin,$mov,$accionconsultardesperdiciopn,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de desperdicio pn </title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de Desperdicio Pn</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabldesperdiciopn.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
 				...
 				<tr> 
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								include ( '../src/FunGen/sesion/fncvisregdesperdiciopn.php'); 
								$reg[0] = 'despercodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregdesperdiciopn('desperdiciopn', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="desperdiciopn"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="desperdiciopn"> 
			<input type="hidden" name="columnas" value="despercodigo,despernombre,desperdescri, tipsolcodigo"> 
			...
			<input type="hidden" name="tipsolcodigo" value="<?php if($accionconsultardesperdiciopn) echo $tipsolcodigo; ?>"> 
			...
			<input type="hidden" name="selcampos" value="despercodigo">
			<!--											-->
