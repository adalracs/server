...
include ( '../src/FunPerPriNiv/pktblvalidaci.php'); 
   include ( '../src/FunGen/sesion/fncalmdat.php'); 
if($accionborrarvalidaci) 
{ 
	include ( 'borravalidaci.php'); 
} 
else 
{ 
	if($accioneditarvalidaci) 
	{ 
		include ( 'editavalidaci.php'); 
	} 
	else 
	{ 
		if($accionnuevovalidaci) 
		{ 
			include ( 'grabavalidaci.php'); 
		} 
		else 
		{ 
			if($accionconsultarvalidaci) 
			{ 
...
<html> 
<head> 
<title>Registros de Validaciones</title> 
...
src="../img/nuevo.gif" 
onclick="form1.action='."'".'ingrnuevvalidaci.php'."'".';submit();"  width="86" 
height="18" alt="Nuevo Registro" border=0>'; 
} 
if($consultar){ 
echo '            <input type="image" name="consultar"  
src="../img/consulta.gif" 
onclick="form1.action='."'".'consultarvalidaci.php'."'".';submit();"  
...
onclick="foo(2);form1.action='maestablvalidaci.php';submit();" 
alt="Anterior"></td> 
          <td width="57"><font size="2" color="#CC9900">Anterior</font></td> 
          <td width="53"> 
<?php 
	$intervalo = 
fncaumdec('validaci',$inicio,$fin,$mov,$accionconsultarvalidaci,$recarreglo); 
...
src="../img/atrasa.gif" 
onclick="foo(1);form1.action='maestablvalidaci.php';submit();" 
alt="Siguiente"></td> 
        </tr> 
        <tr> 
          <td colspan="2">&nbsp;</td> 
...
sans-serif" color="#006699">Codigo</font></b></td> 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'valicodi'; 
	$nureturn = fncvisreg('validaci',$reg,$idtrans); 
?> 
            </table> 
          </td> 
        </tr> 
...
src="../img/primero.gif" 
onclick="foo(3);form1.action='maestablvalidaci.php';submit();" 
alt="Primero"></td> 
...
src="../img/ultimo.gif" 
onclick="foo(4);form1.action='maestablvalidaci.php';submit();" 
alt="Ultimo"></td> 
        </tr> 
        <tr> 
...
validesc 
"> 
<input type="hidden" name="valicodi" value="<?php echo $valicodi; ?>"> 
<input type="hidden" name="valinomb" value="<?php echo $valinomb; ?>"> 
<input type="hidden" name="validesc" value="<?php echo $validesc; ?>"> 
<input type="hidden" name="accionconsultarvalidaci" value="<?php echo 
$accionconsultarvalidaci; ?>"> 
