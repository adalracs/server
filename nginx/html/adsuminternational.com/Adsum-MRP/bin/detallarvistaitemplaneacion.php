<?php 
	...
	if(!$flagdetallarvistaitemplaneacion) 
	{ 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="650">
 			...
 			<input type="hidden" name="flagdetallarvistaitemplaneacion" value="1"> 
			<input type="hidden" name="acciondetallarvistaitemplaneacion">
			...
			<input type="hidden" name="itedescodigo" value="<?php if($accionconsultarvistaitemplaneacion) echo $itedescodigo; ?>"> 
 			...
 			<input type="hidden" name="accionconsultarvistaitemplaneacion" value="<?php echo $accionconsultarvistaitemplaneacion; ?>">
		</form> 
	</body> 
<?php if(!$codigo){ echo " -->"; } ?> 
</html>