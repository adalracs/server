<!--  division contenedora del programa de extrusion-->
<?php 
	if(!$noAjax)
	{
		//primer nivel
		...
		require_once ( "../src/FunPerPriNiv/pktblprogramaextrusion.php");
		...
		require_once ( "../src/FunPerPriNiv/pktblopextrusion.php");
...
<div id="programaextrusion">
	...
	<div id="<?php echo $obj_tab ?>" style="height: 350px; margin:0 auto; overflow:auto;">
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include "../src/FunjQuery/jquery.visors/gestionopp/jquery.programaext.php";
        			break;
    			case "reporteopp":
        			include "../src/FunjQuery/jquery.visors/produccion/jquery.programaext.php";
        			break;
    			case "gestionopparte":
        			include "../src/FunjQuery/jquery.visors/produccion/jquery.programaext.php";
        			break;
        		...
        		case "gestionopprequisicion":
        			include "../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programaext.php";
        			break;
        		case "gestionopprequisicion":
        			include "../src/FunjQuery/jquery.visors/produccion/jquery.programaext.php";
        			break;
        		case "gestionoppanalisispr":
        			...
        			break;
        		default:
       				include "../src/FunjQuery/jquery.visors/programacion/jquery.programaext.php";
       				break;
			}
		?>
	</div>
