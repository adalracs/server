...
ini_set("display_errors", 1);
	...
	if(!$flagborrarfamestatusmat){ 
		...
		$arrkeylinea = $sbreg["famestkeylin"];
	} 
?>
<html> 
	<head> 
		<title>Borrar de registro de familias x estatus</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="470">
 			...
 			<input type="hidden" name="flagborrarfamestatusmat" value="1">
 			<input type="hidden" name="famestcodigo" value="<?php echo $famestcodigo; ?>">
 			<input type="hidden" name="famestcodigo1" value="<?php echo $famestcodigo; ?>">
			<input type="hidden" name="accionborrarfamestatusmat">
