...
if($accionborraroperacio)
{
	include ( 'borraoperacio.php');
}
else
{
	if($accionconsultaroperacio)
	{
...
include('../src/FunGen/fncpageposition.php');
  ...
  $intervalo = fncaumdec
  ('operacio',$inicio,$fin,$mov,$accionconsultaroperacio,$recarreglo);
...
<html> 
<head> 
<title>Registros de operacio</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de operaciones</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabloperacio.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php  
...
onclick="form1.action='."'".'ingrnuevoperacio.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultaroperacio.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestabloperacio.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestabloperacio.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallaroperacio.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borraroperacio.php';
...
onclick="form1.action='."'".'editaroperacio.php'."'".';"  width="87" 
...
color="#FFFFFF">Tipo de operaci&oacute;n</font></span></td> 
<td width="26%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Fecha</font></span></td> 
</tr> 
<?php  
include ( '../src/FunGen/sesion/fncvisregoperacio.php');
$reg[0] = 'operaccodigo';
$reg1[0] = 'n';
$nureturn = fncvisregoperacio('operacio', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?>
</table>
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestabloperacio.php';" alt="Primero"></td> 
...
'menos';form1.action='maestabloperacio.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php  
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestabloperacio.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabloperacio.php',$flagcheck); ?></td> 
  </tr> 
...
">  
 ...
 <input type="hidden" name="tipopecodigo" value="<?php  echo $tipopecodigo; ?>"> 
 <input type="hidden" name="operacvalor" value="<?php  echo $operacvalor; ?>"> 
 <input type="hidden" name="operacfecha" value="<?php  echo $operacfecha; ?>"> 
 <input type="hidden" name="accionconsultaroperacio" value="<?php  echo 
$accionconsultaroperacio; ?>"> 
...
<input type="hidden" name="selcampos" value="operaccodigo, operacvalor, operacfecha">
<!--											-->
