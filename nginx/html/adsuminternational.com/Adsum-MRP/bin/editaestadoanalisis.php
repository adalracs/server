...
function editaestadoanalisis($iRegestadoanalisis,&$flageditarestadoanalisis,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordestadoanalisis($iRegestadoanalisis,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editaestadoanalisis($iRegestadoanalisis,$flageditarestadoanalisis,$campnomb,$codigo);
?> 
