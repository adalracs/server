...
ob_start(); 
	...
	if($accionborrarubicaccapaci) 
		include ( 'borraubicaccapaci.php'); 
	else 
	{ 
		if($accionconsultarubicaccapaci) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarubicaccapaci = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('ubicaccapaci',$inicio,$fin,$mov,$accionconsultarubicaccapaci,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de ubicaciones</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de Ubicaciones</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablubicaccapaci.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								...
								$reg[0] = 'ubicapcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisreg('ubicaccapaci', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="ubicaccapaci"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="ubicaccapaci"> 
			...
			<input type="hidden" name="selcampos" value="ubicapcodigo">
			<!--											-->
