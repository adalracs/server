...
<html> 
<head> 
<title>Consultar en Numerador</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionconsultarnumerado.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagconsultarnumerado){ echo $sbreg[numecodi];}else{ echo $numecodi; } 
?>"> 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagconsultarnumerado){ echo $sbreg[numedesc];}else{ echo $numedesc;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flagconsultarnumerado){ echo $sbreg[numeprox];}else{ echo $numeprox;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flagconsultarnumerado" value="1"> 
<input type="hidden" name="accionconsultarnumerado"> 
