...
*/
    ...
    */
	...
	class procesos_admin extends rs_server
	{
		...
		*/	
		...
		Fecha           : 07-jul-2005
		*/	
		function mostrarUsuagrupcapaBusqueda($paramaters)
		{
			...
			if($nuCantRow > 0)
			{
		    	for($i=0;$i<$nuCantRow;$i++)
				{
					...
					$str = $str.$sbregArray["usuacodi"].",".$sbregArray["usuanombre"]." ".
					$sbregArray["usuapriape"]." ".$sbregArray["usuasegape"].",";
				}
			}
    ...
    */
    ...
    $oRS = new procesos_admin( array( 'mostrarUsuagrupcapa','mostrarUsuagrupcapaBusqueda'));
