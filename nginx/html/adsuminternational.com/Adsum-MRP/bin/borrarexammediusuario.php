...
<html> 
<head> 
<title>Borrar registro de exammediusuario</title> 
...
<tr> 
 ...
 <td width="59%"> 
  ...
  if(!$flagborrarexammediusuario){ echo $sbreg[exmusucodigo];}else{ echo
$exmusucodigo; } ?>" onFocus="if (!agree)this.blur();" > 
 ...
 if(!$flagborrarexammediusuario){ echo $sbreg[examedcodigo];}else{ echo
$examedcodigo; } ?>" onFocus="if (!agree)this.blur();" > 
<td width="50%">Nombre&nbsp;<input type="text" onfocus="if(!agree) this.blur();" size="18" value="<?php
if(!$flagborrarexammediusuario) {echo $examednombre;} else {echo $examednombre;}?>"></td> 
</td> 
 </tr>
...
<tr> 
 ...
 if(!$flagborrarexammediusuario){ echo $sbreg[usuacodi];}else{ echo $usuacodigo;
} ?>" onFocus="if (!agree)this.blur();" > 
</td> 
<td width="50%">Nombre&nbsp;<input type="text" onfocus="if(!agree) this.blur();" size="18" value="<?php
if(!$flagborrarexammediusuario) {echo $usrnombre;} else {echo $usrnombre;}?>"></td> 
</td>
</tr> 
...
<tr> 
 ...
 <td width="25%"> 
  ...
  if(!$flagborrarexammediusuario){ echo $sbreg[exmusupinifec];}else{ echo
...
onclick="form1.accionborrarexammediusuario.value =  1; 
...
alt="Cancelar" border=0> 
 ...
 <input type="hidden" name="flagborrarexammediusuario" value="1"> 
<input type="hidden" name="accionborrarexammediusuario"> 
