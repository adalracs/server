<!--  division contenedora del programa de microperforado-->
<?php 
	...
	if(!$noAjax)
	{
		...
		require_once ( '../src/FunPerPriNiv/pktblprogramamicroperforado.php');
		require_once ( '../src/FunPerPriNiv/pktblopmicroperforado.php');
...
<div id="programamicroperforado">
	...
	<div id="<?php echo $obj_tab ?>" >
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include '../src/FunjQuery/jquery.visors/gestionopp/jquery.programamcr.php';
        			break;
    			case "reporteopp":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programamcr.php';
        			break;
    			case "gestionopparte":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programamcr.php';
        			break;
        		...
        		case "gestionopprequisicion":
        			include '../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programamcr.php';
        			break;
        		...
        		case "gestionoppanalisispr":
        			...
        			break;
        		default:
       				include '../src/FunjQuery/jquery.visors/programacion/jquery.programamcr.php';
       				break;
			}
