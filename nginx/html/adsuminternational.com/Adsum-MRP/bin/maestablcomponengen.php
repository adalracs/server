...
onclick="form1.action='consultarcomponengen.php';"  width="86"
height="18" alt="Consultar" border=0>
 </td>
 <td width="42">
  <input type="image" name="adelanta"  src="../img/adelanta.gif"
onclick="form1.mov.value = 'menos'; form1.action='maestablcomponengen.php';" alt="Anterior"></td>
...
onclick="form1.mov.value = 'mas'; form1.action='maestablcomponengen.php';" alt="Siguiente"></td>
 </tr>
 <tr>
...
<?php
include ( '../src/FunGen/sesion/fncvisregcomponengen.php');
	$reg[0] = 'componcodigo';
	$reg1[0] = 'n';
	$nureturn = fncvisregcomponengen('componen',$reg,$reg1,$idtrans);
?>
   </table>
   </td>
  </tr>
...
onclick="form1.mov.value = 'primero'; form1.action='maestablcomponengen.php';" alt="Primero"></td>
   <td width="46"><input type="image" name="adelanta"
src="../img/adelanta.gif" onclick="form1.mov.value = 'menos'; form1.action='maestablcomponengen.php';"
alt="Anterior"></td>
   <td width="50">
<?php
...
onclick="form1.mov.value = 'ultimo'; form1.action='maestablcomponengen.php';" alt="Ultimo"></td>
  </tr>
  <tr>
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td>
  </tr>
