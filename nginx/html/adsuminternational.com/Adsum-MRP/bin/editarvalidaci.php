...
<html> 
<head> 
<title>Editar registro de Validaciones</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accioneditarvalidaci.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flageditarvalidaci){ echo $sbreg[valicodi];}else{ echo $valicodi; } ?>" 
...
if(!$flageditarvalidaci){ echo $sbreg[valinomb];}else{ echo $valinomb;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flageditarvalidaci){ echo $sbreg[validesc];}else{ echo $validesc;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flageditarvalidaci" value="1"> 
<input type="hidden" name="accioneditarvalidaci"> 
