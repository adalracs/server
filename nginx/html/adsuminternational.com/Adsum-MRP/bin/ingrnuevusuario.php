...
ob_start();
	...
	if($accionnuevousuario)
	    include('grabausuario.php');

ob_end_flush();
?>
<html>
	<head>
		<title>Nuevo registro de Usuarios</title>
...
<?php endif; ?> 
				<tr><td class="ui-widget-header"><span class="style5"><font color="FFFFFF">Ingresar nuevo usuario</font></span></td></tr>
   				<tr>
					<td>
									...
									<div id="fillogue" style="display: block;" >
										<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
				      						<tr>
				        						...
				        						<td class="NoiseDataTD"><input name="usuanomb" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuanomb];}else{ echo $usuanomb;} ?>" size="14"></td>
				      						...
				      						<tr>
					        					...
					        					<td width="28%" class="NoiseDataTD"><input name="usuapass" type="password" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuapass];} ?>" size="17"></td>
					        					...
					        					<td width="30%" class="NoiseDataTD"><input name="usuapass1" type="password" value = "<?php if(!$flagnuevousuario){echo $sbreg[usuapass1];} ?>" size="17" ></td>
				      						</tr>
									...
									<div id="fillogue" style="display: block;" >
										<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
											<!-- <tr class="NoiseErrorDataTD">
				           						...
				           						<td><input type="checkbox" name="usuaactiot" value="3" <?php if($flagnuevousuario){ if($usuaactiot){ echo "checked";}} ?>></td>
				     						</tr> --> 
											<tr class="NoiseErrorDataTD">
				           						<td><?php if($campnomb["usuacodi"] == 1): $usuacodigo = null; ?><span style="color:red;">*</span><?php else:  echo "*"; endif; ?>&nbsp;Registro</td>
				           						<td colspan="3"><input name="usuacodigo" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuacodi];}else{ echo $usuacodigo;} ?>" size="20" onkeypress="if(event.keyCode < 45 || event.keyCode > 57){ event.returnValue = false; }"></td>
				     						</tr>  
											<tr class="NoiseErrorDataTD">
				           						<td><?php if($campnomb["usuadocume"] == 1): $usuadocume = null; ?><span style="color:red;">*</span><?php else:  echo "*"; endif; ?>&nbsp;No. de Identidad</td>
				           						<td colspan="3"><input name="usuadocume" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuadocume];}else{ echo $usuadocume;} ?>" size="20" onkeypress="if(event.keyCode < 45 || event.keyCode > 57){ event.returnValue = false; }"></td>
				     						</tr>  
				          					<tr>
				            					...
				            					<td class="NoiseFooterTD" width="30%"><input name="usuanombre" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuanombre];}else{ echo $usuanombre;} ?>" size="25"></td>
				            					...
				            					<td class="NoiseFooterTD" width="30%"><input name="usuapriape" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuapriape];}else{ echo $usuapriape;} ?>" size="25"></td>
				          					</tr>
				            				<tr>
				            					<td class="NoiseFooterTD"><?php if($campnomb["usuasegape"] == 1){ $usuasegape = null; echo "*";}?>&nbsp;Seg. Apellido</td>
				            					<td class="NoiseFooterTD" colspan="3"><input name="usuasegape" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuasegape];}else{ echo $usuasegape;} ?>" size="25"></td>
				          					</tr>
				          					<tr>
				          				...
				          				<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
				          					<tr>
				            					...
				            					<td class="NoiseFooterTD" width="30%"><input name="usuatelefo" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuatelefo];}else{ echo $usuatelefo;} ?>" size="20"></td>
				            					<td class="NoiseFooterTD" width="20%"><?php if($campnomb["usuatelef2"] == 1){ $usuatelef2 = null; echo "*";} ?>&nbsp;Celular</td>
				            					<td class="NoiseFooterTD" width="30%"><input name="usuatelef2" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuatelef2];}else{ echo $usuatelef2;} ?>" size="20"></td>
				            				</tr>
				          					<tr>
				            					...
				            					<td class="NoiseFooterTD" width="30%"><input name="usuavalhor" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuavalhor];}else{ echo $usuavalhor;} ?>" size="15"></td>
				                   			...
				                   			<tr>
				           						...
				           						<td class="NoiseDataTD" colspan="3"><input name="usuaemail" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuaemail];}else{ echo $usuaemail;} ?>" size="46"></td>
				         					</tr>
				         					<tr>
...
//														floaddepartamento($deptocodigo,$idcon);
				         					...
				         					<tr><td class="NoiseFooterTD" colspan="4"><?php if($campnomb["usuadirecc"] == 1){ $usuadirecc = null; echo "*";} ?>&nbsp;Direcci&oacute;n</td></tr>
				       						<tr><td colspan="4" class="NoiseDataTD" align="center"><textarea name="usuadirecc" cols="78" rows="2" wrap="VIRTUAL"><?php if(!$flagnuevousuario){ echo $sbreg[usuadirecc];}else{ echo $usuadirecc;} ?></textarea></td></tr>
				           					<tr><td colspan="4" class="NoiseErrorDataTD"></td></tr>
				           				</table>
				           				<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content">
											<tr>
				            					<td class="NoiseFooterTD" width="20%"><?php if($campnomb["usuacontac"] == 1){ $usuacontac = null; echo "*";}?>&nbsp;Contacto</td>
				            					<td class="NoiseFooterTD"><input name="usuacontac" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuacontac];}else{ echo $usuacontac;} ?>" size="46"></td>
				          					</tr>          
				          					<tr>
			...
			<input type="hidden" name= "accionnuevousuario">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="nuevo">
			<input type="hidden" name="grupcodi1" value="<?php echo $grupcodi; ?>">
