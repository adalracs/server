...
<html>
<head>
<title>Borrar registro de tipo sistema</title>
...
<tr>
 ...
 <td width="67%" class="NoiseDataTD"><?php echo $sbreg["tipsiscodigo"]; ?></td>
</tr>
<tr>
...
<tr>
 <td colspan="6" class="NoiseFieldCaptionTD Estilo1">&nbsp;Proceso</td>
</tr>
			<?php
...
onClick="form1.accionborrartiposistema.value =  1;
form1.action='maestabltiposistema.php';"  width="86" height="18" alt="Aceptar"
border=0>
...
<td class="NoiseErrorDataTD">&nbsp;</td>
 ...
 <input type="hidden" name="flagborrartiposistema" value="1">
<input type="hidden" name="accionborrartiposistema">
<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
<input type="hidden" name="tipsiscodigo"	value="<?php echo $sbreg["tipsiscodigo"]; ?>">
</form>
</body>
<?php
if(!$codigo)
