...
<html> 
	<head> 
		...
		<script type="text/javascript" src="../src/FunjQuery/jquery.jsscripts/jquery.function_anamp.js"></script>
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="acciondetallarhistorialamp">
			<input type="hidden" name="flagdetallarhistorialamp" value="1">
