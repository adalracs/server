...
ob_start(); 
	...
	if($accionborrarestadoanalisis) 
		include ( 'borraestadoanalisis.php'); 
	else 
	{ 
		if($accionconsultarestadoanalisis) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarestadoanalisis = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('estadoanalisis',$inicio,$fin,$mov,$accionconsultarestadoanalisis,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de estados de analisis</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de estados de analisis</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablestadoanalisis.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
 				...
 				<tr> 
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								include ( '../src/FunGen/sesion/fncvisregestadoanalisis.php'); 
								$reg[0] = 'estanacodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregestadoanalisis('estadoanalisis', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="estadoanalisis"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="estadoanalisis"> 
			...
			<input type="hidden" name="selcampos" value="estanacodigo">
			<!--											-->
