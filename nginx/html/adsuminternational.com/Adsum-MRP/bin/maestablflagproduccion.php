...
ini_set('display_errors',1);
	...
	if($accionborrarflagproduccion) 
		include ( 'borraflagproduccion.php'); 
	else 
	{ 
		if($accionconsultarflagproduccion) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarflagproduccion = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('flagproduccion',$inicio,$fin,$mov,$accionconsultarflagproduccion,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de banderas pn </title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de Banderas Pn</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="750">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablflagproduccion.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="45%" class="ui-state-default">Tipo</td>  
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregflagproduccion.php'); 
								$reg[0] = 'flaprocodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregflagproduccion('flagproduccion', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="flagproduccion"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="flagproduccion"> 
			<input type="hidden" name="columnas" value="flaprocodigo,flapronombre,flaprodescri, tipsolcodigo"> 
			...
			<input type="hidden" name="tipsolcodigo" value="<?php if($accionconsultarflagproduccion) echo $tipsolcodigo; ?>"> 
			...
			<input type="hidden" name="selcampos" value="flaprocodigo">
			<!--											-->
