<?php 
	...
	{ 
		...
		$extruido = ($sbreg['prodesextrui'] == 't')? 'Si' : 'No';
		$pigmen = ($sbreg['prodespigmen'] == 't')? 'Si' : 'No';
	} 
?>
<html> 
	<head> 
		<title>Detalle de registro de proveedores</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="450">
 			...
 			<input type="hidden" name="flagdetallarproveedesa" value="1"> 
			<input type="hidden" name="acciondetallarproveedesa">
