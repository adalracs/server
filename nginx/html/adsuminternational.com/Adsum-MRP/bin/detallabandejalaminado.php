<?php	
	...
	if($plantacodigo || $ordprodesemp || $ordprotiposo)
	{
		$record['plantacodigo'] = $plantacodigo;
		$recordop['plantacodigo'] = '=';
		$record['ordprodesemp'] = $ordprodesemp;
		$recordop['ordprodesemp'] = '=';
		$record['ordprotiposo'] = $ordprotiposo;
		$recordop['ordprotiposo'] = '=';
		$rsOp = dinamicscanopvistabandejalaminado($record, $recordop, $idcon);
	}
	else
	{
		$rsOp = fullscanvistabandejalaminado($idcon);
	}
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
	<tr>
		...
		<td class="ui-state-default" width="10%"  align="center">Anc.L&nbsp;<b>mm</b></td>
		<td class="ui-state-default" width="10%"  align="center">Anc.A&nbsp;<b>mm</b></td>
...
?>			
	<tr <?php echo $complement ?> >
		...
		<td width="10%" class="cont-line">&nbsp;<?php echo $rwOp['ordproanclam'] ?></td>
		<td width="10%" class="cont-line">&nbsp;<?php echo ($rwOp['ordproancalt'])? $rwOp['ordproancalt'] : '---' ;  ?></td>
		<td width="10%" class="cont-line">&nbsp;<?php echo $rwOp['pedvenfecent']; ?></td>
			...
			<div id="filtrOp_<?php echo $a ?>" style="display: none;" >
				<table border="0" cellspacing="1" cellpadding="1" style="border-top:none; border-right:none;" align="left" class="ui-widget-content" width="100%">
					<tr>
						...
						<td width="100" class="ui-state-default"><small>Laminado&nbsp;</small></td>
						<td width="180" class="ui-state-default"><small>Material&nbsp;</small></td>
					</tr>
					<tr class="<?php echo  $class ?>">
						...
						<td class="NoiseFooterTD" valign="top">&nbsp;<small><?php echo strtoupper($rwOp['ordprotiposo']); ?></small></td>
						<td class="NoiseFooterTD" valign="top">&nbsp;<small><?php echo strtoupper($rwOp['ordprodesemp']); ?></small></td>
						<td class="NoiseFooterTD" valign="top">&nbsp;<small><?php echo $rwOp['ordprolamina']; ?></small></td>
						<td class="NoiseFooterTD" valign="top">&nbsp;<small><?php echo '---'; ?></small></td>
					</tr>
				</table>
			</div>
		</td>
