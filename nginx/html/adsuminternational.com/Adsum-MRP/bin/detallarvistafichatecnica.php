...
<?php endif; ?>
			...
			<input type="hidden" name="flagdetallarvistafichatecnica" value="1"> 
			<input type="hidden" name="acciondetallarvistafichatecnica">
			<input type="hidden" name="pedvencodigo" value="<?php if(!$flagdetallarvistafichatecnica){ echo $sbreg[pedvencodigo];}else{ echo $pedvencodigo; }?>"> 
			<input type="hidden" name="produccodigo" id="produccodigo" value="<?php if(!$flagdetallarvistafichatecnica){ echo $sbreg[produccodigo];}else{ echo $produccodigo; } ?>"> 
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="detallar"> 
			<input type="hidden" name="accionnuevovistafichatecnica"> 
