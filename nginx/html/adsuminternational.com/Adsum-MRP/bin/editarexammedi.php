...
if($accioneditarexammedi) 
{ 
		include ( 'editaexammedi.php'); 
		$flageditarexammedi = 1;
}
ob_end_flush();
if(!$flageditarexammedi)
{
...
<html> 
<head> 
<title>Editar registro de exammedi</title> 
...
echo "*";}
?>Nombre</td>
  <td width="66%"><input type="text" name="examednombre"	value="<?php if(!$flageditarexammedi){
...
echo "*";}
?>Periodicidad</td>
                <td><input type="text" name="examedperiod"	value="<?php if(!$flageditarexammedi){
...
?>Descripci&oacute;n</td>
  <td rowspan="2"><textarea name="exameddescri" cols ="40" rows="3" wrap="VIRTUAL"><?php if(!$flageditarexammedi){
...
onclick="form1.accioneditarexammedi.value =  1;"  width="86" height="18" alt="Aceptar" border=0> 
...
if($campnomb){ echo '<font face="Verdana" >Corregir los campos marcados con *</font>';}
 ?>
 <input type="hidden" name="examedcodigo"	value="<?php if(!$flageditarexammedi){ echo $sbreg[examedcodigo];}else{ echo $examedcodigo;} ?>"> 
<input type="hidden" name="accioneditarexammedi"> 
