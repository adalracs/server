<?php 
	...
	if($accionnuevolistaempaque)
		include ( 'grabalistaempaque.php');
...
<?php endif; ?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
							<tr class="ui-widget-header">
								<td width="100%" class="cont-title">&nbsp;Orden de produccion {opp} No.&nbsp;<input type="text" name="ordoppcodigo" id="ordoppcodigo" size="13" value="<?php echo $ordoppcodigo; ?>" title="Digite el Numero de la Orden de produccion {opp}..."><button id="reloadform">Reload</button></td>
							</tr>
						</table>
					</td>
				</tr> 
				...
				<tr>
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
								...
								<td>
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
										<tr>
											...
											<td width="30%" class="NoiseDataTD">&nbsp;<select name="lisempestacodigo" id="lisempestacodigo">
											...
											<td width="30%" class="NoiseDataTD">&nbsp;<select name="plantacodigo" id="plantacodigo"><option value="">--Seleccione--</option>
													<?php 
										...
										<tr>
										  <td class="NoiseFooterTD">&nbsp;Entregado Por:</td>
										  <td class="NoiseDataTD">&nbsp;<?php echo cargausuanombre($usuacodi,$idcon);?></td>
										  <td class="NoiseFooterTD">&nbsp;<?php if($campnomb['lisempnumept'] == 1) echo '*';?>&nbsp;Numero EPT:</td>
										  <td class="NoiseDataTD">&nbsp;<input type="text" name="lisempnumept" id="lisempnumept" value="<?php echo $lisempnumept ?>"/></td>
									  </tr>
										<tr>
											<td width="20%" class="NoiseFooterTD"><?php if($campnomb['lisempdireccion'] == 1){$lisempdireccion = null; echo "*";}?>&nbsp;Direcci&oacute;n</td>
										...
										<tr><td colspan="4" rowspan="2" class="NoiseDataTD"><textarea name="lisempdescri" rows="3" cols="63"><?php if(!$flagnuevolistaempaque){ echo $sbreg[lisempdescri];}else{ echo $lisempdescri;} ?></textarea>  </td></tr>
									</table>
								</td>
							</tr>
							<!-- Datos de los reportes vienen de la orden de entrega -->
							<!--  <tr>
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
										<tr class="ui-state-default">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
										<tr>
											<td class="NoiseDataTD">
												<div id="listlistaempaquedet">
													<?php /*
														$noAjax = true;
														$flagdetallar = 1;
														include '../src/FunjQuery/jquery.visors/jq.vlistaempaquedet.php';*/
													?>
												</div>
												<input type="hidden" name="arrlistaempaquedet" id="arrlistaempaquedet" value="<?php //echo $arrlistaempaquedet ?>" /> 
												<input type="hidden" name="arrlistaempaquedettmp" id="arrlistaempaquedettmp" value="<?php //echo $arrlistaempaquedet ?>" />
											</td>
										</tr>
									</table>
								</td>
							...
							<!-- Datos de los reportes que se van a empacar -->
							<tr>
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
										<tr class="ui-state-default">
											<td class="cont-title">&nbsp;<?php if($campnomb["arrlistaempaque"] == 1){ $arrlistaempaque = null;echo "*";}?>Reporte Lista por Empacar</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
										<tr>
			...
			<input type="hidden" name="flagnuevolistaempaque">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="nuevo">  
			<input type="hidden" name="accionnuevolistaempaque"> 
