...
function editacausa($iRegcausa,&$flageditarcausa,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordcausa($iRegcausa,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editacausa($iRegcausa,$flageditarcausa,$campnomb,$codigo);
?> 
