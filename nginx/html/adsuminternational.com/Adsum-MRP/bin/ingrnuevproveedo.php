...
ob_start();
	...
	if($accionnuevoproveedo)
		include ( 'grabaproveedo.php');
ob_end_flush();
?>
<html> 
	<head> 
...
<?php endif; ?>
  					...
  					<td> 
            			<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr>
								...
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveenombre" size="60"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveenombre];}else {echo $proveenombre; }?>"></td> 
 							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveerepleg" size="50"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveerepleg];}else {echo $proveerepleg; }?>"></td> 
 							</tr>
							<tr>
								<td width="20%" class="NoiseFooterTD"><?php if($campnomb["proveetelefo"] == 1){ $proveetelefo = null; echo "*";}?>&nbsp;Tel&eacute;fono</td>
								<td width="30%" class="NoiseDataTD"><input type="text" name="proveetelefo" size="15"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveetelefo];}else {echo $proveetelefo; }?>"></td> 
								<td width="14%" class="NoiseFooterTD"><?php if($campnomb["proveefax"] == 1){ $proveefax = null; echo "*";}?>&nbsp;FAX</td>
								<td width="36%" class="NoiseDataTD"><input type="text" name="proveefax" size="15"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveefax];}else {echo $proveefax; }?>"></td> 
 							</tr>
      						<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["proveepais"] == 1){ $proveepais = null; echo "*";}?>&nbsp;Pa&iacute;s</td>
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveepais" size="40"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveepais];}else {echo $proveepais; }?>"></td> 
 							</tr>
      						<tr>
      						...
      						<tr>
								...
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveepostal" size="20"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveepostal];}else {echo $proveepostal; }?>"></td> 
 							</tr>
 							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["proveedirecc"] == 1){ $proveedirecc = null; echo "*";}?>&nbsp;Direcci&oacute;n</td>
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveedirecc" size="60"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveedirecc];}else {echo $proveedirecc; }?>"></td> 
 							</tr>
 							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["proveeemail"] == 1){ $proveeemail = null; echo "*";}?>&nbsp;E-mail</td>
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveeemail" size="50"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveeemail];}else {echo $proveeemail; }?>"></td> 
 							</tr>
 							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["proveeurl"] == 1){ $proveeurl = null; echo "*";}?>&nbsp;URL</td>
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveeurl" size="50"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveeurl];}else {echo $proveeurl; }?>"></td> 
 							</tr>
 							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["proveecontac"] == 1){ $proveecontac = null; echo "*";}?>&nbsp;Contacto</td>
								<td colspan="3" class="NoiseDataTD"><input type="text" name="proveecontac" size="50"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveecontac];}else {echo $proveecontac; }?>"></td> 
 							</tr>
							<tr>
								<td class="NoiseFooterTD"><?php if($campnomb["proveetelcon"] == 1){ $proveetelcon = null; echo "*";}?>&nbsp;Tel&eacute;fono</td>
								<td colspan="4" class="NoiseDataTD"><input type="text" name="proveetelcon" size="15"	value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveetelcon];}else {echo $proveetelcon; }?>"></td> 
							...
							<tr><td colspan="4" rowspan="2" class="NoiseDataTD"><textarea name="proveenota" rows="3" cols="110"><?php if(!$flagnuevoproveedo){ echo $sbreg[proveenota];}else{ echo $proveenota;} ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
 			...
 			<input type="hidden" name="proveecodigo" value="<?php if(!$flagnuevoproveedo){ echo $sbreg[proveecodigo];}else{ echo $proveecodigo;} ?>">
			<input type="hidden" name="accionnuevoproveedo">
