...
<title>Borrar registro de componen</title> 
...
align="center"> 
              <tr> 
 <td width="18%" class="NoiseFooterTD">&nbsp;C&oacute;digo</td> 
  <td width="31%" class="NoiseDataTD"><?php if(!$flagdetallarcomponen){ 
echo $sbreg[componcodigo];}else {echo $componcodigo;}?></td> 
 <td width="18%" class="NoiseFooterTD">&nbsp;</td> 
...
echo $equiponombre;} ?></td>
			...
			<tr><td class="NoiseErrorDataTD" colspan="4"></td></tr>
 <tr>
 <td width="18%" class="NoiseFooterTD">&nbsp;Fabricante</td>
<td width="31%" class="NoiseDataTD"><?php if(!$flagdetallarcomponen){ 
echo $sbreg[componfabric];} else {echo $componfabric;} ?></td> 
  <td width="18%" class="NoiseFooterTD"><span class="NoiseFooterTD">&nbsp;Marca</span></td> 
  <td width="33%" class="NoiseDataTD"><?php if(!$flagdetallarcomponen){ 
echo $sbreg[componmarca];}else {echo $componmarca;}?></td> 
 </tr> 
<tr> 
 <td width="18%" class="NoiseFooterTD">&nbsp;Modelo</td> 
  <td width="31%" class="NoiseDataTD"><?php if(!$flagdetallarcomponen){ 
echo $sbreg[componmodelo];} else {echo $componmodelo;} ?></td> 
 <td width="18%" class="NoiseFooterTD"><span class="NoiseFooterTD">&nbsp;No. de serie </span></td> 
  <td width="33%" class="NoiseDataTD"><?php if(!$flagdetallarcomponen){ 
...
onclick="form1.accionborrarcomponen.value =  1; 
...
alt="Cancelar" border=0> 
 ...
 <input type="hidden" name="flagborrarcomponen" value="1"> 
<input type="hidden" name="accionborrarcomponen"> 
<input type="hidden" name="codigo" value="<?php echo $codigo; ?>"> 
<input type="hidden" name="componcodigo" value="<?php if(!$flagdetallarcomponen){ 
echo $sbreg[componcodigo];}else {echo $componcodigo;} ?>"> 
</form> 
</body> 
<?php 
if(!$codigo)
