...
if($accionnuevotipooferta) 
{ 
	include ( 'grabatipooferta.php'); 
} 
ob_end_flush(); 
?> 
...
<html> 
<head> 
<title>Nuevo registro de tipo de oferta</title> 
...
color="FFFFFF"> 
Ingresar nuevo tipo de oferta</font></span></td></tr> 
<tr> 
  <td> 
...
if(!$flagnuevotipooferta){ echo $sbreg[tipofenombre];}else{ echo $tipofenombre; 
}?>"> 
 </td> 
 </tr> 
<tr>
...
<?php
if(!$flagnuevotipooferta)
{
 echo '<option value="">Seleccione';
}
else if($accionnuevotipooferta)
{
	if($estadocodigo)
	{
...
if(!$flagnuevotipooferta){ echo $sbreg[tipofedescri];}else{ echo $tipofedescri;}?></textarea>
 </td> 
 </tr> 
 <tr> 
  <td width="41%">&nbsp;</td> 
...
onclick="form1.accionnuevotipooferta.value =  1;"  width="86" height="18" 
...
if(!$flagnuevotipooferta){ echo $sbreg[tipofecodigo];}else{ echo $tipofecodigo; 
} ?>"> 
<input type="hidden" name="accionnuevotipooferta"> 
