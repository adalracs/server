<?php 	
	include_once ( "../src/FunPerPriNiv//pktbltipomaterial.php"); 
...
<html> 
	<head> 
		<title>Consultar grupo gerencial</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr>
								...
								<td width="80%" class="NoiseDataTD"><input type="text" name="grugercodigo" size="30" value="<?php echo $grugercodigo; ?>"></td> 
 							</tr>
							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Nombre</td>
								<td width="80%" class="NoiseDataTD"><input type="text" name="grugernombre" size="30" value="<?php echo $grugernombre; ?>"></td> 
 							</tr>
 							<tr>
								<td width="20%" class="NoiseFooterTD">&nbsp;Tipo material</td>
 			...
 			<input type="hidden" name="flagconsultargrupogerencial" value="1"> 
			<input type="hidden" name="accionconsultargrupogerencial"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="grugercodigo, grugernombre, tipmatcodigo">
