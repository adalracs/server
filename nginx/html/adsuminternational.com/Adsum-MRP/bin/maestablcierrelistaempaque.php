...
include ('../src/FunPerPriNiv/pktblvistacierrelistaempaque.php');
...
if ($accionborrarcierrelistaempaque) { 
	include ('borracierrelistaempaque.php'); 
} else { 
	if ($accionconsultarcierrelistaempaque) { 
		$nusw = 0; 
...
$intervalo = fncaumdec ( 'vistacierrelistaempaque', $inicio, $fin, $mov, $accionconsultarcierrelistaempaque, $recarreglo ); 
...
<html> 
<head> 
<title>Lista de Empaque {lep}</title> 
...
<p><font class="NoiseFormHeaderFont">Cierre de Lista de Empaque</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="70%"> 
	<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablcierrelistaempaque.php', $flagcheck ); ?></td></tr> 
	<tr><td>&nbsp;</td></tr> 
	<tr><td>&nbsp;</td></tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisreglistaempaque.php'); 
				$reg [0] = 'lisempcodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreglistaempaque ( 'vistacieerrelistaempaque', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> 
		...
		page_position ( $intervalo, 'maestablcierrelistaempaque.php', $flagcheck ); 
		?></td> 
	</tr> 
</table> 
...
<input type="hidden" name="sourcetable" value="cierrelistaempaque"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistacierrelistaempaque"> 
<input type="hidden" name="columnas" value="lisempcodigo"> 
<input type="hidden" name="ordentcodigo" value="<?php if ($accionconsultarcierrelistaempaque) { echo $lisempcodigo; } ?>">  
<input type="hidden" name="accionconsultarcierrelistaempaque"	value="<?php echo $accionconsultarcierrelistaempaque; ?>"> 
