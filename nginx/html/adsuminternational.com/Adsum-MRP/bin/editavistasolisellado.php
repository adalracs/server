...
for($a = 0;$a < $nr_op;$a++){
	...
	$iRegopsellado[ordprocalib] = $$obj_calibre;
	$iRegopsellado[ordprocantid] = $$obj_cant_kg;
	$iRegopsellado[ordproanchop] = $$obj_ancho;
	$iRegopsellado[ordproanchom] = $ancho;
	$iRegopsellado[ordpropista] = $nropistas;
	$iRegopsellado[ordprometros] = $$obj_cant_mt;	
...
//desconectar
$flageditarvistasolisellado = 1;
fncclose($idcon);
fncmsgerror(editaEx);
echo '<script language="javascript">';
echo '<!--//'."\n";
echo 'location ="maestablvistasolisellado.php?codigo='.$codigo.';"';
echo '//-->'."\n";
echo '</script>';
?>