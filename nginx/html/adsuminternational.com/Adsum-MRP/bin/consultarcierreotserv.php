...
<html> 
<head> 
<title>Consultar Cierre OS</title> 
...
<body bgcolor="FFFFFF" text="#000000">
 ...
 <p><font class="NoiseFormHeaderFont">Cierre de OS</font></p>
...
align="center"> 
<tr> 
 <td width="20%" class="NoiseFooterTD">&nbsp;C&oacute;digo cierre</td> 
  <td width="25%"> 
   <input type="text" name="cierotcodigo"	value="<?php 
if(!$flagconsultarcierreotserv){ echo $sbreg[cierotcodigo];}else{ echo 
$cierotcodigo;} ?>"> 
  </td> 
 </tr>
<tr> 
 <td width="20%" class="NoiseFooterTD">&nbsp;No. Orden</td> 
  <td width="25%"> 
   <input type="text" name="ordtracodigo"	value="<?php 
if(!$flagconsultarcierreotserv){ echo $sbreg[ordtracodigo];}else{ echo 
$ordtracodigo;} ?>"> 
  </td> 
 
 <td width="20%"  class="NoiseFooterTD">&nbsp;ODS</td> 
  <td width="25%"> 
   <input type="text" name="clientsolici"	value="<?php 
if(!$flagconsultarcierreotserv){ echo $sbreg[clientsolici];}else{ echo $clientsolici;} 
?>"> 
  </td> 
 </tr> 
<!--<tr> 
...
<tr> 
 <td width="20%"  class="NoiseFooterTD">&nbsp;Tipo de orden</td> 
										<td width="25%"><select name="tareacodigo">
										<?php
 ...
 <td width="20%"  class="NoiseFooterTD">&nbsp;Servicio</td> 
										<td width="25%"> <select name="servicicodigo">
									      	<?php
...
onclick="form1.accionconsultarcierreot.value =  1; 
form1.action='maestablcierreotserv.php';"  width="86" height="18" alt="Aceptar" 
border=0> 
  <input type="image" name="cancelar" src="../img/cancelar.gif" 
onclick="form1.action='maestablcierreotserv.php';"  width="86" height="18" 
...
<input type="hidden" name="accionconsultarcierreot"> 
