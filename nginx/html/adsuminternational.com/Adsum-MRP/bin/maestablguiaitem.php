...
include ( '../src/FunPerPriNiv/pktblguiaitem.php'); 
include ( '../src/FunPerPriNiv/pktbltransportadora.php');
include ( '../src/FunGen/sesion/fncalmdat.php'); 
include ( '../src/FunGen/sesion/fnccaf.php'); 
$reccomact.= fnccaf($GLOBALS[usuacodi],$PATH_TRANSLATED); 
if($accionborrarguiaitem) 
{ 
	include ( 'borraguiaitem.php'); 
} 
else 
{ 
		if($accionconsultarguiaitem) 
			{ 
...
<html> 
<head> 
<title>Registros de Guia de item</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de guias de item</font><br><br></p> 
...
onclick="form1.mov.value = 'menos';form1.action='maestablguiaitem.php';" 
alt="Anterior"></td> 
 <td width="46"><font size="2" color="#CC9900">Anterior</font></td> 
 <td width="50"> 
  <?php
	$intervalo = fncaumdec('guiaitem',$inicio,$fin,$mov,$accionconsultarguiaitem,$recarreglo); 
...
onclick="form1.mov.value = 'mas';form1.action='maestablguiaitem.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarguiaitem.php'."'".';"  width="87" 
height="19"  alt="Ver detalle" border=0></b>'; 
} 
if($reccomact[borrar]){ 
echo '<b><input type="image" name="borrar"  src="../img/borrar.gif" 
onclick="form1.action='."'".'borrarcostoguiaitem.php'."'".';"  width="87" 
...
onclick="form1.action='."'".'editarguiaitem.php'."'".';"  width="87" 
...
color="#FFFFFF">Empresa transportadora</font></span></td> 
<td width="20%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">N�mero de guia</font></span></td>   
</tr> 
<?php 
include ( '../src/FunGen/sesion/fncvisregguiaitem.php'); 
	$reg[0] = 'codguiaitem'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisregguiaitem('guiaitem',$reg,$reg1,$idtrans); 
?> 
   </table> 
   </td> 
  </tr> 
...
onclick="form1.mov.value = 'primero';form1.action='maestablguiaitem.php';" 
alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value = 
'menos';form1.action='maestablguiaitem.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value = 'ultimo';form1.action='maestabguiaitem.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
 ...
 <input type="hidden" name="nombtabl" value="guiaitem"> 
<input type="hidden" name="columnas" value="codguiaitem, 
codtransportadora, 
artcomcodigo, 
numeroguia 
"> 
 <input type="hidden" name="codguiaitem" value="<?php echo $codguiaitem; ?>">  
 <input type="hidden" name="codtransportadora" value="<?php echo $codtransportadora; ?>"> 
 <input type="hidden" name="artcomcodigo" value="<?php echo $artcomcodigo; ?>"> 
 <input type="hidden" name="numeroguia" value="<?php echo $numeroguia; ?>"> 
 <input type="hidden" name="accionconsultarguiaitem" value="<?php echo 
$accionconsultarguiaitem; ?>"> 
