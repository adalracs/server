...
<?php 
		for($b = 0; $b < $nrTroquelado; $b++):
			...
			$SPANTROQUELADO = ($rwTroquelado['equipocodigo'])? 'ui-icon ui-icon-check' : 'ui-icon ui-icon-help' ;
...
?>			
	<tr <?php echo $complement ?>">
		...
		<td class="cont-line">&nbsp;<span class="<?php echo $SPANTROQUELADO; ?>" style="float: left; margin-right: .3em;"></span></td>
	</tr>
	<tr <?php echo $complement ?>">
		<td></td>
		<td colspan="11">
