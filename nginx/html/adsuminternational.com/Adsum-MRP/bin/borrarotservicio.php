...
<html>
	<head>
		<title>Borrar registro de ot servicio</title>
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			...
			<table width="643"  border="0" align="center" cellpadding="2" cellspacing="1" class="NoiseFormTABLE">
 			...
 			<tr>
				<td><div align="center"> 
  					<input type="image" name="aceptar"  src="../img/aceptar.gif" onclick="form1.accionborrarotservicio.value =  1; form1.action='maestablotservicio.php';"  width="86" height="18" alt="Aceptar" border=0> 
