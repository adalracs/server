...
<p><font class="NoiseFormHeaderFont">Colaborador</font></p> 
...
form1.action='maestablusuarigrupcc.php';"  width="86" height="18" alt="Aceptar" 
border=0> 
  <input type="image" name="cancelar" src="../img/cancelar.gif" 
onclick="form1.action='maestablusuarigrupcc.php';"  width="86" height="18" 
