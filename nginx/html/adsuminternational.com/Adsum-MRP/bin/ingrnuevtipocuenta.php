<?php 
	...
	if($accionnuevotipocuenta)
		include ( "grabatipocuenta.php");
...
<html> 
	<head> 
		<title>Nuevo registro tipo cuenta</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Tipo cuenta</font></p> 
...
<?php endif; ?> 
			...
			<input type="hidden" name="accionnuevotipocuenta">  
