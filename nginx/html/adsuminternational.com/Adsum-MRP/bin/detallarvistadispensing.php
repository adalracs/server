<?php 
	...
	if(!$flagdetallarvistadispensing) 
	{ 
		$idcon = fncconn();
...
<?php if (! $codigo) echo "<!--"; ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post" enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">&Iacute;tem / Dispensing</font></p> 
...
<?php endif; ?>
					...
					<td>
						<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							<tr>
  								...
  								<td width="80%" class="NoiseDataTD">&nbsp;<?php echo ($equipocodigo)? strtoupper($equipocodigo) : '-------' ; ?> - <?php echo ($equiponombre)? strtoupper($equiponombre) : '-------' ; ?></td>
  							</tr>
  							<tr>
  								<td colspan="2">
			...
			<input type="hidden" name="flagdetallarvistadispensing" value="1"> 
			<input type="hidden" name="acciondetallarvistadispensing">
			<input type="hidden" name="pedvencodigo" value="<?php if(!$flagdetallarvistadispensing){ echo $sbreg[pedvencodigo];}else{ echo $pedvencodigo; }?>"> 
			<input type="hidden" name="produccodigo" value="<?php if(!$flagdetallarvistadispensing){ echo $sbreg[produccodigo];}else{ echo $produccodigo; } ?>"> 
