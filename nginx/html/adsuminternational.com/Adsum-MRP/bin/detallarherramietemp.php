...
<html> 
<head> 
<title>Detalle de registro de herramietemp</title> 
...
if(!$flagdetallarherramietemp){ echo $sbreg[hertemcodigo];}else{ echo 
$hertemcodigo; } ?>"> 
</td> 
</tr> 
<tr> 
...
if(!$flagdetallarherramietemp){ echo $sbreg[cencoscodigo];}else{ echo 
...
if(!$flagdetallarherramietemp){ echo $sbreg[hertemnombre];}else{ echo 
...
if(!$flagdetallarherramietemp){ echo $sbreg[hertemvalor];}else{ echo 
...
if(!$flagdetallarherramietemp){ echo $sbreg[hertemdescri];}else{ echo 
...
if(!$flagdetallarherramietemp){ echo $sbreg[hertemdispon];}else{ echo 
...
alt="Aceptar" border=0> 
 ...
 <input type="hidden" name="flagdetallarherramietemp" value="1"> 
<input type="hidden" name="acciondetallarherramietemp"> 
