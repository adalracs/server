...
<html> 
<head> 
<title>Borrar registro de Modulo</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionborrarmodulo.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagborrarmodulo){ echo $sbreg[moducodi];}else{ echo $moducodi; } ?>" 
...
sans-serif">Descripción</font></td> 
                <td width="59%"> 
                  <input type="text" name="modudesc" value="<?php 
if(!$flagborrarmodulo){ echo $sbreg[modudesc];}else{ echo $modudesc;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
src="../img/aceptar.gif" 
onclick="foo();form1.action='maestablmodulo.php';submit();"  width="86" 
height="18" align="right" alt="Aceptar" border=0></td> 
          <td width="47%"><input type="image" name="cancelar"  
src="../img/cancelar.gif" 
onclick="form1.action='maestablmodulo.php';submit();"  width="86" height="18" 
...
<input type="hidden" name="flagborrarmodulo" value="1"> 
<input type="hidden" name="accionborrarmodulo"> 
