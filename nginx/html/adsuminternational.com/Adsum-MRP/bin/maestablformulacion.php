...
ob_start(); 
	...
	if($accionborrarformulacion) 
		include ( 'borraformulacion.php'); 
	else 
	{ 
		if($accionconsultarformulacion) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarformulacion = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('vistaformulacion',$inicio,$fin,$mov,$accionconsultarformulacion,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de formulacion</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de formulacion</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="570">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablformulacion.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="60%" class="ui-state-default">Responsable</td>
								<td width="20%" class="ui-state-default">Fecha</td>  
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregformulacion.php'); 
								$reg[0] = 'formulcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregformulacion('vistaformulacion', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
			...
			<input type="hidden" name="columnas" value="formulcodigo,formulnumero,formulfecha"> 
			<input type="hidden" name="formulcodigo" value="<?php if($accionconsultarformulacion) echo $formulcodigo; ?>"> 
