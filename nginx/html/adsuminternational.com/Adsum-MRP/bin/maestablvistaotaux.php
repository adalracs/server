...
onclick="form1.action='consultarvistaotaux.php';"  width="86" height="18" 
alt="Volver" border=0>
 </td> 
 <td width="42"> 
  <input type="image" name="adelanta"  src="../img/adelanta.gif" 
onclick="form1.mov.value = 'menos';form1.action='maestablvistaotaux.php';" alt="Anterior"></td> 
...
onclick="form1.mov.value='mas'; form1.action='maestablvistaotaux.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
  <td colspan="6">
  <div align="right">&nbsp;</div>
...
onclick="form1.mov.value='primero'; form1.action='maestablvistaotaux.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="form1.mov.value='menos'; form1.action='maestablvistaotaux.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
...
onclick="form1.mov.value='ultimo'; form1.action='maestablvistaotaux.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6" class="NoiseErrorDataTD">&nbsp;</td> 
  </tr> 
