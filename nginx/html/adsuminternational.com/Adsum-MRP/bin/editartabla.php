...
<html> 
<head> 
<title>Editar registro de tabla</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accioneditartabla.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flageditartabla){ echo $sbreg[tablcodi];}else{ echo $tablcodi; } ?>" 
...
if(!$flageditartabla){ echo $sbreg[tablnomb];}else{ echo $tablnomb;} ?>"> 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
if(!$flageditartabla){ echo $sbreg[tabldesc];}else{ echo $tabldesc;} ?>"> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%">&nbsp;</td> 
...
<input type="hidden" name="flageditartabla" value="1"> 
<input type="hidden" name="accioneditartabla"> 
