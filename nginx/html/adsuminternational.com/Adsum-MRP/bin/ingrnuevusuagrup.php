...
<html> 
<head> 
<title>Nuevo registro de Usuario-Grupo</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionnuevousuagrup.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
<input type="hidden" name="flagnuevousuagrup" value="1"> 
<input type="hidden" name="accionnuevousuagrup"> 
