...
<html> 
<head> 
<title>Borrar registro de Campo</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionborrarcampo.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagborrarcampo){ echo $sbreg[tablcodi];}else{ echo $tablcodi; } ?>" 
...
if(!$flagborrarcampo){ echo $sbreg[campcodi];}else{ echo $campcodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarcampo){ echo $sbreg[campnomb];}else{ echo $campnomb;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarcampo){ echo $sbreg[campdesc];}else{ echo $campdesc;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagborrarcampo" value="1"> 
<input type="hidden" name="accionborrarcampo"> 
