<?php	
	...
	//conexion
	$idcon = fncconn();
	//validacion de filtros para la bandeja de troquelado
	if($plantacodigo)
	{
		$record['plantacodigo'] = $plantacodigo;
		$recordop['plantacodigo'] = '=';
		$rsOp = dinamicscanopvistabandejatroquelado($record, $recordop, $idcon);
	}
	else
	{
		$rsOp = fullscanvistabandejatroquelado($idcon);
	}
