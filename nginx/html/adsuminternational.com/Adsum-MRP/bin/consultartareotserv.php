...
<html> 
<head> 
<title>Consultar en Gestion de Orden de servicio</title> 
...
<body bgcolor="FFFFFF" text="#000000">
 <font class="NoiseFormHeaderFont">Gestion de Orden de servicio</font>
...
onclick="form1.accionconsultarvistamaxtareot.value =  1; 
form1.action='maestabltareotserv.php';"  width="86" height="18" alt="Aceptar" 
border=0> 
  <input type="image" name="cancelar" src="../img/cancelar.gif" 
onclick="form1.action='maestabltareotserv.php';"  width="86" height="18" 
...
<input type="hidden" name="accionconsultarvistamaxtareot"> 
