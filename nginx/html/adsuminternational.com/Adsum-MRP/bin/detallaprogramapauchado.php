<!--  division contenedora del programa de pauchado-->
<?php 
	...
	if(!$noAjax)
	{
		...
		require_once ( '../src/FunPerPriNiv/pktblprogramapauchado.php');
		...
		require_once ( '../src/FunPerPriNiv/pktbloppauchado.php');
...
<div id="programapauchado">
	...
	<div id="<?php echo $obj_tab ?>" >
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include '../src/FunjQuery/jquery.visors/gestionopp/jquery.programapch.php';
        			break;
    			case "reporteopp":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programapch.php';
        			break;
    			case "gestionopparte":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programapch.php';
        			break;
        		...
        		case "gestionopprequisicion":
        			include '../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programapch.php';
        			break;
        		...
        		case "gestionoppanalisispr":
        			...
        			break;
        		default:
       				include '../src/FunjQuery/jquery.visors/programacion/jquery.programapch.php';
       				break;
			}
