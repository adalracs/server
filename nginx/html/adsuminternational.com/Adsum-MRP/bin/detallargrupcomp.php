...
<html> 
<head> 
<title>Detalle de registro de Grupo Comp</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.acciondetallargrupcomp.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
sans-serif">Código grupo</font></td> 
                <td width="59%"> 
                  <input type="text" name="grupcodi" value="<?php 
if(!$flagdetallargrupcomp){ echo $sbreg[grupcodi];}else{ echo $grupcodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
sans-serif">Código componente</font></td> 
                <td width="59%"> 
                  <input type="text" name="mecocodi" value="<?php 
if(!$flagdetallargrupcomp){ echo $sbreg[mecocodi];}else{ echo $mecocodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagdetallargrupcomp" value="1"> 
<input type="hidden" name="acciondetallargrupcomp"> 
