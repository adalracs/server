...
<TR>
  <TD align="left" colspan="2"><IMG src="<?php echo  fnccargapresentac(3); ?>" alt="Adsum Kallpa" /></TD>
 </TR>
 <TR>
  <TD>&nbsp;</TD>
...
<BR/>
<?php 
include("../src/FunGen/fnccalctasarepar.php");
ob_start();
fnccalctimedrep($strdata, $fecini, $fecfin);
