...
<html> 
<head> 
<title>Detalle de registro de Numerador</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.acciondetallarnumerado.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
if(!$flagdetallarnumerado){ echo $sbreg[numecodi];}else{ echo $numecodi; } ?>" 
...
if(!$flagdetallarnumerado){ echo $sbreg[numedesc];}else{ echo $numedesc;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
sans-serif">Aproximación</font></td> 
                <td width="59%"> 
                  <input type="text" name="numeprox" value="<?php 
if(!$flagdetallarnumerado){ echo $sbreg[numeprox];}else{ echo $numeprox; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagdetallarnumerado" value="1"> 
<input type="hidden" name="acciondetallarnumerado"> 
