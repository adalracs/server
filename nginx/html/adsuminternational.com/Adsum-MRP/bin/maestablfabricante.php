...
ob_start(); 
	...
	if($accionborrarfabricante) 
		include ( 'borrafabricante.php'); 
	else 
	{ 
		if($accionconsultarfabricante) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarfabricante = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('fabricante',$inicio,$fin,$mov,$accionconsultarfabricante,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de fabricante</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de fabricante</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablfabricante.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="50%" class="ui-state-default">Pais</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregfabriproveedo.php'); 
								$reg[0] = 'fabricodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregfabriproveedo('fabricante', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="fabricante"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="fabricante"> 
			...
			<input type="hidden" name="selcampos" value="fabricodigo">
			<!--											-->
