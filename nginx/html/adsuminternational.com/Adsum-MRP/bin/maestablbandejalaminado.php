...
ob_start();
	...
	$idcon = fncconn();
	$rs_equipo = fullscanprogramalaminadodisctequipo($idcon);
	...
	for($a = 0;$a < $nr_equipo;$a++)
	{
		...
		//consulta dinamica al programa de laminado
		$rs_opp = dinamicscanopprogramalaminado1(array('equipocodigo' => $equipo),array('equipocodigo' => '='),$idcon);
...
<html>
	<head>
		<title>Bandeja de solicitudes laminado</title>
	...
	<body bgcolor="FFFFFF" text="#000000">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<!--<p><font class="NoiseFormHeaderFont">{Laminado}</font></p>-->
			<div id="bandejaotgeneral" style="width:900px;align:center;margin-left:20px;">
				<ul>
					<li><a href="#tabs-1"><span class="ui-icon ui-icon-clipboard" style="float: left; margin-right: .3em;"></span>Bandeja laminado.</a></li>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
											...
											<div id="filopsbandejaop" style="padding: 2px 2px 2px 2px; display:block" >
						        				<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
						        					<tr>
														...
														<td width="10%"  class="NoiseFooterTD">&nbsp;Desempe&ntilde;o</td>
														<td width="40%"  class="NoiseFooterTD">&nbsp;<select name="ordprodesemp" id="ordprodesemp" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php
																include ('../src/FunGen/floadvistabandejalaminado.php');
																floadvistabandejalaminado_desemp($ordprodesemp,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														<td width="10%"  class="NoiseFooterTD">&nbsp;Tipo</td>
														<td colspan="3" class="NoiseFooterTD">&nbsp;<select name="ordprotiposo" id="ordprotiposo" onchange="ajax_filtro();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejalaminado_tiposo($ordprotipo,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
										<td class="ui-state-default">
											<div id="detallebandejalaminado" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallabandejalaminado.php'; ?>
											</div>
										</td>
									</tr>
									<tr>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[nuevo] && !$flagcheck)
										echo '<button id="generaropp_lmn">Generar [opp]</button>&nbsp';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
			    		...
			    		<tr>
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
											...
											<div id="filopsbandejaopp" style="padding: 2px 2px 2px 2px; display:block;" >
						        				<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center">
						        					<tr>
														...
														<td width="10%"  class="NoiseFooterTD">&nbsp;Desempe&ntilde;o</td>
														<td width="40%"  class="NoiseFooterTD">&nbsp;<select name="ordprodesemp_opp" id="ordprodesemp_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejalaminado_desempopp($ordprodesemp_opp,$idcon);
															?>
														</select></td>
													</tr>
													<tr>
														<td width="10%"  class="NoiseFooterTD">&nbsp;Tipo</td>
														<td colspan="3" class="NoiseFooterTD">&nbsp;<select name="ordprotiposo_opp" id="ordprotiposo_opp" onchange="ajax_filtroopp();">
															<option value = "">-- Seleccione --</option>
															<?php
																floadvistabandejalaminado_tiposoopp($ordprotiposo_opp,$idcon);
															?>
														</select></td>
													</tr>
						                   		</table>
									...
									<tr>
										<td class="ui-state-default">
											<div id="detalleordenlaminado" style="height: 350px; margin:0 auto; overflow:auto;">
												<?php $noAjax = true;include 'detallaordenlaminado.php'; ?>
											</div>
										</td>
									</tr>						                   				
									<tr>
							...
							<td class="NoiseErrorDataTD" align="center"><div class="ui-buttonset">
								<?php  		
									if($reccomact[modificar] && !$flagcheck)
										echo '<button id="editaropp_lmn">Editar [opp]</button>';
								?>
							</div></td>
						</tr>
						<tr><td>&nbsp;</td></tr> 
