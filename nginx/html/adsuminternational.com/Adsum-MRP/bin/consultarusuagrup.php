...
<html> 
<head> 
<title>Consultar en Usuario-Grupo</title> 
...
<script language="JavaScript"> 
<!-- Begin 
	function foo(){ form1.accionconsultarusuagrup.value =  1; } 
//  End --> 
</script> 
</head> 
<?php 
...
sans-serif">Código de  grupo</font></td> 
                <td width="59%"> 
                  <select name="grupcodi" onChange="submit();"></select> 
                </td> 
              </tr> 
              <tr> 
                <td width="41%"><font size="2" face="Arial, Helvetica, 
...
<input type="hidden" name="flagconsultarusuagrup" value="1"> 
<input type="hidden" name="accionconsultarusuagrup"> 
...
usuacodi 
"> 
<input type="hidden" name="nombtabl" value="usuagrup"> 
</form> 
</body> 
<?php 
    if(!$codigo) 
