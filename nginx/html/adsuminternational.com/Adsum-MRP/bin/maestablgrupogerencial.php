<?php 
	...
	if ($accionborrargrupogerencial) { 
		include ("borragrupogerencial.php"); 
	} else { 
		if ($accionconsultargrupogerencial) { 
			$nusw = 0; 
			...
			if (! $nusw) { 
				$accionconsultargrupogerencial = 0; 
			} 
		} 
	} 
	...
	$intervalo = fncaumdec ( "grupogerencial", $inicio, $fin, $mov, $accionconsultargrupogerencial, $recarreglo ); 
...
<html> 
<head> 
<title>Listado de grupos gerenciales</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de grupos gerenciales</font></p> 
<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="700"> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablgrupogerencial.php', $flagcheck ); ?></td> </tr> 
	<tr> <td>&nbsp;</td> </tr> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<td width="50%" class="ui-state-default tbl-head-font">Nombre</td>				
				<td width="30%" class="ui-state-default tbl-head-font">Tipo material</td>	
			</tr>
				<?php 
				include ('../src/FunGen/sesion/fncvisreggrupogerencial.php'); 
				$reg [0] = 'grugercodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisreggrupogerencial ( 'grupogerencial', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> <td>&nbsp;</td> </tr> 
	<tr> <td class="NoiseErrorDataTD" align="right"> <?php page_position ( $intervalo, 'maestablgrupogerencial.php', $flagcheck ); ?></td> 
	</tr> 
</table> 
<input type="hidden" name="codigo" value="<?php echo $codigo; ?>"> 
<input type="hidden" name="inicio" value="<?php echo $intervalo ["inicio"];	?>"> 
<input type="hidden" name="fin"	value="<?php echo $intervalo ["fin"];	?>"> 
<input type="hidden" name="sourcetable" value="grupogerencial"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="grupogerencial"> 
<input type="hidden" name="columnas" value="grugercodigo, grugernombre, grugerdescri"> 
...
<input type="hidden" name="accionconsultargrupogerencial"	value="<?php echo $accionconsultargrupogerencial; ?>"> 
