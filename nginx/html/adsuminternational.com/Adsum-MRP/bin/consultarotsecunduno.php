...
<tr> 
  <td> 
     ...
     <td align="left">Fecha : <input type="text" name="ordtrafecgen" value="<?php if(!$flagconsultarvistaot){ echo $sbreg[ordtrafecgen];}else{ echo $ordtrafecgen;} ?>" size="10">&nbsp;&nbsp;aaaa-mm-dd</td>
	</tr>
		<tr>
			<td colspan="6"><hr></td>
		</tr>
...
<tr>
  ...
  <td colspan="2">
		...
		<tr>
            ...
            <td colspan="2"><input name="ordtrafecini" type="text"	value="<?php if(!$flagconsultarvistaot){echo $sbreg[ordtrafecini];}else{ echo $ordtrafecini;}?>" size="10" maxlength="10">&nbsp;<span class="style1">aaaa-mm-dd</span>
			</td>
  		...
  		<tr>
 			<td width="16%">Fecha de fin</td>
  			<td colspan="2"><input name="ordtrafecfin" type="text"	value="<?php if(!$flagconsultarvistaot){echo $sbreg[ordtrafecfin];}else{ echo $ordtrafecfin;}?>" size="10" maxlength="10">&nbsp;<span class="style1">aaaa-mm-dd</span>
			</td>
      ...
      <td colspan="2"><?php if($campnomb == "usuacodi")echo "*";?>
        ...
        <td>
<!--        <input name="empleacod" type="text"	value="<?php /* if(!$flagnuevoot){ echo $empleacod;} else {echo $empleacod;} */?>" size="8">-->
      ...
      <!--<input  name="empleanomb" type="text" value="<?php /* echo $empleanomb;*/?>" size="25" onFocus="if (!agree)this.blur();">--></td>
...
onclick="form1.accionconsultarvistaot.value =  1; form1.action='maestablotsecunduno.php';"  
