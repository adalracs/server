...
ob_start(); 
	...
	if($accioneditartipodespacho){ 
		include ( 'editatipodespacho.php'); 
...
<html> 
	<head> 
		<title>Editar registro de tipo de despachos</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table width="350" border="0" align="center" cellpadding="0" cellspacing="0" class="NoiseFormTABLE"> 
  				...
  				<tr> 
  					<td> 
            			<table width="85%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr> 
 								<td width="41%" class="NoiseDataTD"><?php if($campnomb["tipdesnombre"] == 1){$tipdesnombre = null; echo "*";} ?>&nbsp;Nombre tipo despacho</td> 
 								<td width="59%"><input type="text" name="tipdesnombre"	value="<?php if(!$flageditartipodespacho){ echo $sbreg[tipdesnombre];}else{ echo $tipdesnombre; }?>"></td> 
 							</tr> 
  							<tr>
 								<td width="41%" class="NoiseDataTD"> <?php if($campnomb["tipdesdescri"] == 1){ $tipdesdescri=null; echo "*";} ?>&nbsp;Descripci&oacute;n</td>
  								<td rowspan="2"><textarea name="tipdesdescri" rows="3" wrap="VIRTUAL"><?php if(!$flageditartipodespacho){echo $sbreg[tipdesdescri];}else {echo $tipdesdescri;}?></textarea></td>
 							</tr>
 				...
 				<tr> 
					<td><div align="center"> 
  						<input type="image" name="aceptar"  src="../img/aceptar.gif" onclick="form1.accioneditartipodespacho.value =  1;"  width="86" height="18" alt="Aceptar" border=0> 
...
<?php if($campnomb){echo '<font face = "Verdana" >Corregir los capos marcados con *</font>';} ?> 
			<input type="hidden" name="tipdescodigo" value="<?php if(!$flageditartipodespacho){ echo $sbreg[tipdescodigo];}else{ echo $tipdescodigo; } ?>"> 
