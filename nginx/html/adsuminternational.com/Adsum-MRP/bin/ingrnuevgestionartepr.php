<?php
	...
	if($accionnuevogestionartepr) 
		include ( 'grabagestionartepr.php');
...
<html> 
	<head> 
		...
		<script type="text/javascript" src="../src/FunjQuery/jquery.jsscripts/jquery.function_gestionartepr.js"></script>
		<style type="text/css">
...
<?php endif; ?>
					...
					<td>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
							...
							<tr>
								...
								<td colspan="3" class="NoiseDataTD">&nbsp;<?php echo ($ordcomcodcli)? strtoupper($ordcomcodcli) : '---' ; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="	20%" class="NoiseFooterTD"><?php if($campnomb["gesartfpista"] == 1){ $gesartfpista = null;echo "*";}?>&nbsp;Pistas fotopolimeros</td>
								<td width="30%" class="NoiseDataTD">&nbsp;<input type="text" id="gesartfpista" name="gesartfpista" value="<?php echo $gesartfpista ?>" /></td>
							</tr>
							<tr><td colspan="4" class="NoiseFooterTD">&nbsp;Aclaraci&oacute;n</td></tr>
							<tr>
  								<td colspan="4" rowspan="3"><textarea name="gesartdescri" cols="90" rows="3"><?php echo $gesartdescri; ?></textarea></td>
 							</tr>
		  				</table>  		
	  				</td>  
	  			</tr>	
  							...
  							<tr>
  								<td>
  									<div id="filtrlistacolores">
  										<?php 
  											$noAjax = true;
	  										include '../src/FunjQuery/jquery.visors/jquery.artepr.php'; 
  										?>
  									</div>
  								</td>
  							</tr>
			...
			<input type="hidden" name="flagnuevogestionartepr">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="nuevo">  
			<input type="hidden" name="accionnuevogestionartepr"> 
...
<!--		VARIABLES DE LA VISTA -->
			...
			<input type="hidden" name="cod_barras" value="<?php echo $cod_barras ?>">		
		</form>
