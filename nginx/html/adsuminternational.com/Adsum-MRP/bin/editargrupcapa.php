...
ob_start();
	...
	if($accioneditargrupcapa) 
	{ 
		include ( 'editagrupcapa.php'); 
...
ob_end_flush();
	...
	if(!$flageditargrupcapa)
	{
		...
		for($a = 0; $a < $nrInsgrupcapa; $a++)
		{
			...
			$lstempleado .= ($lstempleado) ? ','.$rwInsgrupcapa['usuacodi'] : $rwInsgrupcapa['usuacodi'];
		}  
	}
?>
<html> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">grupo</font></p> 
...
<?php endif; ?>
				...
				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" > 
 							<tr>
								<td width="10%" class="NoiseFooterTD"><?php if($campnomb["grucapnombre"] == 1){ $grucapnombre = null; echo "*";}?>&nbsp;Nombre&nbsp;</td>
								<td width="30%" class="NoiseDataTD" colspan="2"><input type="text" name="grucapnombre" size="70"	value="<?php if(!$flageditargrupcapa){ echo $sbreg[grucapnombre];}else {echo $grucapnombre; }?>"></td>
 							</tr>
 						</table> 
            			...
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
							...
							<tr><td class="NoiseDataTD"><textarea name="grucapdescri" rows="3" cols="91"><?php if(!$flagnuevoacceje){ echo $sbreg[grucapdescri];}else{ echo $grucapdescri;} ?></textarea>  </td></tr>																	
						</table>
					</td>
				</tr> 
				<tr><td>&nbsp;</td></tr>
			...
			<input type="hidden" name="accioneditargrupcapa">
