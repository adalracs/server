<!--  division contenedora del programa de troquelado-->
<?php 
	...
	if(!$noAjax)
	{
		...
		require_once ( '../src/FunPerPriNiv/pktblprogramatroquelado.php');
		...
		require_once ( '../src/FunPerPriNiv/pktbloptroquelado.php');
...
<div id="programatroquelado">
	...
	<div id="<?php echo $obj_tab ?>" >
		<?php 
			...
			switch ( $sourcetable ) {
    			case "gestionopp" :
        			include '../src/FunjQuery/jquery.visors/gestionopp/jquery.programatql.php';
        			break;
    			case "reporteopp":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programatql.php';
        			break;
    			case "gestionopparte":
        			include '../src/FunjQuery/jquery.visors/produccion/jquery.programatql.php';
        			break;
        		...
        		case "gestionopprequisicion":
        			include '../src/FunjQuery/jquery.visors/gestionopprequisicion/jquery.programatql.php';
        			break;
        		...
        		case "gestionoppanalisispr":
        			...
        			break;
        		default:
       				include '../src/FunjQuery/jquery.visors/programacion/jquery.programatql.php';
       				break;
			}
