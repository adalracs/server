...
ob_start(); 
	...
	if($accionborrarproveedesa) 
		include ( 'borraproveedesa.php'); 
	else 
	{ 
		if($accionconsultarproveedesa) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultarproveedesa = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('proveedesa',$inicio,$fin,$mov,$accionconsultarproveedesa,$recarreglo); 
	...
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablproveedesa.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
 				...
 				<tr> 
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								include ( '../src/FunGen/sesion/fncvisregproveedesa.php'); 
								$reg[0] = 'prodescodigo';
								$reg1[0] = 'n'; 
								$nureturn = fncvisregproveedesa('proveedesa', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="proveedesa"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="proveedesa"> 
			...
			<input type="hidden" name="selcampos" value="prodescodigo">
			<!--											-->
