...
<html> 
	<head> 
		<title>Borrar registro de estado de item</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="accionborraritemestado">
			<input type="hidden" name="flagborraritemestado" value="1">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="itestacodigo" value="<?php echo $sbreg[itestacodigo]; ?>">
