...
<html> 
	<head> 
		<title>Consultar reporte saldo</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
  					...
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="0" align="center"> 
							<tr>
								...
								<td width="83%" class="NoiseDataTD"><input type="text" name="itreportesaldo" size="30"	value="<?php echo $itreportesaldo; ?>"></td> 
 							</tr>
							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Kilogramos&nbsp;</td>
								<td width="83%" class="NoiseDataTD"><input type="text" name="kgreportesaldo" size="30"	value="<?php echo $kgreportesaldo; ?>"></td> 
 							</tr>
							<tr>
								<td width="17%" class="NoiseFooterTD">&nbsp;Metros&nbsp;</td>
								<td width="83%" class="NoiseDataTD"><input type="text" name="mtreportesaldo" size="30"	value="<?php echo $mtreportesaldo; ?>"></td> 
 							</tr>
						</table> 
  					</td> 
 				</tr> 
 			...
 			<input type="hidden" name="flagconsultarreportesaldo" value="1"> 
			<input type="hidden" name="accionconsultarreportesaldo"> 
			<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>">
			<input type="hidden" name="sourceaction" value="consultar">
			<input type="hidden" name="columnas" value="itreportesaldo, kgreportesaldo, mtreportesaldo">
