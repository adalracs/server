...
<html> 
	<head> 
		<title>Borrar registro de bodega</title> 
	...
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<table border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content" width="550">
				...
				<tr> 
  					<td> 
            			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center"> 
							...
							<tr><td colspan="2" class="NoiseDataTD">&nbsp;<?php echo $sbreg[bodeganota]; ?></textarea>  </td></tr>
						</table> 
  					</td> 
 				</tr> 
				<tr><td>&nbsp;</td></tr>
 			...
 			<input type="hidden" name="flagborrarbodega1" value="1"> 
			<input type="hidden" name="accionborrarbodega1">
