...
<html> 
<head> 
<title>Borrar registro de Parametro</title> 
...
<script language="JavaScript"> 
<!-- Begin
function foo(){ form1.accionborrarparametr.value =  1; }
//  End -->
</script> 
</head> 
<?php 
...
if(!$flagborrarparametr){ echo $sbreg[moducodi];}else{ echo $moducodi; } ?>" 
...
if(!$flagborrarparametr){ echo $sbreg[paracodi];}else{ echo $paracodi; } ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarparametr){ echo $sbreg[paradesc];}else{ echo $paradesc;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarparametr){ echo $sbreg[paravalo];}else{ echo $paravalo;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
               <tr> 
...
if(!$flagborrarparametr){ echo $sbreg[parapres];}else{ echo $parapres;} ?>" 
onFocus="if (!agree)this.blur();" > 
                </td> 
              </tr> 
              <tr> 
...
<input type="hidden" name="flagborrarparametr" value="1"> 
<input type="hidden" name="accionborrarparametr"> 
