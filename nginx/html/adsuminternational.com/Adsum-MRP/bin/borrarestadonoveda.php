...
<html> 
	<head> 
		<title>Borrar de registro de Novedades</title> 
...
<?php if(!$codigo){ echo "<!--";} ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			...
			<input type="hidden" name="estnovcodigo" value="<?php echo $sbreg[estnovcodigo]; ?>">
 			<input type="hidden" name="flagborrarestadonoveda" value="1"> 
			<input type="hidden" name="accionborrarestadonoveda">
