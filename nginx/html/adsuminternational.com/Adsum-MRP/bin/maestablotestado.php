...
if($accionconsultarotestado)
{
	...
	if(!$nusw)
		$accionconsultarotestado = 0;
}

include ( '../src/FunGen/sesion/fncaumdec.php'); 
include('../src/FunGen/fncpageposition.php');

$intervalo = fncaumdec ('otestado',$inicio,$fin,$mov,$accionconsultarotestado,$recarreglo); 
...
<html> 
<head> 
<title>Registros de otestado</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de estados de OT</font><br><br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr>
  <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablotestado.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevotestado.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarotestado.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablotestado.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablotestado.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarotestado.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarotestado.php';
...
onclick="form1.action='."'".'editarotestado.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'otestacodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('exammedi', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
?>
   </table> 
   </td> 
  </tr> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'primero';form1.action='maestablotestado.php';" 
alt="Primero"></td> 
...
'menos';form1.action='maestablotestado.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablotestado.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
   <td colspan="6"><input type="submit" name="regla" value="Reglas" onclick="form1.action='ingrnuevregotestado.php';"></td> 
...
"> 
 ...
 <input type="hidden" name="otestanombre" value="<?php echo $otestanombre; ?>"> 
 <input type="hidden" name="otestadescri" value="<?php echo $otestadescri; ?>"> 
 <input type="hidden" name="otestatipo" value="<?php echo $otestatipo; ?>"> 
 <input type="hidden" name="accionconsultarotestado" value="<?php echo $accionconsultarotestado; ?>"> 
...
<input type="hidden" name="selcampos" value="otestacodigo, otestanombre">
<!--											-->
