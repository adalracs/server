...
ob_start(); 
	...
	if($accionborrartipoproveedor) 
		include ( 'borratipoproveedor.php'); 
	else 
	{ 
		if($accionconsultartipoproveedor) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultartipoproveedor = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('tipoproveedor',$inicio,$fin,$mov,$accionconsultartipoproveedor,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de tipo de proveedor</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado de tipos de proveedores</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipoproveedor.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
 				...
 				<tr> 
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							...
							<?php 
								include ( '../src/FunGen/sesion/fncvisregtipoproveedor.php'); 
								$reg[0] = 'tipprocodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregtipoproveedor('tipoproveedor', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="tipoproveedor"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="tipoproveedor"> 
			...
			<input type="hidden" name="selcampos" value="tipprocodigo">
			<!--											-->
