...
$intervalo = fncaumdec('usuario',$inicio,$fin,$mov,$accionconsultarusuario,$recarreglo); 
...
<p><font class="NoiseFormHeaderFont">Listado de empleados</font><br>
  <br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE" width="85%"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablusuacolab.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevusuacolab.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarusuacolab.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='menos';form1.action='maestablusuacolab.php';" alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='mas';form1.action='maestablusuacolab.php';" alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarusuacolab.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarusuacolab.php';
...
onclick="form1.action='."'".'editarusuacolab.php'."'".';"  width="87" 
...
cellpadding="1"> 
<tr> 
<td width="6%" class="NoiseFieldCaptionTD"><span class="style5"><font 
...
color="#FFFFFF">Registro</font></span></td> 
<td width="10%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">C&eacute;dula</font></span></td> 
<td width="29%" class="NoiseFieldCaptionTD"><span class="style5"><font 
...
<td width="15%" class="NoiseFieldCaptionTD"><span class="style5"><font 
color="#FFFFFF">Tipo Usuario</font></span></td> 
</tr> 

<?php 
include ( '../src/FunGen/sesion/fncvisregusuarigen.php'); 
	$reg[0] = 'usuacodi'; 
	$reg1[0] = 'n'; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='primero';form1.action='maestablusuacolab.php';" alt="Primero"></td> 
   <td width="46"><input type="image" name="adelanta"  
src="../img/adelanta.gif" onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='menos';form1.action='maestablusuacolab.php';" 
alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value='ultimo';form1.action='maestablusuacolab.php';" alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablusuacolab.php',$flagcheck); ?></td> 
  </tr> 
