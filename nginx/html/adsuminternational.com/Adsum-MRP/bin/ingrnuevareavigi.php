...
<tr>
	<td width="749" class="NoiseColumnTD">Creacion de area de vigilancia </td>
</tr>
<tr>
...
<tr>
	<td><table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td width="17%" class="NoiseSeparatorTD"><div align="center">Fecha y Hora</div></td>
  			<td width="18%" class="NoiseSeparatorTD"><?php $fecha=date("Y-m-d");echo $fecha; ?>
  			  :
  			    <?php $horainicial= date("H:i"); echo $horainicial; ?></td>
  		    <td width="33" colspan="2" class="NoiseSeparatorTD"><div align="right">Estado de creaci&oacute;n </div></td>
  		    <td width="16%" colspan="2" class="NoiseSeparatorTD"><select name="otestacodigo">
          ...
          <tr>
            <td colspan="3">De click en cada posici&oacute;n para se&ntilde;alar un vigia </td>
            <td colspan="2">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
		  <td colspan="6"><p align="center"><iframe src="http://localhost/sistema/bin/ingrnuevareavigi2.php"
      width="700" height="500" scrolling="auto" frameborder="1">
      <p>Texto alternativo para navegadores que no aceptan iframes.</p>
    </iframe></p></td>
		  </tr>
          <tr>
            <td colspan="6" class="NoiseSeparatorTD">Empleados involucrados</td>
          </tr>
          <tr>
            <td>
	Usted ha se&ntilde;alado </td>
            <td><input name="empleacod2" type="text"	value="<?php if($flagnuevoot) echo $empleacod; ?>" size="8"> 
              vigias </td>
            <td><input type="button" name="radio1" value="Buscar encargado" onClick="window.open('consultarusuarioot.php?codigo=<?php echo $codigo?>','','status=no,menubar=no,scrollbars=yes,resizable=yes,left=300,width=800,height=600');" width="86" height="18" border=0 href="#" target="_parent"></td>
