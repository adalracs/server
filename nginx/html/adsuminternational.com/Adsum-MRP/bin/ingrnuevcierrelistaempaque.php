<?php 
	...
	include ('../src/FunPerPriNiv/pktblcierrelistaempaque.php');
	include ('../src/FunPerPriNiv/pktblvistalistaempaque.php');
	include ('../src/FunPerPriNiv/pktbltipocump.php');
	include ( '../src/FunGen/fncstrfecha.php');
	include ('../src/FunGen/cargainput.php');
	
	if($accionnuevocierrelistaempaque)
		include ( 'grabacierrelistaempaque.php');
	...
	{	
		...
		$rsCierreoe = dinamicscancierrelistaempaque($lisempcodigo,$idcon);
		if($rsCierreoe > 0){
			$err = 'La Orden de Entega {oe} se encuentra Cerrada';
		}else{
			$rwOe = loadrecordvistalistaempaque($lisempcodigo,$idcon);
		...
		$rsOereporteopprepotepn = dinamicscanoplistaempreporteoppreportepn(array('lisempcodigo' => $rwOe['lisempcodigo']),array('lisempcodigo' => '='),$idcon);
		$nrOereporteopprepotepn = fncnumreg($rsOereporteopprepotepn);
		unset($arrlistaempaque);
...
<?php if (! $codigo) echo "<!--"; ?> 
	<body bgcolor="FFFFFF" text="#000000"> 
		<form name="form1" method="post" enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Cierre Lista de Empaque</font></p> 
...
<?php endif; ?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="ui-widget-content">
							<tr class="ui-widget-header">
								<td width="100%" class="cont-title">&nbsp;Orden de entrega No.&nbsp;<input type="text" name="lisempcodigo" id="lisempcodigo" size="13" value="<?php echo $lisempcodigo; ?>" title="Digite el Numero de la Orden de entega ..."><button id="reloadform">Reload</button></td>
							</tr>
						</table>
					</td>
				</tr> 
								...
								<td>
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" class="ui-widget-content">
										<tr>
											...
											<td width="30%" class="NoiseDataTD">&nbsp;<?php echo ($rwOe['lisempestacodigo'])? cargalistaempaqueestanombre($rwOe['lisempestacodigo'],$idcon) : '---' ;?></td>
										...
										<tr>
											...
											<td width="30%" class="NoiseDataTD">&nbsp;<?php echo ($rwOe['lisempnumept'])? $rwOe['lisempnumept'] : '---' ; ?></td> 	
										</tr>
										<tr>
										  <td class="NoiseFooterTD">&nbsp;Direccion:</td>
										  <td colspan="3" class="NoiseDataTD">&nbsp;<?php echo ($rwOe['lisempdireccion'])? $rwOe['lisempdireccion'] : '---' ; ?></td>
									  </tr>
										<tr>
										...
										<tr><td colspan="4" rowspan="2" class="NoiseDataTD">&nbsp;<?php echo ($rwOe['lisempdescri'])? $rwOe['lisempdescri'] : '' ; ?></td></tr>
									</table>
								</td>
							</tr>
							<tr>
								...
								<td width="30%" class="NoiseDataTD">&nbsp;
									<select name="lisempestacodigo" id="lisempestacodigo">
										...
										<?php 
											...
											floadlistaempaqueestadocierre($lisempestacodigo,$idcon);
										?>
									</select>
								</td>
							</tr>
							<tr><td colspan="4" class="NoiseFooterTD"><?php if($campnomb["cielisdescri"] == 1){ $cielisdescri = null;echo "*";}?>&nbsp;Aclaraci&oacute;n</td></tr>
							<tr>
  								<td colspan="4" rowspan="3"><textarea name="cielisdescri" cols="90" rows="3"><?php echo $cielisdescri; ?></textarea></td>
 							</tr>
						</table>
					</td>
				</tr>
			...
			<input type="hidden" name="flagnuevocierrelistaempaque">
			<input type="hidden" name="sourcetable" value="<?php echo $sourcetable; ?>"> 
			<input type="hidden" name="sourceaction" id="sourceaction" value="nuevo">  
			<input type="hidden" name="accionnuevocierrelistaempaque"> 
