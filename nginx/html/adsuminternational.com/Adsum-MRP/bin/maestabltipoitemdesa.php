...
ob_start(); 
	...
	if($accionborrartipoitemdesa) 
		include ( 'borratipoitemdesa.php'); 
	else 
	{ 
		if($accionconsultartipoitemdesa) 
		{ 
			$nusw = 0; 
			...
			if(!$nusw)
				$accionconsultartipoitemdesa = 0; 
		} 
	} 
	include ( '../src/FunGen/sesion/fncaumdec.php'); 
	include('../src/FunGen/fncpageposition.php');
	
	$intervalo = fncaumdec('tipoitemdesa',$inicio,$fin,$mov,$accionconsultartipoitemdesa,$recarreglo); 
...
<html> 
	<head> 
		<title>Registros de planes de inspecci&oacute;n</title> 
...
<?php if(!$codigo){ echo "<!--";} ?>
	<body bgcolor="FFFFFF" class="NoisePageBODY"> 
		<form name="form1" method="post"  enctype="multipart/form-data"> 
			<p><font class="NoiseFormHeaderFont">Listado  planes de inspecci&oacute;n</font><br><br></p> 
			<table border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content" width="550">
				<tr><td class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestabltipoitemdesa.php',$flagcheck); ?></td></tr>
  				<tr><td>&nbsp;</td></tr> 
  					...
  					<td> 
  						<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="ui-widget-content"> 
							<tr> 
								...
								<td width="55%" class="ui-state-default">Descripcion</td> 
							</tr> 
							<?php 
								include ( '../src/FunGen/sesion/fncvisregtipoitemdesa.php'); 
								$reg[0] = 'tipitemcodigo'; 
								$reg1[0] = 'n'; 
								$nureturn = fncvisregtipoitemdesa('tipoitemdesa', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck);
							?> 
   						</table> 
   					</td> 
  				</tr> 
 			...
 			<input type="hidden" name="sourcetable" value="tipoitemdesa"> 
 			<input type="hidden" name="selstar" id="selstar" value="0"> 
 			<input type="hidden" name="nombtabl" value="tipoitemdesa"> 
			...
			<input type="hidden" name="selcampos" value="tipitemcodigo">
			<!--											-->
