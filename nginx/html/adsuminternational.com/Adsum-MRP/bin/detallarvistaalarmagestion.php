...
ob_start();
	...
	if(!$flagdetallarvistaalarmagestion) 
	{ 
...
<?php endif; ?>
		    ...
		    <tr> 
                          ...
                          <tr>
							...
							<tr style="display:<?php echo ($nivalacodigo == 2 )? 'auto':'none';?>">
							  ...
							  <td class="NoiseDataTD"><?php 
							  			$idcon = fncconn(); 
							  			echo carganombrecliente($ordcomcodcli,$idcon); //echo $sbreg[ordcomcodcli];  
							  			?></td>
						    </tr>
 			...
 			<input type="hidden" name="flagdetallarvistaalarmagestion" value="1"> 
			<input type="hidden" name="acciondetallarvistaalarmagestion">
