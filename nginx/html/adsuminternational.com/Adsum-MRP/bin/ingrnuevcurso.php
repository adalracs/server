...
<?php endif; ?> 
							...
							<tr> 
 							...
 							<tr><td colspan="2" class="NoiseFooterTD"><?php if($campnomb["cursoobjeti"] == 1){ $cursoobjeti=null; echo "*";} ?>&nbsp;Objetivo</td></tr>
  							...
  							<tr> 
 								...
 								<td width="78%" class="NoiseDataTD"><input type="text" name="cursofecha" id="cursofecha"  size="10" value="<?php if(!$flagnuevocurso){echo $sbreg[cursofecha];}else{ echo $cursofecha; }?>" onclick="this.blur();"></td> 
 							</tr>
			...
			<input type="hidden" name="accionnuevocurso">  
