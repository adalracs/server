...
?>
	<body bgcolor="#FFFFFF" class="NoisePageBODY">
		<form name="form1" method="post"  enctype="multipart/form-data">
			<font class="NoiseFormHeaderFont"> Consulta de usuarios</font> 
			<table border="0" cellspacing="1" cellpadding="2" align="center" class="NoiseFormTABLE" width="60%">
    				<tr><td class="NoiseErrorDataTD">&nbsp;</td></tr>
    				<tr><td class="NoiseFieldCaptionTD"><span class="style5"><font color="FFFFFF">Consultar usuario</font></span></td></tr>
    				<tr>
      					<td>
        						<table width="95%" border="0" cellspacing="1" cellpadding="0" align="center">
        							<tr>
          							...
          							<tr>
            							<td width="22%" class="NoiseFooterTD"><?php if($campnomb["usuanomb"] == 1){ $usuanomb = null; echo "*";} ?>&nbsp;Login</td>
            							<td class="NoiseFooterTD" width="25%"><input name="usuanomb" type="text" value="<?php if(!$flagnuevousuario){ echo $sbreg[usuanomb];}else{ echo $usuanomb;} ?>" size="14"></td>
            							<td colspan="2" class="NoiseFooterTD">&nbsp;</td>
          							</tr>
							...
							<tr>
								...
								?>            							
          							...
          							<tr>
	            						<td colspan="4"><div align="center">Activo              
	                							<input type="radio" name="usuaacti" value="1">
	                							<font size="2" face="Arial, Helvetica,sans-serif">Inactivo</font>
	                							<input type="radio" name="usuaacti" value="2">            
	                						</div></td>
          							</tr>
      						</table>
      					</td>
    				...
    				<tr> 
      					<td colspan="2"> 
        						<div align="center">
          							<input type="image" name="aceptar" src="../img/aceptar.gif" onClick="form1.accionconsultarusuario.value =  1;form1.action='maestablusuario.php';" width="86" height="18" alt="Aceptar" border=0>
          							<input type="image" name="cancelar" src="../img/cancelar.gif" onClick="form1.action='maestablusuario.php';"  width="86" height="18" alt="Cancelar" border=0>
        						</div>
      					</td>
    				</tr>
