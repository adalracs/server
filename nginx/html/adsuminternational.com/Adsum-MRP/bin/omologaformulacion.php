...
Funcion         : omologaformulacion
Decripcion      : Valida la data a omologar y la lleva al paquete.
...
function omologaformulacion(&$iRegformulacion,&$flagnuevoformulacion,&$campnomb)
{
	$nuconn = fncconn();
...
$iRegformulacion[formulorden] = $omologacion;


omologaformulacion($iRegformulacion,$flagnuevoformulacion,$campnomb);
