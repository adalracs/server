...
if($accionborrarsoliservestado) 
{ 
	include ( 'borrasoliservestado.php'); 
} 
else 
{ 
		if($accionconsultarsoliservestado) 
			{ 
//				include ( '../src/FunGen/sesion/fncalmdatc.php'); 
				...
				if(!$nusw){ 
					$accionconsultarsoliservestado = 0; 
				} 
			} 
	} 
...
$intervalo = fncaumdec ('soliservestado',$inicio,$fin,$mov,$accionconsultarsoliservestado,$recarreglo); 
...
<p><font class="NoiseFormHeaderFont">Listado de estados de solicitud de servicio</font><br><br></p> 
<table border="0" cellspacing="1" cellpadding="2" align="center" 
class="NoiseFormTABLE"> 
 <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablsoliservestado.php',$flagcheck); ?></td> 
 </tr> 
  <tr> 
  <td> 
  <?php 
...
onclick="form1.action='."'".'ingrnuevsoliservestado.php'."'".';"  width="86" 
...
onclick="form1.action='."'".'consultarsoliservestado.php'."'".';"  width="86" 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'menos';form1.action='maestablsoliservestado.php';" 
alt="Anterior"></td> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'mas';form1.action='maestablsoliservestado.php';" 
alt="Siguiente"></td> 
 </tr> 
 <tr> 
...
onclick="form1.action='."'".'detallarsoliservestado.php'."'".';"  width="87" 
...
onclick="';
	...
	else echo 'form1.action='."'".'borrarsoliservestado.php';
...
onclick="form1.action='."'".'editarsoliservestado.php'."'".';"  width="87" 
...
include ( '../src/FunGen/sesion/fncvisreg.php'); 
	$reg[0] = 'estsolcodigo'; 
	$reg1[0] = 'n'; 
	$nureturn = fncvisreg('soliservestado', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
?> 
   </table> 
   </td> 
  </tr> 
...
'primero';form1.action='maestablsoliservestado.php';" alt="Primero"></td> 
...
'menos';form1.action='maestablsoliservestado.php';" alt="Anterior"></td> 
   <td width="50"> 
<?php 
        	echo $intervalo[inicio].'-'.$intervalo[fin].' de '.$intervalo[total]; 
?> 
...
onclick="<?php if($flagcheck) echo 'cargarcheck(this.form); '; ?>form1.mov.value = 'ultimo';form1.action='maestablsoliservestado.php';" 
alt="Ultimo"></td> 
  </tr> 
  <tr> 
 <td colspan="6" class="NoiseErrorDataTD" align="right"> <?php page_position($intervalo,'maestablsoliservestado.php',$flagcheck); ?></td> 
...
"> 
 ...
 <input type="hidden" name="estsolnombre" value="<?php echo $estsolnombre; ?>"> 
 <input type="hidden" name="estsoldescri" value="<?php echo $estsoldescri; ?>"> 
 <input type="hidden" name="estsoltipo" value="<?php echo $estsoltipo; ?>"> 
 <input type="hidden" name="accionconsultarsoliservestado" value="<?php echo $accionconsultarsoliservestado; ?>"> 
...
<input type="hidden" name="selcampos" value="estsolcodigo, estsolnombre">
<!--											-->
