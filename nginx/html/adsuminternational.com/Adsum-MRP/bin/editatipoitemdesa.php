...
function editatipoitemdesa($iRegtipoitemdesa,&$flageditartipoitemdesa,&$campnomb,&$codigo)
{
	$nuconn = fncconn();
	define("errorReg",1);
	define("errorCar",2);
	...
	{ 
		...
		if($flagerror != 1)
		{
			$result = uprecordtipoitemdesa($iRegtipoitemdesa,$nuconn);
			if($result < 0 )
			{
				ob_end_clean();
...
editatipoitemdesa($iRegtipoitemdesa,$flageditartipoitemdesa,$campnomb,$codigo);
?> 
