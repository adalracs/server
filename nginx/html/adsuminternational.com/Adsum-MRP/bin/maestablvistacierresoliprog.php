...
if ($accionborrarvistacierresoliprog) { 
	include ('borravistacierresoliprog.php'); 
} else { 
	if ($accionconsultarvistacierresoliprog) { 
		$nusw = 0; 
		...
		if (! $nusw) { 
			$accionconsultarvistacierresoliprog = 0; 
		} 
	} 
} 
...
$intervalo = fncaumdec ( 'vistacierresoliprog', $inicio, $fin, $mov, $accionconsultarvistacierresoliprog, $recarreglo ); 
...
<html> 
<head> 
<title>Registros de solicitud de programacion de programacion</title> 
...
<p><font class="NoiseFormHeaderFont">Listado de Cierre de Solicitudes de programacion </font></p> 
<table width="850px" border="0" cellspacing="1" cellpadding="0" align="center" class="ui-widget-content"> 
	...
	<?php 
	page_position ( $intervalo, 'maestablvistacierresoliprog.php', $flagcheck ); 
	?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	...
	<tr> 
		...
		<table width="100%" border="0" align="center" cellspacing="1" 
			...
			<tr> 
				...
				<?php 
				include ('../src/FunGen/sesion/fncvisregvistacierresoliprog.php'); 
				$reg [0] = 'solprocodigo'; 
				$reg1 [0] = 'n'; 
				$nureturn = fncvisregvistacierresoliprog ( 'vistacierresoliprog', $reg, $reg1, $idtrans, $arr_borrar, $flagcheck); 
				?> 
		</table> 
		</td> 
	</tr> 
	...
	<tr> 
		<td><?php include ('../def/jquery.button_navdown.php'); ?></td> 
	</tr> 
	<tr> 
		<td>&nbsp;</td> 
	</tr> 
...
<input type="hidden" name="sourcetable" value="vistacierresoliprog"> 
<input type="hidden" name="selstar" id="selstar" value="0"> 
<input type="hidden" name="nombtabl" value="vistacierresoliprog"> 
<input type="hidden" name="columnas" value="solprocodigo"> 
<input type="hidden" name="solprocodigo" value="<?php if ($accionconsultarvistacierresoliprog) { echo $solprocodigo; } ?>">  
<input type="hidden" name="accionconsultarvistacierresoliprog"	value="<?php echo $accionconsultarvistacierresoliprog; ?>"> 
